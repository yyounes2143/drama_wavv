...
.method public static synthetic k(Ljava/util/stream/LongStream;)Lj$/util/stream/n0;
    .locals 1
...
# virtual methods
.method public final synthetic a()Lj$/util/stream/n0;
    .locals 2

    const/4 v0, 0x0

    .line 0
    iget-object v1, p0, Lj$/util/stream/l0;->a:Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/l0;->k(Ljava/util/stream/LongStream;)Lj$/util/stream/n0;
...
.method public final synthetic average()Lj$/util/OptionalDouble;
    ...
    invoke-static {v0}, Lj$/util/P;->j(Ljava/util/OptionalDouble;)Lj$/util/OptionalDouble;
...
.method public final synthetic b()Lj$/util/stream/n0;
    .locals 2
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/d3;->k(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic c()Lj$/util/stream/n0;
    .locals 2
...
.method public final synthetic e()Lj$/util/stream/n0;
    .locals 2
...
.method public final synthetic findAny()Lj$/util/OptionalLong;
    ...
    invoke-static {v0}, Lj$/util/P;->l(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic iterator()Lj$/util/M;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/K;->a(Ljava/util/PrimitiveIterator$OfLong;)Lj$/util/M;
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/d3;->k(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Lj$/util/stream/n0;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/OptionalLong;
    ...
    invoke-static {p1}, Lj$/util/P;->l(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/c0;->a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
...
.method public final synthetic spliterator()Lj$/util/Y;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/W;->a(Ljava/util/Spliterator$OfLong;)Lj$/util/Y;
