...
.method public static synthetic k(Lj$/util/stream/n0;)Ljava/util/stream/LongStream;
    .locals 1
...
.method public final synthetic allMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->r()Z
...
.method public final synthetic anyMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->w()Z
...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->asDoubleStream()Lj$/util/stream/E;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->average()Lj$/util/OptionalDouble;

    move-result-object v0

    invoke-static {v0}, Lj$/util/P;->n(Lj$/util/OptionalDouble;)Ljava/util/OptionalDouble;
...
.method public final synthetic distinct()Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/m0;->k(Lj$/util/stream/n0;)Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findAny()Lj$/util/OptionalLong;

    move-result-object v0

    invoke-static {v0}, Lj$/util/P;->p(Lj$/util/OptionalLong;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findFirst()Lj$/util/OptionalLong;
...
.method public final flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/n0;->d(Lj$/util/stream/a;)Lj$/util/stream/n0;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->iterator()Lj$/util/M;

    move-result-object v0

    invoke-static {v0}, Lj$/util/L;->a(Lj$/util/M;)Ljava/util/PrimitiveIterator$OfLong;
...
.method public final synthetic map(Ljava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->e()Lj$/util/stream/n0;
...
.method public final synthetic mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->l()Lj$/util/stream/E;
...
.method public final synthetic mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->x()Lj$/util/stream/IntStream;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->max()Lj$/util/OptionalLong;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->min()Lj$/util/OptionalLong;
...
.method public final synthetic noneMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->n()Z
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/n0;->reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/OptionalLong;

    move-result-object p1

    invoke-static {p1}, Lj$/util/P;->p(Lj$/util/OptionalLong;)Ljava/util/OptionalLong;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->spliterator()Lj$/util/Y;
