...
.method static constructor <clinit>()V
    ...
    .line 743
    invoke-virtual {v0, v6, v7}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 745
    invoke-virtual {v0, v8, v7}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V

    sget-object v9, Lj$/time/format/C;->STRICT:Lj$/time/format/C;

    sget-object v10, Lj$/time/chrono/r;->e:Lj$/time/chrono/r;

    .line 746
    invoke-virtual {v0, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 774
    invoke-virtual {v11, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 840
    invoke-virtual {v11, v12, v7}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 842
    invoke-virtual {v11, v14, v7}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 845
    invoke-virtual {v11, v15, v7}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 847
    invoke-virtual {v11, v13, v7, v5, v3}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/a;IIZ)V

    const/4 v5, 0x0

    .line 848
    invoke-virtual {v11, v9, v5}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;

    move-result-object v7

    sput-object v7, Lj$/time/format/DateTimeFormatter;->g:Lj$/time/format/DateTimeFormatter;
    ...
    sput-object v11, Lj$/time/format/DateTimeFormatter;->h:Lj$/time/format/DateTimeFormatter;
    ...
    .line 963
    invoke-virtual {v7}, Lj$/time/format/DateTimeFormatterBuilder;->v()V

    .line 964
    invoke-virtual {v7}, Lj$/time/format/DateTimeFormatterBuilder;->i()V

    .line 965
    invoke-virtual {v7}, Lj$/time/format/DateTimeFormatterBuilder;->w()V

    .line 966
    invoke-virtual {v7, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    sput-object v11, Lj$/time/format/DateTimeFormatter;->j:Lj$/time/format/DateTimeFormatter;
    ...
    .line 1079
    invoke-virtual {v0, v1, v7, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->p(Lj$/time/temporal/q;IILj$/time/format/D;)V
    ...
    .line 1081
    invoke-virtual {v0, v7, v11}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1123
    invoke-virtual {v0, v7, v11, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->p(Lj$/time/temporal/q;IILj$/time/format/D;)V
    ...
    .line 1125
    invoke-virtual {v0, v2, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1127
    invoke-virtual {v0, v2, v3}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1169
    invoke-virtual {v0, v9, v5}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 1205
    invoke-virtual {v0, v1, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V

    const/4 v4, 0x2

    .line 1206
    invoke-virtual {v0, v6, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V

    .line 1207
    invoke-virtual {v0, v8, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V

    .line 1208
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatterBuilder;->s()V

    .line 1209
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatterBuilder;->v()V
    ...
    .line 1211
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatterBuilder;->w()V
    ...
    .line 1288
    invoke-virtual {v3, v2, v0}, Lj$/time/format/DateTimeFormatterBuilder;->k(Lj$/time/temporal/a;Ljava/util/HashMap;)V
    ...
    .line 1291
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/DateTimeFormatterBuilder;->p(Lj$/time/temporal/q;IILj$/time/format/D;)V
    ...
    .line 1293
    invoke-virtual {v3, v6, v10}, Lj$/time/format/DateTimeFormatterBuilder;->k(Lj$/time/temporal/a;Ljava/util/HashMap;)V
    ...
    .line 1295
    invoke-virtual {v3, v1, v4}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V

    .line 1296
    invoke-virtual {v3, v0}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    .line 1297
    invoke-virtual {v3, v12, v2}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1299
    invoke-virtual {v3, v14, v2}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1302
    invoke-virtual {v3, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->o(Lj$/time/temporal/q;I)V
    ...
    .line 1306
    invoke-virtual {v3, v0, v1}, Lj$/time/format/DateTimeFormatterBuilder;->x(Lj$/time/format/C;Lj$/time/chrono/r;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method constructor <init>(Lj$/time/format/e;Ljava/util/Locale;Lj$/time/format/DecimalStyle;Lj$/time/format/C;Lj$/time/chrono/r;Lj$/time/ZoneId;)V
    .locals 1
    ...
    iput-object p1, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/C;

    .line 1423
    iput-object p5, p0, Lj$/time/format/DateTimeFormatter;->e:Lj$/time/chrono/r;
...
.method private f(Ljava/lang/CharSequence;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {v4, v2, p1, v3}, Lj$/time/format/e;->q(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v2, p1}, Lj$/time/format/v;->t(Lj$/time/format/C;)Lj$/time/temporal/TemporalAccessor;
...
.method public static ofPattern(Ljava/lang/String;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p0}, Lj$/time/format/DateTimeFormatterBuilder;->y(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method public static ofPattern(Ljava/lang/String;Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p1}, Lj$/time/format/DateTimeFormatterBuilder;->y(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method public final b()Lj$/time/format/DecimalStyle;
    .locals 1
...
.method public final e(Ljava/lang/CharSequence;Lj$/time/temporal/r;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-virtual {v0, p2}, Lj$/time/format/B;->B(Lj$/time/temporal/r;)Ljava/lang/Object;
...
.method public format(Lj$/time/temporal/TemporalAccessor;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p0}, Lj$/time/format/x;-><init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    :try_end_0
    ...
    .line 1796
    :try_start_1
    invoke-virtual {p1, v1, v0}, Lj$/time/format/e;->o(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    :try_end_1
...
.method public withDecimalStyle(Lj$/time/format/DecimalStyle;)Lj$/time/format/DateTimeFormatter;
    ...
    iget-object v6, p0, Lj$/time/format/DateTimeFormatter;->e:Lj$/time/chrono/r;
    ...
    invoke-direct/range {v1 .. v7}, Lj$/time/format/DateTimeFormatter;-><init>(Lj$/time/format/e;Ljava/util/Locale;Lj$/time/format/DecimalStyle;Lj$/time/format/C;Lj$/time/chrono/r;Lj$/time/ZoneId;)V
...
.method public withZone(Lj$/time/ZoneId;)Lj$/time/format/DateTimeFormatter;
    ...
    iget-object v4, p0, Lj$/time/format/DateTimeFormatter;->c:Lj$/time/format/DecimalStyle;
