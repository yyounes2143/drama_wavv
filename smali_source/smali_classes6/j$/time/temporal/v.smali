...
.method private constructor <init>(Ljava/lang/String;Lj$/time/temporal/WeekFields;Lj$/time/temporal/s;Lj$/time/temporal/s;Lj$/time/temporal/u;)V
    .locals 0
...
.method private c(Lj$/time/temporal/TemporalAccessor;)I
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    .line 833
    :cond_0
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->t(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method private d(Lj$/time/temporal/TemporalAccessor;)I
    ...
    .line 866
    invoke-interface {p1, v1}, Lj$/time/temporal/TemporalAccessor;->t(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method static e(Lj$/time/temporal/WeekFields;)Lj$/time/temporal/v;
    .locals 7
...
.method private f(Lj$/time/chrono/Chronology;III)Lj$/time/chrono/b;
    .locals 3

    const/4 v0, 0x1

    .line 741
    invoke-interface {p1, p2, v0, v0}, Lj$/time/chrono/Chronology;->H(III)Lj$/time/chrono/b;
...
.method static g(Lj$/time/temporal/WeekFields;)Lj$/time/temporal/v;
    .locals 7
...
.method static h(Lj$/time/temporal/WeekFields;)Lj$/time/temporal/v;
    .locals 7
...
.method static i(Lj$/time/temporal/WeekFields;)Lj$/time/temporal/v;
    .locals 7
...
.method private j(Lj$/time/temporal/TemporalAccessor;Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 1129
    invoke-interface {p1, p2}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    .line 1130
    invoke-interface {p1, p2}, Lj$/time/temporal/TemporalAccessor;->t(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method private k(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/u;
    ...
    invoke-interface {v1, p1}, Lj$/time/chrono/Chronology;->r(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
...
.method public final B(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/u;
    ...
    .line 1112
    :cond_2
    sget-object v0, Lj$/time/temporal/WeekFields;->h:Lj$/time/temporal/s;
...
.method public final q(Ljava/util/HashMap;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/C;)Lj$/time/temporal/TemporalAccessor;
    ...
    iget-object v10, v0, Lj$/time/temporal/v;->b:Lj$/time/temporal/WeekFields;
    ...
    invoke-virtual {v3, v12, v13}, Lj$/time/temporal/a;->T(J)I
    ...
    invoke-virtual {v13, v8, v9}, Lj$/time/temporal/a;->T(J)I
    ...
    .line 976
    invoke-interface {v12, v6, v11, v11}, Lj$/time/chrono/Chronology;->H(III)Lj$/time/chrono/b;
    ...
    invoke-interface {v2, v6}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    .line 977
    invoke-static {v9, v10, v5, v6}, Lj$/com/android/tools/r8/a;->n(JJ)J
    ...
    .line 981
    invoke-virtual {v5, v14, v15}, Lj$/time/temporal/a;->T(J)I

    move-result v7

    .line 982
    invoke-interface {v12, v6, v7, v11}, Lj$/time/chrono/Chronology;->H(III)Lj$/time/chrono/b;
    ...
    invoke-interface {v6, v10}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    invoke-interface {v4, v5}, Lj$/time/temporal/TemporalAccessor;->w(Lj$/time/temporal/q;)J
    ...
    invoke-interface {v5, v6}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    .line 1002
    invoke-static {v9, v10, v6, v7}, Lj$/com/android/tools/r8/a;->n(JJ)J
    ...
    invoke-interface {v5, v10}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    invoke-interface {v4, v13}, Lj$/time/temporal/TemporalAccessor;->w(Lj$/time/temporal/q;)J
    ...
    .line 964
    :cond_a
    sget-object v5, Lj$/time/temporal/WeekFields;->h:Lj$/time/temporal/s;
    ...
    .line 1022
    invoke-virtual {v5, v7, v8, v9}, Lj$/time/temporal/u;->a(JLj$/time/temporal/q;)I
    ...
    .line 1026
    invoke-direct {v0, v12, v5, v11, v4}, Lj$/time/temporal/v;->f(Lj$/time/chrono/Chronology;III)Lj$/time/chrono/b;
    ...
    .line 1031
    invoke-virtual {v6, v7, v8, v9}, Lj$/time/temporal/u;->a(JLj$/time/temporal/q;)I

    move-result v6

    .line 1033
    invoke-direct {v0, v12, v5, v6, v4}, Lj$/time/temporal/v;->f(Lj$/time/chrono/Chronology;III)Lj$/time/chrono/b;
...
.method public final w(Lj$/time/temporal/Temporal;J)Lj$/time/temporal/Temporal;
    ...
    .line 912
    invoke-interface {p1, p0}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lj$/time/temporal/v;->f(Lj$/time/chrono/Chronology;III)Lj$/time/chrono/b;
