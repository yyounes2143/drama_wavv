...
.method constructor <init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 125
    invoke-virtual {p2}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/Chronology;
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->B(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/TemporalAccessor;->B(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    invoke-interface {v4, p1, v1}, Lj$/time/chrono/Chronology;->M(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    :cond_6
    :try_start_0
    invoke-virtual {v1}, Lj$/time/ZoneId;->U()Lj$/time/zone/f;
    ...
    .line 154
    invoke-interface {p1, v6}, Lj$/time/temporal/TemporalAccessor;->q(Lj$/time/temporal/q;)I
    ...
    invoke-virtual {v7}, Lj$/time/ZoneOffset;->b0()I
    ...
    .line 164
    invoke-interface {v4, p1}, Lj$/time/chrono/Chronology;->r(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/w;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/TemporalAccessor;Lj$/time/chrono/Chronology;Lj$/time/ZoneId;)V
...
.method final b()Lj$/time/format/DecimalStyle;
    ...
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->b()Lj$/time/format/DecimalStyle;
...
.method final e(Lj$/time/temporal/q;)Ljava/lang/Long;
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->w(Lj$/time/temporal/q;)J
