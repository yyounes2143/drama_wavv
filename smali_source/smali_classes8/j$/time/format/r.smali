...
# direct methods
.method constructor <init>(Lj$/time/temporal/q;Lj$/time/format/TextStyle;Lj$/time/format/A;)V
    .locals 0
...
.method public final o(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/x;->e(Lj$/time/temporal/q;)Ljava/lang/Long;
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/TemporalAccessor;->B(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lj$/time/format/r;->c:Lj$/time/format/A;

    iget-object v4, p0, Lj$/time/format/r;->a:Lj$/time/temporal/q;

    invoke-virtual/range {v2 .. v8}, Lj$/time/format/A;->d(Lj$/time/chrono/Chronology;Lj$/time/temporal/q;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/A;->e(Lj$/time/temporal/q;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/j;-><init>(Lj$/time/temporal/q;IILj$/time/format/D;)V
    ...
    .line 3330
    invoke-virtual {v0, p1, p2}, Lj$/time/format/j;->o(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
...
.method public final q(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    sget-object v4, Lj$/time/chrono/r;->e:Lj$/time/chrono/r;
    ...
    invoke-virtual {v2, v1, v3, v0, v4}, Lj$/time/format/A;->f(Lj$/time/chrono/Chronology;Lj$/time/temporal/q;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v3, v0, v4}, Lj$/time/format/A;->g(Lj$/time/temporal/q;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual/range {v5 .. v10}, Lj$/time/format/v;->s(Ljava/lang/CharSequence;ILjava/lang/CharSequence;II)Z
    ...
    invoke-virtual/range {v5 .. v10}, Lj$/time/format/v;->o(Lj$/time/temporal/q;JII)I
    ...
    .line 3360
    invoke-interface {v1}, Lj$/time/chrono/Chronology;->O()Ljava/util/List;
    ...
    invoke-virtual/range {v2 .. v7}, Lj$/time/format/v;->s(Ljava/lang/CharSequence;ILjava/lang/CharSequence;II)Z
    ...
    invoke-direct {v0, v1, v3, v4, v2}, Lj$/time/format/j;-><init>(Lj$/time/temporal/q;IILj$/time/format/D;)V
    ...
    .line 3372
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/format/j;->q(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
