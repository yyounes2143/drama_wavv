...
.method private A(Lj$/time/chrono/b;)V
    ...
    .line 364
    iget-object v0, p0, Lj$/time/format/B;->f:Lj$/time/chrono/b;
    ...
    iget-object v1, p0, Lj$/time/format/B;->f:Lj$/time/chrono/b;
    ...
    .line 372
    iput-object p1, p0, Lj$/time/format/B;->f:Lj$/time/chrono/b;
...
.method private m()V
    ...
    .line 340
    invoke-direct {p0, v1}, Lj$/time/format/B;->n(Lj$/time/ZoneId;)V
    ...
    .line 345
    invoke-direct {p0, v0}, Lj$/time/format/B;->n(Lj$/time/ZoneId;)V
...
.method private n(Lj$/time/ZoneId;)V
    .locals 4
    ...
    invoke-interface {v2, v0, p1}, Lj$/time/chrono/Chronology;->M(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    invoke-direct {p0, v0}, Lj$/time/format/B;->A(Lj$/time/chrono/b;)V
    ...
    invoke-virtual {p1}, Lj$/time/LocalTime;->m0()I
    ...
    invoke-direct {p0, v1, v0, p1}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
...
.method private r(JJJJ)V
    ...
    .line 548
    invoke-static {p3, p4, v0, v1}, Lj$/com/android/tools/r8/a;->m(JJ)J
    ...
    .line 549
    invoke-static {p5, p6, p3, p4}, Lj$/com/android/tools/r8/a;->m(JJ)J
    ...
    .line 550
    invoke-static {p1, p2, p7, p8}, Lj$/com/android/tools/r8/a;->g(JJ)J
    ...
    invoke-static {p5}, Lj$/time/Period;->b(I)Lj$/time/Period;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lj$/time/format/B;->y(Lj$/time/LocalTime;Lj$/time/Period;)V
    ...
    invoke-static {p2}, Lj$/time/Period;->b(I)Lj$/time/Period;
...
.method private v()V
    ...
    .line 383
    :cond_0
    invoke-virtual {v1, v5, v6}, Lj$/time/temporal/a;->U(J)V
    ...
    invoke-direct {p0, v1, v2, v5}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 391
    :cond_4
    invoke-virtual {v1, v7, v8}, Lj$/time/temporal/a;->U(J)V
    ...
    invoke-direct {p0, v1, v2, v3}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 401
    :cond_8
    invoke-virtual {v1, v3, v4}, Lj$/time/temporal/a;->U(J)V
    ...
    invoke-direct {p0, v1, v2, v7}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v1, v2, v9}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 427
    invoke-virtual {v1, v9, v10}, Lj$/time/temporal/a;->U(J)V
    ...
    invoke-direct {p0, v1, v2, v11}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v4, v1, v7}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v4, v1, v2}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    .line 480
    invoke-direct/range {v5 .. v13}, Lj$/time/format/B;->r(JJJJ)V

    :cond_19
    return-void
.end method

.method private y(Lj$/time/LocalTime;Lj$/time/Period;)V
    .locals 4
    ...
    iget-object v0, p0, Lj$/time/format/B;->h:Lj$/time/Period;
...
.method public final B(Lj$/time/temporal/r;)Ljava/lang/Object;
    ...
    .line 216
    iget-object p1, p0, Lj$/time/format/B;->f:Lj$/time/chrono/b;
    ...
    .line 224
    :cond_5
    iget-object v0, p0, Lj$/time/format/B;->b:Lj$/time/ZoneId;
...
.method public final f(Lj$/time/temporal/q;)Z
    ...
    .line 183
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->f(Lj$/time/temporal/q;)Z
...
.method final h(Lj$/time/format/C;)V
    .locals 23
    ...
    .line 265
    invoke-direct/range {p0 .. p0}, Lj$/time/format/B;->m()V
    ...
    invoke-interface {v0, v10, v1}, Lj$/time/chrono/Chronology;->K(Ljava/util/Map;Lj$/time/format/C;)Lj$/time/chrono/b;

    move-result-object v0

    invoke-direct {v9, v0}, Lj$/time/format/B;->A(Lj$/time/chrono/b;)V
    ...
    invoke-interface {v3, v10, v9, v4}, Lj$/time/temporal/q;->q(Ljava/util/HashMap;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/C;)Lj$/time/temporal/TemporalAccessor;
    ...
    .line 282
    invoke-interface {v4}, Lj$/time/chrono/ChronoZonedDateTime;->u()Lj$/time/ZoneId;
    ...
    .line 286
    :goto_1
    invoke-interface {v4}, Lj$/time/chrono/ChronoZonedDateTime;->G()Lj$/time/chrono/ChronoLocalDateTime;
    ...
    invoke-direct {v9, v1, v2}, Lj$/time/format/B;->y(Lj$/time/LocalTime;Lj$/time/Period;)V

    .line 291
    invoke-interface {v4}, Lj$/time/chrono/ChronoLocalDateTime;->b()Lj$/time/chrono/b;

    move-result-object v1

    invoke-direct {v9, v1}, Lj$/time/format/B;->A(Lj$/time/chrono/b;)V
    ...
    invoke-direct {v9, v4}, Lj$/time/format/B;->A(Lj$/time/chrono/b;)V
    ...
    invoke-direct {v9, v4, v1}, Lj$/time/format/B;->y(Lj$/time/LocalTime;Lj$/time/Period;)V
    ...
    invoke-direct {v9, v0, v3, v1}, Lj$/time/format/B;->C(Lj$/time/temporal/q;Lj$/time/temporal/a;Ljava/lang/Long;)V
    ...
    invoke-direct/range {v0 .. v8}, Lj$/time/format/B;->r(JJJJ)V
    ...
    invoke-virtual {v3}, Lj$/time/temporal/a;->V()Z
    ...
    :cond_15
    :goto_a
    iget-object v0, v9, Lj$/time/format/B;->f:Lj$/time/chrono/b;

    if-eqz v0, :cond_16

    .line 634
    invoke-direct {v9, v0}, Lj$/time/format/B;->g(Lj$/time/temporal/TemporalAccessor;)V
    ...
    invoke-interface {v0, v2}, Lj$/time/chrono/b;->I(Lj$/time/temporal/p;)Lj$/time/chrono/b;

    move-result-object v0

    iput-object v0, v9, Lj$/time/format/B;->f:Lj$/time/chrono/b;
    ...
    .line 602
    iget-object v1, v9, Lj$/time/format/B;->f:Lj$/time/chrono/b;

    iget-object v2, v9, Lj$/time/format/B;->g:Lj$/time/LocalTime;

    invoke-interface {v1, v2}, Lj$/time/chrono/b;->z(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;

    move-result-object v1

    invoke-interface {v1, v0}, Lj$/time/chrono/ChronoLocalDateTime;->p(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    .line 605
    :cond_1d
    iget-object v0, v9, Lj$/time/format/B;->b:Lj$/time/ZoneId;
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/ChronoLocalDateTime;->p(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
...
.method public final synthetic t(Lj$/time/temporal/q;)Lj$/time/temporal/u;
    .locals 0
