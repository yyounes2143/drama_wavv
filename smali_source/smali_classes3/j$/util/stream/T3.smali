...
.method public constructor <init>(Lj$/util/stream/j2;ILjava/util/function/Predicate;)V
    ...
    .line 335
    iput-object p3, p0, Lj$/util/stream/T3;->m:Ljava/util/function/Predicate;
...
.method final P(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 343
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/T3;->O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    .line 782
    iget-object p2, p0, Lj$/util/stream/T3;->m:Ljava/util/function/Predicate;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p2, v1}, Lj$/util/stream/p4;-><init>(Lj$/util/Spliterator;Ljava/util/function/Predicate;I)V
...
.method final R(ILj$/util/stream/r2;)Lj$/util/stream/r2;
    ...
    invoke-direct {p1, p0, p2, v0}, Lj$/util/stream/S3;-><init>(Lj$/util/stream/T3;Lj$/util/stream/r2;Z)V
...
.method public final k(Lj$/util/stream/C0;Z)Lj$/util/stream/h4;
    ...
    invoke-direct {v0, p0, p1, p2}, Lj$/util/stream/S3;-><init>(Lj$/util/stream/T3;Lj$/util/stream/r2;Z)V
