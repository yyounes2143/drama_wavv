...
.method public final o(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    ...
    invoke-interface {v1, v3}, Lj$/time/chrono/Chronology;->L(Lj$/time/temporal/a;)Lj$/time/temporal/u;

    move-result-object v1

    .line 247
    invoke-virtual {v1}, Lj$/time/temporal/u;->g()Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-virtual {v1}, Lj$/time/temporal/u;->h()Z
    ...
    invoke-interface {p1, v0, v1, v3}, Lj$/time/temporal/Temporal;->d(JLj$/time/temporal/s;)Lj$/time/temporal/Temporal;
