...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/g3;->o(II)I
    ...
    const-string/jumbo p2, "stream has already been operated upon or closed"
...
.method private S(I)Lj$/util/Spliterator;
    ...
    .line 425
    sget-object v3, Lj$/util/stream/g3;->SHORT_CIRCUIT:Lj$/util/stream/g3;

    invoke-virtual {v3, v4}, Lj$/util/stream/g3;->t(I)Z
    ...
    .line 439
    sget v3, Lj$/util/stream/g3;->t:I

    not-int v3, v3

    and-int/2addr v3, v4

    sget v4, Lj$/util/stream/g3;->s:I
    ...
    .line 440
    :cond_1
    sget v3, Lj$/util/stream/g3;->s:I

    not-int v3, v3

    and-int/2addr v3, v4

    sget v4, Lj$/util/stream/g3;->t:I
    ...
    invoke-static {v4, v0}, Lj$/util/stream/g3;->o(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/g3;->o(II)I
...
.method final A(Lj$/util/Spliterator;Lj$/util/stream/r2;)V
    ...
    .line 485
    invoke-interface {p2}, Lj$/util/stream/r2;->k()V
...
.method final B(Lj$/util/Spliterator;Lj$/util/stream/r2;)Z
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/r2;->l(J)V
...
.method final C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
    .locals 2
    ...
    .line 545
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/b;->F(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    .line 548
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/b;->N(JLjava/util/function/IntFunction;)Lj$/util/stream/C0;
...
.method final D(Lj$/util/stream/N3;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/N3;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/N3;->b(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    const-string/jumbo v0, "stream has already been operated upon or closed"
...
.method final E(Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    .locals 4
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->C(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
...
.method abstract F(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/K0;
.end method
...
.method abstract I()Lj$/util/stream/h3;
.end method

.method final J()Lj$/util/stream/h3;
    .locals 2
...
.method abstract N(JLjava/util/function/IntFunction;)Lj$/util/stream/C0;
.end method

.method O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    .locals 0
...
.method P(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 710
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/b;->O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
