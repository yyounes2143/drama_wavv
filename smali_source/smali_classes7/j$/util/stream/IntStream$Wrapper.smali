...
.method public final synthetic allMatch(Ljava/util/function/IntPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->v()Z
...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/n0;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/util/P;->o(Lj$/util/OptionalInt;)Ljava/util/OptionalInt;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    .line 90
    iput-object p1, v1, Lj$/util/stream/Q0;->a:Ljava/util/function/IntFunction;

    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->q(Lj$/util/stream/Q0;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/I;

    move-result-object v0

    invoke-static {v0}, Lj$/util/H;->a(Lj$/util/I;)Ljava/util/PrimitiveIterator$OfInt;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->f()Lj$/util/stream/E;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->m()Lj$/util/stream/n0;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-static {p1}, Lj$/util/P;->o(Lj$/util/OptionalInt;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/V;->a(Lj$/util/Spliterator$OfInt;)Ljava/util/Spliterator$OfInt;
