...
.method constructor <init>(Lj$/util/stream/B;IJJ)V
    ...
    .line 449
    iput-wide p3, p0, Lj$/util/stream/z2;->m:J

    iput-wide p5, p0, Lj$/util/stream/z2;->n:J
...
.method final O(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    iget-wide v8, p0, Lj$/util/stream/z2;->m:J

    iget-wide v10, p0, Lj$/util/stream/z2;->n:J

    move-object v7, p2

    invoke-static/range {v6 .. v11}, Lj$/util/stream/C2;->c(Lj$/util/stream/h3;Lj$/util/Spliterator;JJ)Lj$/util/Spliterator;

    move-result-object p2

    .line 493
    invoke-static {p1, p2, v5}, Lj$/util/stream/y0;->C(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/E0;
    ...
    .line 494
    :cond_0
    sget-object v4, Lj$/util/stream/g3;->ORDERED:Lj$/util/stream/g3;

    invoke-virtual {p1}, Lj$/util/stream/b;->K()I

    move-result v6

    invoke-virtual {v4, v6}, Lj$/util/stream/g3;->t(I)Z
    ...
    check-cast v7, Lj$/util/T;

    .line 452
    iget-wide p1, p0, Lj$/util/stream/z2;->m:J

    cmp-long p3, p1, v0

    iget-wide v8, p0, Lj$/util/stream/z2;->n:J
    ...
    .line 1077
    invoke-direct/range {v6 .. v11}, Lj$/util/stream/I3;-><init>(Lj$/util/Spliterator;JJ)V

    .line 502
    invoke-static {p0, p1, v5}, Lj$/util/stream/y0;->C(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/E0;
    ...
    iget-wide v5, p0, Lj$/util/stream/z2;->m:J

    iget-wide v7, p0, Lj$/util/stream/z2;->n:J
...
.method final P(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 465
    iget-wide v5, v9, Lj$/util/stream/z2;->n:J
    ...
    check-cast v11, Lj$/util/T;

    .line 469
    iget-wide v12, v9, Lj$/util/stream/z2;->m:J

    invoke-static {v12, v13, v5, v6}, Lj$/util/stream/C2;->b(JJ)J
    ...
    .line 871
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/z3;-><init>(Lj$/util/b0;JJ)V
    ...
    invoke-virtual {v4, v8}, Lj$/util/stream/g3;->t(I)Z
    ...
    .line 452
    iget-wide v7, v9, Lj$/util/stream/z2;->m:J
    ...
    .line 1077
    invoke-direct/range {v10 .. v15}, Lj$/util/stream/I3;-><init>(Lj$/util/Spliterator;JJ)V
    ...
    .line 0
    invoke-direct {v4, v0}, Lj$/util/stream/d2;-><init>(I)V

    .line 476
    iget-wide v5, v9, Lj$/util/stream/z2;->m:J

    iget-wide v11, v9, Lj$/util/stream/z2;->n:J
...
.method final R(ILj$/util/stream/r2;)Lj$/util/stream/r2;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/y2;-><init>(Lj$/util/stream/z2;Lj$/util/stream/r2;)V
