.class public interface abstract Lj$/util/stream/E;
...
# virtual methods
.method public abstract a()Lj$/util/stream/E;
.end method

.method public abstract average()Lj$/util/OptionalDouble;
.end method

.method public abstract b()Lj$/util/stream/E;
.end method

.method public abstract boxed()Lj$/util/stream/Stream;
.end method

.method public abstract c()Lj$/util/stream/E;
.end method
...
.method public abstract d(Lj$/util/stream/a;)Lj$/util/stream/E;
.end method

.method public abstract distinct()Lj$/util/stream/E;
.end method
...
.method public abstract iterator()Lj$/util/E;
.end method

.method public abstract j()Lj$/util/stream/n0;
.end method

.method public abstract limit(J)Lj$/util/stream/E;
.end method

.method public abstract map(Ljava/util/function/DoubleUnaryOperator;)Lj$/util/stream/E;
.end method
...
.method public abstract parallel()Lj$/util/stream/E;
.end method

.method public abstract peek(Ljava/util/function/DoubleConsumer;)Lj$/util/stream/E;
.end method
...
.method public abstract sequential()Lj$/util/stream/E;
.end method

.method public abstract skip(J)Lj$/util/stream/E;
.end method

.method public abstract sorted()Lj$/util/stream/E;
.end method
