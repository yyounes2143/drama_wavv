...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->average()Lj$/util/OptionalDouble;
...
.method public final synthetic findAny()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->findAny()Lj$/util/OptionalDouble;
...
.method public final synthetic findFirst()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->findFirst()Lj$/util/OptionalDouble;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->iterator()Lj$/util/E;

    move-result-object v0

    invoke-static {v0}, Lj$/util/D;->a(Lj$/util/E;)Ljava/util/PrimitiveIterator$OfDouble;
...
.method public final synthetic mapToInt(Ljava/util/function/DoubleToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/E;->u()Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/DoubleToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/E;->j()Lj$/util/stream/n0;
...
.method public final synthetic max()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->max()Lj$/util/OptionalDouble;
...
.method public final synthetic min()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->min()Lj$/util/OptionalDouble;
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/E;->reduce(Ljava/util/function/DoubleBinaryOperator;)Lj$/util/OptionalDouble;

    move-result-object p1

    invoke-static {p1}, Lj$/util/P;->n(Lj$/util/OptionalDouble;)Ljava/util/OptionalDouble;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->spliterator()Lj$/util/T;
...
.method public final summaryStatistics()Ljava/util/DoubleSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/E;->summaryStatistics()Lj$/util/x;
