...
public final class C2953x822d33df extends Lambda implements InterfaceC1015n<Modifier, Composer, Integer, Modifier> {
    public C2953x822d33df() {
        super(3);
    }
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, Integer num) {
        ...
        if (mo6329L || mo6354x == Composer.f18698a.getEmpty()) {
            mo6354x = new InsetsPaddingModifier(current.f11380k);
