...
final class WindowInsetsSizeKt$windowInsetsEndWidth$2 extends Lambda implements InterfaceC1015n<WindowInsets, LayoutDirection, Density, Integer> {
    public WindowInsetsSizeKt$windowInsetsEndWidth$2() {
        super(3);
    }

    static {
        new WindowInsetsSizeKt$windowInsetsEndWidth$2();
    }
    ...
    public final Integer invoke(WindowInsets windowInsets, LayoutDirection layoutDirection, Density density) {
        ...
        if (layoutDirection2 == LayoutDirection.f23792b) {
