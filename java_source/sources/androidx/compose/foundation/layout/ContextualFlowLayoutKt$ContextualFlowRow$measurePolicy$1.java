...
final class ContextualFlowLayoutKt$ContextualFlowRow$measurePolicy$1 extends Lambda implements InterfaceC1016o<Integer, FlowLineInfo, Composer, Integer, Unit> {
    public ContextualFlowLayoutKt$ContextualFlowRow$measurePolicy$1() {
        throw null;
    }
    ...
    public final Unit invoke(Integer num, FlowLineInfo flowLineInfo, Composer composer, Integer num2) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-1599700159, intValue, -1, "androidx.compose.foundation.layout.ContextualFlowRow.<anonymous> (ContextualFlowLayout.kt:98)");
        }
        int i10 = flowLineInfo2.f11159a;
        new ContextualFlowRowScopeImpl();
        throw null;
    }
}
