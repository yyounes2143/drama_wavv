...
public final class C2959x8bfce65d extends Lambda implements InterfaceC1015n<Modifier, Composer, Integer, Modifier> {
    public C2959x8bfce65d() {
        super(3);
    }
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, Integer num) {
        ...
        if (mo6329L || mo6354x == Composer.f18698a.getEmpty()) {
            mo6354x = new InsetsPaddingModifier(current.f11376g);
