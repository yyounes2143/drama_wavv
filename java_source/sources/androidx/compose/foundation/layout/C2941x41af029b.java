...
public final class C2941x41af029b extends Lambda implements InterfaceC1015n<Modifier, Composer, Integer, Modifier> {
    public C2941x41af029b() {
        super(3);
    }
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, Integer num) {
        ...
        if (mo6329L || mo6354x == Composer.f18698a.getEmpty()) {
            mo6354x = new InsetsPaddingModifier(current.f11370a);
