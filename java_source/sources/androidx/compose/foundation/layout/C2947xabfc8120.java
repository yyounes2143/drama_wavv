...
public final class C2947xabfc8120 extends Lambda implements InterfaceC1015n<Modifier, Composer, Integer, Modifier> {
    public C2947xabfc8120() {
        super(3);
    }
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, Integer num) {
        ...
        if (mo6329L || mo6354x == Composer.f18698a.getEmpty()) {
            mo6354x = new InsetsPaddingModifier(current.f11373d);
