...
public final class LazyGridDslKt$itemsIndexed$10 extends Lambda implements InterfaceC1016o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final Unit invoke(LazyGridItemScope lazyGridItemScope, Integer num, Composer composer, Integer num2) {
        ...
        if (composer2.mo6346p(i10 & 1, z10)) {
            if (ComposerKt.m6429h()) {
                ComposerKt.m6433l(-911455938, i10, -1, "androidx.compose.foundation.lazy.grid.itemsIndexed.<anonymous> (LazyGridDsl.kt:653)");
            }
            throw null;
        }
        composer2.mo6322E();
