...
public final class LazyGridDslKt$items$5 extends Lambda implements InterfaceC1016o<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final Unit invoke(LazyGridItemScope lazyGridItemScope, Integer num, Composer composer, Integer num2) {
        ...
        if (composer2.mo6346p(i10 & 1, z10)) {
            if (ComposerKt.m6429h()) {
                ComposerKt.m6433l(699646206, i10, -1, "androidx.compose.foundation.lazy.grid.items.<anonymous> (LazyGridDsl.kt:542)");
            }
            throw null;
        }
        composer2.mo6322E();
