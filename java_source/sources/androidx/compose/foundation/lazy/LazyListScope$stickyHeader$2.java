...
final class LazyListScope$stickyHeader$2 extends Lambda implements InterfaceC1015n<LazyItemScope, Composer, Integer, Unit> {
    ...
    public final Unit invoke(LazyItemScope lazyItemScope, Composer composer, Integer num) {
        ...
        if (composer2.mo6346p(intValue & 1, z10)) {
            if (ComposerKt.m6429h()) {
                ComposerKt.m6433l(628101784, intValue, -1, "androidx.compose.foundation.lazy.LazyListScope.stickyHeader.<anonymous> (LazyDsl.kt:148)");
            }
            throw null;
        }
        composer2.mo6322E();
