...
@InterfaceC0269f(m255c = "androidx.compose.foundation.gestures.DragGestureDetectorKt", m256f = "DragGestureDetector.kt", m257l = {1048}, m258m = "awaitVerticalDragOrCancellation-rnUCldI")
/* loaded from: classes9.dex */
final class DragGestureDetectorKt$awaitVerticalDragOrCancellation$1 extends AbstractC0267d {

    /* renamed from: a */
    public AwaitPointerEventScope f10263a;

    /* renamed from: b */
    public Ref.LongRef f10264b;
    ...
    public DragGestureDetectorKt$awaitVerticalDragOrCancellation$1() {
        throw null;
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Object obj3;
        this.f10265c = obj;
        int i10 = this.f10266d | Integer.MIN_VALUE;
        this.f10266d = i10;
        ...
        if (i11 != 0) {
            if (i11 == 1) {
                Ref.LongRef longRef = this.f10264b;
                AwaitPointerEventScope awaitPointerEventScope = this.f10263a;
                C27136b.m51416b(obj);
                do {
                    ...
                    if (pointerInputChange == null) {
                        ...
                        if (pointerInputChange2 != null) {
                            ...
                            this.f10263a = awaitPointerEventScope;
                            this.f10264b = longRef;
                            this.f10266d = 1;
                            obj = awaitPointerEventScope.mo7761D0(PointerEventPass.f21279b, this);
                        }
                    } else {
                        if (Float.intBitsToFloat((int) (PointerEventKt.m7787e(pointerInputChange, true) & 4294967295L)) != 0.0f) {
                        }
                        this.f10263a = awaitPointerEventScope;
                        this.f10264b = longRef;
                        this.f10266d = 1;
