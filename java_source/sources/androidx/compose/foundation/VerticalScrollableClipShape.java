...
@Metadata(m51404d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\bÂ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, m51405d2 = {"Landroidx/compose/foundation/VerticalScrollableClipShape;", "Landroidx/compose/ui/graphics/Shape;", "<init>", "()V", "foundation_release"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
final class VerticalScrollableClipShape implements Shape {
    ...
    /* renamed from: a */
    @NotNull
    public static final VerticalScrollableClipShape f9849a = new VerticalScrollableClipShape();
    ...
    public final Outline mo4759a(long j10, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        return new Outline.Rectangle(new Rect(-mo4857s0, 0.0f, Float.intBitsToFloat((int) (j10 >> 32)) + mo4857s0, Float.intBitsToFloat((int) (j10 & 4294967295L))));
    }
}
