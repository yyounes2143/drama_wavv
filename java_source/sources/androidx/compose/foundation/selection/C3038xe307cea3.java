...
public final class C3038xe307cea3 extends Lambda implements Function1<InspectorInfo, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(InspectorInfo inspectorInfo) {
        InspectorInfo inspectorInfo2 = inspectorInfo;
        inspectorInfo2.getClass();
        ValueElementSequence valueElementSequence = inspectorInfo2.f22471a;
        valueElementSequence.m8397c(null, "state");
        valueElementSequence.m8397c(Boolean.FALSE, "enabled");
