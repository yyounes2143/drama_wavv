...
@StabilityInferred
@Metadata(m51404d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m51405d2 = {"Landroidx/compose/ui/input/pointer/StylusHoverIconModifierNode;", "Landroidx/compose/ui/input/pointer/HoverIconModifierNode;", "ui_release"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class StylusHoverIconModifierNode extends HoverIconModifierNode {
    ...
    public final void mo7770N1(@Nullable PointerIcon pointerIcon) {
        ...
        if (pointerIconService != null) {
            pointerIconService.mo7792c(pointerIcon);
        }
    }
    ...
    public StylusHoverIconModifierNode(@NotNull AndroidPointerIconType androidPointerIconType, @Nullable DpTouchBoundsExpansion dpTouchBoundsExpansion) {
        super(androidPointerIconType, dpTouchBoundsExpansion);
        this.f21361r = "androidx.compose.ui.input.pointer.StylusHoverIcon";
    }
}
