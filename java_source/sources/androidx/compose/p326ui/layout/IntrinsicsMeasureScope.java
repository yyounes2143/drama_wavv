...
@StabilityInferred
@Metadata(m51404d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, m51405d2 = {"Landroidx/compose/ui/layout/IntrinsicsMeasureScope;", "Landroidx/compose/ui/layout/MeasureScope;", "Landroidx/compose/ui/layout/IntrinsicMeasureScope;", "ui_release"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class IntrinsicsMeasureScope implements MeasureScope, IntrinsicMeasureScope {
    ...
    /* renamed from: a */
    @NotNull
    public final LayoutDirection f21465a;

    /* renamed from: b */
    public final /* synthetic */ IntrinsicMeasureScope f21466b;
    ...
    public final MeasureResult mo5382j1(final int i10, final int i11, final Map map, Function1 function1) {
        ...
        return new MeasureResult() { // from class: androidx.compose.ui.layout.IntrinsicsMeasureScope$layout$1
            ...
            public final int getF21468b() {
                return i11;
            }

            @Override // androidx.compose.p326ui.layout.MeasureResult
            /* renamed from: getWidth, reason: from getter */
            public final int getF21467a() {
                return i10;
            }
    ...
    public final long mo4844N(long j10) {
        return this.f21466b.mo4844N(j10);
    }
    ...
    public final float mo4845R(long j10) {
        return this.f21466b.mo4845R(j10);
    }
    ...
    public final float mo4848Y0(int i10) {
        return this.f21466b.mo4848Y0(i10);
    }
    ...
    public final float mo4849Z0(float f10) {
        return this.f21466b.mo4849Z0(f10);
    }
    ...
    public final long mo4851a0(float f10) {
        return this.f21466b.mo4851a0(f10);
    }

    @Override // androidx.compose.p326ui.unit.FontScaling
    /* renamed from: d1 */
    public final float getF23766b() {
        return this.f21466b.getF23766b();
    }
    ...
    public final float mo4853e1(float f10) {
        return this.f21466b.mo4853e1(f10);
    }

    @Override // androidx.compose.p326ui.unit.Density
    /* renamed from: getDensity */
    public final float getF23765a() {
        return this.f21466b.getF23765a();
    }
    ...
    public final int mo4854i1(long j10) {
        return this.f21466b.mo4854i1(j10);
    }

    @Override // androidx.compose.p326ui.layout.IntrinsicMeasureScope
    /* renamed from: j0 */
    public final boolean mo5381j0() {
        return this.f21466b.mo5381j0();
    }
    ...
    public final long mo4856o1(long j10) {
        return this.f21466b.mo4856o1(j10);
    }
    ...
    public final int mo4857s0(float f10) {
        return this.f21466b.mo4857s0(f10);
    }
    ...
    public final float mo4858w0(long j10) {
        return this.f21466b.mo4858w0(j10);
    }
    ...
    public IntrinsicsMeasureScope(@NotNull IntrinsicMeasureScope intrinsicMeasureScope, @NotNull LayoutDirection layoutDirection) {
        this.f21465a = layoutDirection;
        this.f21466b = intrinsicMeasureScope;
    }
}
