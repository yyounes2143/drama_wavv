...
final class AnnotatedStringKt$toLowerCase$1 extends Lambda implements InterfaceC1015n<String, Integer, Integer, String> {
    @Override // p155M9.InterfaceC1015n
    public final String invoke(String str, Integer num, Integer num2) {
        Intrinsics.checkNotNullExpressionValue(str.substring(num.intValue(), num2.intValue()), "substring(...)");
