...
final class IconButtonKt$FilledIconButton$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    public IconButtonKt$FilledIconButton$1() {
        super(1);
    }

    static {
        new IconButtonKt$FilledIconButton$1();
    }
