...
final class NavigationItemKt$NavigationItem$styledLabel$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public NavigationItemKt$NavigationItem$styledLabel$1$1() {
        throw null;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-254668050, intValue, -1, "androidx.compose.material3.NavigationItem.<anonymous>.<anonymous> (NavigationItem.kt:272)");
        }
        throw null;
    }
}
