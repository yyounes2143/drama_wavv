...
final class MenuKt$DropdownMenuContent$alpha$2 extends Lambda implements InterfaceC1015n<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>> {
    public MenuKt$DropdownMenuContent$alpha$2() {
        super(3);
    }

    static {
        new MenuKt$DropdownMenuContent$alpha$2();
    }
    ...
    public final FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> segment, Composer composer, Integer num) {
        ...
        composer2.mo6330M(-1355418157);
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-1355418157, intValue, -1, "androidx.compose.material3.DropdownMenuContent.<anonymous> (Menu.kt:396)");
        }
        if (segment2.mo4458d(Boolean.FALSE, Boolean.TRUE)) {
            m4547d = AnimationSpecKt.m4547d(30, 0, null, 6);
        } else {
            m4547d = AnimationSpecKt.m4547d(75, 0, null, 6);
        }
        if (ComposerKt.m6429h()) {
            ComposerKt.m6432k();
        }
