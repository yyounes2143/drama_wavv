...
final class IconButtonKt$FilledTonalIconToggleButton$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    public IconButtonKt$FilledTonalIconToggleButton$1() {
        super(1);
    }

    static {
        new IconButtonKt$FilledTonalIconToggleButton$1();
    }
