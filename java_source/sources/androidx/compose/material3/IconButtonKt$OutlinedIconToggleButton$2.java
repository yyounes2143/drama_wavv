...
final class IconButtonKt$OutlinedIconToggleButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(1207657396, intValue, -1, "androidx.compose.material3.OutlinedIconToggleButton.<anonymous> (IconButton.kt:572)");
        }
