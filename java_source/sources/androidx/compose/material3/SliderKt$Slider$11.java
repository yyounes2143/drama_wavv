...
final class SliderKt$Slider$11 extends Lambda implements InterfaceC1015n<SliderState, Composer, Integer, Unit> {
    ...
    public final Unit invoke(SliderState sliderState, Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(577038345, intValue, -1, "androidx.compose.material3.Slider.<anonymous> (Slider.kt:349)");
        }
