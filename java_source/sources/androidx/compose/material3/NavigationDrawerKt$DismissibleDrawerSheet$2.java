...
final class NavigationDrawerKt$DismissibleDrawerSheet$2 extends Lambda implements InterfaceC1015n<DrawerPredictiveBackState, Composer, Integer, Unit> {
    public NavigationDrawerKt$DismissibleDrawerSheet$2() {
        throw null;
    }
    ...
    public final Unit invoke(DrawerPredictiveBackState drawerPredictiveBackState, Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-807955710, intValue, -1, "androidx.compose.material3.DismissibleDrawerSheet.<anonymous> (NavigationDrawer.kt:707)");
        }
        throw null;
    }
}
