...
final class ListItemKt$ListItem$decoratedHeadlineContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public ListItemKt$ListItem$decoratedHeadlineContent$1() {
        throw null;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-403249643, intValue, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:105)");
        }
        throw null;
    }
}
