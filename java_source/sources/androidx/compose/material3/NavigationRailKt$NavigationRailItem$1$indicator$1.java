...
final class NavigationRailKt$NavigationRailItem$1$indicator$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-1862011490, intValue, -1, "androidx.compose.material3.NavigationRailItem.<anonymous>.<anonymous> (NavigationRail.kt:269)");
        }
        ...
        if (mo6329L || mo6354x == Composer.f18698a.getEmpty()) {
            mo6354x = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItem$1$indicator$1$1$1
