...
final class SliderKt$RangeSlider$1 extends Lambda implements InterfaceC1015n<RangeSliderState, Composer, Integer, Unit> {
    @Override // p155M9.InterfaceC1015n
    public final Unit invoke(RangeSliderState rangeSliderState, Composer composer, Integer num) {
        Composer composer2 = composer;
        int intValue = num.intValue();
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-811582901, intValue, -1, "androidx.compose.material3.RangeSlider.<anonymous> (Slider.kt:424)");
        }
