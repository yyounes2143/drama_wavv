...
final class IconButtonKt$FilledTonalIconButton$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    public IconButtonKt$FilledTonalIconButton$1() {
        super(1);
    }

    static {
        new IconButtonKt$FilledTonalIconButton$1();
    }
