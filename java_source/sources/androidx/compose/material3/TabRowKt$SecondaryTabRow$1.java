...
final class TabRowKt$SecondaryTabRow$1 extends Lambda implements InterfaceC1015n<TabIndicatorScope, Composer, Integer, Unit> {
    ...
    public final Unit invoke(TabIndicatorScope tabIndicatorScope, Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(286693261, intValue, -1, "androidx.compose.material3.SecondaryTabRow.<anonymous> (TabRow.kt:213)");
        }
