...
public final class CheckboxKt$CheckboxImpl$checkDrawFraction$1 extends Lambda implements InterfaceC1015n<Transition.Segment<ToggleableState>, Composer, Integer, FiniteAnimationSpec<Float>> {

    /* renamed from: a */
    public static final CheckboxKt$CheckboxImpl$checkDrawFraction$1 f15084a = new CheckboxKt$CheckboxImpl$checkDrawFraction$1();
    ...
    public final FiniteAnimationSpec<Float> invoke(Transition.Segment<ToggleableState> segment, Composer composer, Integer num) {
        FiniteAnimationSpec<Float> m4546c;
        Transition.Segment<ToggleableState> segment2 = segment;
        Composer composer2 = composer;
        int intValue = num.intValue();
        composer2.mo6330M(1373301606);
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(1373301606, intValue, -1, "androidx.compose.material3.CheckboxImpl.<anonymous> (Checkbox.kt:276)");
        }
        ...
        if (mo4457c == toggleableState) {
            m4546c = AnimationSpecKt.m4547d(100, 0, null, 6);
        } else if (segment2.mo4456a() == toggleableState) {
            m4546c = new SnapSpec<>(100);
        } else {
            m4546c = AnimationSpecKt.m4546c(0.0f, 0.0f, null, 7);
        }
        if (ComposerKt.m6429h()) {
            ComposerKt.m6432k();
        }
