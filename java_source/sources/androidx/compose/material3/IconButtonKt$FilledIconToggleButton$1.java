...
final class IconButtonKt$FilledIconToggleButton$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    public IconButtonKt$FilledIconToggleButton$1() {
        super(1);
    }

    static {
        new IconButtonKt$FilledIconToggleButton$1();
    }
