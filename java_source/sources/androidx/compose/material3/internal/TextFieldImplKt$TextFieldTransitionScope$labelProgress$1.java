...
public final class TextFieldImplKt$TextFieldTransitionScope$labelProgress$1 extends Lambda implements InterfaceC1015n<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Float>> {

    /* renamed from: a */
    public static final TextFieldImplKt$TextFieldTransitionScope$labelProgress$1 f18115a = new TextFieldImplKt$TextFieldTransitionScope$labelProgress$1();
    ...
    public final FiniteAnimationSpec<Float> invoke(Transition.Segment<InputPhase> segment, Composer composer, Integer num) {
        ...
        composer2.mo6330M(1276209157);
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(1276209157, intValue, -1, "androidx.compose.material3.internal.TextFieldTransitionScope.<anonymous> (TextFieldImpl.kt:354)");
        }
