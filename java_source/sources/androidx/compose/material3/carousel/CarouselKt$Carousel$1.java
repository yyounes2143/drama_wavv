...
final class CarouselKt$Carousel$1 extends Lambda implements InterfaceC1016o<PagerScope, Integer, Composer, Integer, Unit> {
    public CarouselKt$Carousel$1() {
        throw null;
    }
    ...
    public final Unit invoke(PagerScope pagerScope, Integer num, Composer composer, Integer num2) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(687111200, intValue, -1, "androidx.compose.material3.carousel.Carousel.<anonymous> (Carousel.kt:267)");
        }
        ...
        if (mo6354x3 == companion.getEmpty()) {
            mo6354x3 = new Shape() { // from class: androidx.compose.material3.carousel.CarouselKt$Carousel$1$clipShape$1$1
        ...
        if (mo6329L || mo6354x4 == companion.getEmpty()) {
            mo6354x4 = new Function0<Strategy>() { // from class: androidx.compose.material3.carousel.CarouselKt$Carousel$1$1$1
                {
                    super(0);
                }
