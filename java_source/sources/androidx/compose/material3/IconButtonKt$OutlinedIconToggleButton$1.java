...
final class IconButtonKt$OutlinedIconToggleButton$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    public IconButtonKt$OutlinedIconToggleButton$1() {
        super(1);
    }

    static {
        new IconButtonKt$OutlinedIconToggleButton$1();
    }
