...
final class SearchBar_androidKt$DockedSearchBar$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    public SearchBar_androidKt$DockedSearchBar$4() {
        throw null;
    }
    ...
    public final Unit invoke(Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(-303118761, intValue, -1, "androidx.compose.material3.DockedSearchBar.<anonymous> (SearchBar.android.kt:827)");
        }
        SearchBarDefaults searchBarDefaults = SearchBarDefaults.f16822a;
