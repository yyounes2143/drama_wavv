...
final class TooltipKt$animateTooltip$2$scale$2 extends Lambda implements InterfaceC1015n<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>> {

    /* renamed from: a */
    public static final TooltipKt$animateTooltip$2$scale$2 f17656a = new TooltipKt$animateTooltip$2$scale$2();
    ...
    public final FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> segment, Composer composer, Integer num) {
        ...
        composer2.mo6330M(386845748);
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(386845748, intValue, -1, "androidx.compose.material3.animateTooltip.<anonymous>.<anonymous> (Tooltip.kt:587)");
        }
        if (segment2.mo4458d(Boolean.FALSE, Boolean.TRUE)) {
            m4547d = AnimationSpecKt.m4547d(150, 0, EasingKt.f9013b, 2);
        } else {
            m4547d = AnimationSpecKt.m4547d(75, 0, EasingKt.f9013b, 2);
        }
        if (ComposerKt.m6429h()) {
            ComposerKt.m6432k();
        }
