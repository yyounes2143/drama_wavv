...
final class NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    final class C33521 extends Lambda implements Function0<Boolean> {

        /* renamed from: a */
        public final /* synthetic */ DrawerState f16315a;

        /* renamed from: b */
        public final /* synthetic */ InterfaceC1423L f16316b;

        /* compiled from: NavigationDrawer.kt */
        @Metadata(m51404d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0002\u001a\u00020\u0001*\u00020\u0000H\u008a@¢\u0006\u0004\b\u0002\u0010\u0003"}, m51405d2 = {"LSa/L;", "", "<anonymous>", "(LSa/L;)V"}, m51406k = 3, m51407mv = {1, 8, 0})
        @InterfaceC0269f(m255c = "androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1$1$1", m256f = "NavigationDrawer.kt", m257l = {473}, m258m = "invokeSuspend")
        ...
        final class AnonymousClass1 extends AbstractC0273j implements Function2<InterfaceC1423L, InterfaceC27211e<? super Unit>, Object> {
            ...
            /* renamed from: b */
            public final /* synthetic */ DrawerState f16318b;
            ...
            public AnonymousClass1(DrawerState drawerState, InterfaceC27211e<? super AnonymousClass1> interfaceC27211e) {
                ...
                this.f16318b = drawerState;
            }

            @Override // p059E9.AbstractC0264a
            @NotNull
            public final InterfaceC27211e<Unit> create(@Nullable Object obj, @NotNull InterfaceC27211e<?> interfaceC27211e) {
                return new AnonymousClass1(this.f16318b, interfaceC27211e);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                if (i10 != 0) {
                    ...
                    C27136b.m51416b(obj);
                    this.f16317a = 1;
                    if (this.f16318b.m6064a(this) == enumC0226a) {
                        return enumC0226a;
                    }
                }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C33521(DrawerState drawerState, InterfaceC1423L interfaceC1423L) {
            super(0);
            this.f16315a = drawerState;
            this.f16316b = interfaceC1423L;
        }

        @Override // kotlin.jvm.functions.Function0
        public final Boolean invoke() {
            DrawerState drawerState = this.f16315a;
            if (drawerState.f15887a.f17820d.invoke(DrawerValue.f15902a).booleanValue()) {
                C1473h.m2196c(this.f16316b, null, null, new AnonymousClass1(drawerState, null), 3);
            }
            return Boolean.TRUE;
        }
    }
