...
final class TabRowKt$SecondaryScrollableTabRow$1 extends Lambda implements InterfaceC1015n<TabIndicatorScope, Composer, Integer, Unit> {
    ...
    public final Unit invoke(TabIndicatorScope tabIndicatorScope, Composer composer, Integer num) {
        ...
        if (ComposerKt.m6429h()) {
            ComposerKt.m6433l(1535842470, intValue, -1, "androidx.compose.material3.SecondaryScrollableTabRow.<anonymous> (TabRow.kt:434)");
        }
