...
public final class CombineContinuationsWorker extends Worker {
    ...
    public final ListenableWorker.Result doWork() {
        ListenableWorker.Result.Success success = new ListenableWorker.Result.Success(getInputData());
