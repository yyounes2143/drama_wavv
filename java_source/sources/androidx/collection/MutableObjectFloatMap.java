...
@Metadata(m51404d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u00028\u00000\u0002¨\u0006\u0003"}, m51405d2 = {"Landroidx/collection/MutableObjectFloatMap;", "K", "Landroidx/collection/ObjectFloatMap;", "collection"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final void m4340b() {
        ...
        C27189k.m51558l(0, this.f8455d, null, this.f8453b);
        this.f8401f = ScatterMapKt.m4403a(this.f8455d) - this.f8456e;
    }

    public MutableObjectFloatMap(int i10) {
        if (i10 >= 0) {
            m4342d(ScatterMapKt.m4407e(i10));
        } else {
    ...
    /* renamed from: c */
    public final int m4341c(int i10) {
        int i11 = this.f8455d;
        int i12 = i10 & i11;
        int i13 = 0;
        while (true) {
    ...
    /* renamed from: d */
    public final void m4342d(int i10) {
        int i11;
        long[] jArr;
        if (i10 > 0) {
        ...
        this.f8401f = ScatterMapKt.m4403a(this.f8455d) - this.f8456e;
        this.f8453b = new Object[i11];
        this.f8454c = new float[i11];
    }

    public /* synthetic */ MutableObjectFloatMap(Object obj) {
        this(6);
    }
}
