...
@Metadata(m51404d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m51405d2 = {"Landroidx/collection/MutableFloatLongMap;", "Landroidx/collection/FloatLongMap;", "collection"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class MutableFloatLongMap extends FloatLongMap {
    public MutableFloatLongMap(int i10) {
        ...
        if (i10 >= 0) {
            ...
            this.f8288b = new float[max];
            this.f8289c = new long[max];
            return;
        }
