...
@Metadata(m51404d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u00028\u00000\u0002¨\u0006\u0003"}, m51405d2 = {"Landroidx/collection/MutableFloatObjectMap;", "V", "Landroidx/collection/FloatObjectMap;", "collection"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    public MutableFloatObjectMap(int i10) {
        ...
        if (i10 >= 0) {
            ...
            this.f8292b = new float[max];
            this.f8293c = new Object[max];
            return;
        }
