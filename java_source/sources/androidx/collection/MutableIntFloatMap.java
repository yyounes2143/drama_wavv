...
@Metadata(m51404d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001¨\u0006\u0002"}, m51405d2 = {"Landroidx/collection/MutableIntFloatMap;", "Landroidx/collection/IntFloatMap;", "collection"}, m51406k = 1, m51407mv = {1, 9, 0}, m51409xi = 48)
...
public final class MutableIntFloatMap extends IntFloatMap {
    public MutableIntFloatMap(int i10) {
        ...
        if (i10 >= 0) {
            ...
            this.f8303b = new int[max];
            this.f8304c = new float[max];
            return;
        }
