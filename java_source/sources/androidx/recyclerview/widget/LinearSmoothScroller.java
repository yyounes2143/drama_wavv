...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public void onTargetFound(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        if (calculateTimeForDeceleration > 0) {
            action.m12258b(-calculateDxToMakeVisible, -calculateDyToMakeVisible, this.mDecelerateInterpolator, calculateTimeForDeceleration);
        }
    }
    ...
    public void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        ...
        if (computeScrollVectorForPosition != null && (computeScrollVectorForPosition.x != 0.0f || computeScrollVectorForPosition.y != 0.0f)) {
            ...
            action.m12258b((int) (this.mInterimTargetDx * 1.2f), (int) (this.mInterimTargetDy * 1.2f), this.mLinearInterpolator, (int) (calculateTimeForScrolling(10000) * 1.2f));
            return;
        }
        action.f30507d = getTargetPosition();
        stop();
    }
}
