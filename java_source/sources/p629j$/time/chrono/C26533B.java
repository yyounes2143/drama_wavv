...
public final class C26533B extends AbstractC26544d {
    private static final long serialVersionUID = 1300372329181994526L;

    /* renamed from: a */
    private final transient LocalDate f118496a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C26533B(LocalDate localDate) {
        Objects.requireNonNull(localDate, "isoDate");
        this.f118496a = localDate;
    }

    @Override // p629j$.time.chrono.InterfaceC26542b
    /* renamed from: a */
    public final Chronology mo50453a() {
        return C26566z.f118560e;
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.chrono.InterfaceC26542b
    public final int hashCode() {
        C26566z.f118560e.getClass();
        return this.f118496a.hashCode() ^ (-1990173233);
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.chrono.InterfaceC26542b
    /* renamed from: E */
    public final InterfaceC26552l mo50444E() {
        return m50574Y() >= 1 ? EnumC26534C.ROC : EnumC26534C.BEFORE_ROC;
    }
    ...
    public final C26635u mo50413t(InterfaceC26631q interfaceC26631q) {
        ...
        if (AbstractC26548h.m50627h(this, interfaceC26631q)) {
            ...
            int i10 = AbstractC26532A.f118495a[enumC26615a.ordinal()];
            if (i10 == 1 || i10 == 2 || i10 == 3) {
                return this.f118496a.mo50413t(interfaceC26631q);
            }
            if (i10 == 4) {
                C26635u mo50820o = EnumC26615a.YEAR.mo50820o();
                return C26635u.m50845j(1L, m50574Y() <= 0 ? (-mo50820o.m50850e()) + 1912 : mo50820o.m50849d() - 1911);
            }
            return C26566z.f118560e.mo50584L(enumC26615a);
        }
    ...
    public final long mo50414w(InterfaceC26631q interfaceC26631q) {
        if (interfaceC26631q instanceof EnumC26615a) {
            int i10 = AbstractC26532A.f118495a[((EnumC26615a) interfaceC26631q).ordinal()];
            if (i10 == 4) {
                int m50574Y = m50574Y();
                if (m50574Y < 1) {
                    m50574Y = 1 - m50574Y;
            ...
            LocalDate localDate = this.f118496a;
            if (i10 == 5) {
                return ((m50574Y() * 12) + localDate.getMonthValue()) - 1;
            }
            if (i10 == 6) {
                return m50574Y();
            }
    ...
    /* renamed from: Y */
    private int m50574Y() {
        return this.f118496a.getYear() - 1911;
    }
    ...
    */
    public final p629j$.time.chrono.C26533B mo50428c(long r9, p629j$.time.temporal.InterfaceC26631q r11) {
        /*
            r8 = this;
            ...
            return r8
        L10:
            int[] r1 = p629j$.time.chrono.AbstractC26532A.f118495a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            j$.time.LocalDate r3 = r8.f118496a
            r4 = 7
            r5 = 6
            r6 = 4
            if (r2 == r6) goto L4b
            ...
            goto L61
        L27:
            j$.time.chrono.z r11 = p629j$.time.chrono.C26566z.f118560e
            ...
            j$.time.chrono.B r9 = r8.m50575a0(r9)
            return r9
        L4b:
            j$.time.chrono.z r2 = p629j$.time.chrono.C26566z.f118560e
        ...
        L99:
            ...
            j$.time.chrono.B r9 = (p629j$.time.chrono.C26533B) r9
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p629j$.time.chrono.C26533B.mo50428c(long, j$.time.temporal.q):j$.time.chrono.B");
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.chrono.InterfaceC26542b
    /* renamed from: l */
    public final InterfaceC26542b mo50432s(InterfaceC26627m interfaceC26627m) {
        return (C26533B) super.mo50432s(interfaceC26627m);
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.temporal.Temporal
    /* renamed from: s */
    public final Temporal mo50432s(LocalDate localDate) {
        return (C26533B) super.mo50432s(localDate);
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.chrono.InterfaceC26542b
    /* renamed from: I */
    public final InterfaceC26542b mo50445I(InterfaceC26630p interfaceC26630p) {
        return (C26533B) super.mo50445I(interfaceC26630p);
    }

    @Override // p629j$.time.chrono.AbstractC26544d
    /* renamed from: X */
    final InterfaceC26542b mo50578X(long j10) {
        return m50575a0(this.f118496a.m50458j0(j10));
    }

    @Override // p629j$.time.chrono.AbstractC26544d
    /* renamed from: W */
    final InterfaceC26542b mo50577W(long j10) {
        return m50575a0(this.f118496a.plusMonths(j10));
    }

    @Override // p629j$.time.chrono.AbstractC26544d
    /* renamed from: V */
    final InterfaceC26542b mo50576V(long j10) {
        return m50575a0(this.f118496a.m50456h0(j10));
    }
    ...
    public final InterfaceC26542b mo50429d(long j10, InterfaceC26633s interfaceC26633s) {
        return (C26533B) super.mo50429d(j10, interfaceC26633s);
    }
    ...
    public final InterfaceC26542b mo50431o(long j10, InterfaceC26633s interfaceC26633s) {
        return (C26533B) super.mo50431o(j10, interfaceC26633s);
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.temporal.Temporal
    /* renamed from: o */
    public final Temporal mo50431o(long j10, ChronoUnit chronoUnit) {
        return (C26533B) super.mo50431o(j10, chronoUnit);
    }

    /* renamed from: a0 */
    private C26533B m50575a0(LocalDate localDate) {
        return localDate.equals(this.f118496a) ? this : new C26533B(localDate);
    }

    @Override // p629j$.time.chrono.AbstractC26544d, p629j$.time.chrono.InterfaceC26542b
    /* renamed from: x */
    public final long mo50467x() {
        return this.f118496a.mo50467x();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C26533B) {
            return this.f118496a.equals(((C26533B) obj).f118496a);
        }
        return false;
    }
    ...
    private Object writeReplace() {
        return new C26535D((byte) 7, this);
    }
