...
import p756u4.InterfaceC28623a;

@Keep
/* loaded from: classes7.dex */
public class ServiceProvider__TheRouter__236921401 implements InterfaceC28486b {
    ...
    public <T> T interception(Class<T> cls, Object... objArr) {
        if (InterfaceC28623a.class.equals(cls) && objArr.length == 0) {
            return (T) new Object();
        }
        return null;
    }
