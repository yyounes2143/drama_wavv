...
import p790x4.InterfaceC28804a;

@Keep
/* loaded from: classes8.dex */
public class ServiceProvider__TheRouter__38832240 implements InterfaceC28486b {
    ...
    public <T> T interception(Class<T> cls, Object... objArr) {
        if (InterfaceC28804a.class.equals(cls) && objArr.length == 0) {
            return (T) new Object();
        }
        return null;
    }
