...
public final class C27738N<K, V> extends AbstractC27787j0<K, V, Map<K, ? extends V>, HashMap<K, V>> {

    /* renamed from: c */
    @NotNull
    public final C27736M f121791c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Type inference failed for: r0v2, types: [kotlinx.serialization.internal.i0, kotlinx.serialization.internal.M] */
    public C27738N(@NotNull InterfaceC5077c<K> kSerializer, @NotNull InterfaceC5077c<V> vSerializer) {
        ...
        this.f121791c = new AbstractC27785i0("kotlin.collections.HashMap", keyDesc, valueDesc);
    }
