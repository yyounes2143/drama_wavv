...
/* compiled from: SearchResultVh.kt */
@StabilityInferred
/* renamed from: v3.j */
/* loaded from: classes8.dex */
public final class C28699j extends AbstractC13397a<C13444c> {

    /* renamed from: d */
    public static final int f125545d = 8;

    /* renamed from: b */
    @NotNull
    private final InterfaceC13413b f125546b;

    /* renamed from: c */
    @NotNull
    private final SearchItemResultBinding f125547c;

    /* renamed from: t */
    public static Unit m53660t(C28699j c28699j, ContentTagModel tagModel) {
        Intrinsics.checkNotNullParameter(tagModel, "tagModel");
        c28699j.f125546b.mo28155z0(tagModel.m32651u());
    ...
    public final void bind(C13444c c13444c, String str, int i10) {
        String name;
        String description;
        final C13444c baseWrap = c13444c;
        Intrinsics.checkNotNullParameter(baseWrap, "baseWrap");
        final Series m28243v = baseWrap.m28243v();
        if (m28243v != null) {
            final SearchItemResultBinding searchItemResultBinding = this.f125547c;
            SeriesCoverView.setSeries$default(searchItemResultBinding.ivCover, m28243v, null, 0, 0, 14, null);
            ...
            C8158B.m21736i(root, new Function0() { // from class: v3.h
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    String str2;
                    C13444c c13444c2 = C13444c.this;
                    if (c13444c2.m28244w() == 2) {
                        str2 = "search_result_card_click";
                    } else {
                        str2 = "search_youmightlike_result_click";
                    }
                    this.m53661u(str2, c13444c2);
                    C15174l.m30686a(searchItemResultBinding.getRoot().getContext(), new PlayDetail(new PlayDetailArgs(null, null, m28243v, null, null, 0, 1, false, null, false, null, null, false, 0, null, null, null, null, 0, null, null, null, null, null, null, false, 536870779), Source.f79491r, false, 4, (DefaultConstructorMarker) null));
                    return Unit.f119604a;
                }
            });
            ConstraintLayout root2 = this.f125547c.getRoot();
            Intrinsics.checkNotNullExpressionValue(root2, "getRoot(...)");
            C16297a.m34689a(root2, baseWrap, 0.0f, new Function0() { // from class: v3.i
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    String str2;
                    C13444c c13444c2 = C13444c.this;
                    if (c13444c2.m28244w() == 2) {
                        str2 = "search_result_card_show";
                    } else {
                        str2 = "search_youmightlike_result_show";
                    }
                    this.m53661u(str2, c13444c2);
                    return Unit.f119604a;
                }
            }, 14);
            searchItemResultBinding.contentTagsView.setTags(CollectionsKt.m51469r0(getContentTagList(m28243v), 3), new C13978t(this, 1));
        }
    }

    /* renamed from: u */
    public final void m53661u(String str, C13444c c13444c) {
        String str2;
        String str3;
        String str4;
    ...
    */
    public C28699j(android.view.ViewGroup r3, com.dramawave.feature.search.InterfaceC13413b r4) {
        /*
            r2 = this;
            android.content.Context r0 = r3.getContext()
            android.view.LayoutInflater r0 = android.view.LayoutInflater.from(r0)
            r1 = 0
            com.dramawave.feature.search.databinding.SearchItemResultBinding r0 = com.dramawave.feature.search.databinding.SearchItemResultBinding.inflate(r0, r3, r1)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p766v3.C28699j.<init>(android.view.ViewGroup, com.dramawave.feature.search.b):void");
    }
}
