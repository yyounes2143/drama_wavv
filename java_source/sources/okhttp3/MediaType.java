...
public final class MediaType {
    ...
    /* compiled from: MediaType.kt */
    @Metadata(m51404d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0015\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u0007H\u0007¢\u0006\u0002\b\rJ\u0017\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\u0007H\u0007¢\u0006\u0002\b\u000fJ\u0011\u0010\u0010\u001a\u00020\u000b*\u00020\u0007H\u0007¢\u0006\u0002\b\nJ\u0013\u0010\u0011\u001a\u0004\u0018\u00010\u000b*\u00020\u0007H\u0007¢\u0006\u0002\b\u000eR\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u0016\u0010\t\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, m51405d2 = {"Lokhttp3/MediaType$Companion;", "", "()V", "PARAMETER", "Ljava/util/regex/Pattern;", "kotlin.jvm.PlatformType", "QUOTED", "", "TOKEN", "TYPE_SUBTYPE", "get", "Lokhttp3/MediaType;", "mediaType", "-deprecated_get", "parse", "-deprecated_parse", "toMediaType", "toMediaTypeOrNull", OkHttp3Client.NETWORK_CLIENT_OKHTTP}, m51406k = 1, m51407mv = {1, 8, 0}, m51409xi = 48)
    ...
    public static final class Companion {
        ...
        public final MediaType m55294deprecated_get(@NotNull String mediaType) {
        ...
        public final MediaType m55295deprecated_parse(@NotNull String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
                ...
                while (end < str.length()) {
                    ...
                    if (matcher2.lookingAt()) {
                        ...
                        if (group3 == null) {
                            ...
                            } else if (C27591q.m52332r(group4, "'", false) && C27591q.m52324j(group4, "'", false) && group4.length() > 2) {
                        ...
                        sb.append(substring);
                        sb.append("\" for: \"");
                        throw new IllegalArgumentException(C3474c.m6658a(sb, str, '\"').toString());
                    }
                }
                return new MediaType(str, lowerCase, lowerCase2, (String[]) arrayList.toArray(new String[0]), null);
            }
            throw new IllegalArgumentException(C1946d.m2634c('\"', "No subtype found for: \"", str).toString());
        }
    ...
    public boolean equals(@Nullable Object r22) {
        if ((r22 instanceof MediaType) && Intrinsics.areEqual(((MediaType) r22).mediaType, this.mediaType)) {
            return true;
        }
        return false;
    }
    ...
    public final String parameter(@NotNull String name) {
        ...
        int i10 = 0;
        int m675a = C0383c.m675a(0, this.parameterNamesAndValues.length - 1, 2);
        if (m675a >= 0) {
            while (!C27591q.m52325k(this.parameterNamesAndValues[i10], name, true)) {
                if (i10 != m675a) {
                    i10 += 2;
                } else {
                    return null;
