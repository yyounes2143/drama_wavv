...
public final class AdResponseOuterClass {
    ...
    public static final class AdResponse extends GeneratedMessageLite<AdResponse, Builder> implements AdResponseOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<AdResponse, Builder> implements AdResponseOrBuilder {
            public /* synthetic */ Builder(C26332a c26332a) {
                this();
            }
            ...
            public Builder setAdDataVersion(int i10) {
                copyOnWrite();
                ((AdResponse) this.instance).setAdDataVersion(i10);
                return this;
            }
            ...
            public Builder setImpressionConfigurationVersion(int i10) {
                copyOnWrite();
                ((AdResponse) this.instance).setImpressionConfigurationVersion(i10);
                return this;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            C26332a c26332a = null;
            switch (C26332a.f118103a[methodToInvoke.ordinal()]) {
                case 1:
                    return new AdResponse();
                case 2:
                    return new Builder(c26332a);
                case 3:
    ...
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C26332a {
        ...
        static {
            ...
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f118103a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
