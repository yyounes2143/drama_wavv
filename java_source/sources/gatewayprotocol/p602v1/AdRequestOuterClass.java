...
public final class AdRequestOuterClass {
    ...
    public static final class AdRequest extends GeneratedMessageLite<AdRequest, Builder> implements AdRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<AdRequest, Builder> implements AdRequestOrBuilder {
            public /* synthetic */ Builder(C26331a c26331a) {
                this();
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            C26331a c26331a = null;
            switch (C26331a.f118102a[methodToInvoke.ordinal()]) {
                case 1:
                    return new AdRequest();
                case 2:
                    return new Builder(c26331a);
                case 3:
    ...
    public enum AdRequestType implements Internal.EnumLite {
        ...
        /* renamed from: gatewayprotocol.v1.AdRequestOuterClass$AdRequestType$a */
        /* loaded from: classes3.dex */
        public class C26329a implements Internal.EnumLiteMap<AdRequestType> {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            public final AdRequestType findValueByNumber(int i10) {
                return AdRequestType.forNumber(i10);
            }
        }

        /* renamed from: gatewayprotocol.v1.AdRequestOuterClass$AdRequestType$b */
        /* loaded from: classes3.dex */
        public static final class C26330b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final C26330b f118101a = new Object();

            @Override // com.google.protobuf.Internal.EnumVerifier
            public final boolean isInRange(int i10) {
                if (AdRequestType.forNumber(i10) != null) {
                    return true;
                }
                return false;
            }
    ...
    /* renamed from: gatewayprotocol.v1.AdRequestOuterClass$a */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C26331a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f118102a;
        ...
        static {
            ...
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f118102a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
