...
public final class OperativeEventRequestOuterClass {
    ...
    public static final class OperativeEventErrorData extends GeneratedMessageLite<OperativeEventErrorData, Builder> implements OperativeEventErrorDataOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<OperativeEventErrorData, Builder> implements OperativeEventErrorDataOrBuilder {
            public /* synthetic */ Builder(C26381a c26381a) {
                this();
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            C26381a c26381a = null;
            switch (C26381a.f118136a[methodToInvoke.ordinal()]) {
                case 1:
                    return new OperativeEventErrorData();
                case 2:
                    return new Builder(c26381a);
                case 3:
    ...
    public enum OperativeEventErrorType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<OperativeEventErrorType> internalValueMap = new Object();
        private final int value;

        /* renamed from: gatewayprotocol.v1.OperativeEventRequestOuterClass$OperativeEventErrorType$a */
        /* loaded from: classes3.dex */
        public class C26377a implements Internal.EnumLiteMap<OperativeEventErrorType> {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            public final OperativeEventErrorType findValueByNumber(int i10) {
                return OperativeEventErrorType.forNumber(i10);
            }
        }

        /* renamed from: gatewayprotocol.v1.OperativeEventRequestOuterClass$OperativeEventErrorType$b */
        /* loaded from: classes3.dex */
        public static final class C26378b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final C26378b f118134a = new Object();

            @Override // com.google.protobuf.Internal.EnumVerifier
            public final boolean isInRange(int i10) {
                if (OperativeEventErrorType.forNumber(i10) != null) {
                    return true;
                }
                return false;
            }
    ...
    public static final class OperativeEventRequest extends GeneratedMessageLite<OperativeEventRequest, Builder> implements OperativeEventRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<OperativeEventRequest, Builder> implements OperativeEventRequestOrBuilder {
            ...
            public Builder setAdFormatValue(int i10) {
                copyOnWrite();
                ((OperativeEventRequest) this.instance).setAdFormatValue(i10);
                return this;
            }
    ...
    public enum OperativeEventType implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<OperativeEventType> internalValueMap = new Object();
        private final int value;

        /* renamed from: gatewayprotocol.v1.OperativeEventRequestOuterClass$OperativeEventType$a */
        /* loaded from: classes3.dex */
        public class C26379a implements Internal.EnumLiteMap<OperativeEventType> {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            public final OperativeEventType findValueByNumber(int i10) {
                return OperativeEventType.forNumber(i10);
            }
        }

        /* renamed from: gatewayprotocol.v1.OperativeEventRequestOuterClass$OperativeEventType$b */
        /* loaded from: classes3.dex */
        public static final class C26380b implements Internal.EnumVerifier {

            /* renamed from: a */
            public static final C26380b f118135a = new Object();

            @Override // com.google.protobuf.Internal.EnumVerifier
            public final boolean isInRange(int i10) {
                if (OperativeEventType.forNumber(i10) != null) {
                    return true;
                }
                return false;
            }
    ...
    /* renamed from: gatewayprotocol.v1.OperativeEventRequestOuterClass$a */
    /* loaded from: classes3.dex */
    public static /* synthetic */ class C26381a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f118136a;
        ...
        static {
            ...
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f118136a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
