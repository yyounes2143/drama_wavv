...
public final class Path {
    ...
    public static final ByteString toSlash(String str) {
        ...
        throw new IllegalArgumentException(C1945c.m2631a("not a directory separator: ", str));
    }

    static {
        ByteString.Companion companion = ByteString.INSTANCE;
        SLASH = companion.encodeUtf8(MqttTopic.TOPIC_LEVEL_SEPARATOR);
        ...
        while (!buffer.exhausted()) {
            ...
            if (Intrinsics.areEqual(readByteString, byteString3)) {
                if (!z12 || !arrayList.isEmpty()) {
                    if (z10 && (z12 || (!arrayList.isEmpty() && !Intrinsics.areEqual(CollectionsKt.m51450Y(arrayList), byteString3)))) {
                        if (!z11 || arrayList.size() != 1) {
                            Intrinsics.checkNotNullParameter(arrayList, "<this>");
                            if (!arrayList.isEmpty()) {
                                arrayList.remove(C27199u.m51608j(arrayList));
                            }
                        }
                    } else {
    ...
    private static final ByteString toSlash(byte b10) {
        ...
        throw new IllegalArgumentException(C27866l.m52683a(b10, "not a directory separator: "));
    }
}
