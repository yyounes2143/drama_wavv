...
public final class RealBufferedSource implements BufferedSource {
    ...
    */
    ...
    public String readUtf8LineStrict(long limit) {
        if (limit >= 0) {
            long j10 = limit == LongCompanionObject.MAX_VALUE ? Long.MAX_VALUE : limit + 1;
            long indexOf = indexOf((byte) 10, 0L, j10);
            if (indexOf != -1) {
                return okio.internal.Buffer.readUtf8Line(this.bufferField, indexOf);
            }
            if (j10 < LongCompanionObject.MAX_VALUE && request(j10) && this.bufferField.getByte(j10 - 1) == 13 && request(1 + j10) && this.bufferField.getByte(j10) == 10) {
                return okio.internal.Buffer.readUtf8Line(this.bufferField, j10);
            }
    ...
    public long indexOf(byte b10, long fromIndex, long toIndex) {
        ...
        if (0 > fromIndex || fromIndex > toIndex) {
            StringBuilder m6972b = C3484c.m6972b(fromIndex, "fromIndex=", " toIndex=");
            m6972b.append(toIndex);
