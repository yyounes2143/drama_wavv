...
public final class MultiDex {
    ...
    public static void install(Context context) {
        ...
        try {
                    ...
                    if (!installedApk.contains(apkPath)) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                Log.w(TAG, "Something went wrong when trying to clear old MultiDex extraction, continuing without cleaning.", t3);
                            }
            ...
            throw new RuntimeException("Multi dex installation failed (" + e10.getMessage() + ").");
        }
    }
    ...
    private static ApplicationInfo getApplicationInfo(Context context) throws PackageManager.NameNotFoundException {
        try {
            ...
            Log.w(TAG, "Failure while trying to obtain ApplicationInfo from Context. Must be running in test mode. Skip patching.", e3);
            return null;
        }
    }
    ...
    public static final class V19 {
        ...
        public static void install(ClassLoader loader, List<File> additionalClassPathEntries, File optimizedDirectory) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InvocationTargetException, NoSuchMethodException {
            ...
            if (suppressedExceptions.size() > 0) {
                ...
                while (i$.hasNext()) {
                    IOException e3 = i$.next();
                    Log.w(MultiDex.TAG, "Exception in makeDexElement", e3);
                }
    ...
    /* loaded from: classes.dex */
    public static final class C2447V4 {
        private C2447V4() {
        }
