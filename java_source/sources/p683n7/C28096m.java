...
public final class C28096m {
    ...
    public static final String m52911b(@NotNull Context context) {
        ...
        try {
            ...
            Object newProxyInstance = Proxy.newProxyInstance(C28096m.class.getClassLoader(), new Class[]{cls}, new C28095l(obj, objectRef, reentrantLock, newCondition));
            ...
            method.invoke(context.getPackageManager(), context.getPackageName(), Boolean.FALSE, obj, CollectionsKt.m51476y0(m51476y0), newProxyInstance);
            newCondition.await();
    ...
    @NotNull
    /* renamed from: a */
    public static final String m52910a(@Nullable String str) throws Exception {
        int read;
        ...
        try {
            ...
            C0644c.m1117a(bufferedInputStream, null);
            return bigInteger;
        } finally {
        }
    }
