...
public abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC27211e interfaceC27211e = (InterfaceC27211e) objArr[objArr.length - 1];
            try {
                if (this.isNullable) {
                    return KotlinExtensions.awaitNullable(adapt, interfaceC27211e);
                }
                return KotlinExtensions.await(adapt, interfaceC27211e);
            } catch (Exception e3) {
                return KotlinExtensions.suspendAndThrow(e3, interfaceC27211e);
            }
        }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC27211e interfaceC27211e = (InterfaceC27211e) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(adapt, interfaceC27211e);
            } catch (Exception e3) {
                return KotlinExtensions.suspendAndThrow(e3, interfaceC27211e);
            }
        }
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        if (responseType != okhttp3.Response.class) {
            if (responseType != Response.class) {
                if (requestFactory.httpMethod.equals(FirebasePerformance.HttpMethod.HEAD) && !Void.class.equals(responseType)) {
    ...
    private static <ResponseT, ReturnT> CallAdapter<ResponseT, ReturnT> createCallAdapter(Retrofit retrofit, Method method, Type type, Annotation[] annotationArr) {
        try {
            ...
            throw Utils.methodError(method, e3, "Unable to create call adapter for %s", type);
        }
    }
    ...
    private static <ResponseT> Converter<ResponseBody, ResponseT> createResponseConverter(Retrofit retrofit, Method method, Type type) {
        try {
            ...
            throw Utils.methodError(method, e3, "Unable to create converter for %s", type);
        }
    }
}
