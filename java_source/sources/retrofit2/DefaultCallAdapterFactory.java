...
public final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        /* loaded from: classes7.dex */
        public class C284321 implements Callback<T> {
            final /* synthetic */ Callback val$callback;

            public C284321(Callback callback) {
            ...
            public void onFailure(Call<T> call, final Throwable th) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.e
                    ...
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C284321.this.lambda$onFailure$1(callback, th);
                    }
                });
            }
            ...
            public void onResponse(Call<T> call, final Response<T> response) {
                ...
                executor.execute(new Runnable() { // from class: retrofit2.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        DefaultCallAdapterFactory.ExecutorCallbackCall.C284321.this.lambda$onResponse$0(callback, response);
                    }
                });
            }
        }
        ...
        public void enqueue(Callback<T> callback) {
            ...
            this.delegate.enqueue(new C284321(callback));
        }
