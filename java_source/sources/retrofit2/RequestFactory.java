...
public final class RequestFactory {
    ...
    public static final class Builder {
                ...
                if (indexOf != -1 && indexOf != 0 && indexOf != str.length() - 1) {
                    ...
                    if ("Content-Type".equalsIgnoreCase(substring)) {
                        try {
                            ...
                            throw Utils.methodError(this.method, e3, "Malformed content type: %s", trim);
                        }
                    } else {
        ...
        private ParameterHandler<?> parseParameter(int i10, Type type, Annotation[] annotationArr, boolean z10) {
            ...
            if (parameterHandler == null) {
                if (z10) {
                    try {
                        if (Utils.getRawType(type) == InterfaceC27211e.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i10, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                if (this.isMultipart) {
                    ...
                    Headers m53044of = Headers.m53044of(HttpHeaders.CONTENT_DISPOSITION, C2899b.m4983a("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
                            ...
                            if (!MultipartBody.Part.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                return new ParameterHandler.Part(this.method, i10, m53044of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                            }
                    ...
                    if (rawType8.isArray()) {
                        ...
                        if (!MultipartBody.Part.class.isAssignableFrom(boxIfPrimitive)) {
                            return new ParameterHandler.Part(this.method, i10, m53044of, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                        }
                        throw Utils.parameterError(this.method, i10, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                    }
                    if (!MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                        return new ParameterHandler.Part(this.method, i10, m53044of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    }
                    throw Utils.parameterError(this.method, i10, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                ...
                if (!this.isFormEncoded && !this.isMultipart) {
                    if (!this.gotBody) {
                        try {
                            ...
                            throw Utils.parameterError(this.method, e3, i10, "Unable to create @Body converter for %s", type);
                        }
                    }
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof GET) {
                parseHttpMethodAndPath(FirebasePerformance.HttpMethod.GET, ((GET) annotation).value(), false);
                return;
            }
    ...
    public Request create(Object[] objArr) throws IOException {
        ...
        throw new IllegalArgumentException(C3472a.m6657a(parameterHandlerArr.length, ")", C2768b.m4437c(length, "Argument count (", ") doesn't match expected count (")));
    }
