...
@Metadata(m51404d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u0018\u0010\u0000\u001a\u0010\u0012\u0004\u0012\u00020\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u0001*\u00020\u0004¨\u0006\u0005"}, m51405d2 = {"toBuiltInMap", "", "", "", "Lorg/json/JSONObject;", "unity-ads_release"}, m51406k = 2, m51407mv = {1, 8, 0}, m51409xi = 48)
    ...
    public static final Map<String, Object> toBuiltInMap(@NotNull JSONObject jSONObject) {
        ...
        while (it.hasNext()) {
            ...
            if (opt != null) {
                ...
                if (!Intrinsics.areEqual(String.valueOf(opt), AdError.UNDEFINED_DOMAIN) && !Intrinsics.areEqual(String.valueOf(opt), C24187y.f110593z)) {
