...
public final /* data */ class InitializationException extends Exception {
    ...
    /* compiled from: InitializationException.kt */
    @Metadata(m51404d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\n\u0010\u0005\u001a\u00060\u0006j\u0002`\u0007¨\u0006\b"}, m51405d2 = {"Lcom/unity3d/ads/core/data/model/exception/InitializationException$Companion;", "", "()V", "parseFrom", "Lcom/unity3d/ads/core/data/model/exception/InitializationException;", "e", "Ljava/lang/Exception;", "Lkotlin/Exception;", "unity-ads_release"}, m51406k = 1, m51407mv = {1, 8, 0}, m51409xi = 48)
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        @NotNull
        public final InitializationException parseFrom(@NotNull Exception e3) {
            boolean z10;
            String str;
            Intrinsics.checkNotNullParameter(e3, "e");
            if (e3 instanceof C1454a1) {
                z10 = true;
            } else {
                z10 = e3 instanceof NetworkTimeoutException;
            }
            if (z10) {
                return new InitializationException(AndroidInitializeBoldSDK.MSG_TIMEOUT, e3, "timeout", e3.getMessage());
            }
            if (e3 instanceof UnityAdsNetworkException) {
                UnityAdsNetworkException unityAdsNetworkException = (UnityAdsNetworkException) e3;
                if (unityAdsNetworkException.getCode() == null) {
                    str = "network";
                } else {
                    str = "network." + unityAdsNetworkException.getCode();
                }
                return new InitializationException("Network", e3, str, unityAdsNetworkException.getMessage());
            }
            if (e3 instanceof GatewayException) {
                GatewayException gatewayException = (GatewayException) e3;
            ...
            return new InitializationException(AndroidInitializeBoldSDK.MSG_UNKNOWN, e3, "unknown", e3.getMessage());
        }
    }

    public /* synthetic */ InitializationException(String str, Throwable th, String str2, String str3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @NotNull
    public final InitializationException copy(@NotNull String message, @Nullable Throwable throwable, @NotNull String reason, @Nullable String reasonDebug) {
    ...
    public int hashCode() {
        ...
        int m999c = C0570q.m999c((hashCode2 + hashCode) * 31, 31, this.reason);
