...
public final /* data */ class GatewayException extends Exception {
    ...
    public /* synthetic */ GatewayException(String str, Throwable th, String str2, String str3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @NotNull
    public final GatewayException copy(@NotNull String message, @Nullable Throwable throwable, @NotNull String reason, @Nullable String reasonDebug) {
