...
public class BannerErrorInfo {
    ...
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C254401 {
    ...
    public static BannerErrorInfo fromLoadError(UnityAds.UnityAdsLoadError unityAdsLoadError, String str) {
        int i10 = C254401.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
    ...
    public UnityAds.UnityAdsLoadError toLoadError() {
        int i10 = C254401.$SwitchMap$com$unity3d$services$banners$BannerErrorCode[this.errorCode.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
