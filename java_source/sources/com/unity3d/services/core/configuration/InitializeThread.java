        ...
        public InitializeState execute() {
            try {
                ...
                if (Utilities.Sha256(loadCachedFileToByteArray).equals(this._configuration.getWebViewHash())) {
                    return new InitializeStateUpdateCache(this._configuration, new String(loadCachedFileToByteArray, C8148d0.f42897a));
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(Sha256)) {
                    ...
                    if (configuration != null && configuration.getWebViewHash() != null && this._localWebViewConfiguration.getWebViewHash().equals(Sha256) && SdkProperties.getVersionName().equals(this._localWebViewConfiguration.getSdkVersion())) {
                        return new InitializeStateCreate(this._localWebViewConfiguration, new String(this._localWebViewData, C8148d0.f42897a));
                    }
                    Configuration configuration2 = this._configuration;
                    if (configuration2 != null && configuration2.getWebViewHash().equals(Sha256)) {
                        return new InitializeStateCreate(this._configuration, new String(this._localWebViewData, C8148d0.f42897a));
                    }
                }
            } catch (Exception unused) {
            }
    ...
    public static class InitializeStateCleanCache extends InitializeState {
        ...
        public InitializeState execute() {
            try {
                ...
                DeviceLog.error("Failure trying to clean cache: " + e3.getMessage());
            }
    ...
    public static class InitializeStateConfig extends InitializeState {
        ...
        public InitializeState executeWithLoader() {
            ...
            try {
                ...
                return new InitializeStateNetworkError(ErrorState.NetworkConfigRequest, e3, this, this._configuration);
            }
        }
        ...
        public InitializeState executeLegacy(Configuration configuration) {
            try {
                ...
                return new InitializeStateNetworkError(ErrorState.NetworkConfigRequest, e3, this, this._localConfig);
            }
        }
    }
    ...
    public static class InitializeStateCreate extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                return new InitializeStateError(ErrorState.CreateWebApp, e3, this._configuration);
            }
        }
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    ...
                    long retryScalingFactor = (long) (this._configuration.getRetryScalingFactor() * this._retryDelay);
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                if (Sha256 != null && Sha256.equals(this._configuration.getWebViewHash())) {
                    try {
                        String str = new String(readFileBytes, C8148d0.f42897a);
                        DeviceLog.info("Unity Ads init: webapp loaded from local cache");
                        return new InitializeStateCreate(this._configuration, str);
                    } catch (Exception e3) {
                        return new InitializeStateError(ErrorState.LoadCache, e3, this._configuration);
                    }
                }
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    ...
                    return new InitializeStateNetworkError(ErrorState.NetworkWebviewRequest, e3, this, this._configuration);
                }
            } catch (Exception e10) {
                DeviceLog.exception("Malformed URL", e10);
                return new InitializeStateError(ErrorState.MalformedWebviewRequest, e10, this._configuration);
            }
        }
    ...
    public static class InitializeStateRetry extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                ...
                DeviceLog.exception("Init retry interrupted", e3);
        ...
        while (true) {
            try {
                ...
                try {
                    ...
                    DeviceLog.exception("Unity Ads SDK encountered an error during initialization, cancel initialization", e3);
                    ...
                    DeviceLog.exception("Unity Ads SDK failed to initialize due to application doesn't have enough memory to initialize Unity Ads SDK", new Exception(e10));
