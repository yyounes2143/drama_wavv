...
public class DeviceInfo {
    ...
    public static void getApkDigest(WebViewCallback webViewCallback) {
        try {
            ...
            webViewCallback.error(DeviceError.COULDNT_GET_DIGEST, e3.toString());
        }
    }
    ...
    public static void getPackageInfo(WebViewCallback webViewCallback) {
        if (ClientProperties.getApplicationContext() != null) {
            ...
            try {
                ...
                webViewCallback.error(DeviceError.JSON_ERROR, e3.getMessage());
                return;
            }
        }
        ...
        if (sensorList != null) {
            for (Sensor sensor : sensorList) {
                ...
                try {
                    ...
                    jSONObject.put(C24142z.f110454c, sensor.getVendor());
    ...
    /* renamed from: com.unity3d.services.core.api.DeviceInfo$1 */
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C254621 {
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i10 = C254621.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
    ...
    public static void getProcessInfo(WebViewCallback webViewCallback) {
        ...
        if (processInfo != null) {
            try {
                ...
                DeviceLog.exception("Error while constructing process info", e3);
            }
        }
    ...
    private static StorageType getStorageTypeFromString(String str) {
        try {
            ...
            DeviceLog.exception("Illegal argument: " + str, e3);
            return null;
        }
    }
