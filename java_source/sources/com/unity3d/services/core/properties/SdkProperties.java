...
import com.dramawave.shared.p448ui.view.banner.RunnableC16255d;
...
public class SdkProperties {
        ...
        synchronized (linkedHashSet) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    Utilities.wrapCustomerListener(new RunnableC16255d(iUnityAdsInitializationListener, 1));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public static String getDefaultConfigUrl(String str) {
        ...
        sb.append(str2);
        sb.append("/webview/");
        return C2573s.m3576a(sb, getWebViewBranch(), MqttTopic.TOPIC_LEVEL_SEPARATOR, str, "/config.json");
    }
