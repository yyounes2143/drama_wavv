...
public class AdOperationMetric {
    ...
    public static Metric newAdLoadFailure(AdOperationError adOperationError, Long l, boolean z10, boolean z11) {
        return new Metric(AD_LOAD_FAIL, l, getTags(adOperationError, true, z10, Boolean.valueOf(z11)));
    }
    ...
    /* renamed from: com.unity3d.services.core.request.metrics.AdOperationMetric$2 */
    /* loaded from: classes4.dex */
    public static /* synthetic */ class C256032 {
    ...
    private static AdOperationError mapUnityAdsLoadError(UnityAds.UnityAdsLoadError unityAdsLoadError) {
        int i10 = C256032.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
    ...
    private static AdOperationError mapUnityAdsShowError(UnityAds.UnityAdsShowError unityAdsShowError) {
        switch (C256032.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsShowError[unityAdsShowError.ordinal()]) {
            case 1:
                return AdOperationError.init_failed;
            case 2:
    ...
    public static Metric newAdLoadSuccess(Long l, boolean z10, boolean z11) {
        return new Metric(AD_LOAD_SUCCESS, l, getTags(null, false, z10, Boolean.valueOf(z11)));
    }
    ...
    public static Metric newAdLoadFailure(UnityAds.UnityAdsLoadError unityAdsLoadError, Long l, boolean z10, boolean z11) {
        return newAdLoadFailure(mapUnityAdsLoadError(unityAdsLoadError), l, z10, z11);
    }
