...
public final /* data */ class ServiceKey {
    ...
    public ServiceKey(@NotNull String named, @NotNull InterfaceC1347d<?> instanceClass) {
    ...
    public static /* synthetic */ ServiceKey copy$default(ServiceKey serviceKey, String str, InterfaceC1347d interfaceC1347d, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = serviceKey.named;
        }
        if ((i10 & 2) != 0) {
            interfaceC1347d = serviceKey.instanceClass;
        }
        return serviceKey.copy(str, interfaceC1347d);
    }
    ...
    @NotNull
    public final ServiceKey copy(@NotNull String named, @NotNull InterfaceC1347d<?> instanceClass) {
        Intrinsics.checkNotNullParameter(named, "named");
        Intrinsics.checkNotNullParameter(instanceClass, "instanceClass");
    ...
    public /* synthetic */ ServiceKey(String str, InterfaceC1347d interfaceC1347d, int i10, DefaultConstructorMarker defaultConstructorMarker) {
