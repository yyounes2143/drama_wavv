    ...
    */
    private static long getMemoryInfo(com.unity3d.services.core.device.Device.MemoryInfoType r6) {
        /*
            ...
            int[] r1 = com.unity3d.services.core.device.Device.C254811.f117009x950c1f09
            int r2 = r6.ordinal()
            r1 = r1[r2]
            r2 = 1
            if (r1 == r2) goto L11
    ...
    */
    public static java.util.Map<java.lang.String, java.lang.String> getProcessInfo() {
        /*
            ...
            java.lang.String r2 = r3.readLine()     // Catch: java.lang.Throwable -> L24 java.io.IOException -> L27
            java.lang.String r4 = "stat"
            r1.put(r4, r2)     // Catch: java.lang.Throwable -> L24 java.io.IOException -> L27
        ...
        L2f:
            ...
            com.unity3d.services.core.log.DeviceLog.exception(r4, r2)     // Catch: java.lang.Throwable -> L24
            if (r3 == 0) goto L39
            r3.close()     // Catch: java.io.IOException -> L1f
        L39:
            return r1
    ...
    private static boolean searchPathForBinary(String str) {
        File[] listFiles;
        for (String str2 : System.getenv(AndroidStaticDeviceInfoDataSource.ENVIRONMENT_VARIABLE_PATH).split(VipOffDialog.f45550Q)) {
    ...
    public static String getNetworkCountryISO() {
        if (ClientProperties.getApplicationContext() != null) {
            return ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(C8138X.f42848f)).getNetworkCountryIso();
        }
        return "";
    }
    ...
    public static String getNetworkOperator() {
        if (ClientProperties.getApplicationContext() != null) {
            return ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(C8138X.f42848f)).getNetworkOperator();
        }
        return "";
    }
    ...
    public static String getNetworkOperatorName() {
        if (ClientProperties.getApplicationContext() != null) {
            return ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(C8138X.f42848f)).getNetworkOperatorName();
        }
        return "";
    }
    ...
    public static int getNetworkType() {
        if (ClientProperties.getApplicationContext() != null) {
            try {
                return ((TelephonyManager) ClientProperties.getApplicationContext().getSystemService(C8138X.f42848f)).getNetworkType();
    ...
    public static JSONObject getPackageInfo(PackageManager packageManager) throws PackageManager.NameNotFoundException, JSONException {
        ...
        jSONObject.put(C23966i.f109571h, packageInfo.versionCode);
    ...
    public static boolean isUsingWifi() {
        ...
        TelephonyManager telephonyManager = (TelephonyManager) ClientProperties.getApplicationContext().getSystemService(C8138X.f42848f);
