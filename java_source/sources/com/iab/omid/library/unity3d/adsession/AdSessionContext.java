...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, @Nullable String str, String str2) {
        C23681g.m41334a(partner, "Partner is null");
        C23681g.m41334a(webView, "WebView is null");
        if (str2 != null) {
            C23681g.m41335a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, @Nullable String str2, String str3) {
        C23681g.m41334a(partner, "Partner is null");
        C23681g.m41334a((Object) str, "OM SDK JS script content is null");
        C23681g.m41334a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C23681g.m41335a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
