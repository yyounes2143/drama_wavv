...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, @Nullable String str, String str2) {
        C23584g.m40859a(partner, "Partner is null");
        C23584g.m40859a(webView, "WebView is null");
        if (str2 != null) {
            C23584g.m40860a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, @Nullable String str2, String str3) {
        C23584g.m40859a(partner, "Partner is null");
        C23584g.m40859a((Object) str, "OM SDK JS script content is null");
        C23584g.m40859a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C23584g.m40860a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
