...
public interface HWIdentifierService extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements HWIdentifierService {
        ...
        /* loaded from: classes.dex */
        public static class Proxy implements HWIdentifierService {
            ...
            @Override // com.tradplus.ads.base.util.oaid.HWIdentifierService
        ...
        public static HWIdentifierService asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.uodis.opendevice.aidl.OpenDeviceIdentifierService");
            if (queryLocalInterface != null && (queryLocalInterface instanceof HWIdentifierService)) {
                return (HWIdentifierService) queryLocalInterface;
            }
