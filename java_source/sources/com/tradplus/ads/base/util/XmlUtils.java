...
public class XmlUtils {
    ...
    public static String getFirstMatchingStringData(Document document, String str, String str2, String str3) {
        return (String) getFirstMatchFromDocument(document, str, str2, str3, new NodeProcessor<String>() { // from class: com.tradplus.ads.base.util.XmlUtils.1
            @Override // com.tradplus.ads.base.util.XmlUtils.NodeProcessor
    ...
    public static List<Node> getNodesWithElementAndAttribute(Document document, String str, String str2, String str3) {
        return getListFromDocument(document, str, str2, str3, new NodeProcessor<Node>() { // from class: com.tradplus.ads.base.util.XmlUtils.3
            @Override // com.tradplus.ads.base.util.XmlUtils.NodeProcessor
    ...
    public static List<String> getStringDataAsList(Document document, String str, String str2, String str3) {
        return getListFromDocument(document, str, str2, str3, new NodeProcessor<String>() { // from class: com.tradplus.ads.base.util.XmlUtils.2
            @Override // com.tradplus.ads.base.util.XmlUtils.NodeProcessor
            public String process(Node node) {
                return XmlUtils.getNodeValue(node);
            }
