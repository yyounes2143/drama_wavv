...
public enum EnumC19900n implements InterfaceC21012e0 {
    NONE(0),
    SINGLETAP(1),
    TRUESINGLETAP(2),
    UNRECOGNIZED(-1);
    ...
    private static final InterfaceC21015f0 internalValueMap = new InterfaceC21015f0() { // from class: com.fyber.inneractive.sdk.bidder.adm.m
        ...
        public final InterfaceC21012e0 mo35346a(int i10) {
            if (i10 != 0) {
                if (i10 != 1) {
                    ...
                    return EnumC19900n.TRUESINGLETAP;
                }
                return EnumC19900n.SINGLETAP;
            }
            return EnumC19900n.NONE;
        }
    };
