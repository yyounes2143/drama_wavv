...
public enum EnumC19891e implements InterfaceC21012e0 {
    DISPLAY(0),
    VIDEO(1),
    VIDEOANDDISPLAY(2),
    UNRECOGNIZED(-1);
    ...
    private static final InterfaceC21015f0 internalValueMap = new InterfaceC21015f0() { // from class: com.fyber.inneractive.sdk.bidder.adm.d
        ...
        public final InterfaceC21012e0 mo35346a(int i10) {
            if (i10 != 0) {
                if (i10 != 1) {
                    ...
                    return EnumC19891e.VIDEOANDDISPLAY;
                }
                return EnumC19891e.VIDEO;
            }
            return EnumC19891e.DISPLAY;
        }
    };
