...
public enum EnumC19877J implements InterfaceC21012e0 {
    ...
    private static final InterfaceC21015f0 internalValueMap = new InterfaceC21015f0() { // from class: com.fyber.inneractive.sdk.bidder.I
        ...
        public final InterfaceC21012e0 mo35346a(int i10) {
            if (i10 != 0) {
                if (i10 != 1) {
                    ...
                    return EnumC19877J.VIDEO;
                }
                return EnumC19877J.DISPLAY;
            }
            return EnumC19877J.UNITCONTENTTYPEUNKNOWN;
        }
    };
