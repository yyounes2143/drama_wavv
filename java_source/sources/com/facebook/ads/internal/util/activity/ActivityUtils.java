...
import com.facebook.ads.redexgen.core.AbstractC18256Sv;
import com.facebook.ads.redexgen.core.C18257Sw;
import com.facebook.ads.redexgen.core.C18329U7;
import com.facebook.ads.redexgen.core.C18458WH;
import com.facebook.ads.redexgen.core.C18869cu;
import com.facebook.ads.redexgen.core.C18895dL;
import com.facebook.ads.redexgen.core.ExecutorC18522XJ;
import com.facebook.ads.redexgen.core.InterfaceC18456WD;
import com.facebook.ads.redexgen.core.RunnableC18455WC;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final C18458WH A05;
    public static final List<InterfaceC18456WD> A06;
    ...
    public static void A02() {
        byte[] bArr = {14, 2, 35, 69, 86, 75, 88, 75, 86, 91, Ascii.f99709FS, 2, -90, -102, -20, -33, -32, -76, -102, 6, 40, 57, 46, 59, 46, 57, 62, -27, 41, 46, 56, 40, 55, 42, 53, 38, 51, 40, 46, 42, 56, -13, 56, 103, 103, 58, 102, 101, 107, 92, 111, 107, Ascii.ETB, 96, 106, Ascii.ETB, 101, 102, 107, Ascii.ETB, 56, 103, 103, 99, 96, 90, 88, 107, 96, 102, 101, 37, -3, 41, 40, Ascii.f99710GS, 47, 44, 44, Ascii.f99718US, 40, 46, -38, 39, 41, Ascii.f99714RS, 35, 32, 35, Ascii.f99710GS, Ascii.ESC, 46, 35, 41, 40, -38, Ascii.f99718US, 50, Ascii.f99710GS, Ascii.f99718US, 42, 46, 35, 41, 40, -38, 46, 34, 44, 41, 49, 40, Ascii.f99714RS, 47, 44, 35, 40, 33, -38, 44, Ascii.f99718US, 33, 35, 45, 46, Ascii.f99718US, 44, -5, Ascii.f99710GS, 46, 35, 48, 35, 46, 51, -3, Ascii.ESC, 38, 38, Ascii.f99709FS, Ascii.ESC, Ascii.f99710GS, 37, 45, 6, 35, 45, 46, Ascii.f99718US, 40, Ascii.f99718US, 44, 45, 74, 66, -2, Utf8.REPLACEMENT_BYTE, 65, 82, 71, 84, 71, 82, 87, -2, 81, 82, Utf8.REPLACEMENT_BYTE, 82, 67, Ascii.CAN, -2, Ascii.CAN, 41, 61, 59, 45, 44, -24, 41, 43, 60, 49, 62, 49, 60, 65, -24, 49, 59, -24, 54, 55, 60, -24, 58, 45, 59, 61, 53, 45, 44, -10, 44, Utf8.REPLACEMENT_BYTE, 77, Ascii.DC4, -6, Ascii.ETB, Ascii.f99707EM, 42, Ascii.NAK, 43, 42, Ascii.f99718US, 34, -35, -20, -27, 58, 57, 12, 46, Utf8.REPLACEMENT_BYTE, 52, 65, 52, Utf8.REPLACEMENT_BYTE, 68, 14, 61, 48, 44, Utf8.REPLACEMENT_BYTE, 48, 47};
        if (A04[0].charAt(5) != 'm') {
     ...
     */
    public static synchronized void A04(C18869cu c18869cu, Class<? extends Activity> cls) {
        synchronized (ActivityUtils.class) {
            A02 = c18869cu;
            A01 = c18869cu.getApplicationContext();
                ...
                if (aNActivityLifecycleCallbacksListener != null) {
                    ...
                    synchronized (activityStateMap) {
                        try {
                            ...
                            c18869cu.A08().AAy(A01(208, 8, 61), AbstractC18256Sv.A02, new C18257Sw(A01(72, 80, 65)));
                        }
                    }
                    ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c18869cu);
                }
                ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
            } else {
                c18869cu.A08().AAy(A01(216, 3, 3), AbstractC18256Sv.A0d, new C18257Sw(A01(42, 30, 126)));
            }
        }
    }
    ...
    */
    public static synchronized android.app.Activity A00() {
        ...
        L3b:
            if (r1 == 0) goto L41
            android.app.Activity r5 = com.facebook.ads.redexgen.core.AbstractC18453WA.A00()     // Catch: java.lang.Throwable -> La0
        L41:
            ...
            int r1 = com.facebook.ads.redexgen.core.AbstractC18256Sv.A03     // Catch: java.lang.Throwable -> La0
    ...
    public static void A03(C18895dL c18895dL) {
        if (!C18329U7.A1k(c18895dL) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC18455WC runnableC18455WC = new RunnableC18455WC(c18895dL);
        synchronized (A07) {
            A07.add(runnableC18455WC);
        }
        ExecutorC18522XJ.A01.A01().postDelayed(runnableC18455WC, 2000L);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC18456WD> it = A06.iterator();
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C18257Sw c18257Sw = new C18257Sw(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c18257Sw.A05(0);
            A02.A08().AAy(A01(208, 8, 61), AbstractC18256Sv.A03, c18257Sw);
        }
        A08.put(activity, 4);
        if (activity.getClass() != this.A00) {
            ...
            while (it.hasNext()) {
                ExecutorC18522XJ.A01.A01().removeCallbacks((Runnable) it.next());
            }
        }
        A05.A01();
    }
