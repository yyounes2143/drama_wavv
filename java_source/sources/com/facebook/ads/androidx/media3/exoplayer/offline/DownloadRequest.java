...
import com.facebook.ads.redexgen.core.C17186BV;
...
public final class DownloadRequest implements Parcelable {
    ...
    static {
        A01();
        CREATOR = new C17186BV();
    }

    public DownloadRequest(Parcel parcel) {
        this.A02 = (String) AbstractC167744a.A0f(parcel.readString());
        this.A00 = Uri.parse((String) AbstractC167744a.A0f(parcel.readString()));
    ...
    public DownloadRequest(String str, Uri uri, String str2, List<StreamKey> list, byte[] bArr, String str3, byte[] bArr2) {
        byte[] bArr3;
        byte[] bArr4;
        int A0B = AbstractC167744a.A0B(uri, str2);
        if (A0B == 0 || A0B == 2 || A0B == 1) {
            AbstractC166983M.A09(str3 == null, A00(1, 38, 126) + A0B);
        }
        this.A02 = str;
        this.A00 = uri;
        this.A03 = str2;
        ...
        if (bArr2 != null) {
            ...
            bArr4 = AbstractC167744a.A07;
        }
        this.A05 = bArr4;
    }

    public /* synthetic */ DownloadRequest(String str, Uri uri, String str2, List list, byte[] bArr, String str3, byte[] bArr2, C17186BV c17186bv) {
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        return this.A02.equals(downloadRequest.A02) && this.A00.equals(downloadRequest.A00) && AbstractC167744a.A1E(this.A03, downloadRequest.A03) && this.A04.equals(downloadRequest.A04) && Arrays.equals(this.A06, downloadRequest.A06) && AbstractC167744a.A1E(this.A01, downloadRequest.A01) && Arrays.equals(this.A05, downloadRequest.A05);
    }
