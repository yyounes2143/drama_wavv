...
public abstract class AbstractC18118Qg {
    ...
    public C169046g A08;
    public WeakReference<C169046g> A09;
    public int A0C;
    ...
    public int A00 = -1;
    public int A04 = -1;
    public AbstractC18118Qg A06 = null;
    public AbstractC18118Qg A07 = null;
    public List<Object> A0A = null;
    public List<Object> A0B = null;
    public int A0D = 0;
    public C18108QW A0F = null;
    ...
    public static void A0A() {
        A0I = new byte[]{3, 74, 71, Ascii.f99714RS, 126, 55, 57, 48, 49, 44, 59, 58, 86, Ascii.f99718US, Ascii.CAN, 0, Ascii.ETB, Ascii.SUB, Ascii.f99718US, Ascii.DC2, Ascii.f99707EM, 87, 86, Ascii.f99707EM, 73, 88, 75, 92, 87, 77, 60, 114, 115, 104, 60, 110, 121, Byte.MAX_VALUE, 101, Byte.MAX_VALUE, 112, 125, 126, 112, 121, 52, Ascii.CAN, 72, 87, 75, 81, 76, 81, 87, 86, 5, 33, 115, 100, 108, 110, 119, 100, 101, 85, 6, Ascii.SYN, 7, Ascii.DC4, 5, 85, Ascii.DC2, 70, 95, 66, 118, 87, 70, 83, 81, 90, 87, 86, 122, 47, 52, 56, 53, 47, 52, 62, Ascii.SUB, 79, 84, 94, 95, 92, 83, 84, 95, 94, Ascii.SUB, 91, 94, 91, 74, 78, 95, 72, Ascii.SUB, 74, 85, 73, 83, 78, 83, 85, 84, 2, 87, 82, 70, 67, 86, 71, 50, 32, 44, 99, 96, 104, 92, 99, Byte.MAX_VALUE, 49, Ascii.ESC, Ascii.ETB, 71, 123, 71, 88, 68, 13, 34, Ascii.f99710GS, 17, 3, 38, Ascii.f99707EM, Ascii.NAK, 7, 56, Ascii.f99718US, Ascii.f99709FS, Ascii.DC4, Ascii.NAK, 2, 11, 61, 7, Ascii.DC2, Ascii.DC2, 7, 5, 14, 3, 2, 53, 5, Ascii.DC4, 7, Ascii.SYN, 59, 58, 2, 9, 0, Ascii.f99715SI, 6, 4, 50, 2, 19, 0, 17, 60, 46, 52, Ascii.NAK, 34, 36, 62, 36, 43, 38, 37, 43, 34, 103, 35, 34, 36, 53, 34, 42, 34, 41, 51, 34, 35, 103, 37, 34, 43, 40, 48, 103, 119, 125, 103, 50, 41, 42, 38, 51, 36, 47, 34, 35, 103, 55, 38, 46, 53, 103, 40, 33, 103, 52, 34, 51, 14, 52, Ascii.NAK, 34, 36, 62, 38, 37, 43, 34, 111, 110, 103, 36, 38, 43, 43, 52, 103, 33, 40, 53, 103, Ascii.f99710GS, 0, 17, Ascii.f99707EM, 34, Ascii.f99710GS, 17, 3, 84, Ascii.f99707EM, Ascii.NAK, 13, 84, Ascii.SUB, Ascii.ESC, 0, 84, Ascii.SYN, 17, 84, Ascii.SUB, 1, Ascii.CAN, Ascii.CAN, 123};
    }
    ...
    public AbstractC18118Qg(View view) {
        if (view != null) {
            this.A0H = view;
            return;
        }
    ...
    public void A0D(C169046g c169046g) {
        this.A0E = AbstractC18019P3.A00(this.A0H);
        c169046g.A1z(this, 4);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0E(C169046g c169046g) {
        c169046g.A1z(this, this.A0E);
        this.A0E = 0;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0F() {
        return (this.A0C & 16) == 0 && AbstractC18019P3.A0G(this.A0H);
    }
    ...
    public final void A0b(C18108QW c18108qw, boolean z10) {
        this.A0F = c18108qw;
        this.A0G = z10;
    }
    ...
    public final String toString() {
        String A08;
        StringBuilder sb = new StringBuilder(A08(147, 11, 70) + Integer.toHexString(hashCode()) + A08(46, 10, 14) + this.A03 + A08(0, 4, 21) + this.A05 + A08(126, 9, 58) + this.A01 + A08(Sdk.SDKError.Reason.INVALID_CONFIG_RESPONSE_VALUE, 8, 1) + this.A04);
        if (A0h()) {
