...
public abstract class AbstractC17854ML {
    ...
    public static EnumC17852MJ A00(JSONObject jSONObject) {
        return EnumC17852MJ.A00(jSONObject.optString(A02(52, 21, 9)));
    }

    public static C19227io A01(C18895dL c18895dL, JSONObject jSONObject, String str) {
        return new C19227io(jSONObject, c18895dL, str);
    }

    public static Collection<String> A03(C18895dL c18895dL, JSONObject jSONObject) {
        ...
        try {
            ...
            c18895dL.A08().AAy(A02(73, 7, 26), AbstractC18256Sv.A2C, new C18257Sw(e3));
        }
    ...
    public static boolean A06(C18895dL c18895dL, InterfaceC17853MK interfaceC17853MK, InterfaceC18350US interfaceC18350US) {
        EnumC17852MJ A8C = interfaceC17853MK.A8C();
        if (A8C != null) {
            EnumC17852MJ invalidationBehavior = EnumC17852MJ.A03;
            if (A8C != invalidationBehavior) {
                boolean packageInstalled = false;
                Collection<String> A7h = interfaceC17853MK.A7h();
                ...
                while (true) {
                    ...
                    if (AbstractC18499Ww.A04(c18895dL, it.next())) {
                        packageInstalled = true;
                        break;
                    }
                }
                EnumC17852MJ invalidationBehavior2 = EnumC17852MJ.A02;
                if (packageInstalled != (A8C == invalidationBehavior2)) {
                    return false;
                }
                String clientToken = interfaceC17853MK.A7G();
                if (!TextUtils.isEmpty(clientToken)) {
                    interfaceC18350US.AB6(clientToken, null);
                    return true;
                }
                c18895dL.A08().AAy(A02(32, 3, 61), AbstractC18256Sv.A0Z, new C18257Sw(A02(0, 32, 80)));
                return true;
            }
        }
        return false;
