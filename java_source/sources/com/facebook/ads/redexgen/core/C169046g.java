...
public class C169046g extends ViewGroup {
    ...
    public C18063Pm A01;
    public C19078gJ A02;
    public RunnableC18076Pz A03;
    public AbstractC18088QC A04;
    public AbstractC18096QK A05;
    public AbstractC18100QO A06;
    public InterfaceC18109QX A07;
    public RunnableC18117Qf A08;
    public C19061g1 A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public C18001Ol A0d;
    public InterfaceC18091QF A0e;
    public InterfaceC18094QI A0f;
    public AbstractC18103QR A0g;
    public InterfaceC18104QS A0h;
    public AbstractC18105QT A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC18105QT> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C18108QW A0r;
    public final C18115Qd A0s;
    public final C18126Qo A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC18118Qg> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C19063g4 A11;
    public final InterfaceC18125Qn A12;
    public final ArrayList<InterfaceC18104QS> A13;
     ...
     */
    public static C169046g A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof C169046g) {
            return (C169046g) view;
        }
        ViewGroup viewGroup = (ViewGroup) view;
        int childCount = viewGroup.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            C169046g A0H = A0H(viewGroup.getChildAt(i10));
            if (A0H != null) {
                return A0H;
            }
        }
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int A05 = this.A01.A05() - 1; A05 >= 0; A05--) {
                AbstractC18118Qg A0F = A0F(this.A01.A09(A05));
                if (!A0F.A0l()) {
                    long A0C = A0C(A0F);
                    C18095QJ A0E = this.A05.A0E(this.A0s, A0F);
                    AbstractC18118Qg A052 = this.A0t.A05(A0C);
                    if (A052 == null || A052.A0l()) {
                        ...
                        if (A0H && A052 == A0F) {
                            ...
                            C18095QJ A04 = this.A0t.A04(A052);
                            this.A0t.A0E(A0F, A0E);
                            C18095QJ A03 = this.A0t.A03(A0F);
                            if (A04 == null) {
                                A0m(A0C, A0F, A052);
                            } else {
    ...
    static {
        ...
        A1A = new InterpolatorC18087QB();
    }

    public C169046g(Context context) {
        this(context, null);
    }

    public C169046g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C169046g(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A11 = new C19063g4(this);
        this.A0r = new C18108QW(this);
        this.A0t = new C18126Qo();
        this.A0u = new RunnableC18085Q9(this);
        this.A0p = new Rect();
        this.A0z = new Rect();
        this.A0q = new RectF();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C169076j();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC18117Qf(this);
        this.A02 = A1E ? new C19078gJ() : null;
        this.A0s = new C18115Qd();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C19066g7(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        this.A0k = new RunnableC18086QA(this);
        this.A12 = new C19069gA(this);
        ...
        this.A0L = AbstractC18020P4.A00(viewConfiguration, context);
        this.A0M = AbstractC18020P4.A01(viewConfiguration, context);
        ...
        setAccessibilityDelegateCompat(new C19061g1(this));
    ...
    private final long A0C(AbstractC18118Qg abstractC18118Qg) {
        return this.A04.A0M() ? abstractC18118Qg.A0Q() : abstractC18118Qg.A03;
    }

    private View A0D() {
        AbstractC18118Qg A1F2;
        ...
        for (int startFocusSearchIndex = i10; startFocusSearchIndex < A03; startFocusSearchIndex++) {
            AbstractC18118Qg A1F3 = A1F(startFocusSearchIndex);
            if (A1F3 == null) {
                break;
            }
    ...
    private final AbstractC18118Qg A0E(long j10) {
        if (this.A04 == null || !this.A04.A0M()) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC18118Qg abstractC18118Qg = null;
        for (int i10 = 0; i10 < A06; i10++) {
            AbstractC18118Qg holder = A0F(this.A01.A0A(i10));
            if (holder != null && !holder.A0g() && holder.A0Q() == j10) {
                if (this.A01.A0K(holder.A0H)) {
                    abstractC18118Qg = holder;
                } else {
                    return holder;
                }
            }
    ...
    public static AbstractC18118Qg A0F(View view) {
        if (view == null) {
            return null;
        }
    ...
    private final AbstractC18118Qg A0G(View view) {
    ...
    private void A0K() {
        ...
        if (i10 != 0 && A1q()) {
            ...
            AbstractC18037PM.A01(event2, i10);
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i10 = 0; i10 < A05; i10++) {
                AbstractC18118Qg holder = A0F(this.A01.A09(i10));
                if (!holder.A0l() && (!holder.A0f() || this.A04.A0M())) {
                    AbstractC18096QK abstractC18096QK = this.A05;
                    C18115Qd c18115Qd = this.A0s;
                    int i11 = AbstractC18096QK.A06(holder);
                    this.A0t.A0F(holder, abstractC18096QK.A0F(c18115Qd, holder, i11, holder.A0R()));
        ...
        if (this.A0s.A0B) {
            A0i();
            boolean z10 = this.A0s.A0D;
            this.A0s.A0D = false;
            this.A06.A1w(this.A0r, this.A0s);
            this.A0s.A0D = z10;
            for (int i12 = 0; i12 < this.A01.A05(); i12++) {
                AbstractC18118Qg A0F = A0F(this.A01.A09(i12));
                ...
                if (!didStructureChange) {
                    ...
                    if (!didStructureChange2) {
                        int A06 = AbstractC18096QK.A06(A0F);
                        boolean A0o = A0F.A0o(8192);
                        if (!A0o) {
                            A06 |= 4096;
                        }
                        C18095QJ A0F2 = this.A05.A0F(this.A0s, A0F, A06, A0F.A0R());
                        if (A0o) {
                            A1k(A0F, A0F2);
                        } else {
    ...
    private void A0O() {
        this.A01 = new C18063Pm(new C19068g9(this));
    }
    ...
    */
    private void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            if (j10 != -1 && this.A04.A0M()) {
                abstractC18118Qg = A0E(this.A0s.A08);
            }
            View view = null;
            if (abstractC18118Qg == null || this.A01.A0K(abstractC18118Qg.A0H) || !abstractC18118Qg.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    view = A0D();
                }
            } else {
                view = abstractC18118Qg.A0H;
            }
            if (view != null) {
    ...
    private void A0U() {
        ...
        if (this.A0o && hasFocus()) {
            AbstractC18088QC abstractC18088QC = this.A04;
            String[] strArr = A19;
            if (strArr[3].charAt(2) == strArr[2].charAt(2)) {
                throw new RuntimeException();
            }
        ...
        AbstractC18118Qg A0G = view == null ? null : A0G(view);
        if (A0G == null) {
            A0S();
            return;
        }
        ...
        c18115Qd.A01 = A0M;
        C18115Qd c18115Qd2 = this.A0s;
        View child = A0G.A0H;
        c18115Qd2.A02 = A0B(child);
    }
    ...
    private final void A0X() {
        int A06 = this.A01.A06();
        for (int i10 = 0; i10 < A06; i10++) {
            AbstractC18118Qg A0F = A0F(this.A01.A0A(i10));
            if (!A0F.A0l()) {
                A0F.A0S();
            }
        }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC18118Qg abstractC18118Qg = this.A0w.get(size);
            if (abstractC18118Qg.A0H.getParent() == this && !abstractC18118Qg.A0l() && (state = abstractC18118Qg.A02) != -1) {
                AbstractC18019P3.A09(abstractC18118Qg.A0H, state);
                abstractC18118Qg.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C19081gM(new C19067g8(this));
    }
    ...
    private final void A0g() {
        int A06 = this.A01.A06();
        for (int i10 = 0; i10 < A06; i10++) {
            ((C18101QP) this.A01.A0A(i10).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private void A0j(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            A0b();
            AbstractC18054Pd.A00(this.A0a, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
            z10 = true;
        } else if (f11 > 0.0f) {
            A0c();
            AbstractC18054Pd.A00(this.A0b, f11 / getWidth(), f12 / getHeight());
            z10 = true;
        }
        if (f13 < 0.0f) {
            A0d();
            AbstractC18054Pd.A00(this.A0c, (-f13) / getHeight(), f10 / getWidth());
            z10 = true;
        } else if (f13 > 0.0f) {
            A0a();
            AbstractC18054Pd.A00(this.A0Z, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            z10 = true;
        }
        if (!z10 && f11 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private final void A0k(int i10) {
        AbstractC18100QO abstractC18100QO = this.A06;
        if (this.A0i != null) {
    ...
    private void A0m(long j10, AbstractC18118Qg abstractC18118Qg, AbstractC18118Qg abstractC18118Qg2) {
        int A05 = this.A01.A05();
        for (int i10 = 0; i10 < A05; i10++) {
            AbstractC18118Qg other = A0F(this.A01.A09(i10));
            if (other != abstractC18118Qg && A0C(other) == j10) {
                AbstractC18088QC abstractC18088QC = this.A04;
                String[] strArr = A19;
                String str = strArr[0];
                String str2 = strArr[6];
                ...
                if (abstractC18088QC != null && this.A04.A0M()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + other + A0I + abstractC18118Qg + A1J());
                }
                throw new IllegalStateException(A0I(1508, Opcodes.NEWARRAY, 43) + other + A0I + abstractC18118Qg + A1J());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(TXLiteAVCode.WARNING_SPEAKER_DEVICE_EMPTY, 111, 51) + abstractC18118Qg2 + A0I(18, 41, 117) + abstractC18118Qg + A1J());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c18101qp.A03;
        rect.set((view.getLeft() - rect2.left) - c18101qp.leftMargin, (view.getTop() - rect2.top) - c18101qp.topMargin, view.getRight() + rect2.right + c18101qp.rightMargin, view.getBottom() + rect2.bottom + c18101qp.bottomMargin);
    }
    ...
    private void A0p(View view, View view2) {
        ...
        if (layoutParams instanceof C18101QP) {
            ...
            C18101QP c18101qp = (C18101QP) layoutParams;
            if (!c18101qp.A01) {
                Rect insets = c18101qp.A03;
    ...
    private void A0q(AbstractC18088QC abstractC18088QC, boolean z10, boolean z11) {
        if (this.A04 != null) {
        ...
        this.A00.A09();
        AbstractC18088QC abstractC18088QC2 = this.A04;
        this.A04 = abstractC18088QC;
        if (abstractC18088QC != null) {
            abstractC18088QC.A0H(this.A11);
        }
        AbstractC18100QO abstractC18100QO = this.A06;
        C18108QW c18108qw = this.A0r;
        AbstractC18088QC oldAdapter = this.A04;
        c18108qw.A0U(abstractC18088QC2, oldAdapter, z10);
        this.A0s.A0D = true;
        A1R();
    }

    private void A0r(AbstractC18118Qg abstractC18118Qg) {
        View view = abstractC18118Qg.A0H;
        boolean z10 = view.getParent() == this;
        this.A0r.A0Y(A1I(view));
        boolean A0i = abstractC18118Qg.A0i();
        String[] strArr = A19;
        if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
            throw new RuntimeException();
        }
    ...
    public static void A0s(AbstractC18118Qg abstractC18118Qg) {
        if (abstractC18118Qg.A09 != null) {
            C169046g c169046g = abstractC18118Qg.A09.get();
            while (c169046g != null) {
                View item = abstractC18118Qg.A0H;
                if (c169046g == item) {
                    return;
                }
                Object parent = c169046g.getParent();
                if (parent instanceof View) {
                    c169046g = (View) parent;
                } else {
                    c169046g = null;
                }
            }
            abstractC18118Qg.A09 = null;
        }
    }

    private void A0t(AbstractC18118Qg abstractC18118Qg, AbstractC18118Qg abstractC18118Qg2, C18095QJ c18095qj, C18095QJ c18095qj2, boolean z10, boolean z11) {
        abstractC18118Qg.A0d(false);
        if (z10) {
            A0r(abstractC18118Qg);
        }
        if (abstractC18118Qg != abstractC18118Qg2) {
            if (z11) {
                A0r(abstractC18118Qg2);
            }
            abstractC18118Qg.A06 = abstractC18118Qg2;
            A0r(abstractC18118Qg);
            this.A0r.A0Y(abstractC18118Qg);
            abstractC18118Qg2.A0d(false);
            abstractC18118Qg2.A07 = abstractC18118Qg;
        }
        if (this.A05.A0R(abstractC18118Qg, abstractC18118Qg2, c18095qj, c18095qj2)) {
            A1O();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i10 = 0; i10 < A05; i10++) {
            AbstractC18118Qg A0F = A0F(this.A01.A09(i10));
            if (!A0F.A0l()) {
                int count = A0F.A0O();
    ...
    private final boolean A13(int consumedX, int consumedY, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1L();
            A1M();
            AbstractC17981OQ.A01(A0I(1361, 9, 51));
            A1j(this.A0s);
            if (consumedX != 0) {
                i12 = this.A06.A1f(consumedX, this.A0r, this.A0s);
                i10 = consumedX - i12;
            }
            if (consumedY != 0) {
                i13 = this.A06.A1g(consumedY, this.A0r, this.A0s);
                i11 = consumedY - i13;
            }
        ...
        if (A1v(i12, i13, i10, i11, this.A17, 0)) {
            ...
            if (motionEvent != null && !AbstractC17999Oj.A00(motionEvent, 8194)) {
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        if (A1s()) {
            ...
            if (accessibilityEvent != null) {
                i10 = AbstractC18037PM.A00(accessibilityEvent);
            }
            if (i10 == 0) {
                i10 = 0;
            }
    ...
    public final int A1B(View view) {
        AbstractC18118Qg holder = A0F(view);
        if (holder != null) {
            return holder.A0O();
        }
        return -1;
    ...
    public final int A1C(AbstractC18118Qg abstractC18118Qg) {
        if (abstractC18118Qg.A0o(524) || !abstractC18118Qg.A0e()) {
            return -1;
        }
        return this.A00.A05(abstractC18118Qg.A03);
    }
    ...
    public final AbstractC18118Qg A1F(int i10) {
        if (this.A0C) {
            return null;
        }
        int A06 = this.A01.A06();
        AbstractC18118Qg hidden = null;
        for (int i11 = 0; i11 < A06; i11++) {
            AbstractC18118Qg A0F = A0F(this.A01.A0A(i11));
            if (A0F != null && !A0F.A0g()) {
    ...
    public final AbstractC18118Qg A1G(int i10) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final com.facebook.ads.redexgen.core.AbstractC18118Qg A1H(int r9, boolean r10) {
        /*
            r8 = this;
        ...
        L25:
            int r6 = r3.A0O()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C169046g.A19
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
            ...
            throw r0
        L3b:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C169046g.A19
        ...
        L57:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.A1H(int, boolean):com.facebook.ads.redexgen.X.Qg");
    }

    public final AbstractC18118Qg A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    public final String A1J() {
        return A0I(0, 1, 23) + super.toString() + A0I(Opcodes.RET, 10, 87) + this.A04 + A0I(189, 9, 86) + this.A06 + A0I(179, 10, 119) + getContext();
    }
    ...
    */
    public final void A1K() {
        /*
            ...
            if (r0 == 0) goto L1c
        L12:
            com.facebook.ads.redexgen.core.AbstractC17981OQ.A01(r4)
            r5.A0Y()
            com.facebook.ads.redexgen.core.AbstractC17981OQ.A00()
            return
        L1c:
        ...
        L25:
            ...
            com.facebook.ads.redexgen.core.AbstractC17981OQ.A01(r0)
            r5.A1L()
            r5.A1M()
            com.facebook.ads.redexgen.X.gM r0 = r5.A00
            r0.A08()
        ...
        Ld5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.A1K():void");
    }
    ...
    public final void A1O() {
        if (!this.A0K && this.A0F) {
            AbstractC18019P3.A0D(this, this.A0k);
            this.A0K = true;
        }
    }
    ...
    public final void A1Q() {
        ...
        for (int left = 0; left < A05; left++) {
            ...
            AbstractC18118Qg A1I2 = A1I(view);
    ...
    public final void A1Y(int i10) {
        ...
        if (this.A06 == null) {
            ...
            this.A06.A1z(this, this.A0s, i10);
        }
    }
    ...
    public final void A1c(int i10, int i11) {
        int A02 = AbstractC18100QO.A02(i10, getPaddingLeft() + getPaddingRight(), AbstractC18019P3.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i12 = paddingTop + width;
        int width2 = AbstractC18019P3.A02(this);
        setMeasuredDimension(A02, AbstractC18100QO.A02(i11, i12, width2));
    }
    ...
    public final void A1h(AbstractC18105QT abstractC18105QT) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC18105QT);
    }

    public final void A1i(AbstractC18105QT abstractC18105QT) {
        if (this.A0m != null) {
            List<AbstractC18105QT> list = this.A0m;
            if (A19[7].length() != 1) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            list.remove(abstractC18105QT);
        }
    }

    public final void A1j(C18115Qd c18115Qd) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c18115Qd.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c18115Qd.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            c18115Qd.A06 = 0;
            c18115Qd.A07 = 0;
        }
    ...
    public final void A1k(AbstractC18118Qg abstractC18118Qg, C18095QJ c18095qj) {
        abstractC18118Qg.A0a(0, 8192);
        if (this.A0s.A0E) {
            boolean A0j = abstractC18118Qg.A0j();
            if (A19[1].charAt(14) != '5') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (A0j && !abstractC18118Qg.A0g() && !abstractC18118Qg.A0l()) {
                this.A0t.A08(A0C(abstractC18118Qg), abstractC18118Qg);
            }
        }
        this.A0t.A0F(abstractC18118Qg, c18095qj);
    }

    public final void A1l(AbstractC18118Qg abstractC18118Qg, C18095QJ c18095qj, C18095QJ c18095qj2) {
        abstractC18118Qg.A0d(false);
        if (this.A05.A0O(abstractC18118Qg, c18095qj, c18095qj2)) {
            A1O();
        }
    }

    public final void A1m(AbstractC18118Qg abstractC18118Qg, C18095QJ c18095qj, C18095QJ c18095qj2) {
        A0r(abstractC18118Qg);
        abstractC18118Qg.A0d(false);
        if (this.A05.A0P(abstractC18118Qg, c18095qj, c18095qj2)) {
            A1O();
        }
    }
    ...
    public final boolean A1x(View view) {
        ...
        if (A0L) {
            AbstractC18118Qg viewHolder = A0F(view);
    ...
    public final boolean A1y(AbstractC18118Qg abstractC18118Qg) {
        return this.A05 == null || this.A05.A0S(abstractC18118Qg, abstractC18118Qg.A0R());
    }

    public final boolean A1z(AbstractC18118Qg abstractC18118Qg, int i10) {
        if (A1s()) {
            abstractC18118Qg.A02 = i10;
            this.A0w.add(abstractC18118Qg);
            return false;
        }
        AbstractC18019P3.A09(abstractC18118Qg.A0H, i10);
        return true;
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void addFocusables(ArrayList<View> views, int i10, int i11) {
        if (this.A06 == null || !this.A06.A1e(this, views, i10, i11)) {
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C18101QP) && this.A06.A1a((C18101QP) layoutParams);
    }
    ...
    public final int computeVerticalScrollExtent() {
        ...
        return abstractC18100QO.A1k(this.A0s);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.draw(android.graphics.Canvas):void");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x0075, code lost:
        ...
        r2 = com.facebook.ads.redexgen.core.C169046g.A19;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x009e, code lost:
        ...
        if (com.facebook.ads.redexgen.core.C169046g.A1F == false) goto L35;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00c5, code lost:
        ...
        if (com.facebook.ads.redexgen.core.C169046g.A1F == false) goto L51;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:68:0x015e, code lost:
        ...
        com.facebook.ads.redexgen.core.C169046g.A19[1] = "b9MIeYXaHVfTdq5nKFyUZKSBlIH2M87t";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:87:0x0123, code lost:
        ...
        if (com.facebook.ads.redexgen.core.C169046g.A19[7].length() == 1) goto L77;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:90:0x012b, code lost:
        ...
        com.facebook.ads.redexgen.core.C169046g.A19[7] = "d";
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public AbstractC18088QC getAdapter() {
        return this.A04;
    }
    ...
    public C19061g1 getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AbstractC18096QK getItemAnimator() {
        return this.A05;
    }

    public AbstractC18100QO getLayoutManager() {
        return this.A06;
    }
    ...
    public AbstractC18103QR getOnFlingListener() {
        return this.A0g;
    }
    ...
    public C18107QV getRecycledViewPool() {
        return this.A0r.A0H();
    }
    ...
    private C18001Ol getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C18001Ol(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC18076Pz.A07.get();
            RunnableC18076Pz runnableC18076Pz = this.A03;
            String[] strArr = A19;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                throw new RuntimeException();
            }
            ...
            if (runnableC18076Pz == null) {
                this.A03 = new RunnableC18076Pz();
                Display A04 = AbstractC18019P3.A04(this);
                float f10 = 60.0f;
                ...
                RunnableC18076Pz.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        AbstractC17981OQ.A01(A0I(1330, 11, 34));
        A0Y();
        AbstractC17981OQ.A00();
        this.A0D = true;
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            this.A06.A1L(this.A0r, this.A0s, i10, i11);
            ...
            this.A06.A13(i10, i11);
            this.A0s.A0A = true;
            A0M();
            this.A06.A14(i10, i11);
            if (this.A06.A21()) {
                AbstractC18100QO abstractC18100QO = this.A06;
                int widthMode3 = getMeasuredWidth();
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(widthMode3, Ints.MAX_POWER_OF_TWO);
                int widthMode4 = getMeasuredHeight();
                abstractC18100QO.A13(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(widthMode4, Ints.MAX_POWER_OF_TWO));
                this.A0s.A0A = true;
                A0M();
                if (A19[1].charAt(14) != '5') {
                    this.A06.A14(i10, i11);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C169046g.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup
    public final void removeDetachedView(View view, boolean z10) {
        AbstractC18118Qg A0F = A0F(view);
        if (A0F != null) {
            if (A0F.A0i()) {
                A0F.A0V();
            } else if (!A0F.A0l()) {
    ...
    public final boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z10) {
        return this.A06.A1b(this, view, rect, z10);
    }
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ArrayList<InterfaceC18104QS> arrayList = this.A13;
            int i11 = A19[7].length();
            if (i11 != 1) {
                throw new RuntimeException();
            }
    ...
    public void setAccessibilityDelegateCompat(C19061g1 c19061g1) {
        this.A09 = c19061g1;
        AbstractC18019P3.A0B(this, this.A09);
    }

    public void setAdapter(AbstractC18088QC abstractC18088QC) {
        setLayoutFrozen(false);
        A0q(abstractC18088QC, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(InterfaceC18091QF interfaceC18091QF) {
        if (interfaceC18091QF == null) {
            return;
        }
        this.A0e = interfaceC18091QF;
    ...
    public void setItemAnimator(AbstractC18096QK abstractC18096QK) {
        if (this.A05 != null) {
            this.A05.A0H();
            this.A05.A0J(null);
        }
        this.A05 = abstractC18096QK;
        if (this.A05 != null) {
            this.A05.A0J(this.A0f);
        }
    }
    ...
    public void setLayoutFrozen(boolean z10) {
        if (z10 != this.A0I) {
            A1n(A0I(TXLiveConstants.PUSH_EVT_ROOM_NEED_REENTER, 42, 1));
            if (!z10) {
                this.A0I = false;
    ...
    public void setLayoutManager(AbstractC18100QO abstractC18100QO) {
        ...
        this.A01.A0B();
        this.A06 = abstractC18100QO;
        if (abstractC18100QO != null) {
            if (abstractC18100QO.A03 == null) {
                this.A06.A1R(this);
                if (this.A0F) {
                    this.A06.A1P(this);
                }
            } else {
                throw new IllegalArgumentException(A0I(TXLiteAVCode.WARNING_SW_ENCODER_START_FAIL, 14, 42) + abstractC18100QO + A0I(59, 39, 124) + abstractC18100QO.A03.A1J());
            }
        }
        this.A0r.A0O();
        requestLayout();
    ...
    public void setOnFlingListener(AbstractC18103QR abstractC18103QR) {
        this.A0g = abstractC18103QR;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC18105QT abstractC18105QT) {
        this.A0i = abstractC18105QT;
    }
    ...
    public void setRecycledViewPool(C18107QV c18107qv) {
        this.A0r.A0V(c18107qv);
    }

    public void setRecyclerListener(InterfaceC18109QX interfaceC18109QX) {
        this.A07 = interfaceC18109QX;
    }
    ...
    public void setScrollingTouchSlop(int i10) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                return;
            default:
                Log.w(A0I(1370, 12, 39), A0I(1994, 47, 98) + i10 + A0I(Opcodes.IFNULL, 21, 88));
                this.A0X = viewConfiguration.getScaledTouchSlop();
                return;
        }
    }

    public void setViewCacheExtension(AbstractC18116Qe abstractC18116Qe) {
        this.A0r.A0W(abstractC18116Qe);
    }
