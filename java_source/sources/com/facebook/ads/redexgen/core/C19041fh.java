...
public final class C19041fh extends C18146R8 implements MediaViewApi, Repairable, InterfaceC18221SM {
    ...
    private void A05() {
        if (this.A0A != null) {
            ...
            AbstractC18019P3.A0A(this.A0A.getDynamicWebViewController().A0O(), new ColorDrawable(0));
    ...
    private void A07() {
        ...
        EnumC18493Wq.A04(this.A09, EnumC18493Wq.A0B);
        EnumC18493Wq.A04(this.A05, EnumC18493Wq.A0B);
        EnumC18493Wq.A04(this.A01, EnumC18493Wq.A0B);
    }
    ...
    private void A0A(View view, C18114Qc c18114Qc) {
        if (this.A0B != null) {
        ...
        String A1D = c18114Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC18870cv.A01(this.A07, A1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private void A0B(ImageView imageView) {
        if (!this.A0D) {
            ...
            imageView.setId(AbstractC18528XP.A00());
            this.A02 = imageView;
            return;
        }
    ...
    private final void A0C(C18895dL c18895dL, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c18895dL, attributeSet, i10, i11));
        A0H(new C18674Zl(c18895dL, attributeSet, i10, i11));
        this.A08 = new C165170L(c18895dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c18895dL, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C18895dL c18895dL, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c18895dL, attributeSet, i10));
        A0H(new C18674Zl(c18895dL, attributeSet, i10));
        this.A08 = new C165170L(c18895dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c18895dL, attributeSet, i10));
        A07();
    }

    private final void A0E(C18895dL c18895dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c18895dL, attributeSet));
        A0H(new C18674Zl(c18895dL, attributeSet));
        this.A08 = new C165170L(c18895dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c18895dL, attributeSet));
        A07();
    }

    private final void A0F(C18895dL c18895dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c18895dL));
        A0H(new C18674Zl(c18895dL));
        this.A08 = new C165170L(c18895dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c18895dL));
        A07();
    }

    private void A0G(C18114Qc c18114Qc, boolean z10, C18373Up c18373Up) {
        AsyncTaskC17744KZ A04 = new AsyncTaskC17744KZ(this.A02, this.A07).A04();
        if (z10) {
            A04.A06(new C19048fo(this, c18114Qc));
        }
        A04.A07(c18373Up.getUrl());
    }

    private void A0H(C18674Zl c18674Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c18674Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c18674Zl, layoutParams);
            this.A09 = c18674Zl;
            return;
        }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C18158RK) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return !TextUtils.isEmpty(((C18158RK) nativeAd.getNativeAdApi()).A02());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x02f3, code lost:
        ...
        new com.facebook.ads.redexgen.core.AsyncTaskC17744KZ(r17.A03, r17.A07).A05(r17.A03.getHeight(), r17.A03.getWidth()).A06(new com.facebook.ads.redexgen.core.C19044fk(r17, r2)).A07(r2.getAdCoverImage().getUrl());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x0326, code lost:
        ...
        android.util.Log.i(com.facebook.ads.redexgen.core.C19041fh.A0G, A04(292, 9, 49) + ((com.facebook.ads.redexgen.core.C18158RK) r18.getNativeAdApi()).A02());
     */
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19041fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C18895dL A12 = ((C18114Qc) nativeAdBaseApi).A12();
        C18895dL adObjectContext = this.A07;
        ...
        ((C18155RH) this.A05.getMediaViewVideoRendererApi()).A03();
        if (this.A01 != null) {
            this.A01.setVisibility(8);
            if (this.A01 instanceof C18665Zc) {
                ((C18665Zc) this.A01).A04();
            } else {
                ((C169046g) this.A01).setAdapter(null);
            }
        }
        ...
        if (adIcon != null) {
            ...
            if (A0N != null) {
                ...
                if (z10) {
                    this.A03.post(new C19049fp(this, A0L));
                }
            } else {
                A0G(A0L, z10, adIcon);
            }
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C18895dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC18256Sv.A0W, new C18257Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, A0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C19041fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C19041fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19041fh.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        switch (adViewConstructorParams.getInitializationType()) {
            ...
            case 2:
                ...
                A0D(c18895dL, attributeSet, adViewConstructorParams.getDefStyleAttr(), mediaView);
                break;
            case 3:
    ...
    @Override // com.facebook.ads.redexgen.core.C18146R8, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C18155RH) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C18155RH) this.A05.getMediaViewVideoRendererApi()).A07(new C19042fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C18155RH) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A0A());
            mediaViewVideoRenderer.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C19041fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
            this.A05 = mediaViewVideoRenderer;
            this.A0C = !(this.A05 instanceof DefaultMediaViewVideoRenderer);
            mediaViewVideoRenderer.setId(AbstractC18528XP.A00());
            return;
        }
