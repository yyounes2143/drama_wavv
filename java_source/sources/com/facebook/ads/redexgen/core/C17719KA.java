...
public final class C17719KA {
    ...
    public static void A06() {
        A0B = new byte[]{35, Ascii.CAN, Ascii.f99710GS, Ascii.CAN, Ascii.f99707EM, 1, Ascii.CAN, 86, 2, 19, 14, 2, 55, Ascii.SUB, Ascii.f99718US, 17, Ascii.CAN, Ascii.ESC, 19, Ascii.CAN, 2, 76, 86, Ascii.DC4, 38, 33, 53, 55, 55, 0, 54, 38, 19, 34, 49, 48, 38, 49};
    }
    ...
    */
    public static float A00(float r6, int r7) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C17719KA.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
            ...
            throw r0
        L25:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C17719KA.A0C
        ...
        L3c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C17719KA.A00(float, int):float");
    }
    ...
    public static Layout.Alignment A04(int i10) {
        switch (i10) {
            ...
            default:
                AbstractC1674244.A07(A05(23, 15, 34), A05(0, 23, 23) + i10);
                return null;
        }
    }

    public final C166883C A07() {
        int A03;
        ...
        C166883C A0A = new C166883C().A0F(A04(this.A06)).A07(A00(this.A00, this.A04), this.A04).A09(this.A03).A04(A01).A0A(A03);
        float f10 = this.A02;
        float position = A02(A03, A01);
        C166883C A0B2 = A0A.A06(Math.min(f10, position)).A0B(this.A07);
        if (this.A0A != null) {
            A0B2.A0G(this.A0A);
        }
        return A0B2;
    ...
    public final C17712K3 A08() {
        return new C17712K3(A07().A0H(), this.A09, this.A08);
    }
}
