...
public final class C165891W<E> extends AbstractC17140Al<E> {
    ...
    public static final C165891W<Object> A05 = new C165891W<>(A06, 0, A06, 0, 0);
    ...
    public C165891W(Object[] elements, int hashCode, Object[] table, int mask, int size) {
        this.A00 = elements;
        this.A02 = hashCode;
        this.A01 = table;
        this.A03 = mask;
    ...
    public final AbstractC17141Am<E> A0M() {
        return AbstractC17141Am.A09(this.A00, this.A04);
    }
    ...
    public final boolean contains(@CheckForNull Object target) {
        ...
        int A02 = AbstractC19439mU.A02(target);
        while (true) {
