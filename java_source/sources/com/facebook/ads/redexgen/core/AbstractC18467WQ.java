...
public abstract class AbstractC18467WQ {
    ...
    public static void A09() {
        A00 = new byte[]{12, Byte.MAX_VALUE, 69, 9, 94, 101, 9, 126, 121, Byte.MAX_VALUE, 69, 9, 94, 101, 9, 126, Ascii.DC4, 9, Ascii.f99710GS, Ascii.f99715SI, 10, 9, 121, 14, 13, Ascii.ESC, 112, 65, 82, 83, 73, 78, 71, 0, 85, 82, 76, 0, 5, 83, 0, 67, 65, 85, 83, 69, 68, 0, 69, 88, 67, 69, 80, 84, 73, 79, 78, Ascii.SUB, 0, 5, 83, 14, 55, 72, 67, 84, 67, 2, 87, 80, 75, 2, 0, 7, 81, 0, 2, 76, 77, 86, 2, 71, 83, 87, 67, 78, 2, 86, 77, 2, 67, 76, 70, 80, 77, 75, 70, 2, 87, 80, 75, 2, 0, 7, 81, 0, 12, 2, 102, 71, SignedBytes.MAX_POWER_OF_TWO, 87, 69, 2, 75, 76, 68, 77, Ascii.CAN, 2, 7, 81, 12, 2, 109, 80, 75, 69, 75, 76, 67, 78, 2, 87, 80, 75, Ascii.CAN, 2, 7, 81, 116, Byte.MAX_VALUE, 104, Byte.MAX_VALUE, 75, 108, 119, 62, Byte.MAX_VALUE, 107, 106, 118, 113, 108, 119, 106, 103, 36, 62, 60, 59, 109, 60, 48, 62, Byte.MAX_VALUE, 112, 122, 108, 113, 119, 122, 75, 108, 119, 62, Byte.MAX_VALUE, 107, 106, 118, 113, 108, 119, 106, 103, 36, 62, 60, 59, 109, 60, 48, 51, 56, 47, 56, 12, 43, 48, 121, 54, 41, 56, 40, 44, 60, 121, 41, 56, 43, 45, 99, 121, 123, 124, 42, 123, 119, 121, 56, 55, 61, 43, 54, 48, 61, 12, 43, 48, 121, 54, 41, 56, 40, 44, 60, 121, 41, 56, 43, 45, 99, 121, 123, 124, 42, 123, 119, 35, 40, Utf8.REPLACEMENT_BYTE, 40, Ascii.f99709FS, 59, 32, 105, 57, 40, 61, 33, 115, 105, 107, 108, 58, 107, 103, 105, 40, 39, 45, 59, 38, 32, 45, Ascii.f99709FS, 59, 32, 105, 57, 40, 61, 33, 115, 105, 107, 108, 58, 107, 103, 5, 14, Ascii.f99707EM, 14, 58, Ascii.f99710GS, 6, 79, Ascii.f99709FS, 12, 7, 10, 2, 10, 85, 79, 77, 74, Ascii.f99709FS, 77, 65, 79, 14, 1, 11, Ascii.f99710GS, 0, 6, 11, 58, Ascii.f99710GS, 6, 79, Ascii.f99709FS, 12, 7, 10, 2, 10, 85, 79, 77, 74, Ascii.f99709FS, 77, 65};
    }
    ...
    public static Uri A00(String str) {
        ...
        if (A002 != null && !C18329U7.A2p(A002)) {
            return parse;
        }
        if (!A0D(parse)) {
