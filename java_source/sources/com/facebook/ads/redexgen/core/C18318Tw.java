...
public class C18318Tw {
     ...
     */
    public static C18318Tw A04(File file) throws IOException {
        try {
            ...
            return new C18318Tw(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C18318Tw(RandomAccessFile randomAccessFile, long[] jArr, long j10) throws IOException {
        ...
        for (int i11 = this.A00; i11 < jArr.length; i11++) {
            if (jArr[i11] != 0) {
                throw new IOException(String.format(Locale.US, A05(AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y, 66, 57), Integer.valueOf(i11), Integer.valueOf(this.A00), Long.valueOf(jArr[i11])));
            }
        }
    ...
    public static C18318Tw A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(TTAdConstant.PACKAGE_NAME_CODE, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C18319Tx.A03);
            randomAccessFile.write(new byte[C18319Tx.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C18318Tw(randomAccessFile, new long[C18319Tx.A03], randomAccessFile.length());
        } catch (IOException unused) {
