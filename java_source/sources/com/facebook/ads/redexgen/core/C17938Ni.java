...
public final class C17938Ni {
    ...
    public static void A01() {
        A00 = new byte[]{61, 32, 32, 32, 48, 48, 48, 48, 48, 48, 48, 48, 48, 33, 33, 33, 33, 33, 33, 33, 33, 49, 49, 49, 44, 78, 101, 98, 104, 101, 98, 107, 44, 120, 99, 44, Byte.MAX_VALUE, 105, 126, 122, 101, 111, 105, 44, Byte.MAX_VALUE, 121, 111, 111, 105, Byte.MAX_VALUE, Byte.MAX_VALUE, 44, 49, 44, 44, 85, 66, 89, 83, 91, 82, 72, 82, 79, 67, 69, 86, 68, 72, 92, 82, 78, 73, 78, 72, 69, 73, 95, 72, 76, 83, 89, 95, 69, 95, 66, 78, 72, 91, 73, Ascii.DC2, Ascii.NAK, 19, Ascii.f99714RS, Ascii.DC2, 4, 19, Ascii.ETB, 8, 2, 4, Ascii.f99714RS, Ascii.DC2, 5, 10, Ascii.f99714RS, Ascii.ETB, 4, 19, Ascii.DC2, 8, 14, Ascii.f99715SI, 77, 65, 67, 0, 72, 79, 77, 75, 76, 65, 65, 69, 0, 79, 74, 93, 0, 71, SignedBytes.MAX_POWER_OF_TWO, 90, 75, 92, SignedBytes.MAX_POWER_OF_TWO, 79, 66, 0, 71, 94, 77, 0, 111, 91, 74, 71, 75, SignedBytes.MAX_POWER_OF_TWO, 77, 75, 96, 75, 90, 89, 65, 92, 69, 124, 75, 67, 65, 90, 75, 125, 75, 92, 88, 71, 77, 75, Ascii.f99718US, 19, 17, 82, Ascii.SUB, Ascii.f99710GS, Ascii.f99718US, Ascii.f99707EM, Ascii.f99714RS, 19, 19, Ascii.ETB, 82, Ascii.ETB, Ascii.f99710GS, 8, Ascii.f99710GS, Ascii.DC2, Ascii.f99710GS};
    }

    static {
        A01();
        A02 = C17938Ni.class.getSimpleName();
    }

    public static void A02(C18869cu c18869cu, Message message) {
        Bundle bundle = message.getData().getBundle(A00(55, 17, 118));
        if (bundle != null) {
            AbstractC18283TN.A06(c18869cu, bundle.getString(A00(90, 23, 32)), bundle.getString(A00(72, 18, 123)));
        }
    }
    ...
    */
    public static boolean A04(com.facebook.ads.redexgen.core.C18869cu r7, boolean r8, android.content.ServiceConnection r9) {
        /*
            ...
            if (r0 == 0) goto La1
            if (r8 != 0) goto L2a
            boolean r3 = com.facebook.ads.redexgen.core.C18329U7.A1Y(r7)
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C17938Ni.A01
            r0 = 1
            r1 = r1[r0]
            r0 = 26
            ...
            r0 = 53
            if (r1 == r0) goto La4
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C17938Ni.A01
        ...
        L2b:
            if (r0 != 0) goto L37
            java.lang.String r0 = com.facebook.ads.redexgen.core.AbstractC18332UA.A05(r8)
        ...
        L38:
            ...
            boolean r0 = r0.AAF()
            if (r0 == 0) goto L52
            boolean r0 = com.facebook.ads.redexgen.core.C18329U7.A1Y(r7)
            if (r0 == 0) goto L52
        L51:
            r6 = 1
        L52:
            java.lang.String r3 = com.facebook.ads.redexgen.core.AbstractC18332UA.A05(r6)
        ...
        La4:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C17938Ni.A04(com.facebook.ads.redexgen.X.cu, boolean, android.content.ServiceConnection):boolean");
    }
}
