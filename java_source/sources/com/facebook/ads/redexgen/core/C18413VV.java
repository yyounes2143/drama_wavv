...
public final class C18413VV {
    public static C18413VV A00;
    ...
    public static void A05() {
        A01 = new byte[]{118, 115, 72, 101, 114, 103, 120, 101, 99, 126, 121, 112, 72, 116, 120, 121, 113, 126, 112, 77, 72, 77, 92, 88, 73, 94, Ascii.CAN, Ascii.f99710GS, 10, 100, 107, 90, 115, 100, 105, 108, 97, 100, 113, 108, 106, 107, 90, 112, 112, 108, 97, 44, 46, 44, 39, 42, 105, 98, 107, 99, 100, 85, 122, 107, 120, 107, 103, 121, 39, 43, 32, 33, 122, Byte.MAX_VALUE, 106, Byte.MAX_VALUE, Ascii.DLE, Ascii.NAK, 0, Ascii.NAK, 59, Ascii.SYN, Ascii.f99714RS, 17, Ascii.ETB, 0, 84, Ascii.f99710GS, 7, 84, Ascii.SUB, 1, Ascii.CAN, Ascii.CAN, 108, 105, 124, 105, 87, 101, 103, 108, 109, 100, 87, 124, 113, 120, 109, 120, 121, 126, 105, 123, 67, 122, 105, 114, 114, 121, 112, 67, Byte.MAX_VALUE, 115, 114, 122, 117, 123, Ascii.SUB, Ascii.ESC, Ascii.CAN, Ascii.ETB, Ascii.DLE, Ascii.ETB, 10, Ascii.ETB, 17, Ascii.DLE, Ascii.CAN, Ascii.f99715SI, Ascii.f99715SI, Ascii.DC2, Ascii.f99715SI, 75, 72, 76, 89, 88, 95, 72, 114, 78, 66, 67, 75, 68, 74, 82, 88, 85, 71, 92, 107, 87, 91, 90, 82, 93, 83, 46, 45, 37, Ascii.f99710GS, 33, 55, 48, 48, 39, 44, 54, Ascii.f99710GS, 36, 55, 44, 44, 39, 46, 89, 81, 71, 71, 85, 83, 81, 121, 101, 104, 106, 108, 100, 108, 103, 125, 122, 115, 100, 107, 95, 99, 97, 99, 104, 101, 41, 47, 60, 62, 54, 56, 47, 46, 87, 90, 83, 70};
    }
    ...
    public static synchronized C18413VV A00() {
        C18413VV c18413vv;
        synchronized (C18413VV.class) {
            c18413vv = A00;
        }
        return c18413vv;
    }

    private C18047PW A01(C18895dL c18895dL, JSONObject data, long j10) throws JSONException {
        JSONArray placements = data.getJSONArray(A04(190, 10, 45));
        JSONObject jSONObject = placements.getJSONObject(0);
        C18276TF A002 = C18276TF.A00(jSONObject.getJSONObject(A04(124, 10, 90)));
        String optString = jSONObject.optString(A04(TPOptionalID.OPTION_ID_BEFORE_LONG_BUFFER_STRATEGY, 14, 9));
        ...
        C18275TE c18275te = new C18275TE(A002, optString, adReportingConfig, cache, flashConfig, optString2, A06(jSONObject));
        ...
        if (jSONObject.has(A044)) {
            ...
            while (i10 < jSONArray.length()) {
                ...
                AbstractC18360Uc.A06(c18895dL, jSONObject2, j10, str);
                ...
                if (ad != null) {
                    c18275te.A0F(new C18273TC(optString3, optString4, ad, optJSONArray));
                } else {
        ...
        if (jSONObject.has(A045)) {
            c18275te.A0G(jSONObject.getJSONObject(A045));
        }
        String anValidationUuid = data.optString(A04(29, 18, 33));
        return new C18047PW(c18275te, anValidationUuid);
    }

    private C18046PV A02(JSONObject jSONObject) {
        return new C18046PV(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), null);
    }

    private C18046PV A03(JSONObject jSONObject) {
        ...
        try {
            ...
            C18276TF A002 = C18276TF.A00(jSONObject2.getJSONObject(A04(124, 10, 90)));
            String optString = jSONObject2.optString(A04(TPOptionalID.OPTION_ID_BEFORE_LONG_BUFFER_STRATEGY, 14, 9));
            ...
            return new C18046PV(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), new C18275TE(A002, optString, featureConfig, null, optString2, cache, A06(jSONObject2)));
    ...
    public static boolean A06(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(A04)) {
            return jSONObject.getJSONObject(A04).optBoolean(A04(Opcodes.IF_ACMPEQ, 18, 102), false);
        }
        return false;
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public final C18415VX A07(C18895dL c18895dL, String str, long j10) throws JSONException {
        char c10;
        if (!TextUtils.isEmpty(str)) {
            ...
            switch (c10) {
                case 0:
                    return A01(c18895dL, jSONObject, j10);
                case 1:
        ...
        return new C18415VX(EnumC18414VW.A04);
    }
}
