...
public final class C1656417 extends AbstractC170789l {
    ...
    public final long AFy(C1680656 c1680656) throws C19512nf {
        AbstractC167664S.A02(A01(0, 15, 71));
        ...
        try {
            try {
                this.A02.seek(c1680656.A04);
                this.A00 = c1680656.A03 == -1 ? this.A02.length() - c1680656.A04 : c1680656.A03;
                AbstractC167664S.A00();
                if (this.A00 < 0) {
                    throw new C19512nf(null, null, 2008);
                }
                this.A03 = true;
                A0H(c1680656);
                long j10 = this.A00;
    ...
    */
    public static java.io.RandomAccessFile A00(android.net.Uri r6) throws com.facebook.ads.redexgen.core.C19512nf {
        /*
            ...
            java.lang.Object r4 = com.facebook.ads.redexgen.core.AbstractC166983M.A01(r0)     // Catch: java.lang.RuntimeException -> L1b java.lang.SecurityException -> L24 java.io.FileNotFoundException -> L2b
        ...
        L2b:
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C1656417.A05
            r0 = 3
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L4e:
            ...
            boolean r0 = com.facebook.ads.redexgen.core.C1680858.A01(r0)
            if (r0 == 0) goto L77
        L71:
            com.facebook.ads.redexgen.X.nf r0 = new com.facebook.ads.redexgen.X.nf
            r0.<init>(r4, r3)
        ...
        L7a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1656417.A00(android.net.Uri):java.io.RandomAccessFile");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void close() throws com.facebook.ads.redexgen.core.C19512nf {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
        ...
        L73:
            ...
            goto L6d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1656417.close():void");
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1661920
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i10, int i11) throws C19512nf {
        if (i11 == 0) {
            return 0;
        }
        try {
            ...
            try {
                AbstractC167664S.A02(A01(15, 14, 75));
                int read = ((RandomAccessFile) AbstractC167744a.A0f(this.A02)).read(bArr, i10, (int) Math.min(this.A00, i11));
                if (read > 0) {
                    this.A00 -= read;
                    A0F(read);
                }
