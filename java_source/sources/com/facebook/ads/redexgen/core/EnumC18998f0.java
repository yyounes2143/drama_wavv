...
public abstract class EnumC18998f0 {
    ...
    public static final /* synthetic */ EnumC18998f0[] A02;
    public static final EnumC18998f0 A03;
    public static final EnumC18998f0 A04;
    public static final EnumC18998f0 A05;
    public static final EnumC18998f0 A06;
    public static final EnumC18998f0 A07;
    public static final EnumC18998f0 A08;
    ...
    public static void A03() {
        A00 = new byte[]{Ascii.DC4, 39, 39, 52, 44, 71, 106, 106, 105, 96, 100, 107, 102, 77, 87, SignedBytes.MAX_POWER_OF_TWO, 78, 71, 105, 78, 84, 95, 114, 122, 117, 115, 100, 46, 9, Ascii.f99715SI, Ascii.DC4, 19, Ascii.SUB, 94, 101, 96, 101, 100, 124, 101, 43, Byte.MAX_VALUE, 114, 123, 110, 43, 100, 109, 43, 97, 120, 100, 101, 43, 100, 105, 97, 110, 104, Byte.MAX_VALUE, 43, 96, 110, 114};
    }
    ...
    static {
        ...
        final int i10 = 0;
        A03 = new EnumC18998f0(A022, i10) { // from class: com.facebook.ads.redexgen.X.C5
            @Override // com.facebook.ads.redexgen.core.EnumC18998f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i11) {
                return AbstractC18999f1.A01(jSONArray.optJSONArray(i11), jSONArray2.optJSONArray(i11));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC18999f1.A01(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String A023 = A02(5, 7, 74);
        final int i11 = 1;
        A04 = new EnumC18998f0(A023, i11) { // from class: com.facebook.ads.redexgen.X.C4
            @Override // com.facebook.ads.redexgen.core.EnumC18998f0
        ...
        final int i12 = 2;
        A05 = new EnumC18998f0(A024, i12) { // from class: com.facebook.ads.redexgen.X.C3
        ...
        final int i13 = 3;
        A06 = new EnumC18998f0(A025, i13) { // from class: com.facebook.ads.redexgen.X.C2
            ...
            public final boolean A05(JSONArray jSONArray, int i14) {
                ...
                int optInt = jSONArray.optInt(i14, 0);
                if (A00[4].charAt(31) != 'h') {
                    throw new RuntimeException();
                }
                A00[4] = "ESUjQDK13szqjYK8RJAQddjghxYzdQOh";
                return ((double) optInt) == jSONArray.optDouble(i14, 0.0d);
            }
        ...
        final int i14 = 4;
        A07 = new EnumC18998f0(A026, i14) { // from class: com.facebook.ads.redexgen.X.C1
            @Override // com.facebook.ads.redexgen.core.EnumC18998f0
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i15) {
                return AbstractC18999f1.A02(jSONArray.optJSONObject(i15), jSONArray2.optJSONObject(i15));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC18998f0
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC18999f1.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String A027 = A02(27, 6, 50);
        final int i15 = 5;
        A08 = new EnumC18998f0(A027, i15) { // from class: com.facebook.ads.redexgen.X.Bz
            @Override // com.facebook.ads.redexgen.core.EnumC18998f0
    ...
    public EnumC18998f0(String str, int i10) {
    }

    public static EnumC18998f0 A00(JSONArray jSONArray, int i10) {
        for (EnumC18998f0 type : values()) {
    ...
    public static EnumC18998f0 A01(JSONObject jSONObject, String str) {
        for (EnumC18998f0 type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC18998f0[] A04() {
        return new EnumC18998f0[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC18998f0 valueOf(String str) {
        return (EnumC18998f0) Enum.valueOf(EnumC18998f0.class, str);
    }

    public static EnumC18998f0[] values() {
        return (EnumC18998f0[]) A02.clone();
    }
}
