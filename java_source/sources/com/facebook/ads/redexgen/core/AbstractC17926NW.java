...
public abstract class AbstractC17926NW {
    ...
    public static AdSettings.IntegrationErrorMode A00(C18895dL c18895dL) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c18895dL)) {
    ...
    public static boolean A03(C18895dL c18895dL) {
        return (c18895dL.getApplicationInfo().flags & 2) != 0;
    }
}
