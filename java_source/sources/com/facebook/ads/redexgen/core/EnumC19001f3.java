...
public enum EnumC19001f3 {
    A09(A00(TPOptionalID.OPTION_ID_BEFORE_BOOL_ENABLE_NEW_DRM_CLIENT, 13, 123), EnumC19003f5.A03, true),
    A08(A00(128, 17, 124), EnumC19003f5.A04, true),
    A07(A00(114, 14, 33), EnumC19003f5.A04, false),
    A0A(A00(171, 23, 15), EnumC19003f5.A04, false),
    A0B(A00(Opcodes.IFLE, 13, 28), EnumC19003f5.A04, true),
    A06(A00(97, 17, 115), EnumC19003f5.A04, false);
    ...
    EnumC19001f3(String str, EnumC19003f5 enumC19003f5, boolean z10) {
        this.A01 = str;
        this.A00 = enumC19003f5;
        this.A02 = z10;
    }

    public final EnumC19003f5 A03() {
        return this.A00;
    }
    ...
    public static EnumC19001f3[] valuesCustom() {
        EnumC19001f3[] valuesCustom = values();
        String[] strArr = A04;
        ...
        return (EnumC19001f3[]) valuesCustom.clone();
    }
}
