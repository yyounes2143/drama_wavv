...
public final class C18558Xt extends AdNativeComponentView {
    ...
    public final C18375Ur A06;
    public final C17807La A07;
    ...
    public static final int A09 = ((int) AbstractC18488Wl.A02) * 500;
    public static final int A0H = (int) (AbstractC18488Wl.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC18488Wl.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC18488Wl.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC18488Wl.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC18488Wl.A02 * 4.0f);
    public static final int A0C = (int) AbstractC18488Wl.A02;
    public static final int A0F = (int) (AbstractC18488Wl.A02 * 4.0f);
    public static final int A0A = (int) (AbstractC18488Wl.A02 * 0.5d);

    public C18558Xt(C18895dL c18895dL, C18375Ur c18375Ur) {
        super(c18895dL);
        this.A06 = c18375Ur;
        this.A05 = new TextView(c18895dL);
        this.A04 = new TextView(c18895dL);
        this.A03 = new TextView(c18895dL);
        this.A02 = new RelativeLayout(c18895dL);
        this.A00 = new LinearLayout(c18895dL);
        this.A01 = new RelativeLayout(c18895dL);
        this.A07 = new C17807La(c18895dL);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        EnumC18493Wq.A04(this.A07, EnumC18493Wq.A0B);
    ...
    public final void onMeasure(int i10, int i11) {
        int A0F2 = ((int) AbstractC18488Wl.A02) * C18329U7.A0F(getContext());
