...
public final class C18608Yh extends LinearLayout {
    public boolean A00;
    public final ImageView A01;
    public final TextView A02;
    public static final int A04 = (int) (AbstractC18488Wl.A02 * 16.0f);
    public static final int A05 = (int) (AbstractC18488Wl.A02 * 12.0f);
    public static final int A06 = (int) (AbstractC18488Wl.A02 * 12.0f);
    public static final int A03 = (int) (AbstractC18488Wl.A02 * 16.0f);

    public C18608Yh(C18895dL c18895dL) {
        super(c18895dL);
        this.A00 = false;
        setOrientation(0);
    ...
    private void A00() {
        ...
        AbstractC18528XP.A0W(this.A02, false, 14);
        if (this.A00) {
            textColor = -1;
        } else {
            textColor = -10459280;
    ...
    public void setData(String str, EnumC18536XX enumC18536XX) {
        this.A02.setText(str);
        if (enumC18536XX != null) {
