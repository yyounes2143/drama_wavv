...
public final class C18137Qz implements AdViewApi {
    ...
    public final C168846M A0A;
    public final EnumC18386V4 A0B;
    ...
    public static void A02() {
        A0D = new byte[]{-114, -108, -112, -64, -61, -66, -110, -66, -104, -102, -58, -104, -110, -60, -58, -107, 111, -114, -101, -101, -110, -97, 77, -114, -111, 77, -111, -110, -96, -95, -97, -100, -90, -110, -111, -83, -52, -39, -39, -48, -35, -117, -52, -49, -117, -41, -38, -52, -49, -117, -35, -48, -36, -32, -48, -34, -33, -48, -49, -34, -4, 9, 9, 10, Ascii.f99715SI, -69, 1, 4, 9, -1, -69, -4, -69, Ascii.f99715SI, 0, 8, 11, 7, -4, Ascii.f99715SI, 0, -69, Ascii.f99715SI, 3, -4, Ascii.f99715SI, -69, 7, 10, -4, -1, -69, -3, 4, -1, -69, -62, -64, 14, -62, -5, -2, -19, 3, Ascii.DC4, -1, -80, -79, -65, -64, -66, -69, -59, -70, -116, -124, -115, -121, -121, -70, -62, -59, -73, -70, -105, -70};
    }
    ...
    public C18137Qz(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        this.A00 = -1L;
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            this.A07 = adView.getContext().getResources().getDisplayMetrics();
            this.A0B = AbstractC18472WV.A04(adSize);
            this.A0C = str;
            this.A09 = adViewParentApi;
            this.A08 = adView;
            this.A0A = C18149RB.A08(context);
            this.A0A.A0F().A3L(AdPlacementType.BANNER.toString(), str);
            C17923NT c17923nt = new C17923NT(str, AbstractC18472WV.A05(this.A0B), AdPlacementType.BANNER, AbstractC18472WV.A04(adSize), 1, new C19129hB());
            c17923nt.A06(this.A05);
            c17923nt.A07(this.A06);
            this.A03 = new C1692672(this.A0A, c17923nt);
            this.A03.A0S(new C19050fq(this));
            return;
        }
        throw new IllegalArgumentException(A01(100, 6, 115));
    }

    public C18137Qz(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws C18385V2 {
        this(context, str, A00(str2), adViewParentApi, adView);
        this.A0A.A0F().A4L();
    }

    public static AdSize A00(String str) throws C18385V2 {
        EnumC18388V6 template = C18393VB.A00(str);
        if (template != null) {
            C18393VB.A03(template);
            return AbstractC18472WV.A01(template);
        }
        throw new C18385V2(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A01(59, 41, 116), str));
    }
    ...
    public final C1692672 A08() {
        return this.A03;
    }

    public final C168846M A09() {
        return this.A0A;
    }

    public final EnumC18386V4 A0A() {
        return this.A0B;
    }
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        if (this.A06 != null && (A01 = AbstractC18870cv.A01(this.A0A, this.A06)) != null) {
    ...
    public final void destroy() {
        ...
        if (this.A04 != null) {
            ...
            if (C18329U7.A1B(adView.getContext())) {
                this.A04.A07();
                if (this.A01 != null) {
    ...
    public final boolean isAdInvalidated() {
        ...
        this.A0A.A0F().A5X(z10);
        return z10;
    }

    @Override // com.facebook.ads.InterfaceC16468Ad
    public final void loadAd() {
        AbstractC18397VF.A05(A01(120, 6, 47), A01(35, 24, 68), A01(113, 7, 45));
        A03(null);
    }

    @Override // com.facebook.ads.internal.api.AdViewApi
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        AbstractC18397VF.A05(A01(120, 6, 47), A01(35, 24, 68), A01(8, 8, 59));
        A03(((C18364Ug) adViewLoadConfig).A00());
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A01 != null) {
            AbstractC18390V8.A01(this.A07, this.A01, this.A0B);
        }
    }

    @Override // com.facebook.ads.internal.api.AdViewApi, com.facebook.ads.InterfaceC16468Ad
    @Deprecated
    public final void setExtraHints(ExtraHints extraHints) {
        this.A05 = extraHints.getHints();
        this.A06 = extraHints.getMediationData();
        if (C18329U7.A0l(this.A0A) && this.A03 != null) {
