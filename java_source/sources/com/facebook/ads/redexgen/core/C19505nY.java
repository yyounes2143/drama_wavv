...
public class C19505nY extends AbstractC168185I {
    ...
    static {
        A05();
        C166462T.A03(A03(0, 16, 86));
    }

    public C19505nY(int i10) {
        this(i10, 0);
    }

    public C19505nY(int i10, int i11) {
        this.A05 = new C168235N();
        this.A06 = i10;
        this.A07 = i11;
    }

    public static C19505nY A02() {
        return new C19505nY(0);
    }

    private ByteBuffer A04(final int i10) {
        if (this.A06 == 1) {
            ...
            if (A09[2].length() != 11) {
                ...
                throw new IllegalStateException(capacity, i10) { // from class: com.facebook.ads.redexgen.X.5R
                    ...
                    public static String A00(int i12, int i13, int i14) {
                        ...
                        for (int i15 = 0; i15 < copyOfRange.length; i15++) {
                            copyOfRange[i15] = (byte) ((copyOfRange[i15] - i14) - 17);
                        }
                        return new String(copyOfRange);
                    }
                    ...
                    {
                        super(A00(4, 18, 86) + capacity + A00(0, 3, 89) + i10 + A00(3, 1, 114));
                        this.A00 = capacity;
                        this.A01 = i10;
                    }
                };
    ...
    public final boolean A0E() {
        return A09(Ints.MAX_POWER_OF_TWO);
    }
}
