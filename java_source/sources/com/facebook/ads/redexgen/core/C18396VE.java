...
public final class C18396VE implements InterfaceC18348UQ {
    ...
    static {
        A05();
        A04 = C18396VE.class.getSimpleName();
    }

    public C18396VE(C18869cu c18869cu, InterfaceC18465WO interfaceC18465WO) {
        this.A00 = c18869cu;
        this.A01 = interfaceC18465WO;
    }

    public static JSONArray A01(C18869cu c18869cu, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c18869cu, jSONArray, jSONArray2, i10);
    }
    ...
    */
    public static org.json.JSONArray A02(com.facebook.ads.redexgen.core.C18869cu r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) {
        /*
            Method dump skipped, instructions count: 264
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18396VE.A02(com.facebook.ads.redexgen.X.cu, org.json.JSONArray, org.json.JSONArray, int):org.json.JSONArray");
    }
    ...
    */
    private org.json.JSONObject A03() {
        /*
            ...
            boolean r0 = com.facebook.ads.redexgen.core.AbstractC18331U9.A0P(r0)
            if (r0 == 0) goto L46
            com.facebook.ads.redexgen.X.cu r0 = r7.A00
            org.json.JSONArray r6 = com.facebook.ads.redexgen.core.C18258Sx.A03(r0)
            if (r6 == 0) goto L46
            int r0 = r6.length()
            if (r0 <= 0) goto L46
            com.facebook.ads.redexgen.X.cu r5 = r7.A00
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C18396VE.A03
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 5
            ...
            throw r0
        L36:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C18396VE.A03
        ...
        L8d:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18396VE.A03():org.json.JSONObject");
    }
    ...
    private JSONObject A04(int i10) {
        ...
        if (AbstractC18331U9.A0P(this.A00) && (A042 = C18258Sx.A04(this.A00, (A08 = AbstractC18331U9.A08(this.A00)))) != null && A042.length() > 0) {
    ...
    private void A06(String str) {
        if (C18258Sx.A0I(str)) {
            C18869cu c18869cu = this.A00;
            String[] strArr = A03;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                throw new RuntimeException();
            }
            A03[2] = "U9Gor";
            C18258Sx.A0B(c18869cu, str);
            return;
        }
        this.A01.A9x(str);
    }
    ...
    public final JSONObject A5D() {
        int eventLimit = AbstractC18331U9.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC18348UQ
    public final boolean AAS() {
        int eventCount = AbstractC18331U9.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int A7u = this.A01.A7u();
        int eventLimit = C18258Sx.A00(this.A00);
        return A7u + eventLimit > eventCount;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC18348UQ
    public final void ACJ() {
        int A4s = this.A01.A4s(AbstractC18331U9.A0G(this.A00));
        if (A4s > 0) {
            this.A00.A08().AAy(A00(379, 8, 37), AbstractC18256Sv.A10, new C18257Sw(A00(28, 44, 62) + A4s));
        }
    ...
    public final void AD0(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            try {
                ...
                if (this.A00.A05().AAF()) {
                    String eventId = A04;
                    Log.e(eventId, A00(108, 62, 102), e3);
                }
            }
        }
    }
        ...
        for (int errorCode = 0; errorCode < jSONArray.length(); errorCode++) {
            try {
                ...
                if (A00(393, 26, 39).equals(eventId)) {
                    C18329U7.A0V(this.A00).A2y(jSONObject.getString(A00(419, 14, 16)));
                    this.A00.A04().ABq();
                } else {
                    ...
                    if (i10 == 1) {
                        ...
                        if (i10 >= 1000 && i10 < 2000) {
                            ...
                            if (this.A00.A05().AAF()) {
                                Log.e(A04, A00(TPCodecParamers.TP_PROFILE_MJPEG_HUFFMAN_LOSSLESS, 41, 103) + i10 + A002 + eventId + A00);
                            }
                            if (!this.A01.A5i(eventId) && A0P) {
                                C18258Sx.A0D(eventId);
                            }
                ...
                if (this.A00.A05().AAF()) {
                    Log.e(A04, A00(331, 44, 14) + errorCode + A00, e3);
                }
                z10 = false;
            }
        }
