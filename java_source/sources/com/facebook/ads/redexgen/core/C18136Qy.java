...
public final class C18136Qy implements AdSettingsApi {
    ...
    public static void A01() {
        A00 = new byte[]{14, 5, Ascii.ETB, Ascii.f99715SI, 8, 14, 3, Ascii.CAN, Ascii.f99707EM, 10, Ascii.NAK, Ascii.f99718US, Ascii.f99707EM, 3, Ascii.NAK, Ascii.CAN, 3, Ascii.DC4, Ascii.f99710GS, Ascii.f99715SI, Ascii.DC4, 3, Ascii.ETB, Ascii.f99707EM, 5, 90, 107, 125, 122, 46, 99, 97, 106, 107, 46, 106, 107, 120, 103, 109, 107, 46, 102, 111, 125, 102, 52, 46, 71, 120, 117, 126, 48, 100, 117, 99, 100, 121, 126, 119, 48, 105, Byte.MAX_VALUE, 101, 98, 48, 113, 96, 96, 48, 103, 121, 100, 120, 48, 86, 113, 115, 117, 114, Byte.MAX_VALUE, Byte.MAX_VALUE, 123, 55, 99, 48, 113, 116, 48, 101, 126, 121, 100, 99, 48, 105, Byte.MAX_VALUE, 101, 48, 125, 101, 99, 100, 48, 99, 96, 117, 115, 121, 118, 105, 48, 100, 120, 117, 48, 116, 117, 102, 121, 115, 117, 48, 120, 113, 99, 120, 117, 116, 48, 89, 84, 48, 100, Byte.MAX_VALUE, 48, 117, 126, 99, 101, 98, 117, 48, 100, 120, 117, 48, 116, 117, 124, 121, 102, 117, 98, 105, 48, Byte.MAX_VALUE, 118, 48, 100, 117, 99, 100, 48, 113, 116, 99, 60, 48, 113, 116, 116, 48, 100, 120, 117, 48, 118, Byte.MAX_VALUE, 124, 124, Byte.MAX_VALUE, 103, 121, 126, 119, 48, 115, Byte.MAX_VALUE, 116, 117, 48, 114, 117, 118, Byte.MAX_VALUE, 98, 117, 48, 124, Byte.MAX_VALUE, 113, 116, 121, 126, 119, 48, 113, 126, 48, 113, 116, 42, 48, 81, 116, 67, 117, 100, 100, 121, 126, 119, 99, 62, 113, 116, 116, 68, 117, 99, 100, 84, 117, 102, 121, 115, 117, 56, 50, 7, 6, Ascii.NAK, 10, 0, 6, 42, 7, 43, 2, Ascii.DLE, 11, 103, 111, 111, 103, 108, 101, 95, 115, 100, 107, 126, 105, 102, Ascii.DLE, 4, 9, Ascii.f99714RS, 94, 80, Ascii.SYN, 124, 104, 101, 114, 50, 60, 126, 122};
    }
    ...
    public final boolean isTestMode(Context context) {
        if (!AdInternalSettings.isDebugBuild() && !AdInternalSettings.isExplicitTestMode()) {
            ...
            if (!collection.contains(str)) {
                ...
                if (string == null) {
                    SharedPreferences A003 = AbstractC18421Ve.A00(context);
