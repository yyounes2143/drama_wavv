...
public final class C18276TF {
     ...
     */
    public C18276TF(Map<String, String> map) {
        char c10;
        this.A01 = -1;
        this.A00 = -1;
        this.A0B = A0G;
    ...
    public static void A02() {
        A0F = new byte[]{67, 65, 67, 72, 69, 65, 66, 76, 69, 93, 90, 66, 85, 88, 93, 80, 85, SignedBytes.MAX_POWER_OF_TWO, 93, 91, 90, 107, 80, 65, 70, 85, SignedBytes.MAX_POWER_OF_TWO, 93, 91, 90, 107, 93, 90, 107, 71, 81, 87, 91, 90, 80, 71, 4, 0, 7, 54, Ascii.f99718US, 0, 12, Ascii.f99714RS, 8, 11, 0, 5, 0, Ascii.f99710GS, Ascii.DLE, 54, Ascii.f99707EM, 12, Ascii.ESC, 10, 12, 7, Ascii.f99710GS, 8, 14, 12, 6, Ascii.SUB, Ascii.ETB, Ascii.NAK, 19, Ascii.ESC, 19, Ascii.CAN, 2, 41, Ascii.f99714RS, 19, Ascii.f99718US, 17, Ascii.f99714RS, 2, 106, 118, 123, 121, Byte.MAX_VALUE, 119, Byte.MAX_VALUE, 116, 110, 69, 109, 115, 126, 110, 114, 114, 101, 102, 114, 101, 115, 104, 121, 110, 109, 121, 110, 120, 99, 84, Byte.MAX_VALUE, 99, 121, 110, 120, 99, 100, 103, 111, 124, 107, Byte.MAX_VALUE, 123, 107, 125, 122, 81, 122, 103, 99, 107, 97, 123, 122, 120, 117, 124, 105, Ascii.ETB, 8, 5, 4, 14, 62, Ascii.NAK, 8, 12, 4, 62, 17, 14, 13, 13, 8, Ascii.f99715SI, 6, 62, 8, Ascii.f99715SI, Ascii.NAK, 4, 19, Ascii.ETB, 0, 13, 113, 110, 98, 112, 102, 101, 110, 107, 110, 115, 126, 88, 100, 111, 98, 100, 108, 88, 110, 105, 110, 115, 110, 102, 107, 88, 99, 98, 107, 102, 126, 86, 73, 69, 87, 65, 66, 73, 76, 73, 84, 89, Byte.MAX_VALUE, 67, 72, 69, 67, 75, Byte.MAX_VALUE, 73, 78, 84, 69, 82, 86, 65, 76, 47, 48, 60, 46, 56, 59, 48, 53, 48, 45, 32, 6, 58, 49, 60, 58, 50, 6, 45, 48, 58, 50, 60, 43};
    }

    static {
        A02();
        A0H = C18276TF.class.getSimpleName();
        A0G = AdPlacementType.UNKNOWN;
    }

    @Nullable
    public static C18276TF A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
