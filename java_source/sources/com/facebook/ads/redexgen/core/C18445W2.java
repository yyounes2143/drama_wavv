...
public final class C18445W2 {
    public static C18445W2 A03;
    ...
    public final C18444W1 A01 = new C18444W1();
    ...
    public static void A04() {
        A04 = new byte[]{-109, -114, -57, -54, -59, -50, -53, -49, -51, -50, -38, 14, 17, 32, 17, 34, 1, -2, 17, -2, -45, -44, -43, -40, -35, -40, -29, -40, -34, -35, -90, -98, -83, -102, -99, -102, -83, -102, -9, -13, -24, -22, -20, -12, -20, -11, -5, -6, -75, -74, -79, -76, -89, -90, -124, -93, -80, -80, -89, -76, -123, -79, -73, -80, -74, Ascii.SUB, Ascii.ESC, Ascii.SYN, Ascii.f99707EM, 12, 11, -16, Ascii.NAK, Ascii.ESC, 12, Ascii.f99707EM, Ascii.SUB, Ascii.ESC, Ascii.DLE, Ascii.ESC, Ascii.DLE, 8, 19, -22, Ascii.SYN, Ascii.f99709FS, Ascii.NAK, Ascii.ESC, 19, Ascii.DC4, Ascii.f99715SI, Ascii.DC2, 5, 4, -19, 5, 4, 9, Ascii.NAK, 13, -14, 5, 3, Ascii.DC4, 1, 14, 7, 12, 5, -29, Ascii.f99715SI, Ascii.NAK, 14, Ascii.DC4, -27, -26, -31, -28, -41, -42, -64, -45, -26, -37, -24, -41, -76, -45, -32, -32, -41, -28, -75, -31, -25, -32, -26, -88, -87, -92, -89, -102, -103, -125, -106, -87, -98, -85, -102, 120, -92, -86, -93, -87, -32, -31, -36, -33, -46, -47, -65, -61, -80, -36, -30, -37, -31, -80, -91, -87, -95, -101, -81, -80, -99, -87, -84, 34, 39, Ascii.f99714RS, 19, 4, 6};
    }
    ...
    public C18445W2(C18225SQ c18225sq) {
        this.A00 = c18225sq;
    }

    public static C18445W2 A00(C18225SQ c18225sq) {
        if (A03 == null) {
            A03 = new C18445W2(c18225sq);
        }
        return A03;
    }
    ...
    public final int A0A(String str) {
        ...
        C18444W1 c18444w1 = this.A01;
        C18225SQ c18225sq = this.A00;
        String A01 = A01(114, 23, 66);
        if (A05[5].charAt(25) != '7') {
            throw new RuntimeException();
        }
        A05[3] = "fotbcTaHfC";
        return c18444w1.A03(c18225sq, A01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(A01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(A01) < C18329U7.A02(this.A00)) {
    ...
    public final void A0C(String str) {
        try {
            ...
            String clientToken = jSONArray.getJSONObject(0).getJSONObject(A01(20, 10, 63)).getString(A01(Opcodes.RETURN, 4, 126));
    ...
    public final boolean A0F(String str) {
        return !C18329U7.A19(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
