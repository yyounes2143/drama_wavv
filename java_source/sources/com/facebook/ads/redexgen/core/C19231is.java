...
public final class C19231is implements InterfaceC17841M8 {
    ...
    public static final C19231is A03 = new C19231is(Collections.emptyMap());
    public int A00;
    ...
    public C19231is(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C17842M9 c17842m9) {
        HashMap hashMap = new HashMap(otherMetadata);
        A01(hashMap, c17842m9.A08());
        A02(hashMap, c17842m9.A09());
        return hashMap;
    }
    ...
    */
    public static void A01(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19231is.A01(java.util.HashMap, java.util.List):void");
    }
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC19214ia.A06);
        }
    ...
    public final C19231is A05(C17842M9 c17842m9) {
        Map<String, byte[]> A00 = A00(this.A01, c17842m9);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, A00)) {
            return this;
        }
        return new C19231is(A00);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC17841M8
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C19231is) obj).A01);
    }
