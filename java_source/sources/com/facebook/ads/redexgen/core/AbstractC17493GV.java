...
public abstract class AbstractC17493GV {
    ...
    public static void A06() {
        A00 = new byte[]{7, 19, 2, Ascii.f99715SI, 9, 73, Ascii.DLE, 8, 2, 72, 2, Ascii.DC2, Ascii.NAK};
    }

    static {
        A06();
        A02 = new int[]{1, 2, 2, 2, 2, 3, 3, 4, 4, 5, 6, 6, 6, 7, 8, 8};
        A03 = new int[]{-1, 8000, TXRecordCommon.AUDIO_SAMPLERATE_16000, TXRecordCommon.AUDIO_SAMPLERATE_32000, -1, -1, 11025, 22050, TXRecordCommon.AUDIO_SAMPLERATE_44100, -1, -1, 12000, 24000, TXRecordCommon.AUDIO_SAMPLERATE_48000, -1, -1};
        A04 = new int[]{64, 112, 128, 192, 224, 256, 384, 448, 512, 640, ViewUtils.EDGE_TO_EDGE_FLAGS, 896, 1024, 1152, 1280, 1536, AppKeyManager.IMAGE_ACCEPTED_SIZE_Y, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    }
    ...
    public static int A01(byte[] bArr) {
        ...
        switch (bArr[0]) {
            case -2:
                ...
                i10 = (((b10 & 3) << 12) | ((bArr[7] & UnsignedBytes.MAX_VALUE) << 4) | ((bArr[6] & 240) >> 4)) + 1;
                break;
            case -1:
                i10 = (((bArr[7] & 3) << 12) | ((bArr[6] & UnsignedBytes.MAX_VALUE) << 4) | ((bArr[9] & 60) >> 2)) + 1;
                z10 = true;
                break;
            case 31:
                i10 = (((bArr[6] & 3) << 12) | ((bArr[7] & UnsignedBytes.MAX_VALUE) << 4) | ((bArr[8] & 60) >> 2)) + 1;
                z10 = true;
                break;
            default:
                i10 = (((bArr[5] & 3) << 12) | ((bArr[6] & UnsignedBytes.MAX_VALUE) << 4) | ((bArr[7] & 240) >> 4)) + 1;
                break;
        }
    ...
    public static C19583or A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i10;
        C167564I A042 = A04(bArr);
        A042.A09(60);
        ...
        return new C166302D().A0y(str).A11(A05(0, 13, 27)).A0a(i10).A0b(bitrate + amode5).A0m(rate).A0u(drmInitData).A10(str2).A14();
    }

    public static C167564I A04(byte[] bArr) {
        if (bArr[0] == Byte.MAX_VALUE) {
            return new C167564I(bArr);
        }
        ...
        if (copyOf[0] == 31) {
            C167564I c167564i2 = new C167564I(copyOf);
            while (c167564i2.A01() >= 16) {
                c167564i2.A09(2);
                int A042 = c167564i2.A04(14);
                if (A01[4].length() == 13) {
                    throw new RuntimeException();
                }
                String[] strArr = A01;
