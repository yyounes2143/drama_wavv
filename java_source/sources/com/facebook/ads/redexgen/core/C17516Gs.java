...
public final class C17516Gs {
    ...
    public C17516Gs(byte[] bArr, int i10, int i11) {
        A08(bArr, i10, i11);
    }
    ...
    private void A01() {
        AbstractC166983M.A08(this.A02 >= 0 && (this.A02 < this.A01 || (this.A02 == this.A01 && this.A00 == 0)));
        String[] strArr = A04;
    ...
    public final void A07(int i10) {
        ...
        this.A00 = numBytes + (i10 - oldByteOffset2);
    ...
    */
    public final boolean A09() {
        ...
        L2e:
            ...
            goto L1d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C17516Gs.A09():boolean");
    }
    ...
    public final boolean A0B(int i10) {
        ...
        if (i12 >= this.A01) {
            return i12 == this.A01 && newBitOffset == 0;
        }
        return true;
    }
}
