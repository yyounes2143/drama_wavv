...
public enum EnumC19180i2 {
    ...
    public static EnumC19180i2[] valuesCustom() {
        EnumC19180i2[] enumC19180i2Arr = (EnumC19180i2[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) == strArr[4].charAt(20)) {
            throw new RuntimeException();
        }
        A01[3] = "UcBpUNe8sR";
        return enumC19180i2Arr;
    }
}
