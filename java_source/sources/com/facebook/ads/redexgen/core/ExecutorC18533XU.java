...
public final class ExecutorC18533XU implements Executor {
    ...
    public static void A04() {
        A04 = new byte[]{101, 119, 125, 106, 103, 43, 45, 61, 54, 39, 36, 60, 33, 56, Ascii.ETB, 45, 62, 33, 100, 121, 100, Ascii.DC2, 39, 53, 45, 53, 102, 55, 51, 35, 51, 35, 102, 50, 41, 41, 102, 42, 41, 40, 33, 104, 33, 35, 40, 35, 52, 47, 37};
    }

    static {
        A04();
        A08 = new ExecutorC18533XU(A00(7, 7, 23), 0);
        A06 = new ExecutorC18533XU(A00(0, 5, 64), 0);
        A07 = new ExecutorC18533XU(A00(5, 2, 11), 0);
        A03 = 32;
        A0C = Executors.newSingleThreadExecutor();
        A0B = Executors.newFixedThreadPool(5);
        A0D = new AtomicBoolean();
        A0E = new AtomicBoolean();
        A0A = Executors.newCachedThreadPool(new ThreadFactoryC18531XS());
        A09 = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    }

    public ExecutorC18533XU(String str, int i10) {
        this.A02 = i10;
        int CPU_COUNT = Runtime.getRuntime().availableProcessors();
        this.A01 = new ThreadPoolExecutor(Math.max(2, Math.min(CPU_COUNT - 1, 4)), (CPU_COUNT * 2) + 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactoryC18532XT(this, str));
    ...
    public static void A05(Context context) {
        A0D.set(C18329U7.A2k(context));
        A0E.set(C18329U7.A2j(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (ExecutorC18533XU.class) {
            int i10 = A03;
            ...
            if (size == reservedExecutorQueueSize) {
                ...
                C18869cu A00 = AbstractC18224SP.A00();
                if (A00 != null) {
                    A00.A08().AAy(A00(42, 7, 34), AbstractC18256Sv.A1d, new C18257Sw(A00(21, 21, 34), A00(14, 7, 32) + i10));
                }
            }
        }
