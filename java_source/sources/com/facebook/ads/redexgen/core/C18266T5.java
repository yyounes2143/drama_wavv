...
public final class C18266T5 {
    ...
    public static void A09(Context context) {
        ...
        ((ActivityManager) AbstractC19074gF.A00((ActivityManager) context.getSystemService(A01(16, 8, 108)))).getMemoryInfo(memoryInfo);
    ...
    public static void A0A(C18225SQ c18225sq) {
        try {
            Intent A002 = AbstractC18466WP.A00(c18225sq, null, new IntentFilter(A01(24, 37, 65)));
            if (A002 == null) {
                return;
            }
            ...
            c18225sq.A08().AAy(A01(102, 7, 96), AbstractC18256Sv.A1T, new C18257Sw(e3));
        }
    }

    public static synchronized void A0B(C18225SQ c18225sq) {
        synchronized (C18266T5.class) {
            A09(c18225sq);
            A0A(c18225sq);
            if (A04 == null) {
                A04 = (SensorManager) c18225sq.getSystemService(A01(128, 6, 101));
                if (A04 == null) {
                    return;
                }
            }
