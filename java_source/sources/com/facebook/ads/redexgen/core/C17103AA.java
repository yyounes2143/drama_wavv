...
public final class C17103AA implements InterfaceC19636px {
    ...
    public final InterfaceC19641q2 A03;
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC19642q3> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public C17103AA(View view, InterfaceC19641q2 interfaceC19641q2) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC19641q2;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC19636px
