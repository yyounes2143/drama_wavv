...
public class C18672Zj extends WebViewClient {
    ...
    public final WeakReference<C17753Ki> A03;
    public final WeakReference<InterfaceC18670Zh> A04;
    public final WeakReference<AtomicBoolean> A05;
    public final WeakReference<C18520XH> A06;
    public final WeakReference<C18969eX> A07;
    ...
    public C18672Zj(C18895dL c18895dL, WeakReference<InterfaceC18670Zh> weakReference, WeakReference<C18969eX> weakReference2, WeakReference<C18520XH> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C17753Ki> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c18895dL;
    ...
    private void A03(int i10, CharSequence charSequence, long j10) {
        ...
        try {
            jSONObject.put(A01(Opcodes.IF_ICMPNE, 10, 100), i10);
            jSONObject.put(A01(170, 17, 77), charSequence);
            jSONObject.put(A01(202, 21, 122), z10);
            jSONObject.put(A01(Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE, 22, 100), j10);
            jSONObject.put(A01(276, 10, 90), this.A09.get());
        } catch (JSONException unused) {
        }
        this.A02.A08().AAy(A01(306, 8, 81), AbstractC18256Sv.A2f, new C18257Sw(AdErrorType.WEB_VIEW_FAILED_TO_LOAD.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
    }
    ...
    private final void A05(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0F().AKH(webResourceResponse.getStatusCode(), AbstractC18492Wp.A01(webResourceResponse.getStatusCode(), A01(67, 10, 126), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A07(String str, String str2) {
        ...
        try {
            ...
            jSONObject.put(A01(C23915l.f108272f, 10, 12), str2);
            jSONObject.put(A01(276, 10, 90), this.A09.get());
        } catch (JSONException unused) {
        }
        if (this.A02 != null) {
            this.A02.A08().AAy(A01(306, 8, 81), AbstractC18256Sv.A2c, new C18257Sw(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x006c, code lost:
        ...
        r5 = com.facebook.ads.redexgen.core.C18214SF.A09(r7.A02);
        r6 = A0A(r3, r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0098, code lost:
        ...
        r4 = com.facebook.ads.redexgen.core.C17753Ki.A0H;
        r0 = A01(108, 37, 87);
    ...
    */
    private boolean A08(android.net.Uri r8) {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C18672Zj.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.facebook.ads.redexgen.core.C18214SF.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.facebook.ads.redexgen.core.C17753Ki.A01()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18672Zj.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0F().AKF();
        this.A00 = new Date();
        new Handler().postDelayed(new C17755Kk(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean A12 = C18329U7.A12(this.A02);
        ...
        if (A12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AKG(AbstractC18492Wp.A01(webResourceError.getErrorCode(), A01 + ((Object) webResourceError.getDescription()), A01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC18667Ze.A0D(AbstractC18256Sv.A2b);
        InterfaceC18670Zh adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ACj(str, new C18678Zp().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
