...
public class C19315kG<V> implements Iterator<V> {
    public final Collection<V> A00;
    public final Iterator<V> A01;
    public final /* synthetic */ C19316kH A02;
    ...
    public C19315kG(final C19316kH this$1) {
        Iterator<V> A05;
        this.A02 = this$1;
        this.A00 = this.A02.A00;
        A05 = AbstractC166011i.A05(this$1.A00);
        this.A01 = A05;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kG != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedCollection$WrappedIterator */
    public C19315kG(final C19316kH this$1, Iterator<V> delegateIterator) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
    ...
    public final void remove() {
        this.A01.remove();
        AbstractC166011i.A01(this.A02.A04);
        this.A02.A05();
    }
}
