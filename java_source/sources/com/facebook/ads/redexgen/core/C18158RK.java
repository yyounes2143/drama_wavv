...
public final class C18158RK implements NativeAdApi {
    ...
    public C18158RK(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        C18114Qc.A0L(nativeAdBaseApi).A1b(EnumC18388V6.A06);
    }

    public C18158RK(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }

    private C18114Qc A00() {
        return C18114Qc.A0L(this.A01);
    }
    ...
    public final List<NativeAd> A03() {
        ...
        for (C18114Qc internalNativeAd : A00().A1I()) {
    ...
    public final VideoAutoplayBehavior getVideoAutoplayBehavior() {
        return EnumC18378Uu.A00(A00().A19());
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C18895dL A12 = A00().A12();
            C18895dL downloadContext = C18149RB.A03(imageView.getContext());
            downloadContext.A0L(A12);
            C18114Qc.A0k(A00().getAdIcon(), imageView, downloadContext);
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C19041fh) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C19041fh) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
