...
public final class C17641Iu {
    ...
    public int A01;
    public boolean A02;
    public final C17642Iv A04 = new C17642Iv();
    public final C167574J A03 = new C167574J(new byte[65025], 0);
    public int A00 = -1;
    ...
    */
    private int A00(int r5) {
        ...
        L1f:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C17641Iu.A00(int):int");
    }
    ...
    public final boolean A05(InterfaceC19372lN interfaceC19372lN) throws IOException {
        AbstractC166983M.A08(interfaceC19372lN != null);
        if (this.A02) {
            this.A02 = false;
            this.A03.A0d(0);
        }
        while (!this.A02) {
            ...
            if (A05[2].length() == 22) {
                ...
                if (i10 < 0) {
                    if (!this.A04.A03(interfaceC19372lN) || !this.A04.A05(interfaceC19372lN, true)) {
                        return false;
                    }
                    int bytesToSkip = 0;
                    ...
                    if (!AbstractC17497GZ.A02(interfaceC19372lN, i11)) {
                        return false;
                    }
                ...
                if (strArr4[4].charAt(26) != strArr4[5].charAt(26)) {
                    ...
                    if (A00 > 0) {
                        ...
                        if (!AbstractC17497GZ.A03(interfaceC19372lN, this.A03.A0l(), this.A03.A0A(), A00)) {
                            return false;
                        }
                        this.A03.A0e(this.A03.A0A() + A00);
                        int i12 = this.A04.A09[segmentIndex - 1];
                        if (A05[2].length() == 22) {
                            String[] strArr5 = A05;
