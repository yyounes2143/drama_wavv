...
public enum EnumC18388V6 {
    ...
    A06(200),
    A05(500),
    A0A(LogSeverity.EMERGENCY_VALUE),
    A09(801),
    A0B(802),
    A0C(803),
    A04(201),
    ...
    EnumC18388V6(int i10) {
        this.A00 = i10;
    }

    public static EnumC18388V6 A00(int i10) {
        for (EnumC18388V6 enumC18388V6 : values()) {
            if (enumC18388V6.A00 == i10) {
                return enumC18388V6;
            }
        }
        return null;
    ...
    public final AdPlacementType A05(C18225SQ c18225sq) {
        switch (this) {
            case A06:
            case A0A:
            case A09:
            ...
            case A0D:
                boolean A19 = C18329U7.A19(c18225sq);
                String[] strArr = A02;
