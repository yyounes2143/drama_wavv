...
public final class C18006Oq {
    ...
    */
    public static void A00(int[] r43, int r44, int r45, int r46, int r47, int r48, int r49) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18006Oq.A00(int[], int, int, int, int, int, int):void");
    }

    @Nullable
    public final Bitmap A02(Bitmap bitmap, float f10) {
        int w10 = bitmap.getWidth();
        int h8 = bitmap.getHeight();
        try {
            int[] iArr = new int[w10 * h8];
            bitmap.getPixels(iArr, 0, w10, 0, 0, w10, h8);
            int i10 = AbstractC18539Xa.A00;
            ArrayList arrayList = new ArrayList(i10);
            ArrayList<JavaBlurProcess.BlurTask> vertical = new ArrayList<>(i10);
            for (int i11 = 0; i11 < i10; i11++) {
                int h10 = h8;
                int cores = i11;
                arrayList.add(new CallableC18538XZ(iArr, w10, h10, (int) f10, i10, cores, 1));
                h8 = h10;
                int cores2 = i11;
                vertical.add(new CallableC18538XZ(iArr, w10, h8, (int) f10, i10, cores2, 2));
            }
            try {
                AbstractC18539Xa.A01.invokeAll(arrayList);
                try {
                    AbstractC18539Xa.A01.invokeAll(vertical);
                    try {
                        return Bitmap.createBitmap(iArr, w10, h8, Bitmap.Config.ARGB_8888);
