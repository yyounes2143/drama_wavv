...
public final class C169136p extends AbstractC19131hD {
    ...
    public C169136p(C19105gm c19105gm, String str) {
        super(c19105gm.A0B, str, A00(c19105gm));
        this.A01 = c19105gm;
    }

    public static C19104gl A00(C19105gm c19105gm) {
        return new C19104gl(c19105gm);
    }
    ...
    public final void A09() {
        this.A00 = new C19115gw(this.A01, this, A04());
    ...
    public final C19105gm A0E() {
        return this.A01;
    }

    public final void A0F(InterfaceC16468Ad interfaceC16468Ad, String str, AdExperienceType adExperienceType, boolean z10) {
        if (super.A00.A6M()) {
            return;
        }
        this.A01.A02(interfaceC16468Ad);
        if (this.A00 != null) {
        ...
        this.A01.A08 = z10;
        if (AbstractC18332UA.A09(this.A02) && AbstractC18332UA.A0B(this.A02)) {
    ...
    public final void A0G(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, AbstractC17950Nu.A00(new Bundle(), rewardData));
    ...
    public final boolean A0H() {
        ...
        return this.A01.A01 > 0 && C18519XG.A00() > this.A01.A01;
    }
    ...
    public final boolean A0J(InterfaceC16468Ad interfaceC16468Ad, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int A00 = ((C18175Rb) rewardedVideoShowAdConfig).A00();
        long A01 = ((C18175Rb) rewardedVideoShowAdConfig).A01();
        if (super.A00.A6N()) {
            return false;
        }
        this.A01.A02(interfaceC16468Ad);
