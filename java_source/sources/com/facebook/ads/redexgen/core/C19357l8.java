...
public final class C19357l8 implements InterfaceC17495GX {
    ...
    public static final InterfaceC17499Gb A0H = new InterfaceC17499Gb() { // from class: com.facebook.ads.redexgen.X.l9
    ...
    public boolean A09;
    public boolean A0A;
    public final C167574J A0C = new C167574J(4);
    public final C167574J A0B = new C167574J(9);
    public final C167574J A0E = new C167574J(11);
    public final C167574J A0D = new C167574J();
    public final C19356l7 A0F = new C19356l7();
    public int A01 = 1;
    ...
    private C167574J A01(InterfaceC19372lN interfaceC19372lN) throws IOException {
        ...
        interfaceC19372lN.readFully(this.A0D.A0l(), 0, this.A02);
        return this.A0D;
    }
    ...
    private void A02() {
        if (!this.A0A) {
            this.A06.AIN(new C19367lI(-9223372036854775807L));
            this.A0A = true;
        }
    }

    private void A03(InterfaceC19372lN interfaceC19372lN) throws IOException {
    ...
    @RequiresNonNull({"extractorOutput"})
    private boolean A04(InterfaceC19372lN interfaceC19372lN) throws IOException {
        if (!interfaceC19372lN.AGh(this.A0B.A0l(), 0, 9, true)) {
            return false;
        }
        this.A0B.A0f(0);
        C167574J c167574j = this.A0B;
        String[] strArr = A0G;
        if (strArr[5].charAt(7) == strArr[0].charAt(7)) {
            throw new RuntimeException();
        }
        ...
        if (z10 && this.A07 == null) {
            this.A07 = new C19359lA(this.A06.AJh(8, 1));
        }
        if (hasAudio && this.A08 == null) {
            this.A08 = new C19354l5(this.A06.AJh(9, 2));
        }
        this.A06.A6G();
    ...
    @RequiresNonNull({"extractorOutput"})
    private boolean A05(InterfaceC19372lN interfaceC19372lN) throws IOException {
        long j10;
        boolean z10 = true;
        boolean z11 = false;
        long A00 = A00();
        if (this.A03 == 8 && this.A07 != null) {
            A02();
            z11 = this.A07.A00(A01(interfaceC19372lN), A00);
        } else if (this.A03 == 9 && this.A08 != null) {
            A02();
            z11 = this.A08.A00(A01(interfaceC19372lN), A00);
        } else {
            if (this.A03 == 18) {
                boolean wasConsumed = this.A0A;
                if (!wasConsumed) {
                    z11 = this.A0F.A00(A01(interfaceC19372lN), A00);
                    long timestampUs = this.A0F.A0D();
                    if (timestampUs != -9223372036854775807L) {
                        this.A06.AIN(new C19368lJ(this.A0F.A0E(), this.A0F.A0F(), timestampUs));
                        this.A0A = true;
                    }
                }
            }
            interfaceC19372lN.AJJ(this.A02);
            z10 = false;
        }
    ...
    private boolean A06(InterfaceC19372lN interfaceC19372lN) throws IOException {
        if (!interfaceC19372lN.AGh(this.A0E.A0l(), 0, 11, true)) {
            return false;
        }
        this.A0E.A0f(0);
    ...
    public static /* synthetic */ InterfaceC17495GX[] A07() {
        return new InterfaceC17495GX[]{new C19357l8()};
    }
    ...
    */
    public final int AGb(com.facebook.ads.redexgen.core.InterfaceC19372lN r6, com.facebook.ads.redexgen.core.C17517Gt r7) throws java.io.IOException {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.GY r0 = r5.A06
            com.facebook.ads.redexgen.core.AbstractC166983M.A02(r0)
        L5:
            int r0 = r5.A01
            r4 = -1
            switch(r0) {
        ...
        L11:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C19357l8.A0G
            r0 = 6
            r1 = r1[r0]
            r0 = 17
        ...
        L24:
            ...
            throw r0
        L2a:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C19357l8.A0G
        ...
        L79:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19357l8.AGb(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    public final boolean AJL(InterfaceC19372lN interfaceC19372lN) throws IOException {
        interfaceC19372lN.AG9(this.A0C.A0l(), 0, 3);
        this.A0C.A0f(0);
        if (this.A0C.A0K() != 4607062) {
            return false;
        }
        interfaceC19372lN.AG9(this.A0C.A0l(), 0, 2);
        this.A0C.A0f(0);
        if ((this.A0C.A0M() & 250) != 0) {
            return false;
        }
        interfaceC19372lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
        int dataOffset = this.A0C.A0C();
        interfaceC19372lN.AI1();
        interfaceC19372lN.A3z(dataOffset);
        interfaceC19372lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
