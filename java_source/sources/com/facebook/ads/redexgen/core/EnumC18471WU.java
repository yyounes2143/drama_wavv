...
public enum EnumC18471WU {
    ...
    public static final EnumC18471WU[] A03;
    ...
    public static void A03() {
        byte[] bArr = {88, 93, 70, 90, 81, 86, 80, 90, 92, 74, 122, 107, 107, 100, 122, Byte.MAX_VALUE, 43, 58, 58, 53, 43, 46, 53, 60, 88, 110, Byte.MAX_VALUE, Byte.MAX_VALUE, 112, 106, 97, 104, 110, 104, 106, 98, 106, 97, 123, 112, 110, 107, 71, 68, 75, 75, SignedBytes.MAX_POWER_OF_TWO, 87, 90, 81, 74, 90, 76, 75, 81, SignedBytes.MAX_POWER_OF_TWO, 87, 86, 81, 76, 81, 76, 68, 73, 52, 32, 55, 35, 39, 55, 60, 49, 43, 45, 49, 51, 34, 34, 59, 60, 53, 43, 55, 55, 51, 60, 47, 42, 45, 40, 48, 8, Ascii.f99715SI, 13, 8, Ascii.f99715SI, 4, Ascii.f99714RS, Ascii.ETB, 8, 5, 4, 14, Ascii.f99714RS, 0, 5, 93, 68, 72, 67, 69, 94, 80, 80, 82, 69, Ascii.NAK, 12, 0, 11, 13, Ascii.SYN, Ascii.CAN, Ascii.CAN, Ascii.SUB, 13, 0, 17, Ascii.DLE, 0, Ascii.f99714RS, 10, 11, Ascii.DLE, 0, Ascii.SYN, Ascii.DC2, Ascii.f99715SI, 0, 19, Ascii.DLE, Ascii.CAN, Ascii.CAN, Ascii.SYN, 17, Ascii.CAN, 103, 98, 101, 96, 116, 106, 111, 77, 72, 79, 74, 94, SignedBytes.MAX_POWER_OF_TWO, 69, 94, 87, 51, 3, 12, Ascii.f99707EM, 4, Ascii.ESC, 8, Ascii.DC2, 14, 1, 2, Ascii.f99714RS, 8, Ascii.DC2, Ascii.f99715SI, Ascii.CAN, Ascii.f99707EM, Ascii.f99707EM, 2, 3, 47, 52, 51, 60, 51, Utf8.REPLACEMENT_BYTE, 62, 37, 54, 53, 61, 61, 51, 52, 61, 57, 38, 43, 42, 32, 48, 46, 43};
    ...
    static {
        A03();
        A03 = new EnumC18471WU[]{A0H, A09, A06, A0F, A0I, A0J, A0C, A0B};
        JSONArray jSONArray = new JSONArray();
        for (EnumC18471WU supportedCapability : A03) {
            jSONArray.put(supportedCapability.A00());
        }
        A04 = jSONArray.toString();
    }

    EnumC18471WU(int i10) {
        this.A00 = i10;
    }
