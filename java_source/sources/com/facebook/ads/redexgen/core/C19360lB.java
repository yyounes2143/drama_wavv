...
public final class C19360lB implements InterfaceC17495GX {
    ...
    public static final InterfaceC17499Gb A0F = new InterfaceC17499Gb() { // from class: com.facebook.ads.redexgen.X.lC
    ...
    public long A04;
    public Metadata A05;
    public InterfaceC17496GY A06;
    public C17505Gh A07;
    public InterfaceC17525H1 A08;
    public C19362lD A09;
    public final C167574J A0A;
    public final C17500Gc A0B;
    ...
    public C19360lB(int i10) {
        this.A0D = new byte[42];
        this.A0A = new C167574J(new byte[32768], 0);
        this.A0C = (i10 & 1) != 0;
        this.A0B = new C17500Gc();
        this.A03 = 0;
    }

    private int A00(InterfaceC19372lN interfaceC19372lN, C17517Gt c17517Gt) throws IOException {
        AbstractC166983M.A01(this.A08);
        AbstractC166983M.A01(this.A07);
        if (this.A09 != null && this.A09.A09()) {
            return this.A09.A06(interfaceC19372lN, c17517Gt);
        }
        long j10 = this.A04;
        if (A0E[2].length() == 19) {
            A0E[2] = "5vsaEOzV8f26KwvJg69";
            if (j10 == -1) {
                this.A04 = AbstractC17501Gd.A01(interfaceC19372lN, this.A07);
                return 0;
            }
            ...
            if (strArr[6].length() != strArr[1].length()) {
                ...
                if (A0A < 32768) {
                    ...
                    int read = interfaceC19372lN.read(this.A0A.A0l(), A0A, currentLimit);
                    z10 = read == -1;
                    if (!z10) {
    ...
    */
    private long A01(com.facebook.ads.redexgen.core.C167574J r6, boolean r7) {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.Gh r0 = r5.A07
            com.facebook.ads.redexgen.core.AbstractC166983M.A01(r0)
            int r3 = r6.A09()
        L9:
            int r0 = r6.A0A()
            int r0 = r0 + (-16)
            ...
            boolean r0 = com.facebook.ads.redexgen.core.AbstractC17501Gd.A07(r6, r2, r1, r0)
            if (r0 == 0) goto L28
            r6.A0f(r3)
            com.facebook.ads.redexgen.X.Gc r0 = r5.A0B
            long r0 = r0.A00
        ...
        L2d:
            ...
            boolean r2 = com.facebook.ads.redexgen.core.AbstractC17501Gd.A07(r6, r2, r1, r0)     // Catch: java.lang.IndexOutOfBoundsException -> L44
            goto L45
        L44:
            r2 = 0
        L45:
        ...
        L68:
            r3 = -1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C19360lB.A0E
            r0 = 3
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L82:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19360lB.A01(com.facebook.ads.redexgen.X.4J, boolean):long");
    }

    private InterfaceC17520Gw A02(long j10, long j11) {
        AbstractC166983M.A01(this.A07);
        if (this.A07.A0A != null) {
            return new C19369lK(this.A07, j10);
        }
        if (j11 != -1 && this.A07.A09 > 0) {
            this.A09 = new C19362lD(this.A07, this.A01, j10, j11);
            return this.A09.A07();
        }
        return new C19367lI(this.A07.A06());
    }

    private void A03() {
        ((InterfaceC17525H1) AbstractC167744a.A0f(this.A08)).AIA((this.A04 * 1000000) / ((C17505Gh) AbstractC167744a.A0f(this.A07)).A07, 1, this.A00, 0, null);
    }

    private void A04(InterfaceC19372lN interfaceC19372lN) throws IOException {
        this.A01 = AbstractC17503Gf.A00(interfaceC19372lN);
        ((InterfaceC17496GY) AbstractC167744a.A0f(this.A06)).AIN(A02(interfaceC19372lN.A8f(), interfaceC19372lN.A8G()));
        this.A03 = 5;
    }

    private void A05(InterfaceC19372lN interfaceC19372lN) throws IOException {
        interfaceC19372lN.AG9(this.A0D, 0, this.A0D.length);
        interfaceC19372lN.AI1();
        this.A03 = 2;
    }

    private void A06(InterfaceC19372lN interfaceC19372lN) throws IOException {
        this.A05 = AbstractC17503Gf.A02(interfaceC19372lN, !this.A0C);
        this.A03 = 1;
    }

    private void A07(InterfaceC19372lN interfaceC19372lN) throws IOException {
        boolean z10 = false;
        C17502Ge metadataHolder = new C17502Ge(this.A07);
        while (!z10) {
            z10 = AbstractC17503Gf.A0B(interfaceC19372lN, metadataHolder);
            this.A07 = (C17505Gh) AbstractC167744a.A0f(metadataHolder.A00);
        }
        AbstractC166983M.A01(this.A07);
        this.A02 = Math.max(this.A07.A06, 6);
        ((InterfaceC17525H1) AbstractC167744a.A0f(this.A08)).A6W(this.A07.A08(this.A0D, this.A05));
        this.A03 = 4;
    }

    private void A08(InterfaceC19372lN interfaceC19372lN) throws IOException {
        AbstractC17503Gf.A09(interfaceC19372lN);
        this.A03 = 3;
    }

    public static /* synthetic */ InterfaceC17495GX[] A09() {
        return new InterfaceC17495GX[]{new C19360lB()};
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC17495GX
    public final void AA4(InterfaceC17496GY interfaceC17496GY) {
        this.A06 = interfaceC17496GY;
        this.A08 = interfaceC17496GY.AJh(0, 1);
    ...
    public final int AGb(InterfaceC19372lN interfaceC19372lN, C17517Gt c17517Gt) throws IOException {
        switch (this.A03) {
            ...
            case 4:
                ...
                return 0;
            case 5:
                return A00(interfaceC19372lN, c17517Gt);
            default:
    ...
    public final boolean AJL(InterfaceC19372lN interfaceC19372lN) throws IOException {
        AbstractC17503Gf.A01(interfaceC19372lN, false);
        return AbstractC17503Gf.A0A(interfaceC19372lN);
    }
}
