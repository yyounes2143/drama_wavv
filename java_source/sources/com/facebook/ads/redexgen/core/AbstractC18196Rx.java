...
public abstract class AbstractC18196Rx {
     ...
     */
    public static C18189Rp A02(C18225SQ c18225sq) {
        Object A002;
        Method A022;
        Object A003;
        Method A023 = AbstractC18197Ry.A02(A00, A04(AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y, 29, 2), Context.class);
        if (A023 == null || (A002 = AbstractC18197Ry.A00(null, A023, c18225sq)) == null || ((Integer) A002).intValue() != 0 || (A022 = AbstractC18197Ry.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (A003 = AbstractC18197Ry.A00(null, A022, c18225sq)) == null) {
            return null;
        }
        Method A012 = AbstractC18197Ry.A01(A003.getClass(), A04(252, 5, 124), new Class[0]);
        Method A013 = AbstractC18197Ry.A01(A003.getClass(), A04(286, 24, 126), new Class[0]);
        if (A012 == null || A013 == null) {
            return null;
        }
        String str = (String) AbstractC18197Ry.A00(A003, A012, new Object[0]);
        Boolean bool = (Boolean) AbstractC18197Ry.A00(A003, A013, new Object[0]);
        if (str != null) {
            return new C18189Rp(str, bool != null && bool.booleanValue(), EnumC18188Ro.A06);
        }
        return null;
    }
    ...
    */
    public static com.facebook.ads.redexgen.core.C18189Rp A00(com.facebook.ads.redexgen.core.C18225SQ r5) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.AbstractC18196Rx.A02
            r0 = 5
            r1 = r1[r0]
            r0 = 3
            ...
            throw r0
        L2c:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC18196Rx.A02
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC18196Rx.A00(com.facebook.ads.redexgen.X.SQ):com.facebook.ads.redexgen.X.Rp");
    }

    public static C18189Rp A01(C18225SQ c18225sq) {
        InterfaceC18229SU adId = c18225sq.A05().A8p();
        if (adId != null) {
            return new C18189Rp(adId.getId(), adId.AAO(), EnumC18188Ro.A02);
        }
        return null;
    }

    /* JADX WARN: Type inference failed for: r0v9, types: [com.facebook.ads.internal.attribution.GmsAttributionProvider$GoogleAdInfo] */
    public static C18189Rp A03(C18225SQ c18225sq) {
        ServiceConnectionC18195Rw serviceConnectionC18195Rw = new ServiceConnectionC18195Rw();
        Intent intent = new Intent(A04(122, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (c18225sq.bindService(intent, serviceConnectionC18195Rw, 1)) {
            try {
                final IBinder A022 = serviceConnectionC18195Rw.A02();
                ...
                return new C18189Rp(r02.A02(), r02.A03(), EnumC18188Ro.A07);
            } catch (Throwable th) {
                try {
                    c18225sq.A08().AAy(A04(225, 7, 73), AbstractC18256Sv.A1Q, new C18257Sw(th));
                } finally {
                    c18225sq.unbindService(serviceConnectionC18195Rw);
                }
            }
        }
        return null;
