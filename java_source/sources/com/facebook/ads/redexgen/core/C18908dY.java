...
public final class C18908dY extends RelativeLayout {
    ...
    public int A00;
    public C166662p A01;
    public WeakReference<InterfaceC18907dX> A02;
    public final InterfaceC18964eS A03;

    public C18908dY(C18895dL c18895dL, InterfaceC18964eS interfaceC18964eS) {
        super(c18895dL);
        this.A00 = 0;
        this.A03 = interfaceC18964eS;
        AbstractC18528XP.A0H((View) this.A03);
    ...
    private void A00(AnimatorSet animatorSet, final int i10, final boolean z10) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.facebook.ads.redexgen.X.dU
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                C18908dY.this.A04(z10, i10, valueAnimator);
            }
        });
    ...
    public final void A01(AnimatorSet animatorSet, boolean z10) {
        if (z10) {
            ...
            C18905dV c18905dV = new C18905dV(this);
            this.A03.getView().setOutlineProvider(c18905dV);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c18905dV);
            }
    ...
    public final void A02(AbstractC17313Da abstractC17313Da) {
        addView(abstractC17313Da, new RelativeLayout.LayoutParams(-1, -1));
        this.A01 = (C166662p) abstractC17313Da;
    }

    public final void A03(AbstractC17313Da abstractC17313Da) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        WeakReference<InterfaceC18907dX> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f10) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C18906dW(this, f10));
    }

    public void setViewImplInflationListener(InterfaceC18907dX interfaceC18907dX) {
        this.A02 = new WeakReference<>(interfaceC18907dX);
    }
}
