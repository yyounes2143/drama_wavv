...
public abstract class AbstractC19408ly {
    ...
    public static void A09() {
        A00 = new byte[]{65, 89, 95, 88, 12, 78, 73, 12, 92, 67, 91, 73, 94, 12, 67, 74, 12, Ascii.f99714RS, 12, 78, 73, 88, 91, 73, 73, 66, 12, Ascii.f99714RS, 114, Ascii.f99710GS, 12, 77, 66, 72, 12, Ascii.f99714RS, 114, Ascii.f99718US, Ascii.f99709FS, Ascii.SYN, 12};
    }
    ...
    public static int A01(int expectedSize) {
        return Math.max(4, AbstractC19439mU.A01(expectedSize + 1, 1.0d));
    }
    ...
    public static int A05(Object table, int index) {
        if (table instanceof byte[]) {
            ...
            return bArr[index] & UnsignedBytes.MAX_VALUE;
        }
    ...
    public static int A06(@CheckForNull Object key, @CheckForNull Object value, @CheckForNull int mask, Object table, int[] entries, Object[] keys, Object[] values) {
        int tableIndex = AbstractC19439mU.A02(key);
        ...
        do {
            ...
            if (A02(tableIndex2, mask) == lastEntryIndex && AbstractC17188BX.A01(key, keys[entryIndex]) && (values == null || AbstractC17188BX.A01(value, values[entryIndex]))) {
