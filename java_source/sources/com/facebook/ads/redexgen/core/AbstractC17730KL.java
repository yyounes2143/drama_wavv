...
public abstract class AbstractC17730KL extends AbstractC18684Zv {
    ...
    public final AbstractC19178hy A07;
    public final C17903N9 A08;
    public final C17957O2 A09;
    public final C18358Ua A0A;
    ...
    public final C17890Mw A0R;
    public final C17892My A0S;
    public final C18895dL A0T;
    public final C17273Cw A0U;
    public final Runnable A0V;
    public final AtomicBoolean A0W;
    public final boolean A0X;
    public final boolean A0Y;

    public static String A0R(int i10, int i11, int i12) {
    ...
    public static void A0Y() {
        A0Z = new byte[]{58, Ascii.DC2, 4, 2, Ascii.DC2, 60, 108, 103, 106, 121, 125, 96, 97, 80, 122, Byte.MAX_VALUE, Ascii.f99710GS, Ascii.f99709FS, 10, Ascii.SUB, 11, Ascii.DLE, 9, 13, Ascii.DLE, Ascii.SYN, Ascii.ETB, 126, 116, 120, 121, Ascii.f99714RS, 2, Ascii.f99715SI, 13, 11, 49, 6, 1, 2, 10, 11, Ascii.f99709FS, 49, Ascii.SUB, 11, Ascii.SYN, Ascii.SUB, 96, 98, Byte.MAX_VALUE, 119, 98, 117, 99, 99, 79, 114, 113, 98, 99, 116, 102, 112, 99, 117, 116, 117, 78, 103, 120, 117, 116, 126, 98, Byte.MAX_VALUE, 98, 122, 115, 107, 109, 126, 113, 108, 115, 126, 107, 118, 112, 113, 70};
    }

    public abstract void A0q(int i10);

    public abstract void A0s(ViewGroup viewGroup, RelativeLayout relativeLayout, int i10);

    static {
        A0Y();
        A0i = (int) (AbstractC18488Wl.A02 * 44.0f);
        A0b = (int) (AbstractC18488Wl.A02 * 52.0f);
        A0s = (int) (AbstractC18488Wl.A02 * 4.0f);
        A0u = (int) (AbstractC18488Wl.A02 * 8.0f);
        A0j = (int) (AbstractC18488Wl.A02 * 12.0f);
        A0k = (int) (AbstractC18488Wl.A02 * 14.0f);
        A0l = (int) (AbstractC18488Wl.A02 * 16.0f);
        A0m = (int) (AbstractC18488Wl.A02 * 18.0f);
        A0n = (int) (AbstractC18488Wl.A02 * 20.0f);
        A0o = (int) (AbstractC18488Wl.A02 * 24.0f);
        A0p = (int) (AbstractC18488Wl.A02 * 26.0f);
        A0q = (int) (AbstractC18488Wl.A02 * 28.0f);
        A0r = (int) (AbstractC18488Wl.A02 * 32.0f);
        A0t = (int) (AbstractC18488Wl.A02 * 40.0f);
        A0f = (int) (AbstractC18488Wl.A02 * 48.0f);
        A0g = (int) (AbstractC18488Wl.A02 * 100.0f);
        A0h = (int) (AbstractC18488Wl.A02 * 112.0f);
        A0c = (int) (AbstractC18488Wl.A02 * 16.0f);
        A0e = AbstractC17980OP.A02(-1, 128);
        A0d = AbstractC17980OP.A02(-1, 17);
        A0v = (int) (AbstractC18488Wl.A02 * 12.0f);
    }

    public AbstractC17730KL(C18895dL c18895dL, ViewOnClickListenerC17723KE viewOnClickListenerC17723KE, int i10, boolean z10, C17892My c17892My, boolean z11, String str, InterfaceC18350US interfaceC18350US, InterfaceC18552Xn interfaceC18552Xn, C18969eX c18969eX, C18520XH c18520xh, AbstractC19178hy abstractC19178hy, C17273Cw c17273Cw, C18358Ua c18358Ua, boolean z12) {
        super(c18895dL, viewOnClickListenerC17723KE, i10, c17892My, z11, str, interfaceC18350US, interfaceC18552Xn, c18969eX, c18520xh, abstractC19178hy.A21(), abstractC19178hy.A1c(), abstractC19178hy.A0x());
        this.A0W = new AtomicBoolean(true);
        this.A0V = new RunnableC18685Zw(this);
        this.A0D = new RunnableC18686Zx(this);
        this.A0C = new RunnableC18687Zy(this);
        this.A0A = c18358Ua;
        this.A07 = abstractC19178hy;
        this.A09 = AbstractC17958O3.A00(c18895dL.A02());
        this.A0B = interfaceC18552Xn;
        this.A0E = abstractC19178hy.A25();
        this.A08 = abstractC19178hy.A23();
        this.A0S = c17892My;
        this.A0R = abstractC19178hy.A20().A0I();
        this.A0T = c18895dL;
        this.A0X = z10;
        this.A0Y = z12;
        ...
        this.A0J = AbstractC18636Z9.A01(this.A0T, this.A0A, this.A07, EnumC18632Z5.A03, this.A0B, this.A0F);
        AbstractC18528XP.A0I(this.A0J);
        this.A01 = -1;
        this.A03 = GradientCoverImageView.DEFAULT_COLOR;
        this.A0O = A0M();
        this.A0M = A0K();
        this.A0N = A0L();
        A0T();
        ...
        if (!this.A0Y) {
            ...
            this.A0I.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(6, 10, 11)));
        }
        if (super.A08.getParent() != null) {
            ((ViewGroup) super.A08.getParent()).removeView(super.A08);
        }
        this.A0Q = A0P();
        AbstractC18528XP.A0I(this.A0Q);
        this.A0P = A0N();
        AbstractC18528XP.A0I(this.A0P);
        this.A0U = A0Q(c17273Cw);
        ...
        this.A0K.setOnClickListener(new ViewOnClickListenerC18688Zz(this));
        A0p(8);
        ...
        if (this.A07.A0v().equals(A0R(60, 14, 21)) && !abstractC19178hy.A1Z() && this.A06 > 0) {
            this.A04 = A0O();
    ...
    private ImageView A0I() {
        ...
        imageView.setImageBitmap(AbstractC18537XY.A01(EnumC18536XX.CHEVRON_UP));
        return imageView;
    }
    ...
    private LinearLayout A0J() {
        ...
        this.A0G.setImageBitmap(AbstractC18537XY.A01(EnumC18536XX.AD_CHOICE_V2_COLLAPSE));
        linearLayout.addView(this.A0G);
        this.A0H.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        this.A0H.setImageBitmap(AbstractC18537XY.A01(EnumC18536XX.AD_CHOICE_V2_EXPAND));
    ...
    private RelativeLayout A0K() {
        ...
        AbstractC18528XP.A0I(relativeLayout);
    ...
    private C17273Cw A0Q(C17273Cw c17273Cw) {
        if (c17273Cw == null) {
            c17273Cw = new C17273Cw(this.A0T, -1);
            c17273Cw.setVisibility(8);
        }
        c17273Cw.A08(A0e, A0d, true);
        c17273Cw.setPadding(0, 0, 0, 0);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, A0v);
        c17273Cw.setLayoutParams(progressBarLayoutParams);
        return c17273Cw;
    }
    ...
    private void A0S() {
        ...
        AbstractC18528XP.A0Q(super.A08, AbstractC18528XP.A06(this.A01, this.A02));
        super.A08.setLayoutParams(new RelativeLayout.LayoutParams(-2, A0b));
        AbstractC18528XP.A0I(super.A08);
    }
    ...
    private void A0T() {
        ...
        AbstractC18528XP.A0K(super.A09, 0);
        super.A09.setLayoutParams(new RelativeLayout.LayoutParams(A0f, A0f));
        AbstractC18528XP.A0I(super.A09);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0U() {
        if (this.A0A != null) {
            this.A0A.A04(EnumC18357UZ.A0A, null);
        }
        if (this.A09.A0O(this.A0T.A02(), true)) {
            ...
            C18464WN.A0O(new C18464WN(), this.A0T, AbstractC18467WQ.A00(this.A08.A00()), this.A0E);
        }
    }
    ...
    private void A0Z(int i10, int i11) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
    ...
    public final void A0f() {
        ...
        AbstractC18528XP.A0Z(this.A0O, this.A0N, super.A09, this.A0Q, super.A08, this.A0U, this.A04, this.A0P, this.A0K, this.A0J, this.A0I, this.A0M);
        removeAllViews();
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC18684Zv
    public final void A0g() {
        super.A09.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(16, 11, 125)));
        this.A0U.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
    ...
    public final void A0m() {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(super.A08, A0R, -f10, 0.0f);
    ...
    public final void A0o(int i10) {
        if (this.A04 != null) {
            int max = Math.max(0, this.A06 - i10);
            if (max > 0) {
    ...
    public final void A0r(View view, int i10, float[] fArr) {
    ...
    public final void A0t(ViewGroup viewGroup, boolean z10, boolean z11, int i10) {
        AbstractC18528XP.A0Z(this.A0K, this.A0J, this.A0U, super.A09, this.A0Q, this.A0P, this.A04);
    ...
    public C17273Cw getProgressBarAnimation() {
        return this.A0U;
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC18720aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
}
