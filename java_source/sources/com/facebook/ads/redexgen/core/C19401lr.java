...
public class C19401lr<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C19401lr(final C19405lv this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean contains(@CheckForNull Object o) {
        ...
        boolean z10 = o instanceof Map.Entry;
        if (A01[5].charAt(2) != '2') {
        ...
        return AbstractC17188BX.A01(A0F, entry.getValue());
    }
    ...
    public final boolean remove(@CheckForNull Object o) {
        ...
        A0V = this.A00.A0V();
        A0W = this.A00.A0W();
        int A06 = AbstractC19408ly.A06(key, value, A00, A0C, A0T, A0V, A0W);
        if (A06 == -1) {
            return false;
        }
