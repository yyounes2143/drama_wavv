...
public abstract class AbstractC165310Z<K, V> extends AbstractC166011i<K, V> implements InterfaceC17136Ah<K, V> {
    ...
    public AbstractC165310Z(Map<K, Collection<V>> map) {
        super(map);
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0Z != com.google.common.collect.AbstractListMultimap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC166011i, com.facebook.ads.redexgen.core.InterfaceC19546oE
