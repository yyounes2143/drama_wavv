...
public final class C18429Vm<T> implements InterfaceC18316Tu<T> {
    ...
    public C18308Tm A00;
    public C18308Tm A01;
    public List<C18429Vm<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final C18307Tl A04;
    public final C18323U1 A05;
    ...
    public synchronized boolean A06(C18430Vn c18430Vn) {
        if (!this.A02.remove(c18430Vn)) {
            return false;
        }
        if (c18430Vn.A6P() > 0 && c18430Vn.A01().A02.A05(c18430Vn.A01().A01).equals(this.A01)) {
            this.A01 = c18430Vn.A00().A02;
        }
        return true;
    }
    ...
    public C18429Vm(C18313Tr c18313Tr, InterfaceC18321Tz interfaceC18321Tz) throws IOException {
        this.A05 = new C18323U1(c18313Tr.A04(A00(515, 4, 103)), interfaceC18321Tz);
        this.A04 = new C18307Tl(new File(c18313Tr.A05(), A00(TPOptionalID.OPTION_ID_GLOBAL_BOOL_ENABLE_MULTI_NETWORK_CARD, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC18321Tz);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i10, int i11) throws IOException {
        this.A00 = new C18308Tm(i10, i11);
    ...
    public synchronized void A03(C18430Vn c18430Vn) throws C18325U3 {
        if (!this.A03) {
            if (A06(c18430Vn)) {
                if (c18430Vn.A6P() == 0) {
                    return;
                }
                if (this.A00.A04(c18430Vn.A00().A02) == 0) {
                    try {
                        Iterator<C18320Ty> it = c18430Vn.A00.iterator();
                        while (it.hasNext()) {
                            if (it.next().A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), c18430Vn.A00().A00);
                                break;
                            }
                        }
                        ...
                        throw new C18325U3(A00(361, 30, 22), e3);
                    }
                }
                throw new C18325U3(A00(0, 54, 30));
            }
            throw new C18325U3(A00(466, 43, 59));
        }
        throw new C18325U3(A00(427, 39, 60));
    }
    ...
    */
    private void A05(com.facebook.ads.redexgen.core.InterfaceC18321Tz r13) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L7c:
            ...
            goto L5c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18429Vm.A05(com.facebook.ads.redexgen.X.Tz):void");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vn != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.facebook.ads.redexgen.core.InterfaceC18316Tu
    public final synchronized InterfaceC18315Tt A6O(byte[] bArr, int[] iArr) throws C18325U3 {
        C18429Vm<T>.RecordFileBasedFetch c18430Vn;
        if (!this.A03) {
            int i10 = 0;
            int i11 = 0;
            try {
                ...
                while (true) {
                    C18311Tp A0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                    int A00 = A0A.A01().A00();
                    ...
                    i10 += storageOffset2;
                    i11 += i12;
                    if (A0A.A01().A03() == EnumC18309Tn.A03) {
                        arrayList.add(A0A);
                    }
                    if (A0A.A01().A03() == EnumC18309Tn.A04) {
                        break;
                    }
                    if (A0A.A01().A03() == EnumC18309Tn.A05) {
                        ...
                        this.A01 = new C18308Tm(storageOffset5 + 1, 0);
                    } else {
                        this.A01 = this.A01.A05(i12);
                    }
                }
                c18430Vn = new C18430Vn(this, arrayList, mayHaveMoreData);
                this.A02.add(c18430Vn);
                if (!arrayList.isEmpty()) {
                    C18308Tm c18308Tm = c18430Vn.A01().A02;
                    int storageOffset6 = c18430Vn.A01().A01;
                    this.A01 = c18308Tm.A05(storageOffset6);
                }
            } catch (IOException e3) {
                throw new C18325U3(A00(306, 29, 84), e3);
            }
        } else {
            throw new C18325U3(A00(391, 36, 123));
        }
        return c18430Vn;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC18316Tu
    public final synchronized int A8k() throws C18325U3 {
        int A09;
        if (!this.A03) {
            try {
                A09 = this.A05.A09();
                ...
                throw new C18325U3(A00(335, 26, 57), e3);
            }
        } else {
            throw new C18325U3(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC18316Tu
    public final synchronized void AJW(byte[] bArr) throws C18325U3 {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e3) {
                throw new C18325U3(A00(AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y, 25, 62), e3);
            }
        } else {
            throw new C18325U3(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC18316Tu
    public final synchronized void clear() throws C18325U3 {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e3) {
            throw new C18325U3(A00(282, 24, 87), e3);
        }
    }
