...
public final class C17842M9 {
    ...
    public static C17842M9 A00(C17842M9 c17842m9, long j10) {
        return c17842m9.A03(A06(0, 7, 94), j10);
    }

    public static C17842M9 A01(C17842M9 c17842m9, Uri uri) {
        String A06 = A06(7, 9, 58);
        if (uri == null) {
            return c17842m9.A02(A06);
        }
        return c17842m9.A05(A06, uri.toString());
    }

    private final C17842M9 A02(String str) {
        this.A00.add(str);
        this.A01.remove(str);
        return this;
    }

    private final C17842M9 A03(String str, long j10) {
        return A04(str, Long.valueOf(j10));
    }

    private C17842M9 A04(String str, Object obj) {
        this.A01.put((String) AbstractC166983M.A01(str), AbstractC166983M.A01(obj));
        this.A00.remove(str);
        return this;
    }

    private final C17842M9 A05(String str, String str2) {
        return A04(str, str2);
    }
