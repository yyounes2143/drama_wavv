...
public abstract class AbstractC19248jA {
    ...
    public static String A07(int start, int end, int size) {
        if (start < 0 || start > size) {
            return A09(start, size, A06(Opcodes.NEW, 11, 96));
        }
    ...
    public static void A0G(boolean expression, String errorMessageTemplate, int p12, int p2) {
        if (!expression) {
            throw new IllegalArgumentException(Strings.A02(errorMessageTemplate, new Object[]{Integer.valueOf(p12), Integer.valueOf(p2)}));
        }
    }

    public static void A0H(boolean expression, String errorMessageTemplate, long p12) {
        if (!expression) {
            throw new IllegalArgumentException(Strings.A02(errorMessageTemplate, new Object[]{Long.valueOf(p12)}));
        }
    }
}
