...
public final class C18375Ur implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (AbstractC18488Wl.A02 * 4.0f);
    public static final int A07 = (int) (AbstractC18488Wl.A02 * 1.0f);
    ...
    public final int A04(float f10) {
        int i10 = (this.A01 & GradientCoverImageView.DEFAULT_COLOR) | ((~this.A01) & 16777215);
        int textColor = this.A01;
        return AbstractC17980OP.A05(i10, textColor, f10);
    }
    ...
    public final void A05(TextView textView) {
        ...
        AbstractC18528XP.A0Q(textView, stateListDrawable);
