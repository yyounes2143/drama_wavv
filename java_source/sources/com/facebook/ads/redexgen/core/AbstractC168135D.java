...
public abstract class AbstractC168135D {
    ...
    public static long A00(String str) {
        ...
        if (matcher.matches()) {
            return Long.parseLong((String) AbstractC166983M.A01(matcher.group(1)));
        }
        return -1L;
    }
    ...
    public static long A01(String str, String str2) {
        ...
        if (!isEmpty) {
            try {
                ...
                AbstractC1674244.A05(A023, A02(31, 27, 88) + str + A022);
            }
        }
        if (!TextUtils.isEmpty(str2)) {
            ...
            if (matcher.matches()) {
                try {
                    long parseLong = (Long.parseLong((String) AbstractC166983M.A01(matcher.group(2))) - Long.parseLong((String) AbstractC166983M.A01(matcher.group(1)))) + 1;
                    if (j10 < 0) {
                        return parseLong;
                    }
                    if (j10 != parseLong) {
                        AbstractC1674244.A07(A023, A02(9, 22, 119) + str + A02(85, 3, 111) + str2 + A022);
                        j10 = Math.max(j10, parseLong);
                        return j10;
                    }
                    return j10;
                } catch (NumberFormatException unused2) {
                    AbstractC1674244.A05(A023, A02(58, 26, 121) + str2 + A022);
                    return j10;
                }
            }
            return j10;
    ...
    public static String A03(long j10, long j11) {
        ...
        sb.append(A02(TPOptionalID.f113894xa7b03e7e, 6, 83));
        sb.append(j10);
