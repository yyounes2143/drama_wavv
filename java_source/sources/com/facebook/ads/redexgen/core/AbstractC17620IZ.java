...
public abstract class AbstractC17620IZ {
    ...
    static {
        A0B();
        A02 = new String[]{A0A(Opcodes.IFNONNULL, 5, 25), A0A(325, 12, 81), A0A(388, 7, 70), A0A(TTAdConstant.DOWNLOAD_URL_CODE, 5, 80), A0A(442, 5, 111), A0A(887, 4, 109), A0A(963, 6, 61), A0A(997, 7, 80), A0A(1144, 4, 99), A0A(1240, 5, 18), A0A(1311, 7, 11), A0A(1352, 6, 55), A0A(1363, 5, 102), A0A(1390, 3, 103), A0A(1535, 3, 111), A0A(1538, 3, 95), A0A(1545, 6, 115), A0A(1576, 4, 70), A0A(1868, 6, 75), A0A(1068, 10, 110), A0A(67, 11, 84), A0A(1624, 3, 122), A0A(431, 11, 108), A0A(1450, 6, 70), A0A(1696, 10, 107), A0A(568, 11, 59), A0A(78, 7, 92), A0A(1934, 8, 52), A0A(1985, 5, 66), A0A(1148, 9, 48), A0A(891, 6, 107), A0A(1922, 6, 24), A0A(337, 9, 100), A0A(1091, 12, 120), A0A(18, 4, 37), A0A(1004, 5, 23), A0A(903, 4, 66), A0A(1686, 10, 86), A0A(940, 6, 3), A0A(1338, 5, 122), A0A(57, 10, 57), A0A(143, 4, 39), A0A(1682, 4, 127), A0A(1522, 4, 16), A0A(1719, 5, 118), A0A(1210, 10, 5), A0A(1103, 16, 70), A0A(1119, 17, 118), A0A(552, 6, 39), A0A(946, 6, 50), A0A(423, 8, 38), A0A(1874, 17, 53), A0A(539, 10, 16), A0A(1393, 8, 64), A0A(579, 9, 18), A0A(456, 5, 64), A0A(1706, 13, 114), A0A(360, 6, 28), A0A(404, 4, 13), A0A(907, 7, 57), A0A(1909, 6, 107), A0A(298, 13, 109), A0A(1401, 8, 37), A0A(1161, 6, 39), A0A(1265, 15, 110), A0A(KeyboardUtils.KeyboardStatusListener.f43130g, 7, 24), A0A(1330, 8, 9), A0A(1486, 11, 126), A0A(1541, 4, 57), A0A(1615, 9, 34), A0A(1915, 7, 23), A0A(1190, 5, 20), A0A(1928, 6, 99), A0A(31, 9, 75), A0A(22, 9, 81), A0A(1375, 5, 55), A0A(1551, 5, 67), A0A(1245, 7, 74), A0A(1580, 11, 107), A0A(969, 9, 31), A0A(857, 4, 85), A0A(861, 9, 98), A0A(1252, 13, 98), A0A(1740, 5, 26), A0A(846, 11, 109), A0A(151, 5, 72), A0A(1176, 5, 79), A0A(1556, 7, 116), A0A(237, 6, 49), A0A(190, 9, 71), A0A(120, 10, 111), A0A(952, 11, 47), A0A(1462, 16, 39), A0A(1497, 16, 2), A0A(1745, 14, 113), A0A(1667, 9, 11), A0A(Opcodes.IF_ICMPGT, 8, 52), A0A(271, 6, 32), A0A(498, 14, 60), A0A(40, 8, 120), A0A(1009, 6, 114), A0A(1734, 6, 122), A0A(256, 7, 17), A0A(1358, 5, 95), A0A(243, 13, 27), A0A(1676, 6, 121), A0A(1759, 8, 20), A0A(204, 10, 124), A0A(1456, 6, 36), A0A(1409, 11, 116), A0A(1601, 6, 125), A0A(1659, 8, 96), A0A(346, 4, 95), A0A(1863, 5, 43), A0A(1596, 5, 10), A0A(870, 8, 66), A0A(130, 6, 100), A0A(1438, 12, 103), A0A(1563, 13, 23), A0A(878, 9, 53), A0A(491, 4, 64), A0A(1526, 9, 71), A0A(472, 9, 90), A0A(1, 9, 56), A0A(558, 10, 49), A0A(413, 10, 115), A0A(937, 3, 94), A0A(461, 11, 49), A0A(350, 10, 66), A0A(978, 8, 74), A0A(1891, 6, 3), A0A(1053, 5, 36), A0A(Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE, 7, 0), A0A(48, 9, 79), A0A(1380, 10, 45), A0A(147, 4, 34), A0A(277, 21, 26), A0A(986, 11, 26), A0A(179, 11, 3), A0A(395, 9, 15), A0A(366, 22, 127), A0A(311, 14, 42), A0A(1220, 8, 126), A0A(1591, 5, 127), A0A(1897, 12, 74), A0A(85, 5, 95), A0A(1157, 4, 55), A0A(1767, 8, 102), A0A(10, 8, 0), A0A(90, 8, 96), A0A(136, 7, 100), A0A(TPOptionalID.f113892x754375c3, 7, 114), A0A(171, 8, 114), A0A(Sdk.SDKError.Reason.INVALID_GZIP_BID_PAYLOAD_VALUE, 9, 91), A0A(TPReportParams.LIVE_STEP_PLAY, 8, 55), A0A(447, 9, 70), A0A(481, 3, 60), A0A(495, 3, 75), A0A(512, 8, 119), A0A(520, 7, 99), A0A(527, 12, 40), A0A(549, 3, 64), A0A(588, 12, 19), A0A(914, 6, 20), A0A(931, 6, 70), A0A(TPPlayerMsg.TP_PLAYER_INFO_OBJECT_AB_TEST_INFO, 3, 107), A0A(1045, 8, 61), A0A(1078, 13, 61), A0A(1136, 8, 117), A0A(1167, 9, 119), A0A(1181, 9, 39), A0A(1195, 6, 31), A0A(TXLiteAVCode.WARNING_MICROPHONE_DEVICE_EMPTY, 9, 33), A0A(1318, 12, 76), A0A(1343, 9, 83), A0A(1420, 9, 2), A0A(1429, 9, 124), A0A(1513, 9, 67), A0A(1607, 8, 72), A0A(1724, 10, 94), A0A(1942, 9, 7), A0A(1990, 11, 36), A0A(1280, 12, 124), A0A(111, 9, 116), A0A(98, 13, 61), A0A(1292, 19, 78), A0A(1368, 7, 126), A0A(1058, 10, 27), A0A(897, 6, 21), A0A(484, 7, 31), A0A(920, 11, 49), A0A(1478, 8, 18)};
    }

    public static int A00(C167574J c167574j) {
        c167574j.A0g(4);
        if (c167574j.A0C() == 1684108385) {
            c167574j.A0g(8);
            int atomType = c167574j.A0I();
            return atomType;
        }
        AbstractC1674244.A07(A0A(1228, 12, 21), A0A(776, 37, 28));
        return -1;
    }

    public static ApicFrame A01(C167574J c167574j) {
        String mimeType;
        ...
        if (A0C2 == 1684108385) {
            ...
            int flags = AbstractC17603II.A00(atomSize);
            if (flags == 13) {
            ...
            if (mimeType == null) {
                AbstractC1674244.A07(A0A, A0A(1955, 30, 80) + flags);
                return null;
            }
            c167574j.A0g(4);
            ...
            c167574j.A0k(bArr, 0, atomSize3);
            return new ApicFrame(mimeType, null, 3, bArr);
        }
        AbstractC1674244.A07(A0A, A0A(635, 35, 6));
        return null;
    }

    public static CommentFrame A02(int i10, C167574J c167574j) {
        int A0C = c167574j.A0C();
        int atomType = c167574j.A0C();
        if (atomType == 1684108385) {
            c167574j.A0g(8);
            int atomSize = A0C - 16;
            String A0V = c167574j.A0V(atomSize);
            return new CommentFrame(A0A(2043, 3, 64), A0V, A0V);
        }
        AbstractC1674244.A07(A0A(1228, 12, 21), A0A(600, 35, 78) + AbstractC17603II.A02(i10));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static Id3Frame A03(int i10, String str, C167574J c167574j, boolean z10, boolean z11) {
        ...
        if (A002 >= 0) {
            if (z10) {
                return new TextInformationFrame(str, null, MetaExoPlayerCustomizedCollections.A03(Integer.toString(A002)));
            }
            return new CommentFrame(A0A(2043, 3, 64), str, Integer.toString(A002));
        }
        AbstractC1674244.A07(A0A(1228, 12, 21), A0A(813, 33, 122) + AbstractC17603II.A02(i10));
        return null;
    }

    public static Id3Frame A04(C167574J c167574j) {
        int position = c167574j.A09();
        int shortType = c167574j.A0C() + position;
        int typeTopByte = c167574j.A0C();
        int position2 = typeTopByte >> 24;
        int endPosition = position2 & 255;
        try {
            if (endPosition == 169 || endPosition == 253) {
                int i10 = 16777215 & typeTopByte;
                if (i10 == 6516084) {
                    return A02(typeTopByte, c167574j);
                }
                if (i10 != 7233901 && i10 != 7631467) {
                    if (i10 != 6516589 && i10 != 7828084) {
                        if (i10 == 6578553) {
                            return A07(typeTopByte, A0A(1795, 4, 61), c167574j);
                        }
                        if (i10 == 4280916) {
                            return A07(typeTopByte, A0A(1807, 4, 93), c167574j);
                        }
                        if (i10 == 7630703) {
                            return A07(typeTopByte, A0A(1843, 4, 109), c167574j);
                        }
                        if (i10 == 6384738) {
                            return A07(typeTopByte, A0A(1775, 4, 94), c167574j);
                        }
                        if (i10 == 7108978) {
                            return A07(typeTopByte, A0A(1951, 4, 89), c167574j);
                        }
                        if (A01[7].charAt(0) != 122) {
                            A01[4] = "PbKnEML0B11BnhLl3Mtx38aJxEbcIZXa";
                            if (i10 == 6776174) {
                                return A07(typeTopByte, A0A(1791, 4, 72), c167574j);
                            }
                            if (i10 == 6779504) {
                                return A07(typeTopByte, A0A(1799, 4, 15), c167574j);
                            }
                            AbstractC1674244.A04(A0A(1228, 12, 21), A0A(1627, 32, 52) + AbstractC17603II.A02(typeTopByte));
                            c167574j.A0f(shortType);
                            return null;
                        }
                        throw new RuntimeException();
                    }
                    return A07(typeTopByte, A0A(1787, 4, 55), c167574j);
                }
                return A07(typeTopByte, A0A(1803, 4, 123), c167574j);
            }
            if (typeTopByte == 1735291493) {
                return A08(c167574j);
            }
            if (typeTopByte == 1684632427) {
                return A06(typeTopByte, A0A(1815, 4, 104), c167574j);
            }
            if (typeTopByte == 1953655662) {
                return A06(typeTopByte, A0A(1819, 4, 68), c167574j);
            }
            if (typeTopByte == 1953329263) {
                return A03(typeTopByte, A0A(1779, 4, 110), c167574j, true, false);
            }
            if (typeTopByte == 1668311404) {
                return A03(typeTopByte, A0A(1783, 4, 75), c167574j, true, true);
            }
            if (typeTopByte == 1668249202) {
                return A01(c167574j);
            }
            if (typeTopByte == 1631670868) {
                return A07(typeTopByte, A0A(HonorResultCode.PERMISSION_CHECK_REJECT, 4, 100), c167574j);
            }
            if (typeTopByte == 1936682605) {
                return A07(typeTopByte, A0A(1839, 4, 48), c167574j);
            }
            if (typeTopByte == 1936679276) {
                TextInformationFrame A07 = A07(typeTopByte, A0A(1823, 4, 80), c167574j);
                c167574j.A0f(shortType);
            ...
            if (typeTopByte == 1936679282) {
                return A07(typeTopByte, A0A(1827, 4, 39), c167574j);
            }
            if (typeTopByte == 1936679265) {
                return A07(typeTopByte, A0A(1835, 4, 48), c167574j);
            }
            if (typeTopByte == 1936679791) {
                return A07(typeTopByte, A0A(1831, 4, 72), c167574j);
            }
            if (typeTopByte == 1920233063) {
                return A03(typeTopByte, A0A(1018, 14, 42), c167574j, false, false);
            }
            if (typeTopByte == 1885823344) {
                return A03(typeTopByte, A0A(TXLiveConstants.PUSH_EVT_ROOM_USER_EXIT, 13, 104), c167574j, false, true);
            }
            if (typeTopByte == 1936683886) {
                return A07(typeTopByte, A0A(1853, 10, 126), c167574j);
            }
            if (A01[7].charAt(0) != 122) {
                A01[4] = "pV0yRHtOnOdCVty8ixamggbGH5FhKnUJ";
                if (typeTopByte == 1953919848) {
                    return A07(typeTopByte, A0A(1847, 6, 21), c167574j);
                }
                if (typeTopByte == 757935405) {
                    return A05(c167574j, shortType);
                }
                AbstractC1674244.A04(A0A(1228, 12, 21), A0A(1627, 32, 52) + AbstractC17603II.A02(typeTopByte));
                c167574j.A0f(shortType);
                return null;
    ...
    public static InternalFrame A05(C167574J c167574j, int i10) {
        String value = null;
        String str = null;
        int dataAtomSize = -1;
        int i11 = -1;
                ...
                if (name.charAt(25) != 'K') {
                    ...
                    if (atomType == 1851878757) {
                        ...
                        if (name3.charAt(4) != 'a') {
                            ...
                            c167574j.A0g(atomType2);
                        }
                    }
                }
                throw new RuntimeException();
            }
            value = c167574j.A0V(A0C - 12);
        }
        if (value != null && str != null && dataAtomSize != -1) {
            c167574j.A0f(dataAtomSize);
            c167574j.A0g(16);
            String name4 = c167574j.A0V(i11 - 16);
    ...
    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A06(int i10, String str, C167574J c167574j) {
        int A0C = c167574j.A0C();
        int atomType = c167574j.A0C();
        ...
        AbstractC1674244.A07(A0A(1228, 12, 21), A0A(670, 39, 29) + AbstractC17603II.A02(i10));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A07(int i10, String str, C167574J c167574j) {
        int A0C = c167574j.A0C();
        int atomType = c167574j.A0C();
        if (atomType == 1684108385) {
            c167574j.A0g(8);
            int atomSize = A0C - 16;
            return new TextInformationFrame(str, null, MetaExoPlayerCustomizedCollections.A03(c167574j.A0V(atomSize)));
        }
        AbstractC1674244.A07(A0A(1228, 12, 21), A0A(744, 32, 94) + AbstractC17603II.A02(i10));
        return null;
    }
    ...
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.TextInformationFrame A08(com.facebook.ads.redexgen.core.C167574J r4) {
        /*
            int r2 = A00(r4)
            r4 = 0
            if (r2 <= 0) goto L2b
            java.lang.String[] r0 = com.facebook.ads.redexgen.core.AbstractC17620IZ.A02
            int r0 = r0.length
            if (r2 > r0) goto L2b
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.AbstractC17620IZ.A02
            int r0 = r2 + (-1)
            r0 = r1[r0]
        L12:
            if (r0 == 0) goto L2d
            java.lang.String[] r0 = new java.lang.String[]{r0}
            java.util.List r3 = com.facebook.ads.redexgen.core.MetaExoPlayerCustomizedCollections.A03(r0)
        ...
        L2d:
            ...
            com.facebook.ads.redexgen.core.AbstractC1674244.A07(r3, r0)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC17620IZ.A08(com.facebook.ads.redexgen.X.4J):com.facebook.ads.androidx.media3.extractor.metadata.id3.TextInformationFrame");
    }

    public static MdtaMetadataEntry A09(C167574J c167574j, int i10, String str) {
        while (true) {
            int typeIndicator = c167574j.A09();
            if (typeIndicator < i10) {
                int atomType = c167574j.A0C();
                int atomPosition = c167574j.A0C();
                if (atomPosition == 1684108385) {
                    int localeIndicator = c167574j.A0C();
                    int typeIndicator2 = c167574j.A0C();
                    int atomType2 = atomType - 16;
                    byte[] bArr = new byte[atomType2];
                    c167574j.A0k(bArr, 0, atomType2);
                    return new MdtaMetadataEntry(str, bArr, typeIndicator2, localeIndicator);
                }
                c167574j.A0f(typeIndicator + atomType);
            } else {
                return null;
            }
        }
    ...
    public static void A0C(int i10, Metadata metadata, Metadata metadata2, C166302D c166302d, Metadata... metadataArr) {
        ...
        if (metadata3.A02() > 0) {
            c166302d.A0v(metadata3);
        }
    }

    public static void A0D(int i10, C17506Gi c17506Gi, C166302D c166302d) {
        if (i10 == 1 && c17506Gi.A03()) {
            c166302d.A0d(c17506Gi.A00).A0e(c17506Gi.A01);
        }
    }
}
