...
@StabilityInferred
@Metadata(m51404d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0007\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\n\b\u0002\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ%\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\f¢\u0006\u0004\b\u0010\u0010\u0011J\r\u0010\u0012\u001a\u00020\u000f¢\u0006\u0004\b\u0012\u0010\u0013J\u000f\u0010\u0014\u001a\u00020\u000fH\u0014¢\u0006\u0004\b\u0014\u0010\u0013R\u0018\u0010\u0018\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0018\u0010\u001a\u001a\u0004\u0018\u00010\u00158\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0019\u0010\u0017¨\u0006\u001b"}, m51405d2 = {"Lcom/dramawave/shared/general/view/SafeAnimatedTextView;", "Landroidx/appcompat/widget/AppCompatTextView;", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "", "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "", "newText", "", "showDuration", "hideDuration", "", "animateText", "(Ljava/lang/String;JJ)V", "cancelCurrentAnimation", "()V", "onDetachedFromWindow", "Landroid/animation/ObjectAnimator;", "h", "Landroid/animation/ObjectAnimator;", "currentAnimator", "i", "sharkAnimator", "shared_general_release"}, m51406k = 1, m51407mv = {2, 1, 0}, m51409xi = 48)
...
public final class SafeAnimatedTextView extends AppCompatTextView {
    ...
    /* compiled from: SafeAnimatedTextView.kt */
    /* renamed from: com.dramawave.shared.general.view.SafeAnimatedTextView$a */
    /* loaded from: classes.dex */
    public static final class C15185a extends AnimatorListenerAdapter {

        /* renamed from: b */
        final /* synthetic */ String f76956b;

        /* renamed from: c */
        final /* synthetic */ long f76957c;

        /* compiled from: SafeAnimatedTextView.kt */
        /* renamed from: com.dramawave.shared.general.view.SafeAnimatedTextView$a$a */
        /* loaded from: classes.dex */
        public static final class a extends AnimatorListenerAdapter {

            /* renamed from: a */
            final /* synthetic */ SafeAnimatedTextView f76958a;

            public a(SafeAnimatedTextView safeAnimatedTextView) {
                this.f76958a = safeAnimatedTextView;
            }
            ...
            public final void onAnimationCancel(Animator animation) {
                ...
                this.f76958a.setAlpha(1.0f);
            }
        }

        public C15185a(String str, long j10) {
            this.f76956b = str;
            this.f76957c = j10;
        }
        ...
        public final void onAnimationCancel(Animator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            super.onAnimationCancel(animation);
            SafeAnimatedTextView.this.setText(this.f76956b);
        }
        ...
        public final void onAnimationEnd(Animator animation) {
            ...
            ofFloat.setDuration(this.f76957c);
            ofFloat.start();
    ...
    public final void animateText(@NotNull String newText, long showDuration, long hideDuration) {
        ...
        ofFloat.addListener(new C15185a(newText, hideDuration));
        ofFloat.start();
