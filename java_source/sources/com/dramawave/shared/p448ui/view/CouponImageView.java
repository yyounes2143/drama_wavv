...
public final class CouponImageView extends AppCompatImageView {
    ...
    public CouponImageView(@NotNull Context context) {
        this(context, null, 0, 6, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public CouponImageView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    public /* synthetic */ CouponImageView(Context context, AttributeSet attributeSet, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public CouponImageView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
