...
public final class RadiusCardView extends CardView {
    ...
    public RadiusCardView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        setRadius(0.0f);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f87670f1);
        Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "obtainStyledAttributes(...)");
        this.tlRadius = obtainStyledAttributes.getDimension(R$styleable.f87685i1, 0.0f);
        this.trRadius = obtainStyledAttributes.getDimension(R$styleable.f87690j1, 0.0f);
        this.brRadius = obtainStyledAttributes.getDimension(R$styleable.f87680h1, 0.0f);
        this.blRadius = obtainStyledAttributes.getDimension(R$styleable.f87675g1, 0.0f);
