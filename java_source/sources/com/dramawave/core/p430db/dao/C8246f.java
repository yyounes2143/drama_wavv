...
/* renamed from: com.dramawave.core.db.dao.f */
/* loaded from: classes9.dex */
public final class C8246f extends EntityInsertionAdapter<C26404a> {

    /* renamed from: d */
    final /* synthetic */ C8255o f43381d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C8246f(C8255o c8255o, SDownloadDatabase_Impl database) {
        super(database);
        this.f43381d = c8255o;
    ...
    public final String mo12436c() {
        return "INSERT OR REPLACE INTO `s_download_tasks` (`id`,`url`,`filePath`,`priority`,`parentId`,`cover`,`parentCover`,`currentBytes`,`totalBytes`,`speed`,`errorMessage`,`isResumable`,`name`,`position`,`totalCount`,`percent`,`subFilePath`,`rate`,`des`,`owner`,`subState`,`extra1`,`extra2`,`state`,`createTime`,`updateTime`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    }

    @Override // androidx.room.EntityInsertionAdapter
    /* renamed from: e */
    public final void mo12370e(@NonNull SupportSQLiteStatement supportSQLiteStatement, @NonNull C26404a c26404a) {
        C26295a c26295a;
        C26295a c26295a2;
