...
public final class UgcTemplatePublishTabViewBinding implements ViewBinding {
    ...
    private UgcTemplatePublishTabViewBinding(@NonNull ConstraintLayout constraintLayout, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull ImageView imageView, @NonNull FrameLayout frameLayout, @NonNull TextView textView, @NonNull LinearLayout linearLayout3, @NonNull ImageView imageView2, @NonNull FrameLayout frameLayout2, @NonNull TextView textView2, @NonNull View view, @NonNull ImageView imageView3, @NonNull ConstraintLayout constraintLayout2, @NonNull RecyclerView recyclerView, @NonNull FrameLayout frameLayout3, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull View view2, @NonNull TextView textView5, @NonNull TextView textView6) {
        ...
        this.llRemixContainer = constraintLayout2;
        ...
        this.tvPeoplePlaying = textView5;
        this.tvRemixNow = textView6;
    }

    @NonNull
    public static UgcTemplatePublishTabViewBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static UgcTemplatePublishTabViewBinding bind(@NonNull View view) {
        View m12628a;
        View m12628a2;
                                                            ...
                                                            if (textView3 != null) {
                                                                ...
                                                                if (textView4 != null && (m12628a2 = ViewBindings.m12628a((i10 = R$id.f69530m3), view)) != null) {
                                                                    ...
                                                                    if (textView5 != null) {
                                                                        ...
                                                                        if (textView6 != null) {
                                                                            return new UgcTemplatePublishTabViewBinding((ConstraintLayout) view, linearLayout, linearLayout2, imageView, frameLayout, textView, linearLayout3, imageView2, frameLayout2, textView2, m12628a, imageView3, constraintLayout, recyclerView, frameLayout3, textView3, textView4, m12628a2, textView5, textView6);
                                                                        }
                                                                    }
                                                                }
                                                            }
    ...
    @NonNull
    public static UgcTemplatePublishTabViewBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f69645K0, viewGroup, false);
        if (z10) {
