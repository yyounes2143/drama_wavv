...
/* renamed from: com.dramawave.feature.profile.ui.wallet.v */
/* loaded from: classes8.dex */
public final class C12121v implements Function1<ConstrainScope, Unit> {

    /* renamed from: a */
    final /* synthetic */ ConstrainedLayoutReference f62505a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ConstrainScope constrainScope) {
        ConstrainScope constrainAs = constrainScope;
        Intrinsics.checkNotNullParameter(constrainAs, "$this$constrainAs");
        C3825c.m9029a(constrainAs.f24108e, this.f62505a.f24121g, 0.0f, 6);
    ...
    public C12121v(ConstrainedLayoutReference constrainedLayoutReference) {
        this.f62505a = constrainedLayoutReference;
    }
}
