...
public final class C12119t implements Function1<ConstrainScope, Unit> {

    /* renamed from: a */
    final /* synthetic */ ConstrainedLayoutReference f62503a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ConstrainScope constrainScope) {
        ConstrainScope constrainAs = constrainScope;
        Intrinsics.checkNotNullParameter(constrainAs, "$this$constrainAs");
        C3825c.m9029a(constrainAs.f24108e, this.f62503a.f24121g, 0.0f, 6);
    ...
    public C12119t(ConstrainedLayoutReference constrainedLayoutReference) {
        this.f62503a = constrainedLayoutReference;
    }
}
