...
public final class ItemComingSoonBinding implements ViewBinding {
                    ...
                    if (space != null) {
                        ...
                        if (space2 != null) {
                            ...
                            if (space3 != null) {
                                ...
                                if (textView != null && (m12628a = ViewBindings.m12628a((i10 = R$id.f60867t7), view)) != null) {
                                    return new ItemComingSoonBinding((LinearLayout) view, seriesCoverView, imageView, linearLayout, space, space2, space3, textView, m12628a);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static ItemComingSoonBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f60944L, viewGroup, false);
        if (z10) {
    ...
    private ItemComingSoonBinding(@NonNull LinearLayout linearLayout, @NonNull SeriesCoverView seriesCoverView, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout2, @NonNull Space space, @NonNull Space space2, @NonNull Space space3, @NonNull TextView textView, @NonNull View view) {
        this.rootView = linearLayout;
        this.ivCover = seriesCoverView;
        this.ivDateIcon = imageView;
