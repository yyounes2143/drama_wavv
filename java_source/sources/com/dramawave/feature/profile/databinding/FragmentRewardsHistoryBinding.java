...
public final class FragmentRewardsHistoryBinding implements ViewBinding {
    ...
    /* renamed from: rv */
    @NonNull
    public final RecyclerView f61139rv;
        ...
        if (smartRefreshLayout != null) {
            ...
            if (recyclerView != null) {
                ...
                if (qUMUITranslucentTopBar != null) {
                    ...
                    if (titleBar != null) {
                        return new FragmentRewardsHistoryBinding((ConstraintLayout) view, smartRefreshLayout, recyclerView, qUMUITranslucentTopBar, titleBar);
                    }
                }
            }
        }
    ...
    @NonNull
    public static FragmentRewardsHistoryBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f60940J, viewGroup, false);
        if (z10) {
    ...
    private FragmentRewardsHistoryBinding(@NonNull ConstraintLayout constraintLayout, @NonNull SmartRefreshLayout smartRefreshLayout, @NonNull RecyclerView recyclerView, @NonNull QUMUITranslucentTopBar qUMUITranslucentTopBar, @NonNull TitleBar titleBar) {
        this.rootView = constraintLayout;
        this.refreshLayout = smartRefreshLayout;
        this.f61139rv = recyclerView;
