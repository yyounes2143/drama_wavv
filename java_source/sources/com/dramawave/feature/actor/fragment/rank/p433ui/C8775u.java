...
/* renamed from: com.dramawave.feature.actor.fragment.rank.ui.u */
/* loaded from: classes3.dex */
public final class C8775u implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f46109a;

    /* renamed from: b */
    final /* synthetic */ Measurer f46110b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f46111c;

    /* renamed from: d */
    final /* synthetic */ int f46112d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f46113e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.actor.fragment.rank.ui.u$a */
    /* loaded from: classes3.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f46114a;
        ...
        public a(Measurer measurer, List list) {
            super(1);
            this.f46114a = measurer;
            this.f46115b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f46114a.m9016g(placementScope, this.f46115b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f46109a.getF23441a();
        long m9017h = this.f46110b.m9017h(j10, measureScope.getF21512a(), this.f46111c, list, this.f46112d);
        this.f46113e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f46110b, list));
        return mo5382j1;
    }

    public C8775u(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f46109a = mutableState;
        this.f46110b = measurer;
        this.f46111c = constraintSetForInlineDsl;
        this.f46113e = mutableState2;
    }
