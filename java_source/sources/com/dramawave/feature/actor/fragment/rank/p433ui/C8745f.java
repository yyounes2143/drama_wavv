...
/* renamed from: com.dramawave.feature.actor.fragment.rank.ui.f */
/* loaded from: classes8.dex */
public final class C8745f implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f46031a;

    /* renamed from: b */
    final /* synthetic */ Measurer f46032b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f46033c;

    /* renamed from: d */
    final /* synthetic */ int f46034d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f46035e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.actor.fragment.rank.ui.f$a */
    /* loaded from: classes8.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f46036a;

        /* renamed from: b */
        final /* synthetic */ List f46037b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f46036a = measurer;
            this.f46037b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f46036a.m9016g(placementScope, this.f46037b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f46031a.getF23441a();
        long m9017h = this.f46032b.m9017h(j10, measureScope.getF21512a(), this.f46033c, list, this.f46034d);
        this.f46035e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f46032b, list));
        return mo5382j1;
    }

    public C8745f(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f46031a = mutableState;
        this.f46032b = measurer;
        this.f46033c = constraintSetForInlineDsl;
        this.f46035e = mutableState2;
    }
