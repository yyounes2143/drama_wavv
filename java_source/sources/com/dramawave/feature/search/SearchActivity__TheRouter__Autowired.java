...
public class SearchActivity__TheRouter__Autowired {
    ...
    public static void autowiredInject(Object obj) {
        if (obj instanceof SearchActivity) {
            ...
            while (it.hasNext()) {
                try {
                    SearchArgs searchArgs = (SearchArgs) it.next().mo53774a("com.dramawave.core.router.path.SearchArgs", searchActivity, new C28560a("com.dramawave.core.router.path.SearchArgs", "args", "com.dramawave.feature.search.SearchActivity", "args"));
                    if (searchArgs != null) {
                        searchActivity.args = searchArgs;
                    }
