...
public final class AbilityDialogLotteryBinding implements ViewBinding {
    ...
    @NonNull
    public final TextView tvPurpleBar;

    @NonNull
    public static AbilityDialogLotteryBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static AbilityDialogLotteryBinding bind(@NonNull View view) {
                                        ...
                                        if (imageView != null) {
                                            ...
                                            if (autoImageView != null) {
                                                ...
                                                if (imageView2 != null) {
                                                    ...
                                                    if (textView2 != null) {
                                                        return new AbilityDialogLotteryBinding((ScrollView) view, textView, constraintLayout, guideline, guideline2, guideline3, guideline4, guideline5, guideline6, imageView, autoImageView, imageView2, textView2);
                                                    }
                                                }
                                            }
                                        }
    ...
    @NonNull
    public static AbilityDialogLotteryBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f45024p, viewGroup, false);
        if (z10) {
    ...
    private AbilityDialogLotteryBinding(@NonNull ScrollView scrollView, @NonNull TextView textView, @NonNull ConstraintLayout constraintLayout, @NonNull Guideline guideline, @NonNull Guideline guideline2, @NonNull Guideline guideline3, @NonNull Guideline guideline4, @NonNull Guideline guideline5, @NonNull Guideline guideline6, @NonNull ImageView imageView, @NonNull AutoImageView autoImageView, @NonNull ImageView imageView2, @NonNull TextView textView2) {
