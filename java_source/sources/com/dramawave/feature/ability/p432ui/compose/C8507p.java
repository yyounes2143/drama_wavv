...
/* renamed from: com.dramawave.feature.ability.ui.compose.p */
/* loaded from: classes6.dex */
public final class C8507p implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f45308a;

    /* renamed from: b */
    final /* synthetic */ Measurer f45309b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f45310c;

    /* renamed from: d */
    final /* synthetic */ int f45311d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f45312e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.ability.ui.compose.p$a */
    /* loaded from: classes6.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f45313a;

        /* renamed from: b */
        final /* synthetic */ List f45314b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f45313a = measurer;
            this.f45314b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f45313a.m9016g(placementScope, this.f45314b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f45308a.getF23441a();
        long m9017h = this.f45309b.m9017h(j10, measureScope.getF21512a(), this.f45310c, list, this.f45311d);
        this.f45312e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f45309b, list));
        return mo5382j1;
    }

    public C8507p(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f45308a = mutableState;
        this.f45309b = measurer;
        this.f45310c = constraintSetForInlineDsl;
        this.f45312e = mutableState2;
    }
