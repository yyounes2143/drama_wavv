...
/* renamed from: com.dramawave.feature.reward.original.util.v */
/* loaded from: classes7.dex */
public final class C13258v<T> implements Comparator {
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Comparator
    public final int compare(T t3, T t10) {
        return C0145b.m127a(Integer.valueOf(((ZeroGiftBox) t3).getBoxOrderId()), Integer.valueOf(((ZeroGiftBox) t10).getBoxOrderId()));
    }
}
