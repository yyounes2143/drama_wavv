...
/* renamed from: com.dramawave.feature.reward.original.ui.Q0 */
/* loaded from: classes7.dex */
public final class C13112Q0 implements Function1<TaskBase, Unit> {

    /* renamed from: a */
    final /* synthetic */ TaskViewModel f66347a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(TaskBase taskBase) {
        TaskBase task = taskBase;
        Intrinsics.checkNotNullParameter(task, "it");
        TaskViewModel taskViewModel = this.f66347a;
    ...
    public C13112Q0(TaskViewModel taskViewModel) {
        this.f66347a = taskViewModel;
    }
}
