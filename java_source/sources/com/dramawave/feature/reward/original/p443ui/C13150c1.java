...
/* renamed from: com.dramawave.feature.reward.original.ui.c1 */
/* loaded from: classes8.dex */
public final class C13150c1 implements Function1<SpecialOfferItem, Unit> {

    /* renamed from: a */
    final /* synthetic */ TaskViewModel f66452a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(SpecialOfferItem specialOfferItem) {
        SpecialOfferItem item = specialOfferItem;
        Intrinsics.checkNotNullParameter(item, "it");
        TaskViewModel taskViewModel = this.f66452a;
    ...
    public C13150c1(TaskViewModel taskViewModel) {
        this.f66452a = taskViewModel;
    }
}
