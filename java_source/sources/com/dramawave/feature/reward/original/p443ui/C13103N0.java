...
public final class C13103N0 implements Function0<Unit> {

    /* renamed from: a */
    final /* synthetic */ TaskViewModel f66331a;

    @Override // kotlin.jvm.functions.Function0
    public final Unit invoke() {
        TaskViewModel taskViewModel = this.f66331a;
    ...
    public C13103N0(TaskViewModel taskViewModel) {
        this.f66331a = taskViewModel;
    }
}
