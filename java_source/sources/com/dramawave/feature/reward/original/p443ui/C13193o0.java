...
public final class C13193o0 implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f66555a;

    /* renamed from: b */
    final /* synthetic */ Measurer f66556b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f66557c;

    /* renamed from: d */
    final /* synthetic */ int f66558d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f66559e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.reward.original.ui.o0$a */
    /* loaded from: classes5.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f66560a;

        /* renamed from: b */
        final /* synthetic */ List f66561b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f66560a = measurer;
            this.f66561b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f66560a.m9016g(placementScope, this.f66561b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f66555a.getF23441a();
        long m9017h = this.f66556b.m9017h(j10, measureScope.getF21512a(), this.f66557c, list, this.f66558d);
        this.f66559e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f66556b, list));
        return mo5382j1;
    }

    public C13193o0(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f66555a = mutableState;
        this.f66556b = measurer;
        this.f66557c = constraintSetForInlineDsl;
        this.f66559e = mutableState2;
    }
