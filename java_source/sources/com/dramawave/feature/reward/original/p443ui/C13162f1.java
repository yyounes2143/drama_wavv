...
public final class C13162f1 implements Function1<ExtraAd, Unit> {

    /* renamed from: a */
    final /* synthetic */ TaskViewModel f66470a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ExtraAd extraAd) {
        ExtraAd it = extraAd;
        Intrinsics.checkNotNullParameter(it, "it");
        TaskViewModel taskViewModel = this.f66470a;
        if (taskViewModel != null) {
            taskViewModel.m28049t(new AdTask(it.getId(), EnumC1972o.f4972e.m2681a(), it.getExtraAmount(), it.getAdPlatform(), 506), EnumC13334w0.f67343b);
        }
        return Unit.f119604a;
    }

    public C13162f1(TaskViewModel taskViewModel) {
        this.f66470a = taskViewModel;
    }
}
