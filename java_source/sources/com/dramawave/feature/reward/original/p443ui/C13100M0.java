...
public final class C13100M0 implements Function1<AdTask, Unit> {

    /* renamed from: a */
    final /* synthetic */ TaskViewModel f66325a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(AdTask adTask) {
        AdTask adTask2 = adTask;
        Intrinsics.checkNotNullParameter(adTask2, "it");
        TaskViewModel taskViewModel = this.f66325a;
    ...
    public C13100M0(TaskViewModel taskViewModel) {
        this.f66325a = taskViewModel;
    }
}
