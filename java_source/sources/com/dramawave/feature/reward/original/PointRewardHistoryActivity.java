...
public final class PointRewardHistoryActivity extends BaseTraceActivity<ActivityMyItemsHistoryBinding> {
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        fixStatusBar();
        Pair[] pairArr = {new Pair(MyItemsHistoryFragment.f65982s, 0)};
