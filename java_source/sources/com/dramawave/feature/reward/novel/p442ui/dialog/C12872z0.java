...
/* renamed from: com.dramawave.feature.reward.novel.ui.dialog.z0 */
/* loaded from: classes8.dex */
public final class C12872z0 implements Function1<ConstrainScope, Unit> {

    /* renamed from: a */
    final /* synthetic */ ConstrainedLayoutReference f65408a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ConstrainScope constrainScope) {
        ConstrainScope constrainAs = constrainScope;
        Intrinsics.checkNotNullParameter(constrainAs, "$this$constrainAs");
        C3825c.m9029a(constrainAs.f24108e, this.f65408a.f24121g, 0.0f, 6);
    ...
    public C12872z0(ConstrainedLayoutReference constrainedLayoutReference) {
        this.f65408a = constrainedLayoutReference;
    }
}
