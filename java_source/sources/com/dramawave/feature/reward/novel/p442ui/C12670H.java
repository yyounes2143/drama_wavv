...
public final class C12670H implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f64877a;

    /* renamed from: b */
    final /* synthetic */ Measurer f64878b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f64879c;

    /* renamed from: d */
    final /* synthetic */ int f64880d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f64881e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.reward.novel.ui.H$a */
    /* loaded from: classes.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f64882a;

        /* renamed from: b */
        final /* synthetic */ List f64883b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f64882a = measurer;
            this.f64883b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f64882a.m9016g(placementScope, this.f64883b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f64877a.getF23441a();
        long m9017h = this.f64878b.m9017h(j10, measureScope.getF21512a(), this.f64879c, list, this.f64880d);
        this.f64881e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f64878b, list));
        return mo5382j1;
    }

    public C12670H(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f64877a = mutableState;
        this.f64878b = measurer;
        this.f64879c = constraintSetForInlineDsl;
        this.f64881e = mutableState2;
    }
