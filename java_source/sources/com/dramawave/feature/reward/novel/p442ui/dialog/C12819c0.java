...
public final class C12819c0 implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f65231a;

    /* renamed from: b */
    final /* synthetic */ Measurer f65232b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f65233c;

    /* renamed from: d */
    final /* synthetic */ int f65234d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f65235e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.reward.novel.ui.dialog.c0$a */
    /* loaded from: classes6.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f65236a;

        /* renamed from: b */
        final /* synthetic */ List f65237b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f65236a = measurer;
            this.f65237b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f65236a.m9016g(placementScope, this.f65237b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f65231a.getF23441a();
        long m9017h = this.f65232b.m9017h(j10, measureScope.getF21512a(), this.f65233c, list, this.f65234d);
        this.f65235e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f65232b, list));
        return mo5382j1;
    }

    public C12819c0(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f65231a = mutableState;
        this.f65232b = measurer;
        this.f65233c = constraintSetForInlineDsl;
        this.f65235e = mutableState2;
    }
