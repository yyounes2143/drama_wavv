...
public final class C12868x0 implements Function1<ConstrainScope, Unit> {

    /* renamed from: a */
    final /* synthetic */ ConstrainedLayoutReference f65383a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ConstrainScope constrainScope) {
        ConstrainScope constrainAs = constrainScope;
        Intrinsics.checkNotNullParameter(constrainAs, "$this$constrainAs");
        C3825c.m9029a(constrainAs.f24108e, this.f65383a.f24121g, 0.0f, 6);
    ...
    public C12868x0(ConstrainedLayoutReference constrainedLayoutReference) {
        this.f65383a = constrainedLayoutReference;
    }
}
