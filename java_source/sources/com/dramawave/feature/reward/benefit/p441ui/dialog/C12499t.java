...
/* renamed from: com.dramawave.feature.reward.benefit.ui.dialog.t */
/* loaded from: classes5.dex */
public final class C12499t implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f64220a;

    /* renamed from: b */
    final /* synthetic */ Measurer f64221b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f64222c;

    /* renamed from: d */
    final /* synthetic */ int f64223d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f64224e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.reward.benefit.ui.dialog.t$a */
    /* loaded from: classes5.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f64225a;

        /* renamed from: b */
        final /* synthetic */ List f64226b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f64225a = measurer;
            this.f64226b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f64225a.m9016g(placementScope, this.f64226b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f64220a.getF23441a();
        long m9017h = this.f64221b.m9017h(j10, measureScope.getF21512a(), this.f64222c, list, this.f64223d);
        this.f64224e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f64221b, list));
        return mo5382j1;
    }

    public C12499t(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f64220a = mutableState;
        this.f64221b = measurer;
        this.f64222c = constraintSetForInlineDsl;
        this.f64224e = mutableState2;
    }
