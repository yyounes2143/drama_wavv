...
/* renamed from: com.dramawave.feature.reward.benefit.ui.dialog.n */
/* loaded from: classes6.dex */
public final class C12493n implements Function1<ConstrainScope, Unit> {

    /* renamed from: a */
    final /* synthetic */ ConstrainedLayoutReference f64213a;

    @Override // kotlin.jvm.functions.Function1
    public final Unit invoke(ConstrainScope constrainScope) {
        ConstrainScope constrainAs = constrainScope;
        Intrinsics.checkNotNullParameter(constrainAs, "$this$constrainAs");
        C3825c.m9029a(constrainAs.f24108e, this.f64213a.f24121g, 0.0f, 6);
    ...
    public C12493n(ConstrainedLayoutReference constrainedLayoutReference) {
        this.f64213a = constrainedLayoutReference;
    }
}
