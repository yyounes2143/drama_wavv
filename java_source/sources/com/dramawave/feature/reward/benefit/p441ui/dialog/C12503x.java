...
/* renamed from: com.dramawave.feature.reward.benefit.ui.dialog.x */
/* loaded from: classes3.dex */
public final class C12503x implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f64236a;

    /* renamed from: b */
    final /* synthetic */ Measurer f64237b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f64238c;

    /* renamed from: d */
    final /* synthetic */ int f64239d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f64240e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.reward.benefit.ui.dialog.x$a */
    /* loaded from: classes3.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f64241a;

        /* renamed from: b */
        final /* synthetic */ List f64242b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f64241a = measurer;
            this.f64242b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f64241a.m9016g(placementScope, this.f64242b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f64236a.getF23441a();
        long m9017h = this.f64237b.m9017h(j10, measureScope.getF21512a(), this.f64238c, list, this.f64239d);
        this.f64240e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f64237b, list));
        return mo5382j1;
    }

    public C12503x(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f64236a = mutableState;
        this.f64237b = measurer;
        this.f64238c = constraintSetForInlineDsl;
        this.f64240e = mutableState2;
    }
