...
/* renamed from: com.dramawave.feature.home.download.redeem.j */
/* loaded from: classes5.dex */
public final class C10198j implements MeasurePolicy {

    /* renamed from: a */
    final /* synthetic */ MutableState f52805a;

    /* renamed from: b */
    final /* synthetic */ Measurer f52806b;

    /* renamed from: c */
    final /* synthetic */ ConstraintSetForInlineDsl f52807c;

    /* renamed from: d */
    final /* synthetic */ int f52808d = AppKeyManager.NATIVE_IMAGE_ACCEPTED_SIZE_Y;

    /* renamed from: e */
    final /* synthetic */ MutableState f52809e;

    /* compiled from: ConstraintLayout.kt */
    @SourceDebugExtension({"SMAP\nConstraintLayout.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConstraintLayout.kt\nandroidx/constraintlayout/compose/ConstraintLayoutKt$ConstraintLayout$measurePolicy$1$1$1\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,2296:1\n1#2:2297\n*E\n"})
    /* renamed from: com.dramawave.feature.home.download.redeem.j$a */
    /* loaded from: classes5.dex */
    public static final class a extends Lambda implements Function1<Placeable.PlacementScope, Unit> {

        /* renamed from: a */
        final /* synthetic */ Measurer f52810a;

        /* renamed from: b */
        final /* synthetic */ List f52811b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(Measurer measurer, List list) {
            super(1);
            this.f52810a = measurer;
            this.f52811b = list;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Unit invoke(Placeable.PlacementScope placementScope) {
            this.f52810a.m9016g(placementScope, this.f52811b);
    ...
    public final MeasureResult mo4449a(MeasureScope measureScope, List<? extends Measurable> list, long j10) {
        ...
        this.f52805a.getF23441a();
        long m9017h = this.f52806b.m9017h(j10, measureScope.getF21512a(), this.f52807c, list, this.f52808d);
        this.f52809e.getF23441a();
        IntSize.Companion companion = IntSize.f23789b;
        mo5382j1 = measureScope.mo5382j1((int) (m9017h >> 32), (int) (m9017h & 4294967295L), C27158Q.m51485d(), new a(this.f52806b, list));
        return mo5382j1;
    }

    public C10198j(MutableState mutableState, Measurer measurer, ConstraintSetForInlineDsl constraintSetForInlineDsl, MutableState mutableState2) {
        this.f52805a = mutableState;
        this.f52806b = measurer;
        this.f52807c = constraintSetForInlineDsl;
        this.f52809e = mutableState2;
    }
