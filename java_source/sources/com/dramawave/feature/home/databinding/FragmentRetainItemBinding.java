...
public final class FragmentRetainItemBinding implements ViewBinding {
    ...
    @NonNull
    public static FragmentRetainItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragmentRetainItemBinding bind(@NonNull View view) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (tXCloudVideoView != null) {
                                                        return new FragmentRetainItemBinding((CardView) view, constraintLayout, frameLayout, enhancedImageView, imageView, imageView2, linearLayout, linearLayout2, lottieAnimationView, recyclerView, textView, textView2, tXCloudVideoView);
                                                    }
                                                }
                                            }
                                        }
    ...
    @NonNull
    public static FragmentRetainItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f48323V, viewGroup, false);
        if (z10) {
    ...
    private FragmentRetainItemBinding(@NonNull CardView cardView, @NonNull ConstraintLayout constraintLayout, @NonNull FrameLayout frameLayout, @NonNull EnhancedImageView enhancedImageView, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull LottieAnimationView lottieAnimationView, @NonNull RecyclerView recyclerView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TXCloudVideoView tXCloudVideoView) {
