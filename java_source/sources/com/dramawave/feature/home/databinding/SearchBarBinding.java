...
public final class SearchBarBinding implements ViewBinding {
    ...
    public static SearchBarBinding bind(@NonNull View view) {
        ...
        if (imageView != null) {
            ...
            if (qUMUITranslucentTopBar != null) {
                return new SearchBarBinding((ConstraintLayout) view, imageView, qUMUITranslucentTopBar);
            }
        }
    ...
    @NonNull
    public static SearchBarBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f48310Q1, viewGroup, false);
        if (z10) {
    ...
    private SearchBarBinding(@NonNull ConstraintLayout constraintLayout, @NonNull ImageView imageView, @NonNull QUMUITranslucentTopBar qUMUITranslucentTopBar) {
