...
public final class MylistNewNovelItemViewBinding implements ViewBinding {
    ...
    @NonNull
    public static MylistNewNovelItemViewBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static MylistNewNovelItemViewBinding bind(@NonNull View view) {
        View m12628a;
                            ...
                            if (textView != null) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null && (m12628a = ViewBindings.m12628a((i10 = R$id.f56766W), view)) != null) {
                                        return new MylistNewNovelItemViewBinding((ConstraintLayout) view, contentTagsView, group, group2, seriesCoverView, imageView, textView, textView2, textView3, m12628a);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static MylistNewNovelItemViewBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f56812s, viewGroup, false);
        if (z10) {
    ...
    private MylistNewNovelItemViewBinding(@NonNull ConstraintLayout constraintLayout, @NonNull ContentTagsView contentTagsView, @NonNull Group group, @NonNull Group group2, @NonNull SeriesCoverView seriesCoverView, @NonNull ImageView imageView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull View view) {
