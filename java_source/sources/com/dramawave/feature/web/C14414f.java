...
public final class C14414f extends AbstractC16427r {

    /* renamed from: a */
    final /* synthetic */ JsHandlerManagerImpl f73075a;

    public C14414f(JsHandlerManagerImpl jsHandlerManagerImpl) {
        this.f73075a = jsHandlerManagerImpl;
    }
    ...
    public final void mo29558a(JSONObject params, JsBridge.C16408a promise) throws Exception {
        ...
        InterfaceC16426q m29567h = this.f73075a.m29567h();
        if (m29567h != null) {
            m29567h.mo29592s1();
        }
    }
