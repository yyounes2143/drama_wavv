...
public final class C14413e extends AbstractC16427r {

    /* renamed from: a */
    final /* synthetic */ JsHandlerManagerImpl f73074a;

    public C14413e(JsHandlerManagerImpl jsHandlerManagerImpl) {
        this.f73074a = jsHandlerManagerImpl;
    }
    ...
    public final void mo29558a(JSONObject params, JsBridge.C16408a promise) throws Exception {
        ...
        InterfaceC16426q m29567h = this.f73074a.m29567h();
        if (m29567h != null) {
            m29567h.mo29586o0(promise);
        }
    }
}
