...
public final class NovelTripleGridVerticalVH extends AbstractC0057a<NovelItemData> {

    /* renamed from: f */
    @NotNull
    private static final Companion f68716f = new Companion(null);

    /* renamed from: g */
    public static final int f68717g = 8;

    /* renamed from: h */
    private static final int f68718h = 3;

    /* renamed from: d */
    @NotNull
    private final TheaterItemGridTripleBinding f68719d;

    /* renamed from: e */
    @NotNull
    private final InterfaceC0089k f68720e;

    /* compiled from: NovelTripleGridVerticalVH.kt */
    @Metadata(m51404d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, m51405d2 = {"Lcom/dramawave/feature/theater/adapter/headerVH/novel/NovelTripleGridVerticalVH$Companion;", "", "<init>", "()V", "TRIPLE_SPAN_COUNT", "", "feature_theater_release"}, m51406k = 1, m51407mv = {2, 1, 0}, m51409xi = 48)
    /* loaded from: classes9.dex */
    ...
    public final void mo8w(int i10, Object obj) {
        ...
        if (item.getShowTitle()) {
            TextView textView = this.f68719d.title;
            textView.setText(item.getModuleTitle());
            textView.setVisibility(0);
            TextView textView2 = this.f68719d.tvMore;
            if (item.getHasMore()) {
                i12 = 0;
            }
            textView2.setVisibility(i12);
        } else {
            TextView textView3 = this.f68719d.title;
            if (item.getHasMore()) {
                i11 = 4;
            } else {
                i11 = 8;
            ...
            TextView textView4 = this.f68719d.tvMore;
            if (item.getHasMore()) {
                i12 = 0;
            }
            textView4.setVisibility(i12);
        }
        TextView tvMore = this.f68719d.tvMore;
        Intrinsics.checkNotNullExpressionValue(tvMore, "tvMore");
        C8158B.m21736i(tvMore, new C0128h(item, 3));
        MultiTypeQuickAdapter multiTypeQuickAdapter = (MultiTypeQuickAdapter) this.f68720e.getValue();
    ...
    */
    public NovelTripleGridVerticalVH(android.view.ViewGroup r6) {
        /*
            r5 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.dramawave.feature.theater.adapter.headerVH.novel.NovelTripleGridVerticalVH.<init>(android.view.ViewGroup):void");
    }
}
