...
public final class TheaterItemMixGridviewItemBinding implements ViewBinding {
    ...
    @NonNull
    public static TheaterItemMixGridviewItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static TheaterItemMixGridviewItemBinding bind(@NonNull View view) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (appCompatTextView != null) {
                                ...
                                if (linearLayout != null) {
                                    return new TheaterItemMixGridviewItemBinding((ConstraintLayout) view, seriesCoverView, imageView, smartTagsTextView, textView, textView2, appCompatTextView, linearLayout);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static TheaterItemMixGridviewItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f68465A0, viewGroup, false);
        if (z10) {
