...
public final class ComingSoonItemBinding implements ViewBinding {
    ...
    @NonNull
    public static ComingSoonItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ComingSoonItemBinding bind(@NonNull View view) {
                                ...
                                if (textView2 != null) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (textView5 != null) {
                                                return new ComingSoonItemBinding((FrameLayout) view, contentTagsView, seriesCoverView, appCompatImageView, constraintLayout, textView, appCompatTextView, textView2, textView3, textView4, textView5);
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static ComingSoonItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f68547l, viewGroup, false);
        if (z10) {
