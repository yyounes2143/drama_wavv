...
public final class TheaterItemMixComingsoonItemBinding implements ViewBinding {
    ...
    @NonNull
    public static TheaterItemMixComingsoonItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static TheaterItemMixComingsoonItemBinding bind(@NonNull View view) {
        View m12628a;
        View m12628a2;
        View m12628a3;
                                                ...
                                                if (space != null) {
                                                    ...
                                                    if (textView2 != null) {
                                                        ...
                                                        if (appCompatTextView != null) {
                                                            return new TheaterItemMixComingsoonItemBinding((ConstraintLayout) view, barrier, m12628a, m12628a2, textView, constraintLayout, contentTagsView, cycleFlipperView, constraintLayout2, seriesCoverView, appCompatImageView, appCompatImageView2, m12628a3, linearLayoutCompat, space, textView2, appCompatTextView);
                                                        }
                                                    }
                                                }
                                            }
    ...
    @NonNull
    public static TheaterItemMixComingsoonItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R$layout.f68572x0, viewGroup, false);
        if (z10) {
