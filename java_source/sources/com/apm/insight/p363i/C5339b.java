...
import com.apm.insight.p361g.InterfaceC5333c;
...
public final class C5339b implements InterfaceC5333c {

    /* renamed from: a */
    private Context f33905a;

    /* renamed from: b */
    private synchronized void m13957b(final long j10, final Thread thread, final Throwable th, final String str, final String str2, final boolean z10) {
        final File file = new File(C5364j.m14137a(this.f33905a), str);
        C5331a.m13917a().m13933a(file.getName());
        file.mkdirs();
        C5360f.m14111d(file);
        final boolean m14199c = C5367m.m14199c(th);
        C5325a m14380a = C5384f.m14378a().m14380a(CrashType.LAUNCH, new AbstractC5381c.a() { // from class: com.apm.insight.i.b.1

            /* renamed from: a */
            private long f33906a = 0;
            ...
            public final C5325a mo13941a(int i10, C5325a c5325a) {
                String str3;
                String str4;
                this.f33906a = SystemClock.uptimeMillis();
                if (i10 != 0) {
                    if (i10 != 1) {
                        if (i10 != 2) {
                            if (i10 != 3) {
                                if (i10 != 4) {
                                    ...
                                    C5355a.m14058a(C5339b.this.f33905a, c5325a.m13872c());
                                }
                            } else {
                            ...
                            c5325a.m13865a("launch_did", (Object) C5338a.m13955a(C5339b.this.f33905a));
                        ...
                        c5325a.m13865a(StatsEvent.f109035A, Long.valueOf(j10));
                        c5325a.m13865a("main_process", Boolean.valueOf(C5355a.m14062c(C5339b.this.f33905a)));
                        c5325a.m13865a("crash_type", CrashType.JAVA);
                        ...
                        C5331a.m13917a().m13934a(thread, th, true, c5325a);
                    }
                } else {
                    c5325a.m13865a("stack", (Object) C5367m.m14181a(th));
                    c5325a.m13865a(StatsEvent.f109042z, "start_crash");
    ...
    /* renamed from: a */
    public final void mo13939a(long j10, Thread thread, Throwable th, String str, String str2, boolean z10) {
        m13957b(j10, thread, th, str, str2, z10);
    }

    public C5339b(@NonNull Context context) {
