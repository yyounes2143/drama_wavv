...
public class C6317c extends AbstractC6278d<Pair<File, UpdatePackage>, Pair<String, Long>> {
    ...
    public final /* synthetic */ Object mo18871a(InterfaceC6274b<Pair<String, Long>> interfaceC6274b, Pair<File, UpdatePackage> pair) throws Throwable {
        ...
        GeckoLogger.m19085d("gecko-debug-tag", "start active full single file, channel:", ((UpdatePackage) pair2.second).getChannel());
