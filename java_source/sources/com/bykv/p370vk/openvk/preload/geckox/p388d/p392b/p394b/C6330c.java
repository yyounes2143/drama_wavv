...
public class C6330c extends AbstractC6278d<Pair<Uri, UpdatePackage>, Pair<InterfaceC6305a, UpdatePackage>> {

    /* renamed from: d */
    private C6302b f38522d;

    /* renamed from: e */
    private File f38523e;
    ...
    public final void mo18887a(Object... objArr) {
        ...
        this.f38522d = (C6302b) objArr[0];
        this.f38523e = (File) objArr[1];
    }
    ...
    public Object mo18871a(InterfaceC6274b<Pair<InterfaceC6305a, UpdatePackage>> interfaceC6274b, Pair<Uri, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m19085d("gecko-debug-tag", "start download patch zip file, channel:", ((UpdatePackage) pair.second).getChannel());
        UpdatePackage updatePackage = (UpdatePackage) pair.second;
        String uri = ((Uri) pair.first).toString();
        long length = updatePackage.getPatch().getLength();
        File file = this.f38523e;
        ...
        this.f38522d.m18963a();
        InterfaceC6305a m19022a = C6306a.m19022a(file3, length);
        try {
            this.f38522d.m18970i().downloadFile(uri, length, new BufferOutputStream(m19022a));
            try {
            ...
            m19022a.mo19020e();
            StringBuilder m3577b = C2573s.m3577b("download patch zip failed, url:", uri, ", channel:");
