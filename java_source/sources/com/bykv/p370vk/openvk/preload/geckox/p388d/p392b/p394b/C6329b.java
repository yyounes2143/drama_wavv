...
public class C6329b extends AbstractC6278d<Pair<InterfaceC6305a, UpdatePackage>, Pair<InterfaceC6305a, UpdatePackage>> {
    ...
    private static Object a2(InterfaceC6274b<Pair<InterfaceC6305a, UpdatePackage>> interfaceC6274b, Pair<InterfaceC6305a, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m19085d("gecko-debug-tag", "start check patch zip file, channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        try {
            ...
            throw new C6304b("check patch zip file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
}
