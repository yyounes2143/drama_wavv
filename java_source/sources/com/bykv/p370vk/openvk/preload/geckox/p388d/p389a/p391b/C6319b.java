...
public class C6319b extends AbstractC6278d<Pair<InterfaceC6305a, UpdatePackage>, Pair<InterfaceC6305a, UpdatePackage>> {
    ...
    private static Object a2(InterfaceC6274b<Pair<InterfaceC6305a, UpdatePackage>> interfaceC6274b, Pair<InterfaceC6305a, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m19085d("gecko-debug-tag", "start check patch single file, channel:", ((UpdatePackage) pair.second).getChannel());
        InterfaceC6305a interfaceC6305a = (InterfaceC6305a) pair.first;
        interfaceC6305a.mo19017b(0L);
        UpdatePackage updatePackage = (UpdatePackage) pair.second;
        try {
            C6360d.m19123a(new C6309a(interfaceC6305a), updatePackage.getPatch().getMd5());
            return interfaceC6274b.mo18875a((InterfaceC6274b<Pair<InterfaceC6305a, UpdatePackage>>) pair);
        } catch (Throwable th) {
            throw new C6304b("check patch single file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
}
