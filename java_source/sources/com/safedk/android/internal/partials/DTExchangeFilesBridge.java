...
public class DTExchangeFilesBridge {
    public static FileOutputStream fileOutputStreamCtor(File file) throws FileNotFoundException {
        Logger.m43494d("DTExchangeFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/DTExchangeFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;");
        if (!SafeDK.m41951ab()) {
        ...
        return CreativeInfoManager.m42717a(C23964g.f109552p, file.getPath(), new FileOutputStream(file));
    }
}
