...
public class UnityAdsFilesBridge {
    public static FileOutputStream fileOutputStreamCtor(File file) throws FileNotFoundException {
        Logger.m43494d("UnityAdsFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/UnityAdsFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;");
        if (!SafeDK.m41951ab()) {
        ...
        return CreativeInfoManager.m42717a("com.unity3d.ads", file.getPath(), new FileOutputStream(file));
    }
}
