...
public class PangleFilesBridge {
    public static FileOutputStream fileOutputStreamCtor(File file) throws FileNotFoundException {
        Logger.m43494d("PangleFiles|SafeDK: Partial-Files> Lcom/safedk/android/internal/partials/PangleFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;");
        if (!SafeDK.m41951ab()) {
        ...
        return CreativeInfoManager.m42717a(C23964g.f109557u, file.getPath(), new FileOutputStream(file));
    }
}
