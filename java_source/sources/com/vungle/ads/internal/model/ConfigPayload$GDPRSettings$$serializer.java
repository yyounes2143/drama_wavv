...
public final class ConfigPayload$GDPRSettings$$serializer implements InterfaceC27734L<ConfigPayload.GDPRSettings> {
    ...
    @NotNull
    public ConfigPayload.GDPRSettings deserialize(@NotNull InterfaceC27710d decoder) {
        ...
        return new ConfigPayload.GDPRSettings(i10, (Boolean) obj, (String) obj2, (String) obj3, (String) obj4, (String) obj5, (String) obj6, (C27729I0) null);
    }

    @Override // p353cb.InterfaceC5077c
    public void serialize(@NotNull InterfaceC27711e encoder, @NotNull ConfigPayload.GDPRSettings value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC26004f descriptor2 = getDescriptor();
        InterfaceC27709c mo52519b = encoder.mo52519b(descriptor2);
        ConfigPayload.GDPRSettings.write$Self(value, mo52519b, descriptor2);
    ...
    static {
        ...
        C27817y0 c27817y0 = new C27817y0("com.vungle.ads.internal.model.ConfigPayload.GDPRSettings", configPayload$GDPRSettings$$serializer, 6);
        c27817y0.m52603j("is_country_data_protected", true);
        c27817y0.m52603j("consent_title", true);
        c27817y0.m52603j("consent_message", true);
        c27817y0.m52603j("consent_message_version", true);
        c27817y0.m52603j("button_accept", true);
        c27817y0.m52603j("button_deny", true);
        descriptor = c27817y0;
    }
    ...
    public InterfaceC5077c<?>[] childSerializers() {
        ...
        return new InterfaceC5077c[]{m49949b, C25939a.m49949b(c27739n0), C25939a.m49949b(c27739n0), C25939a.m49949b(c27739n0), C25939a.m49949b(c27739n0), C25939a.m49949b(c27739n0)};
    }
