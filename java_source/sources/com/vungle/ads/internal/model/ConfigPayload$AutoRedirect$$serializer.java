...
public final class ConfigPayload$AutoRedirect$$serializer implements InterfaceC27734L<ConfigPayload.AutoRedirect> {
    ...
    @NotNull
    public ConfigPayload.AutoRedirect deserialize(@NotNull InterfaceC27710d decoder) {
        ...
        return new ConfigPayload.AutoRedirect(i10, (Boolean) obj, (Long) obj2, (C27729I0) null);
    }

    @Override // p353cb.InterfaceC5077c
    public void serialize(@NotNull InterfaceC27711e encoder, @NotNull ConfigPayload.AutoRedirect value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        InterfaceC26004f descriptor2 = getDescriptor();
        InterfaceC27709c mo52519b = encoder.mo52519b(descriptor2);
        ConfigPayload.AutoRedirect.write$Self(value, mo52519b, descriptor2);
    ...
    static {
        ...
        C27817y0 c27817y0 = new C27817y0("com.vungle.ads.internal.model.ConfigPayload.AutoRedirect", configPayload$AutoRedirect$$serializer, 2);
        c27817y0.m52603j("allow_auto_redirect", true);
        c27817y0.m52603j("after_click_ms", true);
        descriptor = c27817y0;
    }
    ...
    public InterfaceC5077c<?>[] childSerializers() {
        return new InterfaceC5077c[]{C25939a.m49949b(C27784i.f121850a), C25939a.m49949b(C27781g0.f121844a)};
    }
