...
@Metadata(m51404d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u001c\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0016R\u001c\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\u000f"}, m51405d2 = {"Lcom/vungle/ads/internal/util/RingerModeReceiver;", "Landroid/content/BroadcastReceiver;", "()V", "webClient", "Lcom/vungle/ads/internal/ui/VungleWebClient;", "getWebClient", "()Lcom/vungle/ads/internal/ui/VungleWebClient;", "setWebClient", "(Lcom/vungle/ads/internal/ui/VungleWebClient;)V", "onReceive", "", "context", "Landroid/content/Context;", "intent", "Landroid/content/Intent;", "vungle-ads_release"}, m51406k = 1, m51407mv = {1, 7, 1}, m51409xi = 48)
...
public final class RingerModeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(@Nullable Context context, @Nullable Intent intent) {
        ...
        if (intent != null) {
            try {
                ...
                if (localizedMessage != null) {
                    Logger.INSTANCE.m49804e("RingerModeReceiver", localizedMessage);
                    return;
                }
                return;
            }
        ...
        if (Intrinsics.areEqual(action, "android.media.RINGER_MODE_CHANGED")) {
            ...
            Logger.INSTANCE.m49803d("RingerModeReceiver", "receive ringermode: " + intExtra);
            if (intExtra != 0) {
                if (intExtra != 1) {
