...
public class BundleUtils {
    ...
    public static void put(String str, @Nullable Object obj, Bundle bundle) {
        if (obj != null) {
            ...
            C5954n.m17563h("AppLovinSdk", "Skipped insertion of " + obj + " into Bundle");
            return;
        }
        C5954n.m17563h("AppLovinSdk", "Skipped insertion into Bundle because value is null.");
    }
    ...
    public static void putByte(String str, @Nullable Byte b10, Bundle bundle) {
        if (b10 != null) {
    ...
    public static void putDouble(String str, @Nullable Double d10, Bundle bundle) {
        if (d10 != null) {
    ...
    public static void putFloat(String str, @Nullable Float f10, Bundle bundle) {
        if (f10 != null) {
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            C5954n.m17560c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e3);
        }
        return jSONObject;
    }
