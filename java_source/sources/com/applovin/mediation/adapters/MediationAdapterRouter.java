...
public abstract class MediationAdapterRouter {
    ...
    private final Set<MaxAdapter> loadedAdapters = DesugarCollections.synchronizedSet(new HashSet());
    private final Set<MaxAdapter> showingAdapters = DesugarCollections.synchronizedSet(new HashSet());
    ...
    public void log(String str) {
        ...
        c5950j.m17342I();
        if (C5954n.m17556a()) {
            C5950j.f37012v0.m17342I().m17571d(this.mTag, str);
        }
    }
    ...
    public void log(String str, Throwable th) {
        ...
        c5950j.m17342I();
        if (C5954n.m17556a()) {
            C5950j.f37012v0.m17342I().m17568a(this.mTag, str, th);
        }
    }
