...
public class UnityAdsMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter {
    ...
    /* renamed from: com.applovin.mediation.adapters.UnityAdsMediationAdapter$8 */
    /* loaded from: classes6.dex */
    public static /* synthetic */ class C60998 {
    ...
    private UnityBannerSize toUnityBannerSize(MaxAdFormat maxAdFormat) {
        ...
        if (maxAdFormat == MaxAdFormat.LEADER) {
            return new UnityBannerSize(TradPlusDataConstants.LARGEBANNER_WIDTH, 90);
        }
    ...
    private void updatePrivacyConsent(MaxAdapterParameters maxAdapterParameters, Context context) {
        ...
        if (hasUserConsent != null) {
            metaData.set(GoogleMobileAdsConsentManager.f74459f, hasUserConsent);
            metaData.commit();
        }
        if (maxAdapterParameters.isDoNotSell() != null) {
            metaData.set(GoogleMobileAdsConsentManager.f74460g, Boolean.valueOf(!r3.booleanValue()));
            metaData.commit();
        }
    ...
    public void loadInterstitialAd(MaxAdapterResponseParameters maxAdapterResponseParameters, @Nullable Activity activity, final MaxInterstitialAdapterListener maxInterstitialAdapterListener) {
        ...
        UnityAds.load(thirdPartyAdPlacementId, createAdLoadOptions(maxAdapterResponseParameters), new IUnityAdsLoadListener() { // from class: com.applovin.mediation.adapters.UnityAdsMediationAdapter.3
            ...
            public void onUnityAdsAdLoaded(String str2) {
                UnityAdsMediationAdapter.this.log("Interstitial placement \"" + str2 + "\" loaded");
                maxInterstitialAdapterListener.onInterstitialAdLoaded();
            }

            @Override // com.unity3d.ads.IUnityAdsLoadListener
            public void onUnityAdsFailedToLoad(String str2, UnityAds.UnityAdsLoadError unityAdsLoadError, String str3) {
                UnityAdsMediationAdapter.this.log("Interstitial placement \"" + str2 + "\" failed to load with error: " + unityAdsLoadError + ": " + str3);
    ...
    public void loadRewardedAd(MaxAdapterResponseParameters maxAdapterResponseParameters, @Nullable Activity activity, final MaxRewardedAdapterListener maxRewardedAdapterListener) {
        ...
        UnityAds.load(thirdPartyAdPlacementId, createAdLoadOptions(maxAdapterResponseParameters), new IUnityAdsLoadListener() { // from class: com.applovin.mediation.adapters.UnityAdsMediationAdapter.5
            @Override // com.unity3d.ads.IUnityAdsLoadListener
            public void onUnityAdsAdLoaded(String str2) {
                UnityAdsMediationAdapter.this.log("Rewarded ad placement \"" + str2 + "\" loaded");
                maxRewardedAdapterListener.onRewardedAdLoaded();
            }

            @Override // com.unity3d.ads.IUnityAdsLoadListener
            public void onUnityAdsFailedToLoad(String str2, UnityAds.UnityAdsLoadError unityAdsLoadError, String str3) {
                UnityAdsMediationAdapter.this.log("Rewarded ad placement \"" + str2 + "\" failed to load with error: " + unityAdsLoadError + ": " + str3);
    ...
    public static MaxAdapterError toMaxError(UnityAds.UnityAdsLoadError unityAdsLoadError, String str) {
        ...
        int i10 = C60998.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
        if (i10 == 1) {
    ...
    private static MaxAdapterError toMaxError(UnityAds.UnityAdsShowError unityAdsShowError, String str) {
        MaxAdapterError maxAdapterError = MaxAdapterError.UNSPECIFIED;
        switch (C60998.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsShowError[unityAdsShowError.ordinal()]) {
            case 1:
                maxAdapterError = MaxAdapterError.NOT_INITIALIZED;
                break;
            case 2:
