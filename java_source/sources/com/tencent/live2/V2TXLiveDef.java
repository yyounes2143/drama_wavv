...
public class V2TXLiveDef {
    ...
    public static final class V2TXLiveAudioFrame {
        ...
        public V2TXLiveAudioFrame() {
            this.data = null;
            this.sampleRate = TXRecordCommon.AUDIO_SAMPLERATE_48000;
            this.channel = 1;
            this.timestamp = 0L;
        }
        ...
        public final String toString() {
            ...
            sb.append("][timestamp=");
            return C2479g.m3321b(this.timestamp, "]", sb);
        }
    ...
    public static class V2TXLiveMixStream {
        ...
        public String toString() {
            return "[userId='" + this.userId + "'][streamId='" + this.streamId + "'][x=" + this.f113486x + "][y=" + this.f113487y + "][width=" + this.width + "][height=" + this.height + "][zOrder=" + this.zOrder + "][inputType=" + this.inputType + ']';
        }
        ...
        public V2TXLiveMixStream(V2TXLiveMixStream v2TXLiveMixStream) {
            ...
            this.f113486x = v2TXLiveMixStream.f113486x;
            this.f113487y = v2TXLiveMixStream.f113487y;
    ...
    public static final class V2TXLiveTranscodingConfig {
        ...
        public V2TXLiveTranscodingConfig() {
            ...
            this.audioSampleRate = TXRecordCommon.AUDIO_SAMPLERATE_48000;
        ...
        public final String toString() {
            ...
            sb.append("][mixStreams=");
            sb.append(this.mixStreams);
            sb.append("][outputStreamId='");
            return C2498a.m3383d(sb, this.outputStreamId, "']");
        }
    ...
    public static final class V2TXLiveVideoEncoderParam {
        ...
        public final String toString() {
            StringBuilder sb = new StringBuilder("V2TXLiveVideoEncoderParam{videoResolution=");
            sb.append(this.videoResolution);
            sb.append(", videoResolutionMode=");
            sb.append(this.videoResolutionMode);
            sb.append(", videoFps=");
            sb.append(this.videoFps);
            sb.append(", videoBitrate=");
            sb.append(this.videoBitrate);
            sb.append(", minVideoBitrate=");
            return C2498a.m3382c(sb, this.minVideoBitrate, C24185c.f110587w);
        }
        ...
        public V2TXLiveVideoEncoderParam(V2TXLiveVideoResolution v2TXLiveVideoResolution) {
            ...
            V2TXLiveUtils.C24604a bitrateByResolution = V2TXLiveUtils.getBitrateByResolution(v2TXLiveVideoResolution);
            this.videoBitrate = bitrateByResolution.f113490b;
            this.minVideoBitrate = bitrateByResolution.f113489a;
        }
    }
    ...
    public static final class V2TXLiveStreamInfo {
        ...
        public V2TXLiveStreamInfo(int i10, int i11, int i12, float f10, String str) {
            this.width = i10;
            this.height = i11;
            this.bitrate = i12;
            this.framerate = f10;
