...
public class TXLiveConstants {
    ...
    public static final String NET_STATUS_VIDEO_BLOCK_TIME = "VIDEO_BLOCK_TIME";
    ...
    public static final String NET_STATUS_VIDEO_LARGE_BLOCK_COUNT = "VIDEO_LARGE_BLOCK_COUNT";
    public static final String NET_STATUS_VIDEO_LIGHT_BLOCK_COUNT = "VIDEO_LIGHT_BLOCK_COUNT";
    public static final String NET_STATUS_VIDEO_MEDIUM_BLOCK_COUNT = "VIDEO_MEDIUM_BLOCK_COUNT";
    ...
    public static final int PLAY_EVT_DECODE_FIRST_VIDEO_FRAME = 2035;
    ...
    public static final int PLAY_EVT_RECV_FIRST_VIDEO_FRAME = 2034;
    public static final int PLAY_EVT_RENDER_FIRST_FRAME_ON_VIEW = 2033;
    public static final int PLAY_EVT_RENDER_FIRST_VIDEO_FRAME = 2003;
    ...
    public static final int PLAY_WARNING_VIDEO_TIMESTAMP_ROLLBACK = 2036;
    ...
    public static final int PUSH_EVT_SEND_FIRST_VIDEO_FRAME = 1009;
