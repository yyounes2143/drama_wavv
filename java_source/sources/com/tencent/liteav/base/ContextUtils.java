...
public class ContextUtils {
    ...
    /* loaded from: classes6.dex */
    public static class C24368a {

        /* renamed from: a */
        private static SharedPreferences f112344a = ContextUtils.access$000();
    }
    ...
    public static void initApplicationContextForTests(Context context) {
        initJavaSideApplicationContext(context);
        SharedPreferences unused = C24368a.f112344a = fetchAppSharedPreferences();
    }
