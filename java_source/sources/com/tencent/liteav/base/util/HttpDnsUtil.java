...
public class HttpDnsUtil {
    ...
    private static InterfaceC24413a mCustomHttpDNSCallback = null;
    ...
    /* loaded from: classes2.dex */
    public interface InterfaceC24413a {
        /* renamed from: a */
        void mo46687a(String str, List<String> list);
    }

    /* renamed from: com.tencent.liteav.base.util.HttpDnsUtil$b */
    /* loaded from: classes2.dex */
    public static class C24414b extends SSLSocketFactory {

        /* renamed from: a */
        private HttpsURLConnection f112479a;
        ...
        public C24414b(HttpsURLConnection httpsURLConnection) {
            this.f112479a = httpsURLConnection;
        }
        ...
        public final Socket createSocket(Socket socket, String str, int i10, boolean z10) throws IOException {
            String requestProperty = this.f112479a.getRequestProperty("Host");
            ...
            LiteavLog.m46697i(HttpDnsUtil.TAG, "Setting SNI hostname");
            sSLCertificateSocketFactory.setHostname(sSLSocket, str);
            SSLSession session = sSLSocket.getSession();
            if (HttpsURLConnection.getDefaultHostnameVerifier().verify(str, session)) {
                LiteavLog.m46697i(HttpDnsUtil.TAG, "Established " + session.getProtocol() + " connection with " + session.getPeerHost() + " using " + session.getCipherSuite());
                return sSLSocket;
            }
    ...
    public static void applySniForHttpsConnection(HttpURLConnection httpURLConnection, final String str) {
        if (httpURLConnection instanceof HttpsURLConnection) {
            ...
            httpsURLConnection.setSSLSocketFactory(new C24414b(httpsURLConnection));
            try {
                ...
                LiteavLog.m46693e(TAG, "applySniForHttpsConnection error: " + Log.getStackTraceString(th));
            }
        }
    }
        ...
        if (str != null && !"".equals(str)) {
            if (sValidIPV4Pattern == null) {
                try {
                    ...
                    LiteavLog.m46693e(TAG, "Pattern.compile fail " + Log.getStackTraceString(e3));
                    return false;
                }
            }
            if (sValidIPV4Pattern.matcher(str).matches() || str.contains(VipOffDialog.f45550Q)) {
                return true;
            }
        }
        return false;
    ...
    public static void enableCustomHttpDNS(boolean z10, InterfaceC24413a interfaceC24413a) {
        LiteavLog.m46697i(TAG, "enableCustomHttpDNS: ".concat(String.valueOf(z10)));
        synchronized (mLock) {
            mEnableCustomHttpDNS = z10;
            mCustomHttpDNSCallback = interfaceC24413a;
        }
    }
        ...
        synchronized (mLock) {
            if (mEnableCustomHttpDNS && mCustomHttpDNSCallback != null) {
                ...
                if (property != null && property2 != null) {
                    LiteavLog.m46703w(TAG, "local proxy is on, don't use httpdns. proxyHost=" + property + " ,proxyPort=" + property2);
                    return false;
                }
                return true;
            }
    ...
    public static HttpURLConnection createConnectionUseCustomHttpDNS(String str, String str2) throws Exception {
        ...
        HttpURLConnection httpURLConnection = (HttpURLConnection) ((URLConnection) FirebasePerfUrlConnection.instrument(new URL(convertHttpDNSURL).openConnection()));
        httpURLConnection.setRequestProperty("Host", str2);
        applySniForHttpsConnection(httpURLConnection, str2);
        LiteavLog.m46697i(TAG, "create http conn use httpDns, original url: " + str + " , new url: " + convertHttpDNSURL);
    ...
    public static String parseAddressUseCustomHttpDns(String str) {
        ...
        ArrayList arrayList = new ArrayList();
        synchronized (mLock) {
            mCustomHttpDNSCallback.mo46687a(str, arrayList);
        }
        if (arrayList.size() > 0) {
            String str2 = (String) arrayList.get(0);
            StringBuilder m4671a = C2812d.m4671a("parse host: ", str, " and return ipAddress: ", str2, " ,costTime: ");
            m4671a.append(SystemClock.elapsedRealtime() - elapsedRealtime);
            m4671a.append(" ms");
            LiteavLog.m46697i(TAG, m4671a.toString());
            return str2;
        }
        LiteavLog.m46697i(TAG, "parse host: " + str + " ,return empty ipAddress");
        return "";
    }
}
