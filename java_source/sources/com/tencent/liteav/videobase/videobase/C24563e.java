...
public final class C24563e {

    /* renamed from: a */
    private static final Map<a, Integer> f113229a = new HashMap<a, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.1
        {
    ...
    /* renamed from: b */
    private static final Map<c, Integer> f113230b = new HashMap<c, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.2
        {
    ...
    /* renamed from: c */
    private static final Map<b, Integer> f113231c = new HashMap<b, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.3
        {
    ...
    /* renamed from: d */
    private static final Map<b, Integer> f113232d = new HashMap<b, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.4
        {
            ...
            put(b.EVT_VIDEO_CAPTURE_CAMERA_START_SUCCESS, Integer.valueOf(Sdk.SDKError.Reason.AD_PUBLISHER_MISMATCH_VALUE));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_START_SUCCESS, Integer.valueOf(Sdk.SDKError.Reason.AD_INTERNAL_INTEGRATION_ERROR_VALUE));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_STOP_SUCCESS, Integer.valueOf(Sdk.SDKError.Reason.CONFIG_NOT_FOUND_ERROR_VALUE));
    ...
    /* renamed from: com.tencent.liteav.videobase.videobase.e$b */
    /* loaded from: classes5.dex */
    public enum b {
        EVT_CODE_NONE,
    ...
    /* renamed from: com.tencent.liteav.videobase.videobase.e$c */
    /* loaded from: classes5.dex */
    public enum c {
        ...
        WARNING_VIDEO_DECODE_START_FAILED_OUT_OF_MEMORY(Sdk.SDKError.Reason.AD_EXPIRED_VALUE),
