...
public class HonorConstant {
    ...
    public static final int HNAUDIO_SERVICE_ADVANCEDRECORD = 2;
    public static final int HNAUDIO_SERVICE_EARRETURN = 1;
    public static final int HNAUDIO_SERVICE_HIGHSAMPLERATEPLAY = 3;
    public static final int HNAUDIO_SERVICE_RECORDDENOISE = 4;
