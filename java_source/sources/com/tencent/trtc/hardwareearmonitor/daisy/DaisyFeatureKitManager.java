...
public class DaisyFeatureKitManager {
    ...
    public static boolean isAudioKitSupport(Context context) {
        ...
        if (packageManager != null) {
            try {
                ...
                LiteavLog.m46693e(TAG, "isAudioKitSupport ,NameNotFoundException");
                return false;
            }
        }
        return true;
        ...
        synchronized (BIND_SERVICE_LOCK) {
            try {
                ...
                try {
                    ...
                    LiteavLog.m46695e(TAG, "bindService, SecurityException, %s", e3.getMessage());
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public <T extends DaisyAudioFeaturesKit> T createFeatureKit(int i10, Context context) {
