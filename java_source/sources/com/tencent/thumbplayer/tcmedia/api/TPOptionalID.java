...
public class TPOptionalID {
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_DISABLE_MEDIA_CODEC_DOLBY_VISION_COMPONENT", type = 3, value = 219)
    public static final int OPTION_ID_BEFORE_BOOL_DISABLE_MEDIA_CODEC_DOLBY_VISION_COMPONENT = 220;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_ACCURATE_DURATION", type = 3, value = 131)
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_ACCURATE_DURATION = 144;
    ...
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_DRM_L3 = 510;
    ...
    /* renamed from: OPTION_ID_BEFORE_BOOL_ENABLE_FFMPEG_LIVE_HLS_FIRST_SEGMENT_DISCONTINUITY_FIX */
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTIONAL_ID_BEFORE_BOOL_ENABLE_FFMPEG_LIVE_HLS_FIRST_SEGMENT_DISCONTINUITY_FIX", type = 3, value = 143)
    public static final int f113892x754375c3 = 156;
    ...
    /* renamed from: OPTION_ID_BEFORE_BOOL_ENABLE_HLS_AV_SEPARATE_TIMESTAMP_CALCULATOR_FIX_LOGIC */
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_HLS_AV_SEPARATE_TIMESTAMP_CALCULATOR_FIX_LOGIC", type = 3, value = 136)
    public static final int f113893xfb836cef = 149;

    /* renamed from: OPTION_ID_BEFORE_BOOL_ENABLE_IGNORE_VIDEO_STREAM_IN_COMMON_AUDIO_FORMATS */
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_IGNORE_VIDEO_STREAM_IN_COMMON_AUDIO_FORMATS", type = 3, value = 133)
    public static final int f113894xa7b03e7e = 146;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_DRM_DRM_CLIENT", type = 3, value = 132)
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_NEW_DRM_CLIENT = 145;

    /* renamed from: OPTION_ID_BEFORE_BOOL_ENABLE_ORIGINAL_VIDEO_INFO_CALLBACK_FROM_SURFACE_LISTENER */
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_ORIGINAL_VIDEO_INFO_CALLBACK_FROM_SURFACE_LISTENER", type = 3, value = 130)
    public static final int f113895xc9bdf6cd = 143;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_PREMIUM", type = 3, value = 182)
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_PREMIUM = 182;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_REFACTOR_RENDER", type = 3, value = 444)
    @Deprecated
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_REFACTOR_RENDER = 444;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_RELEASE_MEDIA_CODEC_WHEN_SET_SURFACE", type = 3, value = 211)
    public static final int OPTION_ID_BEFORE_BOOL_RELEASE_MEDIA_CODEC_WHEN_SET_SURFACE = 219;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_ENABLE_MEDIACODEC_OUTPUT_DATA", type = 3, value = 183)
    public static final int OPTION_ID_BEFORE_ENABLE_MEDIACODEC_OUTPUT_DATA = 183;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_INT_AUDIO_AVSYNC_STRATEGY", type = 4, value = 419)
    public static final int OPTION_ID_BEFORE_INT_AUDIO_AVSYNC_STRATEGY = 419;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_AUDIO_BLUETOOTH_MAX_LIMIT_LATENCY_MS", type = 1, value = 418)
    public static final int OPTION_ID_BEFORE_LONG_AUDIO_BLUETOOTH_MAX_LIMIT_LATENCY_MS = 418;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_AUDIO_DECODE_THREAD_PRIORITY", type = 4, value = 218)
    public static final int OPTION_ID_BEFORE_LONG_AUDIO_DECODE_THREAD_PRIORITY = 218;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_AUDIO_RENDER_THREAD_PRIORITY", type = 4, value = 413)
    public static final int OPTION_ID_BEFORE_LONG_AUDIO_RENDER_THREAD_PRIORITY = 413;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_BUFFER_STRATEGY", type = 4, value = 125)
    public static final int OPTION_ID_BEFORE_LONG_BUFFER_STRATEGY = 139;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_DEMUX_THREAD_PRIORITY", type = 4, value = 127)
    public static final int OPTION_ID_BEFORE_LONG_DEMUX_THREAD_PRIORITY = 138;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_PLAYER_SCHEDULING_THREAD_PRIORITY", type = 4, value = 80)
    public static final int OPTION_ID_BEFORE_LONG_PLAYER_SCHEDULING_THREAD_PRIORITY = 80;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_SEEK_AV_PTS_ALIGN_MAX_THRESHOLD_MS", type = 1, value = 129)
    public static final int OPTION_ID_BEFORE_LONG_SEEK_AV_PTS_ALIGN_MAX_THRESHOLD_MS = 142;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_VIDEO_DECODE_THREAD_PRIORITY", type = 4, value = 217)
    public static final int OPTION_ID_BEFORE_LONG_VIDEO_DECODE_THREAD_PRIORITY = 217;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_OBJECT_AUDIO_ATTRIBUTES", type = 8, value = 414)
    public static final int OPTION_ID_BEFORE_OBJECT_AUDIO_ATTRIBUTES = 414;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_OBJECT_BUFFER_CONFIG", type = 8, value = 126)
    public static final int OPTION_ID_BEFORE_OBJECT_JITTER_BUFFER_CONFIG = 140;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_QUEUE_INT_SPECIAL_SEI_TYPES_CALLBACK", type = 5, value = 128)
    public static final int OPTION_ID_BEFORE_QUEUE_INT_SPECIAL_SEI_TYPES_CALLBACK = 141;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_STRING_HLS_OVERLAY_IV", type = 2, value = 181)
    public static final int OPTION_ID_BEFORE_STRING_HLS_OVERLAY_IV = 181;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_STRING_HLS_OVERLAY_KEY", type = 2, value = 180)
    public static final int OPTION_ID_BEFORE_STRING_HLS_OVERLAY_KEY = 180;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_STRING_MP4_OVERLAY_IV", type = 2, value = 185)
    public static final int OPTION_ID_BEFORE_STRING_MP4_OVERLAY_IV = 185;

    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_STRING_MP4_OVERLAY_KEY", type = 2, value = 184)
    public static final int OPTION_ID_BEFORE_STRING_MP4_OVERLAY_KEY = 184;
    public static final int OPTION_ID_GLOBAL_BOOL_ENABLE_MULTI_NETWORK_CARD = 509;
    public static final int OPTION_ID_GLOBAL_BOOL_ENABLE_SUGGESTED_BITRATE_CALLBACK = 508;
