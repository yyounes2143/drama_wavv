...
public interface ITPNativePlayerMessageCallback {
    ...
    void onASyncCallResult(int i10, long j10, int i11, int i12);

    void onDetailInfo(TPDetailInfo tPDetailInfo);

    void onError(int i10, int i11);

    void onInfoLong(int i10, long j10, long j11);

    void onInfoObject(int i10, Object obj, long j10, long j11);
}
