...
public class TPDownloadProxyEnum {
    public static final String CELLULAR_NETWORK_INTERFACE_ID = "cellular_interface_id";
    public static final int CLEAR_CACHE_MODE_ALL_ONLINE_STORAGE = 8;
    public static final int CLEAR_CACHE_MODE_MEMORY_STORAGE = 4;
    public static final int CLEAR_CACHE_MODE_OFFLINE_PROPERY = 2;
    public static final int CLEAR_CACHE_MODE_STORAGE = 1;
    public static final int DLMODE_ALL = Integer.MAX_VALUE;
    ...
    public static final String DLPARAM_ADV_REMAIN_TIME = "dl_param_adv_remain_time";
    public static final String DLPARAM_APP_TESTID = "dl_param_app_testid";
    public static final String DLPARAM_APP_TEST_SWITCH = "dl_param_app_test_switch";
    public static final String DLPARAM_BAND_WIDTH_LEVEL = "dl_param_band_width_level";
    public static final String DLPARAM_BUFFER_SIZE = "dl_param_buffer_size";
    ...
    public static final String DLPARAM_DEVICE_CERTIFICATE_URL = "dl_param_device_certificate_url";
    public static final String DLPARAM_DNS_CACHE_FIRST = "dl_param_dns_cache_first";
    public static final String DLPARAM_EMERGENCY_TIME = "dl_param_emergency_time";
    ...
    public static final String DLPARAM_HTTP_PROXY_HOST = "dl_param_http_proxy_host";
    public static final String DLPARAM_HTTP_PROXY_PORT = "dl_param_http_proxy_port";
    public static final String DLPARAM_IS_OFFLINE = "dl_param_is_offline";
    public static final String DLPARAM_KEY_LICENSE_URL = "dl_param_key_license_url";
    public static final String DLPARAM_MAX_BITRATE = "dl_param_max_bitrate";
    public static final String DLPARAM_MULTI_NETWORK = "dl_param_multi_network";
    ...
    public static final String DLPARAM_PLAYER_TESTID = "dl_param_player_testid";
    ...
    public static final String DLPARAM_PREFERRED_AUDIO_TRACK = "dl_param_preferred_audio_track";
    public static final String DLPARAM_PREFERRED_BITRATE_INDEX = "dl_param_preferred_bitrate_index";
    public static final String DLPARAM_PREFERRED_RESOLUTION = "dl_param_preferred_resolution";
    ...
    public static final String DLPARAM_SAFE_PLAY_TIME = "dl_param_safe_play_time";
    ...
    public static final String DLPARAM_USER_FORMAT = "dl_param_user_format";
    ...
    public static final String DLPARAM_VINFO_SECONDARY_M3U8_LIST = "dl_param_vinfo_secondary_m3u8";
    ...
    public static final int DLTYPE_CLIP_MP4_PREPARE = 202;
    ...
    public static final int DLTYPE_HLS_VOD_PROXYLOAD = 18;
    public static final int DLTYPE_HTTP_FLV_LIVE = 16;
    public static final int DLTYPE_HTTP_PRELOAD_FLV_LIVE = 17;
    ...
    public static final int DL_OFFLINE_SCHEDULE_LEVEL_PREFERRED_RESOLUTION = 4;
    public static final int DL_OFFLINE_SCHEDULE_LEVEL_UNSUPPORTED = 3;
    ...
    public static final int PLAYING_STATE_ON_ADAPTIVE_PLAY = 200;
    public static final int PLAYING_STATE_ON_BLOCKING = 2;
    public static final int PLAYING_STATE_ON_NONADAPTIVE_PLAY = 201;
    ...
    public static final int PLAYING_STATE_SPEED_RATIO_FAST = 302;
    public static final int PLAYING_STATE_SPEED_RATIO_NORMAL = 300;
    public static final int PLAYING_STATE_SPEED_RATIO_SLOW = 301;
    public static final String TAB_ABUSERID = "abuserid";
    public static final String TAB_CALLBACK_ACK = "tab_callback_ack";
    public static final String TAB_OMGID = "omgid";
    public static final String TAB_QIMEI36 = "qimei36";
    public static final String TASKINFO_ADAPTIVE_DYNAMIC_SWITCH = "taskinfo_adaptive_dynamic_switch";
    public static final String TASKINFO_BUFFER_SIZE_BYTE = "taskinfo_buffer_size_byte";
    public static final String TASKINFO_GET_METADATA_BITRATE_KBPS = "taskInfo_get_metadata_bitrate_kbps";
    public static final String TASKINFO_GET_METADATA_PLAY_OFFSET = "taskInfo_get_metadata_play_offset";
    public static final String TASKINFO_MAX_BITRATE = "taskinfo_max_bitrate";
    public static final String TASKINFO_PLAYER_START = "taskInfo_player_start";
    public static final String TASKINFO_PLAY_OFFSET = "taskinfo_play_offset";
    public static final String TASKINFO_SPEED_RATIO = "taskinfo_speed_ratio";
    ...
    public static final String USER_IS_VIP = "qx_is_vip";
    ...
    public static final String USE_MULTI_NETWORK = "use_multi_network";
}
