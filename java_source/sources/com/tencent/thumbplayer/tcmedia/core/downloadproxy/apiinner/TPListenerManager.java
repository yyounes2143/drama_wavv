...
public class TPListenerManager {
    ...
    public synchronized void handleCallbackMessage(final int i10, final int i11, final Object obj, final Object obj2, final Object obj3, final Object obj4, final Object obj5) {
        if (2008 == i10) {
            if (this.mNetwork == null) {
                TPDLProxyLog.m48088e(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, network is null");
                return;
            }
            String byteArrayToString = TPDLProxyUtils.byteArrayToString((byte[]) obj);
            ...
            try {
                ...
                TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, bind begin, sock fd: ".concat(String.valueOf(parseInt)));
                this.mNetwork.bindSocket(fileDescriptor);
                TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, bind socket success, sock fd: ".concat(String.valueOf(parseInt)));
            } catch (Throwable th) {
                TPDownloadProxyNative.getInstance().setUserData(TPDownloadProxyEnum.CELLULAR_NETWORK_INTERFACE_ID, "-1");
                TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, bind socket failed: " + th.toString());
            }
            TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, sock call back end, sock fd: " + parseInt + ", str_sock: " + byteArrayToString);
            return;
        }
                ...
                try {
                    for (Map.Entry entry : map.entrySet()) {
                        ...
                        if (currentPlayOffset != null && currentPlayOffset.length == 2) {
                            TPDownloadProxyNative.getInstance().updateTaskInfo(intValue, TPDownloadProxyEnum.TASKINFO_PLAY_OFFSET, currentPlayOffset[0] + ";" + currentPlayOffset[1]);
                        }
                    ...
                    if (i10 != 2003) {
                        if (i10 != 2009) {
                            if (i10 != 2014) {
                                if (i10 != 2017) {
                                    if (i10 != 3001) {
                                        if (i10 != MSG_NOTIFY_HIT_CACHE) {
                                            if (i10 != 2006) {
                                                if (i10 != 2007) {
                                                    if (i10 != 2020) {
                                                        if (i10 != MSG_MULTI_NETWORK_STATUS) {
                                                            switch (i10) {
                                                                case 5:
                                                        ...
                                                        TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, C3888c.m9774a(i10, "MULTI_NETWORK msg: ", ", info: ", byteArrayToString2));
                                                        return;
                                                    }
                                                    ...
                                                    TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, C3888c.m9774a(i10, "MULTI_NETWORK msg: ", ", info: ", byteArrayToString3));
                                                    return;
                                                }
                            ...
                            TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "MSG_TAB_TESTID: ".concat(String.valueOf(byteArrayToString5)));
                            return;
                        }
    ...
    public void setNetwork(Network network) {
        TPDLProxyLog.m48089i(FILE_NAME, 0, ITPDLProxyLogListener.COMMON_TAG, "cellular_network, set network");
