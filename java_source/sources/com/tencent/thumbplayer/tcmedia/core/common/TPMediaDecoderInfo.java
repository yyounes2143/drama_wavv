...
public final class TPMediaDecoderInfo implements Serializable {
    ...
    private int getMaxBitRate(MediaCodecInfo.AudioCapabilities audioCapabilities) {
        ...
        if (audioCapabilities != null) {
            ...
            range = new Range<>(8000, Integer.valueOf(DEFAULT_MAX_BITRATE));
        }
    ...
    private int getMaxWidth(MediaCodecInfo.VideoCapabilities videoCapabilities) {
        ...
        if (videoCapabilities != null) {
            ...
            range = new Range<>(0, Integer.valueOf(DEFAULT_MAX_WIDTH));
        }
        return range.getUpper().intValue();
    }
    ...
    private boolean isValidCodecForGoogle(String str) {
        if (str.startsWith("c2.google.") && !str.contains("hevc") && !str.contains("secure")) {
            return true;
        }
        return false;
    }
    ...
    private boolean isVideoSoftwareOnly(String str) {
        ...
        if (!lowerCase.startsWith("omx.google.") && !lowerCase.startsWith("omx.ffmpeg.") && ((!lowerCase.startsWith("omx.sec.") || !lowerCase.contains(".sw.")) && !lowerCase.equals("omx.qcom.video.decoder.hevcswvdec") && ((!lowerCase.startsWith("omx.qti.video.decoder") || !lowerCase.contains("sw")) && !lowerCase.startsWith("c2.android.") && !isValidCodecForGoogle(lowerCase)))) {
            return false;
        }
        return true;
    }
    ...
    private void reset() {
        ...
        this.maxHeight = 720;
        this.maxLumaWidth = DEFAULT_MAX_WIDTH;
    ...
    public final DecoderProfileLevel getMaxProfileLevel() {
        ...
        for (DecoderProfileLevel decoderProfileLevel2 : this.profileLevels) {
            int i11 = decoderProfileLevel2.level;
            if (i11 >= i10) {
    ...
    public TPMediaDecoderInfo(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities) {
        ...
        if (str.contains(MimeTypes.BASE_TYPE_AUDIO) && codecCapabilities != null && (audioCapabilities = codecCapabilities.getAudioCapabilities()) != null) {
