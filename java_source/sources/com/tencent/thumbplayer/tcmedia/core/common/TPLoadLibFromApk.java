...
public final class TPLoadLibFromApk {
    ...
    public static String find(String str, Context context) {
        ...
        if (str2 == null) {
            File file = new File(context.getDir("recover_lib", 0), C2899b.m4983a("lib", str, ".so"));
            if (file.canRead()) {
            ...
            try {
                ...
                if (context == null) {
                    try {
                        ...
                        throw ((UnsatisfiedLinkError) new UnsatisfiedLinkError("Failed loading library: ".concat(str)).initCause(e3.getCause()));
                    } catch (Exception e10) {
                        throw ((UnsatisfiedLinkError) new UnsatisfiedLinkError("Failed loading library: ".concat(str)).initCause(e10));
                    }
                }
                File file = new File(context.getDir("recover_lib", 0), C2899b.m4983a("lib", str, ".so"));
    ...
    private static boolean extractLibrary(ZipFile zipFile, String str, List<String> list, File file) {
        ...
        if (!it.hasNext() || (entry = zipFile.getEntry(C4405c.m11827a("lib/", it.next(), "/lib", str, ".so"))) == null) {
            return false;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:7:0x00a2 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
