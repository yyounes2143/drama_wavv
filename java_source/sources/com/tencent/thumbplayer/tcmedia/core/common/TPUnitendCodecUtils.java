...
public class TPUnitendCodecUtils {
    ...
    public static int convertOmxProfileToDolbyVision(int i10) {
        ...
        TPNativeLog.printLog(2, "TPUnitendCodecUtils", C3090a.m5596a(i10, i11, "convertOmxProfileToDolbyVision omxProfile:", " dolbyVisionProfile:"));
        return i11;
    }
    ...
    */
    public static synchronized java.lang.String getDolbyVisionDecoderName(java.lang.String r16, int r17, int r18, boolean r19) {
        ...
        Lae:
            ...
            r2 = 2
            com.tencent.thumbplayer.tcmedia.core.common.TPNativeLog.printLog(r2, r0, r1)     // Catch: java.lang.Throwable -> L4c
            goto Lc2
        Lbd:
            int r8 = r8 + 1
            r5 = 0
