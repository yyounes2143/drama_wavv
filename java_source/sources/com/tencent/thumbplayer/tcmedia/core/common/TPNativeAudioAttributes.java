...
public class TPNativeAudioAttributes {
    ...
    public static class Builder {
        ...
        public Builder addFlags(int i10) {
            this.mFlags = (i10 & TPNativeAudioAttributes.TP_NATIVE_FLAG_PUBLIC) | this.mFlags;
            return this;
        }
        ...
        public Builder setFlags(int i10) {
            this.mFlags = i10 & TPNativeAudioAttributes.TP_NATIVE_FLAG_PUBLIC;
            return this;
        }
        ...
        public Builder setLegacyStreamType(@TPNativeAudioAttributeStreamType int i10) {
            ...
            if (hashMap.containsKey(Integer.valueOf(i10))) {
                this.mContentType = hashMap.get(Integer.valueOf(i10)).intValue();
            } else {
                this.mContentType = 0;
            }
            HashMap<Integer, Integer> hashMap2 = mMapStreamTypeToUsage;
            if (hashMap2.containsKey(Integer.valueOf(i10))) {
                this.mUsage = hashMap2.get(Integer.valueOf(i10)).intValue();
            } else {
                this.mUsage = 0;
            }
            return this;
    ...
    public static String contentTypeToString(@TPNativeAudioAttributeContentType int i10) {
        ...
        return "unknown content type".concat(String.valueOf(i10));
    }
    ...
    public static String usageToString(@TPNativeAudioAttributeUsage int i10) {
        ...
        return "unknown usage ".concat(String.valueOf(i10));
    }
