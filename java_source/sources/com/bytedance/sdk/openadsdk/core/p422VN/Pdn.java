...
public class Pdn extends Yhp {
    ...
    public RDh Kjv(float f10, float f11, float f12, float f13, SparseArray<GNk.Kjv> sparseArray, long j10, long j11, View view, View view2, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.QWA = i17;
        return new RDh.Kjv().enB(f16).m20883kU(f17).m20885mc(f18).GNk(f19).Yhp(j12).Kjv(j13).Yhp(Kjv).Kjv(iArr).GNk(lnG.GNk(view)).m20887mc(iArr2).m20886mc(this.Zat).m20884kU(this.Mba).enB(this.Jdh).Yhp(com.bytedance.sdk.openadsdk.core.Pdn.Yhp().Kjv() ? i14 : 2).Kjv(sparseArray).Kjv(str).Kjv(i11).Kjv(jSONObject).Yhp(jSONObject2).Kjv();
    }

    public Pdn(@NonNull Context context, @NonNull QWA qwa, @NonNull String str, int i10) {
