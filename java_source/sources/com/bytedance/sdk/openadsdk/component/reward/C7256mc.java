...
/* renamed from: com.bytedance.sdk.openadsdk.component.reward.mc */
/* loaded from: classes2.dex */
public class C7256mc {

    @SuppressLint({"StaticFieldLeak"})
    private static volatile C7256mc Kjv;
    private final Kjv.Yhp GNk;
    private final Context Yhp;

    /* renamed from: mc */
    private final Map<QWA, Long> f40359mc = C2993a.m5338b();
    ...
    public void Kjv(String str, QWA qwa) {
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Kjv(str, qwa);
            return;
        }
    ...
    private C7256mc(Context context) {
        ...
        this.GNk = new Kjv.Yhp("sp_full_screen_video");
    }
    ...
    public void Kjv() {
        ...
        File dataDir;
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Yhp();
            return;
        }
        try {
            int i10 = Build.VERSION.SDK_INT;
            boolean fWG = com.bytedance.sdk.openadsdk.core.Pdn.fWG("sp_full_screen_video");
            if (fWG) {
            ...
            if (file.exists() && file.isDirectory() && (listFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.mc.1
        ...
        try {
            ...
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (listFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.mc.2
                @Override // java.io.FileFilter
    ...
    public void Kjv(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.Kjv kjv) {
        ...
        if (kjv == null || kjv.enB() == null || !kjv.enB().Fzk()) {
            if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
                com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Kjv(adSlot, kjv);
                return;
            }
            if (kjv == null || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm()) || (enB = kjv.enB()) == null || enB.pXN() == 2) {
                return;
            }
            try {
                this.GNk.Kjv(adSlot, kjv.m20743Ff().toString(), kjv.Yhp());
            } catch (Throwable unused) {
            }
        }
    }

    public static C7256mc Kjv(Context context) {
        if (Kjv == null) {
            synchronized (C7256mc.class) {
                try {
                    if (Kjv == null) {
                        Kjv = new C7256mc(context);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public String Kjv(QWA qwa) {
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            return com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Kjv(qwa);
        }
    ...
    public String Kjv(String str, String str2, int i10) {
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            return com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Kjv(str, str2, i10);
        }
        if (TextUtils.isEmpty(str)) {
            return null;
        }
    ...
    public com.bytedance.sdk.openadsdk.core.model.Kjv Kjv(String str, boolean z10) {
        ...
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            com.bytedance.sdk.openadsdk.common.Kjv Kjv2 = com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video");
    ...
    public void Kjv(final boolean z10, final QWA qwa, final long j10, String str) {
        Long remove = this.f40359mc.remove(qwa);
        ...
        com.bytedance.sdk.openadsdk.hMq.GNk.Kjv(str2, false, new com.bytedance.sdk.openadsdk.hMq.Yhp() { // from class: com.bytedance.sdk.openadsdk.component.reward.mc.3
    ...
    public void Kjv(final QWA qwa, final Kjv.InterfaceC29065Kjv<Object> interfaceC29065Kjv) {
        ...
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Kjv(qwa, interfaceC29065Kjv);
            return;
        }
        this.f40359mc.put(qwa, Long.valueOf(SystemClock.elapsedRealtime()));
        if (qwa.mo20787Pz() != null && !TextUtils.isEmpty(qwa.mo20787Pz().f5549g)) {
            ...
            m19823mc.Kjv(new com.bytedance.sdk.component.fWG.Kjv.Kjv() { // from class: com.bytedance.sdk.openadsdk.component.reward.mc.4
                ...
                public void Kjv(com.bytedance.sdk.component.fWG.Yhp.GNk gNk, com.bytedance.sdk.component.fWG.Yhp yhp) {
                    if (yhp.enB() && yhp.m19824kU() != null && yhp.m19824kU().exists()) {
                        ...
                        C7256mc.this.Kjv(true, qwa, yhp.Kjv(), yhp.Yhp());
                        return;
                    }
                    ...
                    C7256mc.this.Kjv(false, qwa, yhp.Kjv(), yhp.Yhp());
                }
                ...
                public void Kjv(com.bytedance.sdk.component.fWG.Yhp.GNk gNk, IOException iOException) {
                    ...
                    C7256mc.this.Kjv(false, qwa, -2L, iOException.getMessage());
                }
            });
            return;
        }
    ...
    public void Kjv(String str) {
        if (com.bytedance.sdk.openadsdk.common.Kjv.Kjv()) {
            com.bytedance.sdk.openadsdk.common.Kjv.Kjv("sp_full_screen_video").Yhp(str);
        } else {
            this.GNk.fWG(str);
        }
    }
