...
/* renamed from: com.bytedance.sdk.openadsdk.component.reward.view.kU */
/* loaded from: classes6.dex */
public class C7279kU extends C7473mc {
    private float Kjv;

    public C7279kU(Context context) {
        this(context, null);
    }
    ...
    public C7279kU(Context context, AttributeSet attributeSet) {
