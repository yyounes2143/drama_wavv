...
public class RDh {
    public static void Kjv(String str, int i10, String str2, String str3, String str4) {
        try {
            ...
            if (Kjv != null) {
                if (Kjv.mo20787Pz() != null) {
                    Kjv.mo20787Pz().f5550h = str5;
                }
                if (Kjv.yKm() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        Kjv.yKm().Kjv(str2);
                        Kjv.yKm().Yhp("Test the downloaded app");
                    } else {
                        Kjv.yKm().Kjv((String) null);
                        Kjv.yKm().Yhp("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        Kjv.yKm().GNk(str3);
                    ...
                    if (!TextUtils.isEmpty(str2)) {
                        if (Kjv.mo20765FE() != null) {
                            Kjv.mo20765FE().Kjv(str2);
                        } else {
            ...
            arrayList.add(Kjv);
            kjv.Kjv(arrayList);
            new C7248Yy(bea.Kjv(), kjv).Kjv(true);
        } catch (Exception e3) {
            C6804kZ.Yhp("PlayableVerityHelper", e3.getMessage());
        }
    }
}
