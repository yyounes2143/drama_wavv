...
public class Pdn extends RDh {
    ...
    public Pdn(Context context, AttributeSet attributeSet) {
    ...
    public void Kjv(Context context) {
        ...
        fwg2.setGravity(16);
        fwg2.setPadding(Yhp4, 0, 0, 0);
        fwg.addView(fwg2);
        AXE fWG = fWG(context);
        this.GNk = fWG;
        int i11 = hMq.UdE;
        fWG.setId(i11);
        int Yhp5 = lnG.Yhp(context, 40.0f);
        ...
        this.f39963mc = Yhp6;
        Yhp6.setId(hMq.NXF);
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(lnG.Yhp(context, 130.0f), lnG.Yhp(context, 20.0f));
        layoutParams5.leftMargin = Yhp2;
        layoutParams5.setMarginStart(Yhp2);
        ...
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(lnG.Yhp(context, 80.0f), lnG.Yhp(context, 30.0f));
        layoutParams7.addRule(21);
        layoutParams7.addRule(11);
        layoutParams7.addRule(15);
        layoutParams7.rightMargin = Yhp;
        layoutParams7.setMarginEnd(Yhp);
    ...
    public C7470VN Yhp(Context context) {
        ...
        c7470vn.setGravity(16);
        c7470vn.setMaxWidth(lnG.Yhp(context, 153.0f));
        c7470vn.setSingleLine();
        c7470vn.setText("Pangle");
        c7470vn.setTextColor(-1);
        c7470vn.setTextSize(2, 14.0f);
        return c7470vn;
    }

    public Pdn(Context context, AttributeSet attributeSet, int i10) {
    ...
    public C7470VN GNk(Context context) {
        ...
        GNk.setGravity(16);
        GNk.setMaxWidth(lnG.Yhp(context, 153.0f));
        GNk.setTextColor(-1);
        GNk.setTextSize(2, 13.0f);
        return GNk;
    }
