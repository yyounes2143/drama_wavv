...
public class GNk extends RDh {
    ...
    public void Kjv(Context context) {
        ...
        c7472kU.addView(gNk);
        com.bytedance.sdk.openadsdk.core.p423kU.GNk m20023kU = m20023kU(context);
        this.Kjv = m20023kU;
        ...
        this.GNk.setLayoutParams(new LinearLayout.LayoutParams(Yhp3, Yhp3));
        c7472kU2.addView(this.GNk);
        C7470VN Yhp4 = Yhp(context);
        this.f39963mc = Yhp4;
        Yhp4.setId(hMq.NXF);
        LinearLayout.LayoutParams layoutParams4 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams4.topMargin = lnG.Yhp(context, 4.0f);
        this.f39963mc.setLayoutParams(layoutParams4);
        c7472kU2.addView(this.f39963mc);
        C7470VN GNk = GNk(context);
        this.f39962kU = GNk;
        GNk.setId(hMq.f41214LQ);
        LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams5.topMargin = Yhp;
        layoutParams5.bottomMargin = lnG.Yhp(context, 25.0f);
        this.f39962kU.setLayoutParams(layoutParams5);
        c7472kU2.addView(this.f39962kU);
        C7470VN mo20021mc = mo20021mc(context);
        this.enB = mo20021mc;
        mo20021mc.setId(hMq.VLj);
        LinearLayout.LayoutParams layoutParams6 = new LinearLayout.LayoutParams(-1, lnG.Yhp(context, 32.0f));
        layoutParams6.topMargin = Yhp2;
        this.enB.setLayoutParams(layoutParams6);
        c7472kU2.addView(this.enB);
    }

    public GNk(Context context, AttributeSet attributeSet, int i10) {
