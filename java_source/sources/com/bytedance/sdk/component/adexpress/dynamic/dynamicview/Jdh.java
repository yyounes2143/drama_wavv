...
public class Jdh extends enB implements com.bytedance.sdk.component.adexpress.dynamic.GNk {
    private boolean Kjv;
    ...
    public Jdh(Context context, DynamicRootView dynamicRootView, C6686VN c6686vn) {
        ...
        if (dynamicRootView.getRenderRequest() != null) {
            if (!dynamicRootView.getRenderRequest().TVS()) {
    ...
    public boolean Pdn() {
        ...
        if (view != null) {
            ...
            int Kjv2 = (int) com.bytedance.sdk.component.adexpress.mc.fWG.Kjv(this.hLn, this.f39429SI.Yhp());
            this.hMq.setPadding(Kjv2, Kjv2, Kjv2, Kjv2);
        }
        setVisibility(8);
        return true;
    }
