...
public final class C22170b {

    /* renamed from: a */
    public static final HashMap f99528a;

    /* renamed from: b */
    public static final HashMap f99529b;
    ...
    /* renamed from: a */
    public static String m38099a(int i10) {
        HashMap hashMap = f99528a;
        Integer valueOf = Integer.valueOf(i10);
        if (hashMap.containsKey(valueOf)) {
            HashMap hashMap2 = f99529b;
            if (hashMap2.containsKey(valueOf)) {
                return C2586a.m3681b((String) hashMap.get(valueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/StandardIntegrityErrorCode.html#", (String) hashMap2.get(valueOf), ")");
            }
            return "";
        }
        return "";
