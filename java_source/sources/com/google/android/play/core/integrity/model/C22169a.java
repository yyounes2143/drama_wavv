...
public final class C22169a {

    /* renamed from: a */
    public static final HashMap f99526a;

    /* renamed from: b */
    public static final HashMap f99527b;
    ...
    /* renamed from: a */
    public static String m38098a(int i10) {
        HashMap hashMap = f99526a;
        Integer valueOf = Integer.valueOf(i10);
        if (hashMap.containsKey(valueOf)) {
            HashMap hashMap2 = f99527b;
            if (hashMap2.containsKey(valueOf)) {
                return C2586a.m3681b((String) hashMap.get(valueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/IntegrityErrorCode.html#", (String) hashMap2.get(valueOf), ")");
            }
            return "";
        }
        return "";
