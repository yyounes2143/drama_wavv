...
public class SchemeExpressive extends DynamicScheme {
    ...
    /* renamed from: a */
    public static final double[] f97069a = {0.0d, 21.0d, 51.0d, 121.0d, 151.0d, 191.0d, 271.0d, 321.0d, 360.0d};

    /* renamed from: b */
    public static final double[] f97070b = {45.0d, 95.0d, 45.0d, 20.0d, 45.0d, 90.0d, 45.0d, 45.0d, 45.0d};

    /* renamed from: c */
    public static final double[] f97071c = {120.0d, 120.0d, 20.0d, 45.0d, 20.0d, 15.0d, 20.0d, 120.0d, 120.0d};
    ...
    */
    public SchemeExpressive(com.google.android.material.color.utilities.Hct r12, boolean r13, double r14) {
        /*
            ...
            double[] r0 = com.google.android.material.color.utilities.SchemeExpressive.f97069a
            double[] r1 = com.google.android.material.color.utilities.SchemeExpressive.f97070b
            ...
            double[] r1 = com.google.android.material.color.utilities.SchemeExpressive.f97071c
