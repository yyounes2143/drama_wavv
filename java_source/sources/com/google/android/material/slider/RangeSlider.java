...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public static class RangeSliderState extends AbsSavedState {
        ...
        public RangeSliderState(Parcel parcel) {
            ...
            this.f98495a = parcel.readFloat();
            this.f98496b = parcel.readInt();
        }

        @Override // android.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i10) {
            super.writeToParcel(parcel, i10);
            parcel.writeFloat(this.f98495a);
            parcel.writeInt(this.f98496b);
        }
    }
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.f98493A0 = rangeSliderState.f98495a;
        int i10 = rangeSliderState.f98496b;
        this.f98494B0 = i10;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C21539R.styleable.RangeSlider, i10, BaseSlider.f98405v0, new int[0]);
        if (obtainStyledAttributes.hasValue(C21539R.styleable.RangeSlider_values)) {
            TypedArray obtainTypedArray = obtainStyledAttributes.getResources().obtainTypedArray(obtainStyledAttributes.getResourceId(C21539R.styleable.RangeSlider_values, 0));
        ...
        this.f98493A0 = obtainStyledAttributes.getDimension(C21539R.styleable.RangeSlider_minSeparation, 0.0f);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f98495a = this.f98493A0;
        rangeSliderState.f98496b = this.f98494B0;
