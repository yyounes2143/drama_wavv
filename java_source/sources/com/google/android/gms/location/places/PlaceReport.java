...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", m37227id = 3)
    private final String tag;

    @SafeParcelable.VersionField(m37230id = 1)
    private final int versionCode;

    @SafeParcelable.Field(getter = "getPlaceId", m37227id = 2)
    private final String zza;

    @SafeParcelable.Field(getter = "getSource", m37227id = 4)
    ...
    public PlaceReport(@SafeParcelable.Param(m37228id = 1) int i10, @SafeParcelable.Param(m37228id = 2) String str, @SafeParcelable.Param(m37228id = 3) String str2, @SafeParcelable.Param(m37228id = 4) String str3) {
    ...
    public String toString() {
        ...
        stringHelper.add(C24347s.z.f112201z, this.tag);
