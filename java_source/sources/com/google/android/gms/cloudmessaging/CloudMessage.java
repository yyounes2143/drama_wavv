...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    private static int zzb(@Nullable String str) {
        ...
        if (Objects.equals(str, C10960i.f56685d)) {
            return 2;
        }
        return 0;
    }
    ...
    @Nullable
    public String getTo() {
        return this.zza.getStringExtra(Constants.MessagePayloadKeys.f103651TO);
    }
    ...
    @KeepForSdk
    public CloudMessage(@NonNull @SafeParcelable.Param(m37228id = 1) Intent intent) {
        this.zza = intent;
    }
