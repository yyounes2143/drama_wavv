...
public final class OutOfContextTestingActivity extends Activity {
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        zzdt zzh = zzbb.zza().zzh(this, new zzbou());
        if (zzh == null) {
            finish();
            return;
        }
        setContentView(C21402R.layout.admob_empty_layout);
        LinearLayout linearLayout = (LinearLayout) findViewById(C21402R.id.layout);
