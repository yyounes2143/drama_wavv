...
public final class zzs {
    ...
    public final void zzf(com.google.android.gms.ads.internal.client.zzm zzmVar, VersionInfoParcel versionInfoParcel) {
        ...
        if (bundle != null) {
            ...
            if (((Boolean) zzbdu.zza.zze()).booleanValue()) {
                Bundle zzb = zzad.zzb(this.zza, (String) zzbdu.zzb.zze());
    ...
    public zzs(Context context, String str) {
        ...
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzh("Unable to get package version name for reporting", e3);
