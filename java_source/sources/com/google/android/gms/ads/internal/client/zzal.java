...
public final class zzal extends zzba {
    ...
    public zzal(zzaz zzazVar, Context context, zzr zzrVar, String str, zzboy zzboyVar) {
        this.zza = context;
        this.zzb = zzrVar;
        this.zzc = str;
        this.zzd = zzboyVar;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzco zzcoVar) throws RemoteException {
        return zzcoVar.zzd(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 251410000);
    }
