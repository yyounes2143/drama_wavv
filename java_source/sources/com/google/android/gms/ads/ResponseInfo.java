...
public final class ResponseInfo {
    ...
    public String getMediationAdapterClassName() {
        try {
            ...
            zzo.zzh("Could not forward getMediationAdapterClassName to ResponseInfo.", e3);
            return null;
        }
    }
    ...
    public Bundle getResponseExtras() {
        try {
            ...
            zzo.zzh("Could not forward getResponseExtras to ResponseInfo.", e3);
        }
        return new Bundle();
    }
    ...
    public String getResponseId() {
        try {
            ...
            zzo.zzh("Could not forward getResponseId to ResponseInfo.", e3);
            return null;
        }
    }
    ...
    public final JSONObject zzd() throws JSONException {
        ...
        if (responseId == null) {
            jSONObject.put("Response ID", C24187y.f110593z);
        } else {
            jSONObject.put("Response ID", responseId);
        }
        String mediationAdapterClassName = getMediationAdapterClassName();
        if (mediationAdapterClassName == null) {
            jSONObject.put("Mediation Adapter Class Name", C24187y.f110593z);
        } else {
    ...
    private ResponseInfo(@Nullable zzdx zzdxVar) {
        ...
        if (zzdxVar != null) {
            try {
                ...
                zzo.zzh("Could not forward getAdapterResponseInfo to ResponseInfo.", e3);
            }
        }
