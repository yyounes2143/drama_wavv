    ...
    private final void zaw(int i10) throws ParseException {
        if (!this.zat.isEmpty()) {
            ...
            if (intValue == i10) {
                ...
                throw new ParseException(C3090a.m5596a(i10, intValue, "Expected state ", " but had "));
            }
        }
        throw new ParseException(C3477d.m6716a(i10, "Expected state ", " but had empty stack"));
    }
