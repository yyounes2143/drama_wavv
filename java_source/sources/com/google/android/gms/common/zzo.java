...
public final class zzo {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    zzd2 = zzy.zzd("module call", e3);
                }
            } catch (DynamiteModule.LoadingException e10) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e10);
                zzd2 = zzy.zzd("module init: ".concat(String.valueOf(e10.getMessage())), e10);
            }
    ...
    public static /* synthetic */ String zze(boolean z10, String str, zzj zzjVar) {
        ...
        return str2 + ": pkg=" + str + ", sha256=" + Hex.bytesToStringLowercase(zza2.digest(zzjVar.zzc())) + ", atk=" + z10 + ", ver=12451000.false";
    }
    ...
    private static zzy zzf(final String str, final zzj zzjVar, final boolean z10, boolean z11) {
        try {
            ...
            try {
                ...
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e3);
                return zzy.zzd("module call", e3);
            }
        } catch (DynamiteModule.LoadingException e10) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e10);
            return zzy.zzd("module init: ".concat(String.valueOf(e10.getMessage())), e10);
        }
    }
