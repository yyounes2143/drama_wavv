...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    @Deprecated
    @KeepForSdk
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t3, @NonNull U u10) {
        ...
        Preconditions.checkArgument(Objects.equal(t3.getListenerKey(), u10.getListenerKey()), "Listener registration and unregistration methods must be constructed with the same ListenerHolder.");
        return this.zaa.zao(this, t3, u10, new Runnable() { // from class: com.google.android.gms.common.api.zad
