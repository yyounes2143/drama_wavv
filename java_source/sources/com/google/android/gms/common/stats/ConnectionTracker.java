...
public class ConnectionTracker {
    ...
    private final boolean zzb(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, boolean z10, Executor executor) {
    ...
    public boolean bindService(@NonNull Context context, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i10) {
        return zzb(context, context.getClass().getName(), intent, serviceConnection, i10, true, null);
    }
