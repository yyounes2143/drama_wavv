...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m37227id = 1)
    private final List zab;

    @SafeParcelable.Field(getter = "getIsUrgent", m37227id = 2)
    private final boolean zac;

    @Nullable
    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m37227id = 3)
    private final String zad;

    @Nullable
    @SafeParcelable.Field(getter = "getCallingPackage", m37227id = 4)
    ...
    public ApiFeatureRequest(@NonNull @SafeParcelable.Param(m37228id = 1) List list, @SafeParcelable.Param(m37228id = 2) boolean z10, @Nullable @SafeParcelable.Param(m37228id = 3) String str, @Nullable @SafeParcelable.Param(m37228id = 4) String str2) {
