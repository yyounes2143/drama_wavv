...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C21411R.styleable.SignInButton, 0, 0);
        try {
            this.zaa = obtainStyledAttributes.getInt(C21411R.styleable.SignInButton_buttonSize, 0);
            this.zab = obtainStyledAttributes.getInt(C21411R.styleable.SignInButton_colorScheme, 2);
