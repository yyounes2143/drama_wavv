...
public class SafeParcelReader {
        ...
        */
        public ParseException(@androidx.annotation.NonNull java.lang.String r5, @androidx.annotation.NonNull android.os.Parcel r6) {
            /*
                ...
                androidx.constraintlayout.core.state.C3840a.m9265a(r0, r5, r1, r3, r2)
                r2.append(r6)
    ...
    private static void zzb(Parcel parcel, int i10, int i11, int i12) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(hexString).length() + length + 19 + String.valueOf(i11).length() + 4 + 1);
        C2768b.m4438d(i12, i11, "Expected size ", " got ", sb);
        throw new ParseException(C2816h.m4679a(" (0x", hexString, ")", sb), parcel);
    }
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i10) {
        if (parcel.dataPosition() == i10) {
            ...
            throw new ParseException(C0199u.m173b(i10, "Overread allowed size end=", new StringBuilder(String.valueOf(i10).length() + 26)), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(dataPosition).length() + 32 + String.valueOf(i10).length());
    ...
    private static void zza(Parcel parcel, int i10, int i11) {
        ...
        C2768b.m4438d(i11, readSize, "Expected size ", " got ", sb);
        throw new ParseException(C2816h.m4679a(" (0x", hexString, ")", sb), parcel);
    }
}
