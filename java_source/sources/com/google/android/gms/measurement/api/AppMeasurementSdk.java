...
public class AppMeasurementSdk {
    ...
    @KeepForSdk
    public void clearConditionalUserProperty(@NonNull @Size String str, @Nullable String str2, @Nullable Bundle bundle) {
    ...
    @KeepForSdk
    @WorkerThread
    public Map<String, Object> getUserProperties(@Nullable String str, @Nullable @Size String str2, boolean z10) {
    ...
    @KeepForSdk
    public void logEventNoInterceptor(@NonNull String str, @NonNull String str2, @Nullable Bundle bundle, long j10) {
