...
public interface zzgb extends IInterface {
    ...
    @Nullable
    List zzj(zzr zzrVar, boolean z10) throws RemoteException;

    @Nullable
    byte[] zzk(zzbg zzbgVar, String str) throws RemoteException;

    void zzl(long j10, @Nullable String str, @Nullable String str2, String str3) throws RemoteException;
    ...
    List zzp(@Nullable String str, @Nullable String str2, boolean z10, zzr zzrVar) throws RemoteException;

    List zzq(String str, @Nullable String str2, @Nullable String str3, boolean z10) throws RemoteException;
