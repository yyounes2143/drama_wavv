...
public final class zzmo implements Runnable {
    ...
    public final void run() {
        ...
        if (zzZ == null) {
            C21415b.m37226b(zznlVar.zzu, "Failed to send default event parameters to service");
            return;
        }
        zzbe zzbeVar = null;
        ...
        try {
            ...
            this.zze.zzu.zzaV().zzb().zzb("Failed to send default event parameters to service", e3);
        }
    }
}
