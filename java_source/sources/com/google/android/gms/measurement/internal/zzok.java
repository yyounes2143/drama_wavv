...
public final class zzok extends zzos {
    ...
    public final void zzc(long j10) {
        ...
        zzd();
        zzicVar.zzaV().zzk().zzb("Scheduling upload, millis", Long.valueOf(j10));
        long elapsedRealtime = zzicVar.zzaZ().elapsedRealtime() + j10;
        zzicVar.zzc();
        if (j10 < Math.max(0L, ((Long) zzfy.zzL.zzb(null)).longValue()) && !zzf().zzc()) {
            zzf().zzb(j10);
        }
        zzicVar.zzaU();
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            persistableBundle.putString(FileUploadManager.f107329j, "com.google.android.gms.measurement.UPLOAD");
        ...
        if (alarmManager != null) {
            zzicVar.zzc();
            alarmManager.setInexactRepeating(2, elapsedRealtime, Math.max(((Long) zzfy.zzG.zzb(null)).longValue(), j10), zzj());
        }
    }
