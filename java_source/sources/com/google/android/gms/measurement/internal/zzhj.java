    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        if (iBinder != null) {
            try {
                ...
                this.zza.zza.zzaV().zze().zzb("Exception occurred while calling Install Referrer API", e3);
                return;
            }
        }
        C21530a.m37362a(this.zza.zza, "Install Referrer connection returned with null binder");
    }
