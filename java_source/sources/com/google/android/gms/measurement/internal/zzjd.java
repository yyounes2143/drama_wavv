...
public final class zzjd extends zzga {
    ...
    public final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        if (bundle.isEmpty() && zzp) {
            ...
            try {
                ...
                zzj.zzu.zzaV().zzb().zzb("Error clearing default event params", e3);
                return;
            }
        }
        ...
        try {
            ...
            zzj2.zzu.zzaV().zzb().zzc("Error storing default event parameters. appId", zzgu.zzl(str), e10);
        }
        zzpg zzpgVar2 = this.zza;
        zzav zzj3 = zzpgVar2.zzj();
        long j10 = zzrVar.zzD;
        if (zzj3.zzV(str, j10)) {
            zzpgVar2.zzj().zzW(str, Long.valueOf(j10), null, bundle);
        }
    }
    ...
    public final List zzr(String str, String str2, zzr zzrVar) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzb("Failed to get conditional user properties", e3);
            return Collections.emptyList();
        }
    }
    ...
    public final List zzs(String str, String str2, String str3) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzb("Failed to get conditional user properties as", e3);
            return Collections.emptyList();
        }
    }
    ...
    public final zzao zzw(zzr zzrVar) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get consent. appId", zzgu.zzl(zzrVar.zza), e3);
    ...
    public final List zzx(zzr zzrVar, Bundle bundle) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgu.zzl(zzrVar.zza), e10);
            return Collections.emptyList();
        }
    }
    ...
    public final /* synthetic */ void zzH(zzr zzrVar, Bundle bundle, zzge zzgeVar, String str) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to return trigger URIs for app", str, e3);
        }
    }
    ...
    public final /* synthetic */ void zzI(String str, zzoo zzooVar, zzgh zzghVar) {
            ...
            if (!zzpgVar.zzO(str, zzpjVar.zze())) {
                ...
                try {
                    ...
                    for (int i10 = 0; i10 < zzhzVar.zzb(); i10++) {
                        com.google.android.gms.internal.measurement.zzic zzicVar = (com.google.android.gms.internal.measurement.zzic) zzhzVar.zzc(i10).zzcl();
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("[sgtm] Failed to return upload batches for app", str, e3);
        }
    }
