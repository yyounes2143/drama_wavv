...
public final class zzau extends com.google.android.gms.internal.measurement.zzby {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        zzavVar.zzu.zzc();
        if (zzavVar.zzas().zzc(C8150b.f42944j)) {
            try {
                ...
                try {
                    ...
                    this.zza.zzu.zzaV().zzb().zzb("Failed to open freshly created database", e3);
                    throw e3;
                }
            }
        }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        zzaw.zza(zzicVar.zzaV(), sQLiteDatabase, "events", "CREATE TABLE IF NOT EXISTS events ( app_id TEXT NOT NULL, name TEXT NOT NULL, lifetime_count INTEGER NOT NULL, current_bundle_count INTEGER NOT NULL, last_fire_timestamp INTEGER NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,lifetime_count,current_bundle_count,last_fire_timestamp", strArr);
