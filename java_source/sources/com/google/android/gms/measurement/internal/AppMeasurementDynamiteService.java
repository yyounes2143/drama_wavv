...
public class AppMeasurementDynamiteService extends com.google.android.gms.internal.measurement.zzcq {
    ...
    public void initialize(IObjectWrapper iObjectWrapper, com.google.android.gms.internal.measurement.zzdd zzddVar, long j10) throws RemoteException {
        ...
        if (zzicVar == null) {
            this.zza = zzic.zzy((Context) Preconditions.checkNotNull((Context) ObjectWrapper.unwrap(iObjectWrapper)), zzddVar, Long.valueOf(j10));
        } else {
            C21530a.m37362a(zzicVar, "Attempting to initialize multiple times");
        }
    }
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, com.google.android.gms.internal.measurement.zzcu zzcuVar, long j10) throws RemoteException {
        ...
        bundle2.putString("_o", C15171i.f76887e);
        this.zza.zzaW().zzj(new zzj(this, zzcuVar, new zzbg(str2, new zzbe(bundle), C15171i.f76887e, j10), str));
    }
    ...
    public void onActivitySaveInstanceStateByScionActivityInfo(com.google.android.gms.internal.measurement.zzdf zzdfVar, com.google.android.gms.internal.measurement.zzcu zzcuVar, long j10) throws RemoteException {
        ...
        try {
            ...
            this.zza.zzaV().zze().zzb("Error returning bundle value to wrapper", e3);
        }
    }
        ...
        this.zza.zzj().zzt(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzo
            ...
            public final /* synthetic */ void run() {
                try {
                    ...
                    ((zzic) Preconditions.checkNotNull(AppMeasurementDynamiteService.this.zza)).zzaV().zze().zzb("Failed to call IDynamiteUploadBatchesCallback", e3);
                }
            }
        });
    }
    ...
    public void setConditionalUserProperty(@NonNull Bundle bundle, long j10) throws RemoteException {
        zzb();
        if (bundle == null) {
            C21415b.m37226b(this.zza, "Conditional user property must not be null");
        } else {
    ...
    public void setDataCollectionEnabled(boolean z10) throws RemoteException {
        ...
        zzlj zzj = this.zza.zzj();
        zzj.zzb();
        zzj.zzu.zzaW().zzj(new zzjy(zzj, z10));
    }
    ...
    public void setSessionTimeoutDuration(long j10) throws RemoteException {
        zzb();
        zzlj zzj = this.zza.zzj();
        zzj.zzu.zzaW().zzj(new zzka(zzj, j10));
    }
    ...
    public void setUserId(@NonNull final String str, long j10) throws RemoteException {
        ...
        if (str != null && TextUtils.isEmpty(str)) {
            C21530a.m37362a(zzj.zzu, "User ID must be non-empty or null");
        } else {
            ...
            zzj.zzL(null, C24161z.f110505w, str, true, j10);
        }
    }
