    ...
    public final /* synthetic */ void zzJ(String str, int i10, Throwable th, byte[] bArr, Map map) {
        ...
        if (i10 != 200 && i10 != 204) {
            ...
            if (i10 != 304) {
                ...
                zzP(zzguVar);
                zzguVar.zze().zzc("Network Request for Deferred Deep Link failed. response, exception", Integer.valueOf(i11), th);
            }
        } else {
            i11 = i10;
        }
        if (th == null) {
            ...
            if (bArr != null && bArr.length != 0) {
                try {
                    ...
                    double optDouble = jSONObject.optDouble(StatsEvent.f109035A, 0.0d);
                    ...
                    if (!TextUtils.isEmpty(optString)) {
                        ...
                        if (queryIntentActivities != null && !queryIntentActivities.isEmpty()) {
                            ...
                            this.zzo.zzF(AdFreeInfo.f75238h, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, bundle2);
                            zzN(zzppVar);
                            if (!TextUtils.isEmpty(optString)) {
                                try {
                                    SharedPreferences.Editor edit = context.getSharedPreferences("google.analytics.deferred.deeplink.prefs", 0).edit();
                                    edit.putString("deeplink", optString);
                                    edit.putLong(StatsEvent.f109035A, Double.doubleToRawLongBits(optDouble));
                                    if (edit.commit()) {
                                    ...
                                    zzP(zzguVar3);
                                    zzguVar3.zzb().zzb("Failed to persist Deferred Deep Link. exception", e3);
                                    return;
                                }
                            }
                            return;
                    ...
                    zzP(zzguVar5);
                    zzguVar5.zzb().zzb("Failed to parse the Deferred Deep Link response. exception", e10);
                    return;
                }
            }
        ...
        zzP(zzguVar7);
        zzguVar7.zze().zzc("Network Request for Deferred Deep Link failed. response, exception", Integer.valueOf(i11), th);
    }
