...
public final class zznl extends zzg {
    ...
    public final /* synthetic */ void zzS(AtomicReference atomicReference, zzr zzrVar, Bundle bundle) {
        ...
        synchronized (atomicReference) {
            try {
                ...
                this.zzu.zzaV().zzb().zzb("Failed to request trigger URIs; remote exception", e3);
    ...
    public final /* synthetic */ void zzT(AtomicReference atomicReference, zzr zzrVar, zzoo zzooVar) {
        ...
        synchronized (atomicReference) {
            try {
                ...
                this.zzu.zzaV().zzb().zzb("[sgtm] Failed to get upload batches; remote exception", e3);
                atomicReference.notifyAll();
            }
            if (zzgbVar == null) {
    ...
    private final zzr zzah(boolean z10) {
        ...
        if (z10) {
            ...
            if (zzicVar2.zzd().zzb != null && (zzb = zzicVar2.zzd().zzb.zzb()) != null && zzb != zzhh.zza) {
                ...
                str = C2816h.m4679a(valueOf, VipOffDialog.f45550Q, str2, new StringBuilder(valueOf.length() + 1 + String.valueOf(str2).length()));
            }
        }
        return zzv.zzh(str);
    }
    ...
    public final /* synthetic */ void zzQ() {
        ...
        if (zzgbVar == null) {
            C21415b.m37226b(this.zzu, "Failed to send storage consent settings to service");
            return;
        }
        try {
            zzr zzah = zzah(false);
            ...
            this.zzu.zzaV().zzb().zzb("Failed to send storage consent settings to the service", e3);
        }
    }
    ...
    public final /* synthetic */ void zzR() {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            C21415b.m37226b(this.zzu, "Failed to send Dma consent settings to service");
            return;
        }
        try {
            zzr zzah = zzah(false);
            ...
            this.zzu.zzaV().zzb().zzb("Failed to send Dma consent settings to the service", e3);
        }
    }
    ...
    public final /* synthetic */ void zzU(zzr zzrVar, zzaf zzafVar) {
        zzgb zzgbVar = this.zzb;
        if (zzgbVar == null) {
            C21415b.m37226b(this.zzu, "[sgtm] Discarding data. Failed to update batch upload status.");
            return;
        }
        try {
            ...
            this.zzu.zzaV().zzb().zzc("[sgtm] Failed to update batch upload status, rowId, exception", Long.valueOf(zzafVar.zza), e3);
        }
    }
    ...
    */
    ...
    private final void zzaf(Runnable runnable) throws IllegalStateException {
        ...
        zzicVar.zzc();
        if (size >= 1000) {
            C21415b.m37226b(zzicVar, "Discarding data. Max runnable queue size reached");
            return;
        }
        list.add(runnable);
        this.zzh.zzb(60000L);
    ...
    public final void zzX() {
        ...
        while (it.hasNext()) {
            try {
                ...
                this.zzu.zzaV().zzb().zzb("Task exception while flushing queue", e3);
            }
        }
        this.zzg.clear();
        this.zzh.zzd();
        ...
        if (!zzh()) {
            if (!zzK()) {
                ...
                if (!zzicVar.zzc().zzE()) {
                    ...
                    C21415b.m37226b(zzicVar, "Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
                    return;
                }
                return;
            }
    ...
    */
    ...
    public final zzao zzz() {
        ...
        try {
            ...
            this.zzu.zzaV().zzb().zzb("Failed to get consents; remote exception", e3);
            return null;
        }
    }
}
