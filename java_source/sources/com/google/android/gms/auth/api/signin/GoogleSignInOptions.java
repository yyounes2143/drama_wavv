...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", m37227id = 2)
    private final ArrayList zah;

    @Nullable
    @SafeParcelable.Field(getter = "getAccount", m37227id = 3)
    private Account zai;

    @SafeParcelable.Field(getter = "isIdTokenRequested", m37227id = 4)
    private boolean zaj;

    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", m37227id = 5)
    private final boolean zak;

    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", m37227id = 6)
    private final boolean zal;

    @Nullable
    @SafeParcelable.Field(getter = "getServerClientId", m37227id = 7)
    private String zam;

    @Nullable
    @SafeParcelable.Field(getter = "getHostedDomain", m37227id = 8)
    private String zan;

    @SafeParcelable.Field(getter = "getExtensions", m37227id = 9)
    private ArrayList zao;

    @Nullable
    @SafeParcelable.Field(getter = "getLogSessionId", m37227id = 10)
    private String zap;
    private Map zaq;
    ...
    */
    ...
    public GoogleSignInOptions(@SafeParcelable.Param(m37228id = 1) int i10, @SafeParcelable.Param(m37228id = 2) ArrayList arrayList, @Nullable @SafeParcelable.Param(m37228id = 3) Account account, @SafeParcelable.Param(m37228id = 4) boolean z10, @SafeParcelable.Param(m37228id = 5) boolean z11, @SafeParcelable.Param(m37228id = 6) boolean z12, @Nullable @SafeParcelable.Param(m37228id = 7) String str, @Nullable @SafeParcelable.Param(m37228id = 8) String str2, @SafeParcelable.Param(m37228id = 9) ArrayList arrayList2, @Nullable @SafeParcelable.Param(m37228id = 10) String str3) {
