...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", m37227id = 3)
    private Bundle zac;

    @SafeParcelable.Constructor
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(m37228id = 1) int i10, @SafeParcelable.Param(m37228id = 2) int i11, @SafeParcelable.Param(m37228id = 3) Bundle bundle) {
        this.zaa = i10;
        this.zab = i11;
        this.zac = bundle;
    }
