...
public final class SignInConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getConsumerPkgName", m37227id = 2)
    private final String zba;

    @SafeParcelable.Field(getter = "getGoogleConfig", m37227id = 5)
    ...
    public SignInConfiguration(@NonNull @SafeParcelable.Param(m37228id = 2) String str, @NonNull @SafeParcelable.Param(m37228id = 5) GoogleSignInOptions googleSignInOptions) {
