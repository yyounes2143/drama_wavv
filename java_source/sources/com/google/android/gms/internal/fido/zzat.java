...
public abstract class zzat extends zzaq implements List, RandomAccess {
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (zzal.zza(get(i10), list.get(i10))) {
                        }
                    }
                    return true;
                }
    ...
    public static zzat zzg(Object[] objArr, int i10) {
        if (i10 == 0) {
            return zzaw.zza;
        }
        return new zzaw(objArr, i10);
    }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzat subList(int i10, int i11) {
        zzam.zze(i10, i11, size());
        int i12 = i11 - i10;
        if (i12 == size()) {
            return this;
        }
        ...
        return new zzas(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzba listIterator(int i10) {
        zzam.zzb(i10, size(), FirebaseAnalytics.Param.INDEX);
        if (isEmpty()) {
            return zza;
        }
