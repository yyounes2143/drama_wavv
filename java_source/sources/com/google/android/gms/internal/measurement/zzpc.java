...
public final class zzpc implements Supplier {
    private static final zzpc zza = new zzpc();
    private final Supplier zzb = Suppliers.ofInstance(new zzpe());
    ...
    public static long zzai() {
        return zza.get().zzai();
    }

    public static long zzaj() {
        return zza.get().zzaj();
    }

    public static long zzak() {
        return zza.get().zzak();
    }

    public static long zzal() {
        return zza.get().zzal();
    }

    public static long zzam() {
        return zza.get().zzam();
    }

    public static long zzan() {
        return zza.get().zzan();
    }

    public static long zzao() {
        return zza.get().zzao();
    }
