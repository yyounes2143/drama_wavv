...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzb = zzb2.zzc("measurement.app_uninstalled_additional_ad_id_cache_time", C8150b.f42944j);
        ...
        zzj = zzb2.zzc("measurement.session.engagement_interval", C8150b.f42944j);
        ...
        zzb2.zzc("measurement.config.cache_time.service", C8150b.f42944j);
        ...
        zzQ = zzb2.zzc("measurement.sgtm.upload.min_delay_after_background", TTAdConstant.AD_MAX_EVENT_TIME);
        ...
        zzT = zzb2.zzc("measurement.sgtm.upload.retry_interval", TTAdConstant.AD_MAX_EVENT_TIME);
        ...
        zzag = zzb2.zzc("measurement.upload.initial_upload_delay_time", Font.Companion.MaximumAsyncTimeoutMillis);
        zzah = zzb2.zzc("measurement.upload.interval", C8150b.f42944j);
        ...
        zzav = zzb2.zzc("measurement.upload.window_interval", C8150b.f42944j);
