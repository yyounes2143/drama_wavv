    ...
    public static int zzj(zzlv zzlvVar, Object obj) {
        ...
        if (zzlvVar.zzd()) {
            ...
            if (zzlvVar.zze()) {
                ...
                return zzlm.zzz(i11) + zzlm.zzz(zza << 3) + i11;
            }
            int i12 = 0;
            while (i10 < size) {
    ...
    private static final int zzm(Map.Entry entry) {
        ...
        if (zzlvVar.zzc() == zzou.MESSAGE && !zzlvVar.zzd() && !zzlvVar.zze()) {
            if (value instanceof zzmv) {
                ...
                int zzz2 = zzlm.zzz(8);
                i10 = zzz2 + zzz2;
                zzz = zzlm.zzz(zza) + zzlm.zzz(16);
                int zzz3 = zzlm.zzz(24);
                int zzb = ((zzmv) value).zzb();
                zzC = C5464H3.m14531b(zzb, zzb, zzz3);
            } else {
                int zza2 = ((zzlv) entry.getKey()).zza();
                int zzz4 = zzlm.zzz(8);
                i10 = zzz4 + zzz4;
                zzz = zzlm.zzz(zza2) + zzlm.zzz(16);
                zzC = zzlm.zzC((zznm) value) + zzlm.zzz(24);
            }
            return i10 + zzz + zzC;
        }
