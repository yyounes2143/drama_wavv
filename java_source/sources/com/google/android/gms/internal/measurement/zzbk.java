...
public enum zzbk {
    ...
    private static final Map zzap = new HashMap();
    private final int zzao;

    static {
        for (zzbk zzbkVar : values()) {
            zzap.put(Integer.valueOf(zzbkVar.zzao), zzbkVar);
        }
    }

    public static zzbk zza(int i10) {
        return (zzbk) zzap.get(Integer.valueOf(i10));
    }
