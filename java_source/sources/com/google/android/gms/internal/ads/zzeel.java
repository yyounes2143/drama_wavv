...
public final class zzeel implements zzecl {
    ...
    public final /* bridge */ /* synthetic */ Object zza(zzfbg zzfbgVar, zzfau zzfauVar, zzeci zzeciVar) throws zzfbw, zzefy {
        ...
        zzdeb zzd = this.zzb.zzd(new zzcqw(zzfbgVar, zzfauVar, zzeciVar.zza), new zzdee(zzeefVar, null));
        zzeefVar.zzc(zzd.zzc());
        ((zzedw) zzeciVar.zzc).zzc(zzd.zzj());
        return zzd.zzg();
    }
    ...
    public final void zzb(zzfbg zzfbgVar, zzfau zzfauVar, zzeci zzeciVar) throws zzfbw {
        try {
            ...
            com.google.android.gms.ads.internal.util.zze.zzb("Remote exception loading a interstitial RTB ad", e3);
            throw new zzfbw(e3);
        }
    }
