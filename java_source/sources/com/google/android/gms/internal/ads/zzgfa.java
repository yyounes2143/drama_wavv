...
public final class zzgfa {
    ...
    public /* synthetic */ zzgfa(zzgfd zzgfdVar) {
    }

    public final zzgfa zza(int i10) throws GeneralSecurityException {
    ...
    public final zzgfa zzc(int i10) throws GeneralSecurityException {
        if (i10 >= 16) {
    ...
    public final zzgfa zzd(int i10) throws GeneralSecurityException {
        if (i10 >= 12 && i10 <= 16) {
    ...
    public final zzgfa zze(int i10) throws GeneralSecurityException {
        if (i10 >= 10) {
