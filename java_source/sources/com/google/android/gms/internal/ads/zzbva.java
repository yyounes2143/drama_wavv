...
public final class zzbva {
    ...
    private static boolean zzm(String str) {
        ...
        if (!str.equals("1") && !str.equals(InneractiveMediationDefs.SHOW_HOUSE_AD_YES)) {
            return false;
        }
        return true;
    }
    ...
    public zzbva(JSONObject jSONObject) {
        ...
        this.zze = zzm(jSONObject.optString("cookies_include", InneractiveMediationDefs.SHOW_HOUSE_AD_YES));
