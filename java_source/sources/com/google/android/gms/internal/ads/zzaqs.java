...
public abstract class zzaqs implements zzaqt {
    ...
    public final zzaqw zzb(zzhek zzhekVar, zzaqx zzaqxVar) throws IOException {
        ...
        long j10;
        String str;
        long zzb2 = zzhekVar.zzb();
        ThreadLocal threadLocal = this.zza;
        ((ByteBuffer) threadLocal.get()).rewind().limit(8);
        do {
            zza = zzhekVar.zza((ByteBuffer) threadLocal.get());
            if (zza == 8) {
                ((ByteBuffer) threadLocal.get()).rewind();
                long zze = zzaqv.zze((ByteBuffer) threadLocal.get());
                byte[] bArr = null;
                if (zze < 8 && zze > 1) {
                    Logger logger = zzb;
                ...
                try {
                    ...
                    if (zze == 1) {
                        ...
                        j10 = zzaqv.zzf((ByteBuffer) threadLocal2.get()) - 16;
                    } else if (zze == 0) {
                        j10 = zzhekVar.zzc() - zzhekVar.zzb();
                    } else {
                        j10 = zze - 8;
                    }
                    if ("uuid".equals(str2)) {
                    ...
                    long j11 = j10;
                    if (zzaqxVar instanceof zzaqw) {
                        str = ((zzaqw) zzaqxVar).zza();
                    } else {
                        str = "";
                    }
                    zzaqw zza2 = zza(str2, bArr, str);
                    ThreadLocal threadLocal4 = this.zza;
                    ((ByteBuffer) threadLocal4.get()).rewind();
                    zza2.zzb(zzhekVar, (ByteBuffer) threadLocal4.get(), j11, this);
                    return zza2;
