...
public final class zzej {
    ...
    public final int zzd(int i10) {
        ...
        byte[] bArr2 = this.zza;
        int i15 = this.zzb;
        int i16 = i12 | ((bArr2[i15] & UnsignedBytes.MAX_VALUE) >> (8 - i11));
        int i17 = 32 - i10;
        if (i11 == 8) {
            this.zzc = 0;
            this.zzb = i15 + 1;
    ...
    public final void zzh(byte[] bArr, int i10, int i11) {
        ...
        while (true) {
            ...
            bArr[i13] = b11;
            bArr[i13] = (byte) (((bArr2[i15] & UnsignedBytes.MAX_VALUE) >> (8 - i16)) | b11);
            i13++;
        }
        int i17 = i11 & 7;
        if (i17 == 0) {
        ...
        if (i18 + i17 > 8) {
            ...
            int i19 = this.zzb;
            this.zzb = i19 + 1;
            b12 = (byte) (b12 | ((bArr3[i19] & UnsignedBytes.MAX_VALUE) << i18));
            bArr[i12] = b12;
            i18 -= 8;
        }
        int i20 = i18 + i17;
