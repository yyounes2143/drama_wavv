...
public final class zzar {
    ...
    public final zzar zza(byte[] bArr, int i10) {
        if (this.zzf == null || i10 == 3 || !Objects.equals(this.zzg, 3)) {
    ...
    public final zzar zzb(@Nullable zzat zzatVar) {
        if (zzatVar != null) {
            ...
            zzfww zzfwwVar = zzatVar.zzB;
            if (!zzfwwVar.isEmpty()) {
                this.zzz = zzfww.zzl(zzfwwVar);
            }
        }
        return this;
    }
    ...
    public final zzar zzk(@IntRange @Nullable Integer num) {
        this.zzn = num;
        return this;
    }

    public final zzar zzl(@IntRange @Nullable Integer num) {
        this.zzm = num;
        return this;
    }
    ...
    public final zzar zzn(@IntRange @Nullable Integer num) {
        this.zzq = num;
        return this;
    }

    public final zzar zzo(@IntRange @Nullable Integer num) {
        this.zzp = num;
        return this;
    }
