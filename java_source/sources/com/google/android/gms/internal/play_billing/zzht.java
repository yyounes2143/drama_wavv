...
public class zzht extends AbstractMap {
    ...
    public final boolean equals(Object obj) {
        ...
        if (i10 == zzhtVar.zzb) {
            for (int i11 = 0; i11 < i10; i11++) {
                if (!zzg(i11).equals(zzhtVar.zzg(i11))) {
                    return false;
                }
            }
            if (i10 == size) {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i12 = 0;
        if (i11 >= 0) {
            int compareTo = comparable.compareTo(((zzhp) this.zza[i11]).zza());
            if (compareTo > 0) {
                return -(i10 + 1);
            }
            if (compareTo == 0) {
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int compareTo2 = comparable.compareTo(((zzhp) this.zza[i13]).zza());
            if (compareTo2 < 0) {
                i11 = i13 - 1;
    ...
    public final Object zzm(int i10) {
        zzo();
        Object value = ((zzhp) this.zza[i10]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i11] = new zzhp(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i10] = new zzhp(this, comparable, obj);
        this.zzb++;
        return null;
    }
