...
final class zzfe extends zzeh implements RandomAccess, zzfz {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfeVar.zzc) {
            return false;
        }
        double[] dArr = zzfeVar.zzb;
    ...
    private zzfe(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzfz zzd(int i10) {
        ...
        if (i10 >= this.zzc) {
            ...
            return new zzfe(copyOf, this.zzc, true);
        }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i11 >= i10) {
            ...
            System.arraycopy(zzfeVar.zzb, 0, this.zzb, this.zzc, zzfeVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
