...
public class RegisterResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getRegisterData", m37227id = 2)
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getClientDataString", m37227id = 4)
    ...
    public RegisterResponseData(@SafeParcelable.Param(m37228id = 2) byte[] bArr, @SafeParcelable.Param(m37228id = 3) String str, @Nullable @SafeParcelable.Param(m37228id = 4) String str2) {
        this.zza = bArr;
        try {
