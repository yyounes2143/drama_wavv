...
public class SignRequestParams extends RequestParams {
    ...
    @SafeParcelable.Field(getter = "getDefaultSignChallenge", m37227id = 5)
    ...
    public SignRequestParams(@SafeParcelable.Param(m37228id = 2) Integer num, @Nullable @SafeParcelable.Param(m37228id = 3) Double d10, @SafeParcelable.Param(m37228id = 4) Uri uri, @SafeParcelable.Param(m37228id = 5) byte[] bArr, @SafeParcelable.Param(m37228id = 6) List list, @SafeParcelable.Param(m37228id = 7) ChannelIdValue channelIdValue, @SafeParcelable.Param(m37228id = 8) String str) {
        boolean z10;
        boolean z11;
        this.zza = num;
        this.zzb = d10;
