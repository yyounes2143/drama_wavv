...
public class SignResponseData extends ResponseData {
    ...
    @SafeParcelable.Field(getter = "getClientDataString", m37227id = 3)
    private final String zzb;

    @SafeParcelable.Field(getter = "getSignatureData", m37227id = 4)
    private final byte[] zzc;

    @SafeParcelable.Field(getter = "getApplication", m37227id = 5)
    ...
    public SignResponseData(@NonNull @SafeParcelable.Param(m37228id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(m37228id = 3) String str, @NonNull @SafeParcelable.Param(m37228id = 4) byte[] bArr2, @NonNull @SafeParcelable.Param(m37228id = 5) byte[] bArr3) {
