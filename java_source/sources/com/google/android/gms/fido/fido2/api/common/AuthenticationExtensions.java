...
public class AuthenticationExtensions extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getFidoAppIdExtension", m37227id = 2)
    private final FidoAppIdExtension zza;

    @Nullable
    @SafeParcelable.Field(getter = "getCableAuthenticationExtension", m37227id = 3)
    private final zzs zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getUserVerificationMethodExtension", m37227id = 4)
    private final UserVerificationMethodExtension zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getGoogleMultiAssertionExtension", m37227id = 5)
    private final zzz zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getGoogleSessionIdExtension", m37227id = 6)
    private final zzab zze;

    @Nullable
    @SafeParcelable.Field(getter = "getGoogleSilentVerificationExtension", m37227id = 7)
    private final zzad zzf;

    @Nullable
    @SafeParcelable.Field(getter = "getDevicePublicKeyExtension", m37227id = 8)
    private final zzu zzg;

    @Nullable
    @SafeParcelable.Field(getter = "getGoogleTunnelServerIdExtension", m37227id = 9)
    private final zzag zzh;

    @Nullable
    @SafeParcelable.Field(getter = "getGoogleThirdPartyPaymentExtension", m37227id = 10)
    private final GoogleThirdPartyPaymentExtension zzi;

    @Nullable
    @SafeParcelable.Field(getter = "getPrfExtension", m37227id = 11)
    ...
    public AuthenticationExtensions(@Nullable @SafeParcelable.Param(m37228id = 2) FidoAppIdExtension fidoAppIdExtension, @Nullable @SafeParcelable.Param(m37228id = 3) zzs zzsVar, @Nullable @SafeParcelable.Param(m37228id = 4) UserVerificationMethodExtension userVerificationMethodExtension, @Nullable @SafeParcelable.Param(m37228id = 5) zzz zzzVar, @Nullable @SafeParcelable.Param(m37228id = 6) zzab zzabVar, @Nullable @SafeParcelable.Param(m37228id = 7) zzad zzadVar, @Nullable @SafeParcelable.Param(m37228id = 8) zzu zzuVar, @Nullable @SafeParcelable.Param(m37228id = 9) zzag zzagVar, @Nullable @SafeParcelable.Param(m37228id = 10) GoogleThirdPartyPaymentExtension googleThirdPartyPaymentExtension, @Nullable @SafeParcelable.Param(m37228id = 11) zzai zzaiVar) {
        this.zza = fidoAppIdExtension;
