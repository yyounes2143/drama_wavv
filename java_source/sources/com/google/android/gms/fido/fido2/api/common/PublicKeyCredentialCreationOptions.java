...
public class PublicKeyCredentialCreationOptions extends RequestOptions {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getRp", m37227id = 2)
    private final PublicKeyCredentialRpEntity zza;

    @NonNull
    @SafeParcelable.Field(getter = "getUser", m37227id = 3)
    private final PublicKeyCredentialUserEntity zzb;

    @NonNull
    @SafeParcelable.Field(getter = "getChallenge", m37227id = 4)
    private final byte[] zzc;

    @NonNull
    @SafeParcelable.Field(getter = "getParameters", m37227id = 5)
    private final List zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getTimeoutSeconds", m37227id = 6)
    private final Double zze;

    @Nullable
    @SafeParcelable.Field(getter = "getExcludeList", m37227id = 7)
    private final List zzf;

    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticatorSelection", m37227id = 8)
    private final AuthenticatorSelectionCriteria zzg;

    @Nullable
    @SafeParcelable.Field(getter = "getRequestId", m37227id = 9)
    private final Integer zzh;

    @Nullable
    @SafeParcelable.Field(getter = "getTokenBinding", m37227id = 10)
    private final TokenBinding zzi;

    @Nullable
    @SafeParcelable.Field(getter = "getAttestationConveyancePreferenceAsString", m37227id = 11, type = C23970m.f109601f)
    private final AttestationConveyancePreference zzj;

    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticationExtensions", m37227id = 12)
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialCreationOptions build() {
            ...
            return new PublicKeyCredentialCreationOptions(publicKeyCredentialRpEntity, publicKeyCredentialUserEntity, bArr, list, d10, list2, authenticatorSelectionCriteria, num, tokenBinding, attestationConveyancePreference, this.zzk);
        }
    ...
    public PublicKeyCredentialCreationOptions(@NonNull @SafeParcelable.Param(m37228id = 2) PublicKeyCredentialRpEntity publicKeyCredentialRpEntity, @NonNull @SafeParcelable.Param(m37228id = 3) PublicKeyCredentialUserEntity publicKeyCredentialUserEntity, @NonNull @SafeParcelable.Param(m37228id = 4) byte[] bArr, @NonNull @SafeParcelable.Param(m37228id = 5) List list, @Nullable @SafeParcelable.Param(m37228id = 6) Double d10, @Nullable @SafeParcelable.Param(m37228id = 7) List list2, @Nullable @SafeParcelable.Param(m37228id = 8) AuthenticatorSelectionCriteria authenticatorSelectionCriteria, @Nullable @SafeParcelable.Param(m37228id = 9) Integer num, @Nullable @SafeParcelable.Param(m37228id = 10) TokenBinding tokenBinding, @Nullable @SafeParcelable.Param(m37228id = 11) String str, @Nullable @SafeParcelable.Param(m37228id = 12) AuthenticationExtensions authenticationExtensions) {
        this.zza = (PublicKeyCredentialRpEntity) Preconditions.checkNotNull(publicKeyCredentialRpEntity);
        this.zzb = (PublicKeyCredentialUserEntity) Preconditions.checkNotNull(publicKeyCredentialUserEntity);
        this.zzc = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzd = (List) Preconditions.checkNotNull(list);
