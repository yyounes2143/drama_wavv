...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getRpId", m37227id = 4)
    private final String zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getAllowList", m37227id = 5)
    private final List zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getRequestId", m37227id = 6)
    private final Integer zze;

    @Nullable
    @SafeParcelable.Field(getter = "getTokenBinding", m37227id = 7)
    private final TokenBinding zzf;

    @Nullable
    @SafeParcelable.Field(getter = "getUserVerificationAsString", m37227id = 8, type = C23970m.f109601f)
    private final zzay zzg;

    @Nullable
    @SafeParcelable.Field(getter = "getAuthenticationExtensions", m37227id = 9)
    private final AuthenticationExtensions zzh;

    @Nullable
    @SafeParcelable.Field(getter = "getLongRequestId", m37227id = 10)
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialRequestOptions build() {
            ...
            return new PublicKeyCredentialRequestOptions(bArr, d10, str, list, num, tokenBinding, zzayVar, this.zzh, null);
        }
    ...
    public PublicKeyCredentialRequestOptions(@NonNull @SafeParcelable.Param(m37228id = 2) byte[] bArr, @Nullable @SafeParcelable.Param(m37228id = 3) Double d10, @NonNull @SafeParcelable.Param(m37228id = 4) String str, @Nullable @SafeParcelable.Param(m37228id = 5) List list, @Nullable @SafeParcelable.Param(m37228id = 6) Integer num, @Nullable @SafeParcelable.Param(m37228id = 7) TokenBinding tokenBinding, @Nullable @SafeParcelable.Param(m37228id = 8) String str2, @Nullable @SafeParcelable.Param(m37228id = 9) AuthenticationExtensions authenticationExtensions, @Nullable @SafeParcelable.Param(m37228id = 10) Long l) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d10;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
