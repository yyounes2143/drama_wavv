...
public class AuthenticatorAssertionResponse extends AuthenticatorResponse {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getClientDataJSON", m37227id = 3)
    private final byte[] zzb;

    @NonNull
    @SafeParcelable.Field(getter = "getAuthenticatorData", m37227id = 4)
    private final byte[] zzc;

    @NonNull
    @SafeParcelable.Field(getter = "getSignature", m37227id = 5)
    private final byte[] zzd;

    @Nullable
    @SafeParcelable.Field(getter = "getUserHandle", m37227id = 6)
    ...
    public AuthenticatorAssertionResponse(@NonNull @SafeParcelable.Param(m37228id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(m37228id = 3) byte[] bArr2, @NonNull @SafeParcelable.Param(m37228id = 4) byte[] bArr3, @NonNull @SafeParcelable.Param(m37228id = 5) byte[] bArr4, @Nullable @SafeParcelable.Param(m37228id = 6) byte[] bArr5) {
