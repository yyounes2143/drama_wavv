...
public class AuthenticatorAttestationResponse extends AuthenticatorResponse {
    ...
    @NonNull
    @SafeParcelable.Field(getter = "getAttestationObject", m37227id = 4)
    private final byte[] zzc;

    @NonNull
    @SafeParcelable.Field(getter = "getTransports", m37227id = 5)
    ...
    public AuthenticatorAttestationResponse(@NonNull @SafeParcelable.Param(m37228id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(m37228id = 3) byte[] bArr2, @NonNull @SafeParcelable.Param(m37228id = 4) byte[] bArr3, @NonNull @SafeParcelable.Param(m37228id = 5) String[] strArr) {
