...
public class AuthenticationExtensionsClientOutputs extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(getter = "getUvmEntries", m37227id = 1)
    private final UvmEntries zza;

    @Nullable
    @SafeParcelable.Field(getter = "getDevicePubKey", m37227id = 2)
    private final zzf zzb;

    @Nullable
    @SafeParcelable.Field(getter = "getCredProps", m37227id = 3)
    private final AuthenticationExtensionsCredPropsOutputs zzc;

    @Nullable
    @SafeParcelable.Field(getter = "getPrf", m37227id = 4)
    ...
    public AuthenticationExtensionsClientOutputs(@Nullable @SafeParcelable.Param(m37228id = 1) UvmEntries uvmEntries, @Nullable @SafeParcelable.Param(m37228id = 2) zzf zzfVar, @Nullable @SafeParcelable.Param(m37228id = 3) AuthenticationExtensionsCredPropsOutputs authenticationExtensionsCredPropsOutputs, @Nullable @SafeParcelable.Param(m37228id = 4) zzh zzhVar) {
        this.zza = uvmEntries;
        this.zzb = zzfVar;
