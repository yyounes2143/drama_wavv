...
public final class Gson {
    ...
    /* loaded from: classes.dex */
    public class C231181 extends TypeAdapter<Number> {
    ...
    /* loaded from: classes.dex */
    public class C231192 extends TypeAdapter<Number> {
        @Override // com.google.gson.TypeAdapter
        /* renamed from: read */
        public Number read2(JsonReader jsonReader) throws IOException {
            if (jsonReader.peek() == JsonToken.NULL) {
    ...
    public static class FutureTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
        ...
        /* renamed from: a */
        public TypeAdapter<T> f104777a = null;

        @Override // com.google.gson.internal.bind.SerializationDelegatingTypeAdapter
        public TypeAdapter<T> getSerializationDelegate() {
            TypeAdapter<T> typeAdapter = this.f104777a;
            if (typeAdapter != null) {
                return typeAdapter;
            }
        ...
        public void setDelegate(TypeAdapter<T> typeAdapter) {
            if (this.f104777a == null) {
                this.f104777a = typeAdapter;
                return;
            }
    ...
    */
    public <T> com.google.gson.TypeAdapter<T> getAdapter(com.google.gson.reflect.TypeToken<T> r7) {
        ...
        L31:
            ...
            java.util.List<com.google.gson.TypeAdapterFactory> r3 = r6.factories     // Catch: java.lang.Throwable -> L59
