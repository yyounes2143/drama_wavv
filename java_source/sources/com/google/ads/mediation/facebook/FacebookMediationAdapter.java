...
public class FacebookMediationAdapter extends RtbAdapter {
    ...
    /* renamed from: a */
    public final MetaFactory f95183a = new MetaFactory();
    ...
    public void initialize(@NonNull Context context, @NonNull final InitializationCompleteCallback initializationCompleteCallback, @NonNull List<MediationConfiguration> list) {
        ...
        if (FacebookInitializer.f95179d == null) {
            FacebookInitializer.f95179d = new FacebookInitializer();
        }
        FacebookInitializer facebookInitializer = FacebookInitializer.f95179d;
        ...
        if (facebookInitializer.f95180a) {
            facebookInitializer.f95182c.add(listener);
            return;
        }
        if (facebookInitializer.f95181b) {
            listener.onInitializeSuccess();
            return;
        }
        facebookInitializer.f95180a = true;
        if (facebookInitializer == null) {
            FacebookInitializer.f95179d = new FacebookInitializer();
        }
        FacebookInitializer.f95179d.f95182c.add(listener);
        AudienceNetworkAds.buildInitSettings(context).withMediationService("GOOGLE:6.20.0.0").withPlacementIds(arrayList).withInitListener(facebookInitializer).initialize();
    }
    ...
    public void loadRtbBannerAd(@NonNull MediationBannerAdConfiguration mediationBannerAdConfiguration, @NonNull MediationAdLoadCallback<MediationBannerAd, MediationBannerAdCallback> mediationAdLoadCallback) {
        new FacebookRtbBannerAd(mediationBannerAdConfiguration, mediationAdLoadCallback, this.f95183a).render();
    }

    @Override // com.google.android.gms.ads.mediation.rtb.RtbAdapter
    public void loadRtbInterstitialAd(@NonNull MediationInterstitialAdConfiguration mediationInterstitialAdConfiguration, @NonNull MediationAdLoadCallback<MediationInterstitialAd, MediationInterstitialAdCallback> mediationAdLoadCallback) {
        new FacebookRtbInterstitialAd(mediationInterstitialAdConfiguration, mediationAdLoadCallback, this.f95183a).render();
    }
    ...
    public void loadRtbNativeAd(@NonNull MediationNativeAdConfiguration mediationNativeAdConfiguration, @NonNull MediationAdLoadCallback<UnifiedNativeAdMapper, MediationNativeAdCallback> mediationAdLoadCallback) {
        new FacebookRtbNativeAd(mediationNativeAdConfiguration, mediationAdLoadCallback, this.f95183a).render();
    }

    @Override // com.google.android.gms.ads.mediation.rtb.RtbAdapter
    public void loadRtbRewardedAd(@NonNull MediationRewardedAdConfiguration mediationRewardedAdConfiguration, @NonNull MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback> mediationAdLoadCallback) {
        new FacebookRewardedAd(mediationRewardedAdConfiguration, mediationAdLoadCallback, this.f95183a).render();
    }
    ...
    public void loadRtbRewardedInterstitialAd(@NonNull MediationRewardedAdConfiguration mediationRewardedAdConfiguration, @NonNull MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback> mediationAdLoadCallback) {
        new FacebookRewardedInterstitialAd(mediationRewardedAdConfiguration, mediationAdLoadCallback, this.f95183a).render();
    }
