...
public class UnityMediationAdapter extends RtbAdapter {
    ...
    /* renamed from: com.google.ads.mediation.unity.UnityMediationAdapter$1 */
    /* loaded from: classes8.dex */
    public class C213291 implements IUnityAdsInitializationListener {
        ...
        public void onInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
            AdError m37077b = UnityAdsAdapterUtils.m37077b(unityAdsInitializationError, "Unity Ads initialization failed: [" + unityAdsInitializationError + "] " + str);
            m37077b.toString();
            InitializationCompleteCallback.this.onInitializationFailed(m37077b.toString());
        }
    ...
    public UnityMediationAdapter() {
        this.unityInitializer = UnityInitializer.m37082a();
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.unityInitializer.initializeUnityAds(context, str, new IUnityAdsInitializationListener() { // from class: com.google.ads.mediation.unity.UnityMediationAdapter.1
                ...
                public void onInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str2) {
                    AdError m37077b = UnityAdsAdapterUtils.m37077b(unityAdsInitializationError, "Unity Ads initialization failed: [" + unityAdsInitializationError + "] " + str2);
                    m37077b.toString();
                    InitializationCompleteCallback.this.onInitializationFailed(m37077b.toString());
                }
    ...
    public void collectSignals(@NonNull RtbSignalData rtbSignalData, @NonNull SignalCallbacks signalCallbacks) {
        UnityAds.getToken(new C1759a0(signalCallbacks));
    }

    @Override // com.google.android.gms.ads.mediation.Adapter
    @NonNull
    public VersionInfo getVersionInfo() {
        String[] split = "4.14.2.0".split("\\.");
        if (split.length >= 4) {
