...
public final class FilteredEntrySetMultimap<K, V> extends FilteredEntryMultimap<K, V> implements FilteredSetMultimap<K, V> {
    public FilteredEntrySetMultimap() {
        throw null;
    }
    ...
    public Set<V> get(@ParametricNullness K k8) {
        return (Set) super.get((FilteredEntrySetMultimap<K, V>) k8);
    }
    ...
    public Set<V> replaceValues(@ParametricNullness K k8, Iterable<? extends V> iterable) {
        return (Set) super.replaceValues((FilteredEntrySetMultimap<K, V>) k8, (Iterable) iterable);
    }

    @Override // com.google.common.collect.FilteredEntryMultimap, com.google.common.collect.FilteredMultimap
    public SetMultimap<K, V> unfiltered() {
        return (SetMultimap) this.f100337f;
    }
