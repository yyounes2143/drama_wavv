...
public final class MultiFormatOneDReader extends OneDReader {
    ...
    /* renamed from: a */
    public final OneDReader[] f105509a;

    @Override // com.google.zxing.oned.OneDReader
    public Result decodeRow(int i10, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        for (OneDReader oneDReader : this.f105509a) {
            try {
                return oneDReader.decodeRow(i10, bitArray, map);
    ...
    public MultiFormatOneDReader(Map<DecodeHintType, ?> map) {
        ...
        if (collection != null) {
            ...
            if (collection.contains(BarcodeFormat.CODE_39)) {
                arrayList.add(new Code39Reader(z10));
            }
        ...
        this.f105509a = (OneDReader[]) arrayList.toArray(new OneDReader[arrayList.size()]);
    }
}
