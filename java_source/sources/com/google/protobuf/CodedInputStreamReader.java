...
public final class CodedInputStreamReader implements Reader {
    ...
    */
    ...
    /* loaded from: classes8.dex */
    public static /* synthetic */ class C232601 {
    ...
    private <T> void mergeGroupFieldInternal(T t3, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
    ...
    private <T> void mergeMessageFieldInternal(T t3, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
    ...
    private Object readField(WireFormat.FieldType fieldType, Class<?> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        switch (C232601.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
