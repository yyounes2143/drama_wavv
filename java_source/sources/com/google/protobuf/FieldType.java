...
public final class FieldType {
    ...
    /* loaded from: classes2.dex */
    public static /* synthetic */ class C232821 {
    ...
    static {
        ...
        for (FieldType fieldType52 : values) {
            VALUES[fieldType52.f105085id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i10, int i11, Collection collection, JavaType javaType) {
        int i12;
        this.f105085id = i11;
        this.collection = collection;
        this.javaType = javaType;
        int i13 = C232821.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i13 != 1) {
            if (i13 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i12 = C232821.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
