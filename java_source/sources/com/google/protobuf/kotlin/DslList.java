...
public final class DslList<E, P extends DslProxy> implements List<E>, KMappedMarker, p629j$.util.List {
    ...
    public DslList(@NotNull java.util.List<? extends E> delegate) {
