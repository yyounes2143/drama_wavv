...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public /* synthetic */ Builder(C232811 c232811) {
            this();
        }
        ...
        public Object getFieldAllowBuilders(T t3) {
        ...
        public Object getRepeatedField(T t3, int i10) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t3, i10), true);
        }
        ...
        public Object getRepeatedFieldAllowBuilders(T t3, int i10) {
            if (t3.isRepeated()) {
                Object fieldAllowBuilders = getFieldAllowBuilders(t3);
                if (fieldAllowBuilders != null) {
        ...
        public void setRepeatedField(T t3, int i10, Object obj) {
            boolean z10;
            ensureIsMutable();
            if (t3.isRepeated()) {
                if (!this.hasNestedBuilders && !(obj instanceof MessageLite.Builder)) {
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t3, Object obj, boolean z10) {
    ...
    public /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C232811 c232811) {
        this(smallSortedMap);
    }
    ...
    /* loaded from: classes5.dex */
    public static /* synthetic */ class C232811 {
    ...
    public static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (C232811.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C232811) null);
    }
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C232811.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 1:
