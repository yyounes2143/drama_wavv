...
public class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class Entry implements Map.Entry<K, V>, Comparable<SmallSortedMap<K, V>.Entry> {
        ...
        public String toString() {
            return this.key + ImpressionLog.f107415Z + this.value;
        }
    ...
    private int binarySearchInArray(K k8) {
        int i10;
        int size = this.entryList.size();
        int i11 = size - 1;
        if (i11 >= 0) {
            int compareTo = k8.compareTo(this.entryList.get(i11).getKey());
            if (compareTo > 0) {
                i10 = size + 1;
                return -i10;
            }
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int compareTo2 = k8.compareTo(this.entryList.get(i13).getKey());
            if (compareTo2 < 0) {
                i11 = i13 - 1;
    ...
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int i10) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(i10) { // from class: com.google.protobuf.SmallSortedMap.1
            ...
            public /* bridge */ /* synthetic */ Object put(Object obj, Object obj2) {
                return super.put((C233021<FieldDescriptorType>) obj, (Comparable) obj2);
            }
    ...
    public static <K extends Comparable<K>, V> SmallSortedMap<K, V> newInstanceForTest(int i10) {
        return new SmallSortedMap<>(i10);
    }
    ...
    public V put(K k8, V v10) {
        checkMutable();
        int binarySearchInArray = binarySearchInArray(k8);
        if (binarySearchInArray >= 0) {
        ...
        if (i10 >= this.maxArraySize) {
            return getOverflowEntriesMutable().put(k8, v10);
        }
        int size = this.entryList.size();
        ...
        this.entryList.add(i10, new Entry(k8, v10));
        return null;
    }
