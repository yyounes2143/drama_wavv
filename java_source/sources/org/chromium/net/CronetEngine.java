...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        /* renamed from: org.chromium.net.CronetEngine$Builder$a */
        /* loaded from: classes2.dex */
        public class C28166a implements Comparator<CronetProvider> {
            ...
            if (str != null && str2 != null) {
                ...
                for (int i10 = 0; i10 < split.length && i10 < split2.length; i10++) {
                    try {
                        ...
                        throw new IllegalArgumentException("Unable to convert version segments into integers: " + split[i10] + " & " + split2[i10], e3);
                    }
                }
