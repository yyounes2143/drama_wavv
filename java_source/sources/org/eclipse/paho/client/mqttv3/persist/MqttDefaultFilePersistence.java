...
public class MqttDefaultFilePersistence implements MqttClientPersistence {
    ...
    public boolean containsKey(String str) throws MqttPersistenceException {
        checkIsOpen();
        return new File(this.clientDir, C3091b.m5597a(str, MESSAGE_FILE_EXTENSION)).exists();
    }
    ...
    public void put(String str, MqttPersistable mqttPersistable) throws MqttPersistenceException {
        checkIsOpen();
        File file = new File(this.clientDir, C3091b.m5597a(str, MESSAGE_FILE_EXTENSION));
        File file2 = new File(this.clientDir, C3091b.m5597a(str, ".msg.bup"));
